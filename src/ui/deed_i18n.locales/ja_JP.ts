...
export const table: DeedLocaleTable = {
  ...
  prog_veteran: {
    name: '古参',
    desc: '生涯経験値250,000を獲得する。',
    title: '古参',
  },
  prog_champion: {
    name: '勇者',
    desc: '生涯経験値500,000を獲得する。',
    title: '勇者',
  },
  prog_paragon: {
    name: '範士',
    desc: '生涯経験値1,000,000を獲得する。',
    title: '範士',
  },
  prog_mythic: {
    name: '神話',
    desc: '生涯経験値2,500,000を獲得する。',
    title: '神話',
  },
  prog_eternal: {
    name: '永遠',
    desc: '生涯経験値5,000,000を獲得する。',
    title: '永遠',
  },
  prog_prestige: {
    name: 'もう一度はじめから',
  ...
  prog_prestige_5: {
    name: '三つ子の魂',
    desc: 'プレステージランク5に到達する。',
  },
  prog_prestige_10: {
    name: '永久機関',
    desc: 'プレステージランク10に到達する。',
  },
  prog_first_harvest: {
    name: '野の実り',
    desc: '初めて採集ポイントを収穫する。',
  ...
  cmb_heavy_hitter: {
    name: '剛打の使い手',
    desc: '合計500,000のダメージを与える。',
  },
  cmb_critical_eye: {
    name: '会心の眼',
    desc: 'クリティカルヒットを500回命中させる。',
  },
  cmb_giantslayer: {
    name: '巨人殺し',
    desc: '自分より5レベル以上高い敵にとどめの一撃を放つ。',
  },
  cmb_first_fall: {
    name: '埃を払って立て',
    desc: '初めて死ぬ。誰にでもあることだ。',
  },
  dgn_hollow_crypt: {
    name: '墓所破り',
    desc: '虚ろの墓所で墓呼びのモーセンを倒す。',
  },
  dgn_sunken_bastion: {
    name: '解けた霧の縛め',
  ...
  dlv_litany_heroic: {
    name: '英雄：溺れし連祷',
    desc: '溺れし連祷を英雄ティアで攻略する。',
  },
  dlv_lore_journal: {
    name: '欄外の書き込み',
    desc: 'デルヴ日誌の項目5つをすべて解放する。',
  },
  dlv_companion_max: {
    name: '深みの友',
    desc: 'デルヴの相棒を最高位まで育て上げる。',
  },
  dlv_companions_both: {
    name: '灯る二つのランタン',
  ...
  col_discovery_250: {
    name: '大いなる目録',
    desc: '250種類のアイテムを発見する。',
  },
  col_first_rare: {
    name: 'サムシング・ブルー',
    desc: '初めてレア品質のアイテムを手に入れる。',
  },
  col_first_epic: {
    name: '高貴なる紫',
    desc: '初めてエピック品質のアイテムを手に入れる。',
  },
  col_first_legendary: {
    name: '果報は橙色',
  ...
  pvp_arena_2v2_1600: {
    name: '二人三脚',
    desc: 'アリーナの2v2部門でレート1600に到達する。',
  },
  pvp_arena_2v2_1750: {
    name: '戦慄の二人組',
    desc: 'アリーナの2v2部門でレート1750に到達する。',
  },
  pvp_arena_2v2_1900: {
    name: '完璧なる連携',
    desc: 'アリーナの2v2部門でレート1900に到達する。',
  },
  pvp_duel_first_win: {
    name: '表へ出ろ',
    desc: '決闘に勝利する。',
  ...
  pvp_vcup_first_win: {
    name: '初めての銀杯',
    desc: 'ヴェイルカップのレート戦に勝利する。',
  },
  pvp_vcup_wins_10: {
    name: '熟練ボアボーラー',
    desc: 'ヴェイルカップのレート戦で10勝する。',
  },
  pvp_vcup_wins_25: {
    name: 'ボアボールの伝説',
  ...
  pvp_fiesta_first_win: {
    name: '宴の主役',
    desc: '2v2フィエスタの一戦に勝利する。',
  },
  pvp_fiesta_double: {
    name: '二丁上がり',
    desc: 'フィエスタで4秒以内に2回の撃破を決める。',
  },
  pvp_fiesta_shutdown: {
    name: '祭りに水を差す者',
  ...
  pvp_fiesta_five_kills: {
    name: '宴を背負う者',
    desc: 'フィエスタの一戦で5回の撃破を決める。',
  },
  soc_first_party: {
    name: '持つべきものは仲間',
    desc: '他のプレイヤーとパーティを組む。',
  },
  soc_full_house: {
    name: 'フルハウス',
    desc: '5人満員のパーティでダンジョンを攻略する。',
  },
  soc_guild_joined: {
    name: '同じ旗の下に',
    desc: 'ギルドの一員になる。',
  ...
  soc_first_trade: {
    name: '公正な取引',
    desc: '他のプレイヤーとの取引を成立させる。',
  },
  soc_first_sale: {
    name: '本日開店',
    desc: '世界市場での初めての売上金を受け取る。',
  },
  soc_steady_custom: {
    name: '堅実な商い',
  ...
  soc_pocket_money: {
    name: '小遣い銭',
    desc: '硬貨を生涯累計で1ゴールド拾い集める。',
  },
  soc_heavy_purse: {
    name: 'ずっしり重い財布',
    desc: '硬貨を生涯累計で10ゴールド拾い集める。',
  },
  soc_wyrms_hoard: {
    name: 'ワームの財宝',
    desc: '硬貨を生涯累計で100ゴールド拾い集める。',
  },
  soc_civic_duty: {
    name: '市民の務め',
    desc: '町の重点ポイントを初めて割り振る。',
  },
  exp_long_road_north: {
    name: '北への長い道',
  ...
  feat_era_cap: {
    name: '第一の時代の申し子',
    desc: '第一の時代のさなかにレベル20へ到達した。',
  },
  feat_book_complete: {
    name: '書のすべて',
    desc: '功績の書に載るすべての功績を獲得する。',
  },
  ...
  prog_tools_of_the_trade: {
    name: '商売道具',
    desc: '[JA] Complete a craft at a crafting station.',
  },
  dgn_nythraxis_crypt: {
    name: '墓所が守りしもの',
