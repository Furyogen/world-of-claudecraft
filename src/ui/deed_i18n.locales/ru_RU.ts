...
export const table: DeedLocaleTable = {
  ...
  prog_the_long_middle: {
    name: 'Долгая середина',
    desc: 'Достигните 15-го уровня.',
  },
  prog_level_cap: {
    name: 'Вид с вершины',
    desc: 'Достигните 20-го уровня, предела развития.',
  },
  prog_well_rested: {
  ...
  prog_talented: {
    name: 'Очко, вложенное с умом',
    desc: 'Потратьте первое очко талантов.',
  },
  prog_specialized: {
  ...
  prog_prestige_5: {
    ...
    desc: 'Достигните 5-го ранга престижа.',
  },
  prog_prestige_10: {
    name: 'Вечный двигатель',
    desc: 'Достигните 10-го ранга престижа.',
  },
  prog_first_harvest: {
    name: 'Плоды земли',
  ...
  prog_mining_100: {
    name: 'Руда в крови',
    desc: 'Доведите навык горного дела до 100.',
  },
  prog_logging_100: {
    name: 'Рубщик сердцевины',
    desc: 'Доведите навык лесозаготовки до 100.',
  },
  prog_herbalism_100: {
    name: 'Хозяин луга',
    desc: 'Доведите навык травничества до 100.',
  },
  ...
  prog_first_craft: {
    name: 'Ручная работа',
    desc: 'Успешно создайте своё первое изделие.',
  },
  ...
  cmb_first_blood: {
    name: 'Первая кровь',
    desc: 'Одолейте своего первого врага.',
  },
  cmb_slayer: {
    name: 'Истребитель',
    desc: 'Одолейте 1000 врагов.',
  },
  cmb_legion_of_one: {
    name: 'Легион из одного',
    desc: 'Одолейте 10 000 врагов.',
  },
  cmb_heavy_hitter: {
    name: 'Тяжёлая рука',
    desc: 'Нанесите 500 000 суммарного урона.',
  },
  cmb_critical_eye: {
    name: 'Намётанный глаз',
    desc: 'Нанесите 500 критических ударов.',
  },
  cmb_giantslayer: {
  ...
  dlv_reliquary: {
    name: 'Ходок в Реликварий',
    desc: 'Пройдите Обрушившийся Реликварий.',
  },
  ...
  dlv_litany: {
    name: 'Утишить Литанию',
    desc: 'Пройдите Утонувшую Литанию.',
  },
  dlv_litany_heroic: {
  ...
  dlv_clears_50: {
    name: 'Пятьдесят саженей',
    desc: 'Завершите 50 вылазок.',
  },
  dlv_solo_heroic: {
    name: 'Третий лишний',
  ...
  chr_vale_packbreaker: {
    name: 'Гроза стаи',
    desc: 'Убейте 3 лесных волков за 10 секунд.',
  },
  chr_vale_cup_debut: {
  ...
  col_discovery_75: {
    name: 'Сорока',
    desc: 'Найдите 75 разных предметов.',
  },
  col_discovery_150: {
    name: 'Кунсткамера',
  ...
  col_discovery_250: {
    ...
    desc: 'Найдите 250 разных предметов.',
  },
  col_first_rare: {
    name: 'Синяя птица',
    desc: 'Получите свой первый предмет редкого качества.',
  },
  col_first_epic: {
  ...
  pvp_vcup_first_win: {
    name: 'Первый трофей',
    desc: 'Выиграйте рейтинговый матч Кубка Долины.',
  },
  pvp_vcup_wins_10: {
  ...
  pvp_fiesta_first_win: {
    name: 'Душа Фиесты',
    desc: 'Победите в бою Фиесты 2 на 2.',
  },
  pvp_fiesta_double: {
    name: 'Двойной удар',
  ...
  soc_first_party: {
    name: 'Вместе веселее',
    desc: 'Вступите в группу с другим игроком.',
  },
  soc_full_house: {
    name: 'Аншлаг',
    desc: 'Пройдите подземелье полной группой из пяти человек.',
  },
  soc_guild_joined: {
    name: 'Под одним знаменем',
    desc: 'Станьте членом гильдии.',
  },
  soc_guild_founded: {
    name: 'Перо основателя',
    desc: 'Создайте собственную гильдию.',
  },
  soc_first_trade: {
    name: 'Честный обмен',
    desc: 'Завершите обмен с другим игроком.',
  },
  soc_first_sale: {
    name: 'Лавка открыта',
  ...
  soc_room_for_more: {
    name: 'Место ещё найдётся',
    desc: 'Купите своё первое расширение банка.',
  },
  ...
  exp_first_ore: {
    name: 'Вгрызайся в землю',
    desc: 'Разработайте свою первую рудную жилу.',
  },
  exp_first_timber: {
    name: 'Поберегись!',
    desc: 'Соберите древесину со своей первой делянки.',
  },
  exp_first_herb: {
    name: 'Лёгкая рука',
    desc: 'Соберите травы со своих первых зарослей.',
  },
  feat_era_cap: {
  ...
  prog_tools_of_the_trade: {
    name: 'Орудия ремесла',
    desc: '[RU] Complete a craft at a crafting station.',
  },
  dgn_nythraxis_crypt: {
