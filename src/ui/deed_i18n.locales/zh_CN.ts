...
export const table: DeedLocaleTable = {
  prog_first_steps: {
    name: '千里之行',
    desc: '达到2级，在漫漫长路上迈出你的第一步。',
  },
  prog_finding_your_feet: {
    name: '站稳脚跟',
    desc: '达到5级；荒野看上去已经小了一些。',
  },
  prog_double_digits: {
    name: '迈入两位数',
    desc: '达到10级，解锁你的天赋。',
  ...
  prog_specialized: {
    name: '志向已定',
    desc: '选择一门专精，并习得它的招牌技能。',
  },
  prog_deep_roots: {
    name: '根深蒂固',
    desc: '将一点天赋点投入最后一排的天赋。',
  },
  prog_full_build: {
    name: '六行俱全',
  ...
  prog_veteran: {
    name: '老兵',
    desc: '生涯累计获得250,000点经验。',
    title: '老兵',
  },
  prog_champion: {
    name: '冠军',
    desc: '生涯累计获得500,000点经验。',
    title: '冠军',
  },
  prog_paragon: {
    name: '典范',
    desc: '生涯累计获得1,000,000点经验。',
    title: '典范',
  },
  prog_mythic: {
    name: '神话',
    desc: '生涯累计获得2,500,000点经验。',
    title: '神话',
  },
  prog_eternal: {
    name: '永恒',
    desc: '生涯累计获得5,000,000点经验。',
    title: '永恒',
  },
  prog_prestige: {
    name: '从头再来',
    desc: '达到等级上限，再次填满经验条，获得转生1阶。',
  },
  prog_prestige_5: {
    name: '积习难改',
    desc: '达到转生5阶。',
  ...
  cmb_giantslayer: {
    name: '屠巨者',
    desc: '对一个至少比你高出五级的敌人打出最后一击。',
  },
  cmb_first_fall: {
    name: '掸土再战',
    desc: '迎来你的第一次死亡；再强的英雄也难免此劫。',
  },
  dgn_hollow_crypt: {
    name: '破墓者',
    desc: '在空洞墓穴中击败唤墓者莫森。',
  ...
  dgn_vael_thralls: {
    name: '绝不为奴',
    desc: '击败缚雾者维尔时，他召来的溺亡奴仆已尽数被斩。',
  },
  dgn_ysolei_moonspawn: {
    name: '月孽尽除',
    desc: '击败伊索蕾时，她召来的月之孽生已尽数被斩。',
  },
  dgn_ysolei_flawless: {
    name: '眼中无泪',
  ...
  chr_vale_packbreaker: {
    name: '破群者',
    desc: '在 10 秒内斩杀 3 只森林狼。',
  },
  chr_vale_cup_debut: {
    name: '铜桶新秀',
    desc: '在母猪场进行的溪谷杯比赛中登场并触到球。',
  },
  chr_vale_rares: {
    name: '溪谷群凶',
  ...
  col_true_colors: {
    name: '真我本色',
    desc: '穿着你职业默认之外的任意外观登场。',
  },
  col_all_slots: {
    name: '十一分讲究',
    desc: '让全部十一个装备栏位同时都有装备。',
  },
  col_quartermaster_buyout: {
    name: '老主顾',
    desc: '发现军需官维克斯所售的全部十件货品。',
  },
  col_glimmerfin: {
    name: '一线微光',
    desc: '钓起一条微光鳍锦鲤。',
  ...
  col_full_creel: {
    name: '满载鱼篓',
    desc: '发现来自溪谷、湿地与高地水域的全部六种常见渔获。',
  },
  col_junk_drawer: {
    name: '杂物抽屉',
    desc: '发现 10 件不同的粗糙品质物品。',
  },
  pvp_arena_first_match: {
    name: '靴中黄沙',
    desc: '在灰烬竞技场打一场评级赛，任一组别皆可。',
  },
  pvp_arena_first_win: {
    name: '满场喝彩',
    desc: '在任一组别中赢下一场竞技场评级赛。',
  },
  pvp_arena_1v1_1600: {
    name: '竞技场挑战者',
    desc: '在竞技场1v1组别中将评级提升至1600。',
  },
  pvp_arena_1v1_1750: {
    name: '竞技场劲敌',
    desc: '在竞技场1v1组别中将评级提升至1750。',
  },
  pvp_arena_1v1_1900: {
    name: '角斗士',
  ...
  pvp_arena_2v2_1600: {
    name: '二人同心',
    desc: '在竞技场2v2组别中将评级提升至1600。',
  },
  pvp_arena_2v2_1750: {
    name: '绝命双煞',
    desc: '在竞技场2v2组别中将评级提升至1750。',
  },
  pvp_arena_2v2_1900: {
    name: '天作之合',
    desc: '在竞技场2v2组别中将评级提升至1900。',
  },
  pvp_duel_first_win: {
    name: '门外了断',
    desc: '赢得一场决斗。',
  ...
  pvp_vcup_hat_trick: {
    name: '帽子戏法',
    desc: '在3v3或更大组别的单场溪谷杯评级赛中攻入3球。',
  },
  pvp_vcup_golden_goal: {
    name: '黄金一刻',
    desc: '射入决定一场溪谷杯评级赛胜负的金球。',
  },
  pvp_vcup_first_save: {
    name: '一双稳手',
    desc: '在溪谷杯评级赛中担任守门员并完成一次扑救。',
  },
  ...
  soc_first_sale: {
    name: '开张大吉',
    desc: '领取你在世界市场首笔成交的货款。',
  },
  soc_steady_custom: {
    name: '细水长流',
    desc: '从你的世界市场销售中生涯累计收取10金币。',
  },
  soc_market_magnate: {
    name: '市场巨贾',
  ...
  exp_long_road_north: {
    name: '北上长路',
    desc: '造访全部三座主城：东溪、芬桥与高望。',
  },
  exp_vale_wayfarer: {
    name: '溪谷远行者',
    desc: '造访东溪谷的全部11处具名之地。',
  },
  exp_marsh_wayfarer: {
    name: '湿地远行者',
    desc: '造访泥沼湿地的全部8处具名之地。',
  },
  exp_peaks_wayfarer: {
    name: '高地远行者',
    desc: '造访荆峰高地的全部10处具名之地。',
  },
  exp_world_traveler: {
    name: '周游世界',
    desc: '赢得全部三个区域的远行者功绩。',
  ...
  hid_keepers_toll_twice: {
    name: '看守者二度收账',
    desc: '在看守者的代价仍压在你身上时死去。',
  },
  hid_roll_hundred: {
    name: '天生一百',
    desc: '在一次普通的 /roll 中掷出完美的100点。',
  },
  hid_yumi_cheer: {
    name: '由美的头号粉丝',
    desc: '在比赛正酣时，于由美听得见的地方为她欢呼。',
  },
  ...
  hid_companion_save: {
    name: '有她看着呢',
    desc: '你的探秘伙伴把一名倒下的队友重新拉了起来。',
  },
  hid_codfather: {
    name: '加入家族',
    desc: '将鳕鱼教父从深沼浅滩中拖了上来。',
  },
  prog_crown_below: {
    name: '地底王冠',
  ...
  prog_tools_of_the_trade: {
    name: '吃饭的家伙',
    desc: '[ZH-CN] Complete a craft at a crafting station.',
  },
  dgn_nythraxis_crypt: {
    name: '墓穴深藏之物',
