...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'Bisukan',
  'hudChrome.playerMenu.unmute': 'Batalkan bisu',
  ...
  'hudChrome.social.mutedSection': 'Dibisukan',
  'hudChrome.social.blockedSection': 'Diblokir',
  'hudChrome.social.stopMutingTitle': 'Batalkan bisu {name}',
