...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[ID] Buy',
  'delveUi.shop.buyConfirmBody':
    '[ID] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[ID] Cancel',
  'delveUi.shop.buyConfirmTitle': '[ID] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[ID] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[ID] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[ID] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[ID] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[ID] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[ID] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[ID] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[ID] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[ID] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[ID] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[ID] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[ID] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[ID] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[ID] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[ID] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[ID] Frostgill Chowder',
  'entities.items.game_meat.name': '[ID] Game Meat',
  'entities.items.glass_vial.name': '[ID] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[ID] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[ID] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[ID] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[ID] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[ID] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[ID] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[ID] Homespun Cloth',
  'entities.items.homespun_hood.name': '[ID] Homespun Hood',
  'entities.items.homespun_mitts.name': '[ID] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[ID] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[ID] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[ID] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[ID] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[ID] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[ID] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[ID] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[ID] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[ID] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[ID] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[ID] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[ID] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[ID] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[ID] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[ID] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[ID] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[ID] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[ID] Prime Cut',
  'entities.items.pristine_hide.name': '[ID] Pristine Hide',
  'entities.items.pristine_silk.name': '[ID] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[ID] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[ID] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[ID] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[ID] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[ID] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[ID] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[ID] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[ID] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[ID] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[ID] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[ID] Smithing Flux',
  'entities.items.spider_silk.name': '[ID] Spider Silk',
  'entities.items.spool_of_thread.name': '[ID] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[ID] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[ID] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[ID] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[ID] Sunweave Treads',
  'entities.items.tanning_agent.name': '[ID] Tanning Agent',
  'entities.items.thorium_warblade.name': '[ID] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[ID] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[ID] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[ID] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[ID] Venom Gland',
  'entities.items.venomfire_elixir.name': '[ID] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[ID] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[ID] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[ID] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[ID] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[ID] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[ID] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[ID] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[ID] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[ID] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[ID] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[ID] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[ID] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[ID] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[ID] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[ID] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[ID] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[ID] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[ID] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[ID] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[ID] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[ID] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[ID] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[ID] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[ID] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[ID] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[ID] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[ID] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[ID] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[ID] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[ID] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[ID] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[ID] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[ID] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[ID] Buy',
  'heroicShop.buyConfirmBody':
    '[ID] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[ID] Cancel',
  'heroicShop.buyConfirmTitle': '[ID] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[ID] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[ID] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[ID] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[ID] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[ID] Enchanted',
  'hudChrome.crafting.makersMark': '[ID] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[ID] Masterwork',
  'hudChrome.crafting.masterworkToast': '[ID] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[ID] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[ID] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[ID] Station',
  'hudChrome.crafting.stationName.apothecary': '[ID] Apothecary',
  'hudChrome.crafting.stationName.forge': '[ID] Forge',
  'hudChrome.crafting.stationName.kitchens': '[ID] Kitchens',
  'hudChrome.crafting.stationName.loom': '[ID] Loom',
  'hudChrome.crafting.stationName.tannery': '[ID] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[ID] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[ID] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[ID] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[ID] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[ID] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[ID] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[ID] Cancel',
  'hudChrome.death.healerConfirmTitle': "[ID] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[ID] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[ID] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[ID] Professions',
  'hudChrome.options.showThirdActionBar': '[ID] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[ID] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[ID] Common cap',
  'hudChrome.professions.ceilingRare': '[ID] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[ID] No empowerment cap',
  'hudChrome.professions.close': '[ID] Close professions',
  'hudChrome.professions.ctaHeader': '[ID] Next step',
  'hudChrome.professions.ctaRaise':
    '[ID] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[ID] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[ID] Gathering',
  'hudChrome.professions.hobbyLabel': '[ID] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[ID] Identity',
  'hudChrome.professions.majorsLabel': '[ID] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[ID] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[ID] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[ID] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[ID] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[ID] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[ID] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[ID] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[ID] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[ID] Perks',
  'hudChrome.professions.returnsLabel': '[ID] Returns: {count}',
  'hudChrome.professions.ringAria': '[ID] Craft wheel',
  'hudChrome.professions.roleDormant': '[ID] Dormant',
  'hudChrome.professions.roleHobby': '[ID] Hobby',
  'hudChrome.professions.roleMajor': '[ID] Major',
  'hudChrome.professions.roleUnattuned': '[ID] Unattuned',
  'hudChrome.professions.skillValue': '[ID] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[ID] Craft skills',
  'hudChrome.professions.switchCost': '[ID] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[ID] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[ID] Tier {tier}',
  'hudChrome.professions.title': '[ID] Professions',
  'hudChrome.professions.tutorialLine':
    '[ID] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[ID] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[ID] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[ID] You cannot afford that training.',
  'hudChrome.training.close': '[ID] Close training',
  'hudChrome.training.dialogOption': '[ID] Training',
  'hudChrome.training.dialogOptionAria': '[ID] Browse training from {name}',
  'hudChrome.training.empty': '[ID] This master has nothing to teach.',
  'hudChrome.training.free': '[ID] Free',
  'hudChrome.training.learned': '[ID] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[ID] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[ID] You must be at the station to train.',
  'hudChrome.training.requirement': '[ID] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[ID] Known',
  'hudChrome.training.stateLocked': '[ID] Locked',
  'hudChrome.training.stateTeachable': '[ID] Available',
  'hudChrome.training.tierUnmet': '[ID] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[ID] Training: {name}',
  'hudChrome.training.trainAria': '[ID] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[ID] Legendary',
  'loading.reconnectingAttempt':
    '[ID] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[ID] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[ID] This is taking longer than usual. Check your internet connection.',
};
