...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[VI] Buy',
  'delveUi.shop.buyConfirmBody':
    '[VI] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[VI] Cancel',
  'delveUi.shop.buyConfirmTitle': '[VI] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[VI] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[VI] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[VI] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[VI] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[VI] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[VI] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[VI] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[VI] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[VI] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[VI] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[VI] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[VI] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[VI] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[VI] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[VI] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[VI] Frostgill Chowder',
  'entities.items.game_meat.name': '[VI] Game Meat',
  'entities.items.glass_vial.name': '[VI] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[VI] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[VI] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[VI] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[VI] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[VI] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[VI] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[VI] Homespun Cloth',
  'entities.items.homespun_hood.name': '[VI] Homespun Hood',
  'entities.items.homespun_mitts.name': '[VI] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[VI] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[VI] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[VI] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[VI] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[VI] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[VI] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[VI] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[VI] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[VI] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[VI] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[VI] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[VI] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[VI] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[VI] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[VI] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[VI] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[VI] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[VI] Prime Cut',
  'entities.items.pristine_hide.name': '[VI] Pristine Hide',
  'entities.items.pristine_silk.name': '[VI] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[VI] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[VI] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[VI] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[VI] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[VI] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[VI] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[VI] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[VI] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[VI] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[VI] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[VI] Smithing Flux',
  'entities.items.spider_silk.name': '[VI] Spider Silk',
  'entities.items.spool_of_thread.name': '[VI] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[VI] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[VI] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[VI] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[VI] Sunweave Treads',
  'entities.items.tanning_agent.name': '[VI] Tanning Agent',
  'entities.items.thorium_warblade.name': '[VI] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[VI] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[VI] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[VI] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[VI] Venom Gland',
  'entities.items.venomfire_elixir.name': '[VI] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[VI] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[VI] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[VI] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[VI] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[VI] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[VI] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[VI] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[VI] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[VI] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[VI] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[VI] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[VI] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[VI] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[VI] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[VI] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[VI] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[VI] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[VI] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[VI] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[VI] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[VI] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[VI] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[VI] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[VI] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[VI] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[VI] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[VI] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[VI] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[VI] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[VI] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[VI] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[VI] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[VI] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[VI] Buy',
  'heroicShop.buyConfirmBody':
    '[VI] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[VI] Cancel',
  'heroicShop.buyConfirmTitle': '[VI] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[VI] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[VI] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[VI] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[VI] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[VI] Enchanted',
  'hudChrome.crafting.makersMark': '[VI] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[VI] Masterwork',
  'hudChrome.crafting.masterworkToast': '[VI] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[VI] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[VI] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[VI] Station',
  'hudChrome.crafting.stationName.apothecary': '[VI] Apothecary',
  'hudChrome.crafting.stationName.forge': '[VI] Forge',
  'hudChrome.crafting.stationName.kitchens': '[VI] Kitchens',
  'hudChrome.crafting.stationName.loom': '[VI] Loom',
  'hudChrome.crafting.stationName.tannery': '[VI] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[VI] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[VI] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[VI] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[VI] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[VI] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[VI] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[VI] Cancel',
  'hudChrome.death.healerConfirmTitle': "[VI] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[VI] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[VI] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[VI] Professions',
  'hudChrome.options.showThirdActionBar': '[VI] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[VI] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[VI] Common cap',
  'hudChrome.professions.ceilingRare': '[VI] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[VI] No empowerment cap',
  'hudChrome.professions.close': '[VI] Close professions',
  'hudChrome.professions.ctaHeader': '[VI] Next step',
  'hudChrome.professions.ctaRaise':
    '[VI] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[VI] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[VI] Gathering',
  'hudChrome.professions.hobbyLabel': '[VI] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[VI] Identity',
  'hudChrome.professions.majorsLabel': '[VI] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[VI] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[VI] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[VI] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[VI] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[VI] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[VI] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[VI] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[VI] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[VI] Perks',
  'hudChrome.professions.returnsLabel': '[VI] Returns: {count}',
  'hudChrome.professions.ringAria': '[VI] Craft wheel',
  'hudChrome.professions.roleDormant': '[VI] Dormant',
  'hudChrome.professions.roleHobby': '[VI] Hobby',
  'hudChrome.professions.roleMajor': '[VI] Major',
  'hudChrome.professions.roleUnattuned': '[VI] Unattuned',
  'hudChrome.professions.skillValue': '[VI] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[VI] Craft skills',
  'hudChrome.professions.switchCost': '[VI] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[VI] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[VI] Tier {tier}',
  'hudChrome.professions.title': '[VI] Professions',
  'hudChrome.professions.tutorialLine':
    '[VI] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[VI] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[VI] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[VI] You cannot afford that training.',
  'hudChrome.training.close': '[VI] Close training',
  'hudChrome.training.dialogOption': '[VI] Training',
  'hudChrome.training.dialogOptionAria': '[VI] Browse training from {name}',
  'hudChrome.training.empty': '[VI] This master has nothing to teach.',
  'hudChrome.training.free': '[VI] Free',
  'hudChrome.training.learned': '[VI] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[VI] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[VI] You must be at the station to train.',
  'hudChrome.training.requirement': '[VI] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[VI] Known',
  'hudChrome.training.stateLocked': '[VI] Locked',
  'hudChrome.training.stateTeachable': '[VI] Available',
  'hudChrome.training.tierUnmet': '[VI] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[VI] Training: {name}',
  'hudChrome.training.trainAria': '[VI] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[VI] Legendary',
  'loading.reconnectingAttempt':
    '[VI] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[VI] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[VI] This is taking longer than usual. Check your internet connection.',
};
