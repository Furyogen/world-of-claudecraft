...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'Sourdine',
  'hudChrome.playerMenu.unmute': 'Retirer la sourdine',
  ...
  'hudChrome.social.mutedSection': 'En sourdine',
  'hudChrome.social.blockedSection': 'Bloqués',
  'hudChrome.social.stopMutingTitle': 'Retirer {name} de la sourdine',
