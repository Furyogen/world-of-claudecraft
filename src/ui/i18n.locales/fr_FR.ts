...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[FR] Buy',
  'delveUi.shop.buyConfirmBody':
    '[FR] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[FR] Cancel',
  'delveUi.shop.buyConfirmTitle': '[FR] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[FR] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[FR] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[FR] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[FR] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[FR] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[FR] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[FR] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[FR] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[FR] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[FR] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[FR] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[FR] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[FR] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[FR] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[FR] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[FR] Frostgill Chowder',
  'entities.items.game_meat.name': '[FR] Game Meat',
  'entities.items.glass_vial.name': '[FR] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[FR] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[FR] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[FR] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[FR] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[FR] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[FR] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[FR] Homespun Cloth',
  'entities.items.homespun_hood.name': '[FR] Homespun Hood',
  'entities.items.homespun_mitts.name': '[FR] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[FR] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[FR] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[FR] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[FR] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[FR] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[FR] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[FR] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[FR] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[FR] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[FR] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[FR] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[FR] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[FR] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[FR] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[FR] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[FR] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[FR] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[FR] Prime Cut',
  'entities.items.pristine_hide.name': '[FR] Pristine Hide',
  'entities.items.pristine_silk.name': '[FR] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[FR] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[FR] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[FR] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[FR] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[FR] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[FR] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[FR] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[FR] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[FR] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[FR] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[FR] Smithing Flux',
  'entities.items.spider_silk.name': '[FR] Spider Silk',
  'entities.items.spool_of_thread.name': '[FR] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[FR] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[FR] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[FR] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[FR] Sunweave Treads',
  'entities.items.tanning_agent.name': '[FR] Tanning Agent',
  'entities.items.thorium_warblade.name': '[FR] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[FR] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[FR] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[FR] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[FR] Venom Gland',
  'entities.items.venomfire_elixir.name': '[FR] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[FR] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[FR] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[FR] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[FR] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[FR] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[FR] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[FR] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[FR] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[FR] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[FR] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[FR] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[FR] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[FR] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[FR] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[FR] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[FR] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[FR] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[FR] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[FR] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[FR] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[FR] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[FR] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[FR] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[FR] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[FR] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[FR] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[FR] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[FR] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[FR] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[FR] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[FR] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[FR] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[FR] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[FR] Buy',
  'heroicShop.buyConfirmBody':
    '[FR] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[FR] Cancel',
  'heroicShop.buyConfirmTitle': '[FR] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[FR] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[FR] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[FR] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[FR] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[FR] Enchanted',
  'hudChrome.crafting.makersMark': '[FR] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[FR] Masterwork',
  'hudChrome.crafting.masterworkToast': '[FR] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[FR] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[FR] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[FR] Station',
  'hudChrome.crafting.stationName.apothecary': '[FR] Apothecary',
  'hudChrome.crafting.stationName.forge': '[FR] Forge',
  'hudChrome.crafting.stationName.kitchens': '[FR] Kitchens',
  'hudChrome.crafting.stationName.loom': '[FR] Loom',
  'hudChrome.crafting.stationName.tannery': '[FR] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[FR] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[FR] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[FR] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[FR] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[FR] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[FR] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[FR] Cancel',
  'hudChrome.death.healerConfirmTitle': "[FR] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[FR] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[FR] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[FR] Professions',
  'hudChrome.options.showThirdActionBar': '[FR] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[FR] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[FR] Common cap',
  'hudChrome.professions.ceilingRare': '[FR] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[FR] No empowerment cap',
  'hudChrome.professions.close': '[FR] Close professions',
  'hudChrome.professions.ctaHeader': '[FR] Next step',
  'hudChrome.professions.ctaRaise':
    '[FR] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[FR] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[FR] Gathering',
  'hudChrome.professions.hobbyLabel': '[FR] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[FR] Identity',
  'hudChrome.professions.majorsLabel': '[FR] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[FR] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[FR] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[FR] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[FR] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[FR] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[FR] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[FR] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[FR] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[FR] Perks',
  'hudChrome.professions.returnsLabel': '[FR] Returns: {count}',
  'hudChrome.professions.ringAria': '[FR] Craft wheel',
  'hudChrome.professions.roleDormant': '[FR] Dormant',
  'hudChrome.professions.roleHobby': '[FR] Hobby',
  'hudChrome.professions.roleMajor': '[FR] Major',
  'hudChrome.professions.roleUnattuned': '[FR] Unattuned',
  'hudChrome.professions.skillValue': '[FR] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[FR] Craft skills',
  'hudChrome.professions.switchCost': '[FR] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[FR] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[FR] Tier {tier}',
  'hudChrome.professions.title': '[FR] Professions',
  'hudChrome.professions.tutorialLine':
    '[FR] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[FR] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[FR] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[FR] You cannot afford that training.',
  'hudChrome.training.close': '[FR] Close training',
  'hudChrome.training.dialogOption': '[FR] Training',
  'hudChrome.training.dialogOptionAria': '[FR] Browse training from {name}',
  'hudChrome.training.empty': '[FR] This master has nothing to teach.',
  'hudChrome.training.free': '[FR] Free',
  'hudChrome.training.learned': '[FR] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[FR] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[FR] You must be at the station to train.',
  'hudChrome.training.requirement': '[FR] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[FR] Known',
  'hudChrome.training.stateLocked': '[FR] Locked',
  'hudChrome.training.stateTeachable': '[FR] Available',
  'hudChrome.training.tierUnmet': '[FR] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[FR] Training: {name}',
  'hudChrome.training.trainAria': '[FR] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[FR] Legendary',
  'loading.reconnectingAttempt':
    '[FR] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[FR] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[FR] This is taking longer than usual. Check your internet connection.',
};
