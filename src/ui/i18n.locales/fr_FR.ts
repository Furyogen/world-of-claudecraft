...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'La Porte-des-Marées',
  'entities.zones.atlantis.name': 'Atlantide',
  'entities.zones.atlantis.welcome': "Le dôme chante encore, et l'Atlantide perdure sous la Sous-Marée.",
  'entities.zones.atlantis.pois.0.label': 'Atlantide',
  'entities.zones.atlantis.pois.1.label': 'Place de la Porte-des-Marées',
  'entities.zones.atlantis.pois.2.label': 'La Couronne de Lumen',
  'entities.zones.atlantis.pois.3.label': 'Marché aux Perles',
  'entities.zones.atlantis.pois.4.label': 'Les Archives Noyées',
  'entities.zones.atlantis.pois.5.label': 'Annexe des Gardevarechs',
  'entities.mobs.glimmerfin_eel.name': 'Anguille scintillante',
  'entities.mobs.pearlshell_skitterer.name': 'Trottineur nacré',
  'entities.mobs.kelpshade_lurker.name': 'Rôdeur des varechs',
  'entities.mobs.undertow_maw.name': 'La Gueule du Ressac',
  'entities.npcs.keeper_nerissa.name': 'Gardienne Nerissa',
  'entities.npcs.keeper_nerissa.title': 'Gardienne de la Couronne de Lumen',
  'entities.npcs.keeper_nerissa.greeting': "Prends garde au verre, surfacien. Il tient depuis un âge — aide-nous à ce qu'il tienne.",
  'entities.npcs.tidewright_ollo.name': 'Ollo Forge-Marées',
  'entities.npcs.tidewright_ollo.title': 'Forge-Marées du Marché aux Perles',
  'entities.npcs.tidewright_ollo.greeting': "Tout frais des derniers alambics secs des profondeurs. La pièce d'abord, les histoires ensuite.",
