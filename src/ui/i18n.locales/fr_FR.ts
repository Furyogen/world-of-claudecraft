...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.mirror_world.welcome': 'Le verre se souvient de toi. Prends garde au côté où tu marches.',
  ...
  'entities.npcs.dread_sentinel_b.greeting': 'Nous tenions la chaussée dans la vie. Nous la tenons encore.',
  'entities.npcs.dread_sentinel_c.name': 'Sentinelle funeste',
  'entities.npcs.dread_sentinel_c.title': 'Gardien du Miroir de sable',
  'entities.npcs.dread_sentinel_c.greeting': "Fais demi-tour. Le verre noir n'est pas pour les vivants... ni ne le fut jamais pour nous.",
  'entities.quests.q_gargoyle_south.title': 'Le Tribut du Gardien',
  'entities.quests.q_gargoyle_south.text': 'La lueur se change en mots derrière tes yeux : les faucheurs encombrent mon verre, {playerName}. Éclaircis-les, et la voie vers Highwatch sera tienne.',
  'entities.quests.q_gargoyle_south.completion': 'La pierre vibre une fois, satisfaite. Derrière elle, le miroir s’éclaircit comme un souffle enfin relâché.',
  ...
  'entities.quests.q_gargoyle_west.text': 'La lueur se change en mots derrière tes yeux : apporte-moi quatre draps blancs pris aux pauvres morts, {playerName}. La route d’Eastbrook s’ouvre à qui paie en toile.',
  'entities.quests.q_gargoyle_west.completion': 'Les draps s’enfoncent dans la pierre et disparaissent. Le miroir derrière elle s’éveille de lumière.',
  'entities.quests.q_gargoyle_west.objectives.0.label': 'Drap blanc',
  'entities.quests.q_gargoyle_north.title': 'Éclat moissonné',
  'entities.quests.q_gargoyle_north.text': 'La lueur se change en mots derrière tes yeux : les hardes spectrales brûlent trop fort pour le verre, {playerName}. Abats-en cinq, et Fenbridge n’est plus qu’un pas.',
  'entities.quests.q_gargoyle_north.completion': 'La pierre boit la lumière que tu as versée. Le miroir derrière elle s’ouvre comme un œil.',
  ...
  'entities.npcs.veilwright_ollo.greeting': "Manteaux de morts, soupirs en bouteille, prix honnêtes : le voile pourvoit. Tout sur mon étal fut posé par quelqu'un qui ne possède plus rien ; l'astuce, c'est de distinguer ce dont les morts en ont fini de ce qu'ils serrent encore. Trompe-toi, et ils viennent à l'étal à minuit. Demande à la Gardienne la lumière du puits, si tu veux la version triste. Moi, je ne vends que les manteaux.",
  ...
  'entities.npcs.gargoyle_sentinel_south.greeting': 'Des yeux de pierre grincent vers toi. Elle écoute.',
  ...
  'entities.npcs.gargoyle_sentinel_west.greeting': 'Des yeux de pierre grincent vers toi. Elle écoute.',
  ...
  'entities.npcs.gargoyle_sentinel_north.greeting': 'Des yeux de pierre grincent vers toi. Elle écoute.',
  ...
  'entities.npcs.mistwitch_morwen.greeting': 'La brume garde les tiens éveillés. Je peux te brasser l’autre sommeil — celui qui répond.',
  'entities.quests.q_deepdream_recipe.title': 'Une recette de sommeil profond',
  'entities.quests.q_deepdream_recipe.text': 'Le philtre réclame trois voix, {playerName} : deux draps blancs pris aux fantômes de misère qui ne possèdent rien d\'autre, deux cornes des licornes spectrales qui paissent dans la pénombre, et deux capuches taillées aux faucheurs qui veillent sur la ceinture. Apporte-les et je te brasserai un sommeil qui a des dents.',
  'entities.quests.q_deepdream_recipe.completion': 'Drap, corne, capuche — les pauvres, les radieux, les patients. Le chaudron t\'aime bien. Bois-le dans un endroit doux, voyageur : tu rencontreras qui tu portes en toi.',
  ...
  'entities.quests.q_face_your_echo.text': 'Bois le philtre et le rêve dressera un miroir devant toi — ton Écho, chaque cicatrice et chaque tour à toi de l’autre côté. Bats ce que tu es, {playerName}, et rapporte-moi la tête que tu feras.',
  'entities.quests.q_face_your_echo.completion': 'Tu es revenu, et le miroir non. Ce qu’il t’a laissé dans la main est à toi — le rêve ne paie ce prix qu’une fois.',
