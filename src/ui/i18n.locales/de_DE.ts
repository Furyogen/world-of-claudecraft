...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[DE] Buy',
  'delveUi.shop.buyConfirmBody':
    '[DE] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[DE] Cancel',
  'delveUi.shop.buyConfirmTitle': '[DE] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[DE] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[DE] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[DE] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[DE] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[DE] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[DE] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[DE] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[DE] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[DE] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[DE] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[DE] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[DE] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[DE] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[DE] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[DE] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[DE] Frostgill Chowder',
  'entities.items.game_meat.name': '[DE] Game Meat',
  'entities.items.glass_vial.name': '[DE] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[DE] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[DE] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[DE] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[DE] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[DE] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[DE] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[DE] Homespun Cloth',
  'entities.items.homespun_hood.name': '[DE] Homespun Hood',
  'entities.items.homespun_mitts.name': '[DE] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[DE] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[DE] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[DE] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[DE] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[DE] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[DE] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[DE] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[DE] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[DE] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[DE] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[DE] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[DE] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[DE] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[DE] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[DE] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[DE] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[DE] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[DE] Prime Cut',
  'entities.items.pristine_hide.name': '[DE] Pristine Hide',
  'entities.items.pristine_silk.name': '[DE] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[DE] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[DE] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[DE] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[DE] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[DE] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[DE] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[DE] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[DE] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[DE] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[DE] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[DE] Smithing Flux',
  'entities.items.spider_silk.name': '[DE] Spider Silk',
  'entities.items.spool_of_thread.name': '[DE] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[DE] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[DE] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[DE] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[DE] Sunweave Treads',
  'entities.items.tanning_agent.name': '[DE] Tanning Agent',
  'entities.items.thorium_warblade.name': '[DE] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[DE] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[DE] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[DE] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[DE] Venom Gland',
  'entities.items.venomfire_elixir.name': '[DE] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[DE] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[DE] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[DE] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[DE] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[DE] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[DE] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[DE] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[DE] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[DE] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[DE] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[DE] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[DE] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[DE] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[DE] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[DE] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[DE] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[DE] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[DE] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[DE] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[DE] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[DE] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[DE] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[DE] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[DE] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[DE] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[DE] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[DE] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[DE] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[DE] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[DE] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[DE] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[DE] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[DE] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[DE] Buy',
  'heroicShop.buyConfirmBody':
    '[DE] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[DE] Cancel',
  'heroicShop.buyConfirmTitle': '[DE] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[DE] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[DE] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[DE] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[DE] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[DE] Enchanted',
  'hudChrome.crafting.makersMark': '[DE] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[DE] Masterwork',
  'hudChrome.crafting.masterworkToast': '[DE] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[DE] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[DE] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[DE] Station',
  'hudChrome.crafting.stationName.apothecary': '[DE] Apothecary',
  'hudChrome.crafting.stationName.forge': '[DE] Forge',
  'hudChrome.crafting.stationName.kitchens': '[DE] Kitchens',
  'hudChrome.crafting.stationName.loom': '[DE] Loom',
  'hudChrome.crafting.stationName.tannery': '[DE] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[DE] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[DE] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[DE] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[DE] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[DE] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[DE] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[DE] Cancel',
  'hudChrome.death.healerConfirmTitle': "[DE] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[DE] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[DE] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[DE] Professions',
  'hudChrome.options.showThirdActionBar': '[DE] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[DE] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[DE] Common cap',
  'hudChrome.professions.ceilingRare': '[DE] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[DE] No empowerment cap',
  'hudChrome.professions.close': '[DE] Close professions',
  'hudChrome.professions.ctaHeader': '[DE] Next step',
  'hudChrome.professions.ctaRaise':
    '[DE] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[DE] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[DE] Gathering',
  'hudChrome.professions.hobbyLabel': '[DE] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[DE] Identity',
  'hudChrome.professions.majorsLabel': '[DE] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[DE] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[DE] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[DE] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[DE] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[DE] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[DE] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[DE] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[DE] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[DE] Perks',
  'hudChrome.professions.returnsLabel': '[DE] Returns: {count}',
  'hudChrome.professions.ringAria': '[DE] Craft wheel',
  'hudChrome.professions.roleDormant': '[DE] Dormant',
  'hudChrome.professions.roleHobby': '[DE] Hobby',
  'hudChrome.professions.roleMajor': '[DE] Major',
  'hudChrome.professions.roleUnattuned': '[DE] Unattuned',
  'hudChrome.professions.skillValue': '[DE] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[DE] Craft skills',
  'hudChrome.professions.switchCost': '[DE] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[DE] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[DE] Tier {tier}',
  'hudChrome.professions.title': '[DE] Professions',
  'hudChrome.professions.tutorialLine':
    '[DE] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[DE] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[DE] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[DE] You cannot afford that training.',
  'hudChrome.training.close': '[DE] Close training',
  'hudChrome.training.dialogOption': '[DE] Training',
  'hudChrome.training.dialogOptionAria': '[DE] Browse training from {name}',
  'hudChrome.training.empty': '[DE] This master has nothing to teach.',
  'hudChrome.training.free': '[DE] Free',
  'hudChrome.training.learned': '[DE] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[DE] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[DE] You must be at the station to train.',
  'hudChrome.training.requirement': '[DE] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[DE] Known',
  'hudChrome.training.stateLocked': '[DE] Locked',
  'hudChrome.training.stateTeachable': '[DE] Available',
  'hudChrome.training.tierUnmet': '[DE] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[DE] Training: {name}',
  'hudChrome.training.trainAria': '[DE] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[DE] Legendary',
  'loading.reconnectingAttempt':
    '[DE] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[DE] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[DE] This is taking longer than usual. Check your internet connection.',
};
