...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_old_cragmaw.completion': "Endlich gefallen. Die Pirscher bleiben nun im hohen Schnee, {playerName}, und meine Patrouillen können die Straße ohne Blutvergießen gehen.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Alter Cragmaw erschlagen",
  'entities.quests.q_old_cragmaw.text': "Die Bergleute gaben den Spuren einen Namen: Alter Cragmaw. Seine Höhle liegt auf dem westlichen Grat über der Südstraße, {playerName}. Nimm Hilfe mit und besiege das alte Biest.",
  'entities.quests.q_old_cragmaw.title': "Alter Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Zehn gute Felle, aber viele sind zerrissen, {playerName}. Etwas auf diesem Grat greift die eigenen Artgenossen an.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Gratpirscherfell",
  'entities.quests.q_stalker_cloaks.text': "Die Soldaten auf der Mauer brauchen warme Mäntel, {playerName}. Sammle zehn Felle von den Graten südlich des Tors.",
  'entities.quests.q_stalker_cloaks.title': "Mäntel für die Wache",
  'entities.quests.q_stalkers_return.completion': "Vierzehn weitere, und jeden Morgen gibt es frische Spuren. Was dort oben läuft, ist keine gewöhnliche Katze.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Gratpirscher erschlagen",
  'entities.quests.q_stalkers_return.text': "Zwölf tot und der Grat ist noch immer voller Tiere, {playerName}. Etwas treibt sie zur Mauer. Erlege vierzehn weitere.",
  ...
  'wallet.extensionHelp': "Damit hier eine Wallet angezeigt wird, halte eine Browser-Wallet-Erweiterung wie Solflare Wallet aktiv.",
};
