...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.mirror_world.welcome': 'Das Glas erinnert sich an dich. Achte darauf, auf welcher Seite du gehst.',
  ...
  'entities.npcs.dread_sentinel_c.greeting': 'Kehr um. Das schwarze Glas ist nicht für die Lebenden - noch war es das je für uns.',
  'entities.quests.q_gargoyle_south.title': 'Der Zoll des Wächters',
  'entities.quests.q_gargoyle_south.text': 'Das Schimmern wird zu Worten hinter deinen Augen: die Schnitter drängen sich an meinem Glas, {playerName}. Lichte sie, und der Weg nach Highwatch gehört dir.',
  'entities.quests.q_gargoyle_south.completion': 'Der Stein summt einmal, zufrieden. Dahinter klart der Spiegel auf wie ein endlich losgelassener Atem.',
  ...
  'entities.quests.q_gargoyle_west.text': 'Das Schimmern wird zu Worten hinter deinen Augen: bring mir vier weiße Laken von den armen Toten, {playerName}. Der Weg nach Eastbrook öffnet sich dem, der in Tuch zahlt.',
  'entities.quests.q_gargoyle_west.completion': 'Die Laken sinken in den Stein und sind fort. Der Spiegel dahinter erwacht im Licht.',
  ...
  'entities.quests.q_gargoyle_north.text': 'Das Schimmern wird zu Worten hinter deinen Augen: die Geisterherden brennen dem Glas zu hell, {playerName}. Erlege fünf, und Fenbridge ist nur einen Schritt entfernt.',
  'entities.quests.q_gargoyle_north.completion': 'Der Stein trinkt das Licht, das du vergossen hast. Der Spiegel dahinter öffnet sich wie ein Auge.',
  ...
  'entities.npcs.veilwright_ollo.greeting': 'Mäntel toter Männer, Seufzer in Flaschen, ehrliche Preise - der Schleier versorgt. Alles auf meinem Tisch legte jemand ab, der nun nichts mehr besitzt; die Kunst ist, zu erkennen, womit die Toten fertig sind und was sie noch umklammern. Irrst du dich, kommen sie um Mitternacht an den Stand. Frag die Hüterin nach dem Licht im Brunnen, willst du die traurige Fassung. Ich verkaufe nur die Mäntel.',
  'entities.npcs.gargoyle_sentinel_south.name': 'Gargoyle-Wache',
  'entities.npcs.gargoyle_sentinel_south.title': 'Hüter des Spiegels',
  'entities.npcs.gargoyle_sentinel_south.greeting': 'Steinerne Augen knirschen zu dir herüber. Es hört zu.',
  'entities.npcs.gargoyle_sentinel_west.name': 'Gargoyle-Wache',
  'entities.npcs.gargoyle_sentinel_west.title': 'Hüter des Spiegels',
  'entities.npcs.gargoyle_sentinel_west.greeting': 'Steinerne Augen knirschen zu dir herüber. Es hört zu.',
  'entities.npcs.gargoyle_sentinel_north.name': 'Gargoyle-Wache',
  'entities.npcs.gargoyle_sentinel_north.title': 'Hüter des Spiegels',
  'entities.npcs.gargoyle_sentinel_north.greeting': 'Steinerne Augen knirschen zu dir herüber. Es hört zu.',
  'entities.npcs.mistwitch_morwen.name': 'Morwen die Nebelhexe',
  'entities.npcs.mistwitch_morwen.title': 'Traumbrauerin der Mulde',
  'entities.npcs.mistwitch_morwen.greeting': 'Der Nebel hält die meisten von euch wach. Ich braue dir die andere Art von Schlaf — die Art, die zurückspricht.',
  'entities.quests.q_deepdream_recipe.title': 'Ein Rezept für tiefen Schlaf',
  'entities.quests.q_deepdream_recipe.text': 'Der Trank verlangt drei Stimmen, {playerName}: zwei weiße Laken von den Armutsgeistern, die sonst nichts besitzen, zwei Hörner der Geist-Einhörner, die im Düster grasen, und zwei Kapuzen, den Schnittern abgeschnitten, die den Gürtel bewachen. Bring sie mir, und ich braue dir einen Schlaf mit Zähnen.',
  'entities.quests.q_deepdream_recipe.completion': 'Laken, Horn, Kapuze — die Armen, die Strahlenden, die Geduldigen. Der Kessel mag dich. Trink ihn an einem weichen Ort, Wanderer: du wirst treffen, wen du mit dir trägst.',
  ...
  'entities.quests.q_face_your_echo.text': 'Trink den Trank, und der Traum stellt dir einen Spiegel hin — dein Echo, jede Narbe und jeder deiner Tricks auf der anderen Seite. Besiege, was du bist, {playerName}, und bring mir den Blick auf deinem Gesicht zurück.',
  'entities.quests.q_face_your_echo.completion': 'Du bist zurückgekehrt, und der Spiegel nicht. Was er dir in der Hand gelassen hat, gehört dir — der Traum zahlt diesen Preis nur einmal.',
