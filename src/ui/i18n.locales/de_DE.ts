...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'Stumm',
  'hudChrome.playerMenu.unmute': 'Stumm aufheben',
  ...
  'hudChrome.social.mutedSection': 'Stummgeschaltet',
  'hudChrome.social.blockedSection': 'Blockiert',
  'hudChrome.social.stopMutingTitle': '{name} nicht mehr stummschalten',
