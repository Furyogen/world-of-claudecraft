...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Das Gezeitentor',
  'entities.zones.atlantis.name': 'Atlantis',
  'entities.zones.atlantis.welcome': 'Die Kuppel singt noch, und Atlantis überdauert unter der Untertide.',
  'entities.zones.atlantis.pois.0.label': 'Atlantis',
  'entities.zones.atlantis.pois.1.label': 'Gezeitentor-Platz',
  'entities.zones.atlantis.pois.2.label': 'Die Lumenkrone',
  'entities.zones.atlantis.pois.3.label': 'Perlenmarkt',
  'entities.zones.atlantis.pois.4.label': 'Das Ertrunkene Archiv',
  'entities.zones.atlantis.pois.5.label': 'Tangwächter-Anbau',
  'entities.mobs.glimmerfin_eel.name': 'Glimmerflossen-Aal',
  'entities.mobs.pearlshell_skitterer.name': 'Perlschalen-Krabbler',
  'entities.mobs.kelpshade_lurker.name': 'Tangschatten-Lauerer',
  'entities.mobs.undertow_maw.name': 'Der Sogschlund',
  'entities.npcs.keeper_nerissa.name': 'Bewahrerin Nerissa',
  'entities.npcs.keeper_nerissa.title': 'Wächterin der Lumenkrone',
  'entities.npcs.keeper_nerissa.greeting': 'Achte auf das Glas, Oberflächler. Es hält seit einem Zeitalter — hilf uns, dass es so bleibt.',
  'entities.npcs.tidewright_ollo.name': 'Gezeitenschmied Ollo',
  'entities.npcs.tidewright_ollo.title': 'Gezeitenschmied des Perlenmarkts',
  'entities.npcs.tidewright_ollo.greeting': 'Frisch aus den letzten trockenen Destillen der Tiefe. Erst die Münzen, dann die Geschichten.',
