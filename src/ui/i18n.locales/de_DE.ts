...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashen_psalter.name': 'Aschenpsalter',
  'entities.items.brimming_waterskin.name': 'Randvoller Wasserschlauch',
  'entities.items.cactus_pressed_water.name': 'Kaktuspresswasser',
  'entities.items.caravan_guard_mail.name': 'Karawanenwächter-Kettenhemd',
  'entities.items.caravan_manifest.name': 'Wasserfleckiges Frachtverzeichnis',
  'entities.items.cinder_soaked_veil.name': 'Aschgetränkter Schleier',
  'entities.items.crown_brazier.name': 'Kronenfeuerbecken',
  'entities.items.crown_guard_seal.name': 'Siegel der Kronwache',
  'entities.items.duneblade_token.name': 'Dünenklingen-Marke',
  'entities.items.duneforged_warblade.name': 'Dünengeschmiedete Kriegsklinge',
  'entities.items.dunewatch_sash.name': 'Dünenwacht-Schärpe',
  'entities.items.duskmane_pelt.name': 'Dämmermähnenfell',
  'entities.items.emberbound_leggings.name': 'Glutgebundene Gamaschen',
  'entities.items.emberglass_scepter.name': 'Glutglas-Zepter',
  'entities.items.emberveil_writ.name': 'Erlass des Glutschleiers',
  'entities.items.glasscarab_shell.name': 'Glaskäferpanzer',
  'entities.items.glasscut_dirk.name': 'Glasschnitt-Dolch',
  'entities.items.heart_of_the_first_ember.name': 'Herz der Ersten Glut',
  'entities.items.heartspring_offering.name': 'Opferschale der Herzquelle',
  'entities.items.kareshs_last_skin.name': 'Kareshs letzter Schlauch',
  'entities.items.lastwell_datewine.name': 'Dattelwein vom Letzten Brunnen',
  'entities.items.living_cinder.name': 'Lebende Glut',
  'entities.items.moltenheart_girdle.name': 'Schmelzherz-Gürtel',
  'entities.items.moltenheart_slagcore.name': 'Schmelzherz-Schlackenkern',
  'entities.items.mural_rubbing.name': 'Wandbild-Abrieb',
  'entities.items.parched_kings_goblet.name': 'Der Kelch des Ausgedörrten Königs',
  'entities.items.prowler_fang.name': 'Streunerfangzahn',
  'entities.items.sentinel_core_stone.name': 'Wächter-Kernstein',
  'entities.items.springheart_blessing.name': 'Segen des Quellherzens',
  'entities.items.stolen_waterskin.name': 'Gestohlener Wasserschlauch',
  'entities.items.sunbaked_flatbread.name': 'Sonnengebackenes Fladenbrot',
  'entities.items.sunbleached_bone.name': 'Sonnengebleichter Knochen',
  'entities.items.sunbleached_staff.name': 'Sonnengebleichter Stab',
  'entities.items.sunglass_shard.name': 'Sonnenglasscherbe',
  'entities.items.sunspeakers_ash_crown.name': 'Aschenkrone des Sonnensprechers',
  'entities.items.vestment_of_the_sunken_crown.name': 'Gewand der Versunkenen Krone',
  'entities.items.vigil_obelisk_dawn.name': 'Morgenfeuer-Siegel',
  'entities.items.vigil_obelisk_dusk.name': 'Abendfeuer-Siegel',
  'entities.items.vigil_obelisk_noon.name': 'Mittagsfeuer-Siegel',
  'entities.items.wastes_relic_cache.name': 'Relikttruhe des Sonnenhofs',
  'entities.items.wastewalker_jerkin.name': 'Ödniswanderer-Wams',
  'entities.items.wastewalker_treads.name': 'Ödniswanderer-Stiefel',
