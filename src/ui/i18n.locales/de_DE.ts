...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.recovery.body': "Lege eine E-Mail-Adresse fest, damit du dein Konto wiederherstellen kannst. Wir verwenden sie nur, um zu bestätigen, dass dieses Konto dir gehört, falls du dein Passwort zurücksetzen musst.",
  ...
  'entities.quests.q_old_cragmaw.completion': "Endlich liegt er. Die Bergleute schworen, diese Katze würde die Mauer selbst überdauern. Die Stalker bleiben nun in ihrem hohen Schnee, {playerName}, und meine Patrouillen können die Straße gehen, ohne dafür zu bluten. Der ganze Grat ist durch deine Arbeit stiller.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Alter Cragmaw getötet",
  'entities.quests.q_old_cragmaw.text': "Die Bergleute gaben den Spuren, die meine Späherin fand, einen Namen: Alter Cragmaw, ein narbenfelliger Tyrann von einer Katze, der drei Generationen seines eigenen Rudels überlebt hat. Wegen ihm strömen die Stalker auf meine Straße, {playerName}. Sein Bau liegt auf dem westlichen Grat über der Straße nach Süden. Nimm einen Freund mit und streck den alten Teufel nieder.",
  'entities.quests.q_old_cragmaw.title': "Alter Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Zehn gute Pelze, dick wie alle, die ich habe... nein, sieh dir das an, {playerName}. Zerrissen, die Hälfte davon, und von keiner Klinge und keinem Speer. Klauenspuren so breit wie meine Hand, mitten durch das Winterfell. Etwas auf diesem Grat zerfleischt seine eigene Art.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Gratstalker-Pelz",
  'entities.quests.q_stalker_cloaks.text': "Acht Pelze fütterten die Mäntel der Offiziere, und nun will jeder Soldat auf der Mauer dasselbe, {playerName}. Sie haben recht: Der Winter nimmt zuerst Finger, und Entschuldigungen wärmen nicht. Zehn weitere Pelze von den Graten südlich des Tores, und die ganze Wache schläft warm.",
  'entities.quests.q_stalker_cloaks.title': "Mäntel für die Wache",
  'entities.quests.q_stalkers_return.completion': "Vierzehn weitere, und meine Patrouillen zählen morgens noch immer frische Spuren. Meine Späherin kam vom hohen Grat zurück, weiß wie die Schneegrenze: Abdrücke so groß wie ein Schild, sagt sie, und alte Beute, die kein Stalker liegen ließe. Was auch immer dort oben geht, es ist keine gewöhnliche Katze.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Gratstalker getötet",
  'entities.quests.q_stalkers_return.text': "Zwölf tot, und der Grat wimmelt dichter als an dem Tag, an dem du begonnen hast, {playerName}. Bestien werfen sich nicht aus Hunger gegen eine Mauer. Etwas auf dem hohen Grat treibt sie hinab, und bis ich weiß was, hört das Ausdünnen nicht auf. Vierzehn weitere.",
  'entities.quests.q_stalkers_return.title': "Die Stalker kehren zurück",
  'hudChrome.dailyRewards.pointsGained': "{points} tägliche Belohnungspunkte erhalten.",
  ...
  'hudChrome.options.showOwnNameplate': "Meine Namensplakette anzeigen",
  'hudChrome.options.walkByAutoloot': "Automatisch im Vorbeigehen plündern",
  'hudChrome.targetFrame.lock': "Zielrahmen sperren",
  'hudChrome.targetFrame.unlock': "Zielrahmen verschieben",
