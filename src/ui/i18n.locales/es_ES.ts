...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.worldBoss.spawn': "{name} se alza sobre Thornpeak Heights!",
  ...
  'entities.mobs.thunzharr_stormling.name': "Pequeño tormentoso despertado",
  'entities.mobs.thunzharr_waking_peak.name': "Thunzharr, la Cima Despierta",
};
