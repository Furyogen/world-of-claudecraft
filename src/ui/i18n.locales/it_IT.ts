...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.gathering': '[IT] Gathering',
  'hud.errors.tradeBound': '[IT] That item is bound and cannot be traded.',
  'hud.social.status.afk': '[IT] Away',
  'stats.charactersCreated': '[IT] Characters Created',
  'entities.items.acolyte_chain_grips.name': '[IT] Acolyte Chain Grips',
  'entities.items.briarroot_staff.name': '[IT] Briarroot Staff',
  'entities.items.cragprowl_belt.name': '[IT] Cragprowl Belt',
  'entities.items.cragthorn_greatstaff.name': '[IT] Cragthorn Greatstaff',
  'entities.items.cragward_pauldrons.name': '[IT] Cragward Pauldrons',
  'entities.items.cryptbloom_shoulderguards.name': '[IT] Cryptbloom Shoulderguards',
  'entities.items.dreamroot_boots.name': '[IT] Dreamroot Boots',
  'entities.items.duskthorn_mantle.name': '[IT] Duskthorn Mantle',
  'entities.items.fenbark_leggings.name': '[IT] Fenbark Leggings',
  'entities.items.fenshadow_maul.name': '[IT] Fenshadow Maul',
  'entities.items.fenwarden_sabatons.name': '[IT] Fenwarden Sabatons',
  'entities.items.gravewyrm_thornmaul.name': '[IT] Gravewyrm Thornmaul',
  'entities.items.grovewardens_grips.name': '[IT] Grovewarden\'s Grips',
  'entities.items.lunarward_cinch.name': '[IT] Lunarward Cinch',
  'entities.items.marshlight_hauberk.name': '[IT] Marshlight Hauberk',
  'entities.items.maul_of_the_scourged_wilds.name': '[IT] Maul of the Scourged Wilds',
  'entities.items.mirebloom_treads.name': '[IT] Mirebloom Treads',
  'entities.items.moonbark_vestments.name': '[IT] Moonbark Vestments',
  'entities.items.mosshide_vest.name': '[IT] Mosshide Vest',
  'entities.items.nightfangs_greatstaff.name': '[IT] Nightfang\'s Greatstaff',
  'entities.items.peaksong_helm.name': '[IT] Peaksong Helm',
  'entities.items.pearlward_aegis.name': '[IT] Pearlward Aegis',
  'entities.items.resonant_hide.name': '[IT] Resonant Hide',
  'entities.items.resonant_links.name': '[IT] Resonant Links',
  'entities.items.resonant_steel.name': '[IT] Resonant Steel',
  'entities.items.resonant_thread.name': '[IT] Resonant Thread',
  'entities.items.resonant_timber.name': '[IT] Resonant Timber',
  'entities.items.revenantstep_treads.name': '[IT] Revenantstep Treads',
  'entities.items.shardfang_grips.name': '[IT] Shardfang Grips',
  'entities.items.shardsong_mantle.name': '[IT] Shardsong Mantle',
  'entities.items.stormbark_mantle.name': '[IT] Stormbark Mantle',
  'entities.items.stormchant_gauntlets.name': '[IT] Stormchant Gauntlets',
  'entities.items.stormroot_cowl.name': '[IT] Stormroot Cowl',
  'entities.items.stormvotive_hauberk.name': '[IT] Stormvotive Hauberk',
  'entities.items.thornling_grips.name': '[IT] Thornling Grips',
  'entities.items.thornpeak_wildwraps.name': '[IT] Thornpeak Wildwraps',
  'entities.items.thunderward_legguards.name': '[IT] Thunderward Legguards',
  'entities.items.tidehymn_slippers.name': '[IT] Tidehymn Slippers',
  'entities.items.valefire_lantern.name': '[IT] Valefire Lantern',
  'entities.items.verdant_walkers.name': '[IT] Verdant Walkers',
  'entities.items.vestments_of_the_waking_grove.name': '[IT] Vestments of the Waking Grove',
  'entities.items.votive_chain_belt.name': '[IT] Votive Chain Belt',
  'entities.items.wildgrove_cinch.name': '[IT] Wildgrove Cinch',
  'entities.items.wildgrowth_leggings.name': '[IT] Wildgrowth Leggings',
  'entities.items.wildsoul_maul.name': '[IT] Wildsoul Maul',
  'entities.items.wyrmcult_spellgrips.name': '[IT] Wyrmcult Spellgrips',
  ...
  'entities.letters.mastery_reset_notice.sender': '[IT] The Guildhall',
  'entities.letters.mastery_reset_notice.subject': '[IT] Your craft, made honest',
  'entities.letters.prof_tier_alchemy_cooking_1.body':
    '[IT] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving.',
  'entities.letters.prof_tier_alchemy_cooking_1.sender': '[IT] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_1.subject': '[IT] A taste of things to come',
  'entities.letters.prof_tier_alchemy_cooking_2.body':
    '[IT] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long.',
  'entities.letters.prof_tier_alchemy_cooking_2.sender': '[IT] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_2.subject': '[IT] Rare work, and no burnt edges',
  'entities.letters.prof_tier_alchemy_cooking_3.body':
    '[IT] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting.',
  'entities.letters.prof_tier_alchemy_cooking_3.sender': '[IT] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_3.subject': '[IT] Now you are cooking',
  'entities.letters.prof_tier_alchemy_cooking_4.body':
    '[IT] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle.',
  'entities.letters.prof_tier_alchemy_cooking_4.sender': '[IT] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_4.subject': '[IT] One course from the feast',
  'entities.letters.prof_tier_alchemy_cooking_5.body':
    '[IT] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table.',
  'entities.letters.prof_tier_alchemy_cooking_5.sender': '[IT] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_5.subject': '[IT] Mastery, served hot',
  'entities.letters.prof_tier_engineering_alchemy_1.body':
    '[IT] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go.',
  'entities.letters.prof_tier_engineering_alchemy_1.sender': '[IT] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_1.subject': '[IT] FIRST spark, ha',
  'entities.letters.prof_tier_engineering_alchemy_2.body':
    '[IT] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA.',
  'entities.letters.prof_tier_engineering_alchemy_2.sender': '[IT] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_2.subject': '[IT] Rare, oh, RARE',
  'entities.letters.prof_tier_engineering_alchemy_3.body':
    '[IT] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses.',
  'entities.letters.prof_tier_engineering_alchemy_3.sender': '[IT] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_3.subject': '[IT] Now it gets loud',
  'entities.letters.prof_tier_engineering_alchemy_4.body':
    '[IT] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink.',
  'entities.letters.prof_tier_engineering_alchemy_4.sender': '[IT] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_4.subject': '[IT] One rung, ONE, from the top',
  'entities.letters.prof_tier_engineering_alchemy_5.body':
    '[IT] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous.',
  'entities.letters.prof_tier_engineering_alchemy_5.sender': '[IT] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_5.subject': '[IT] MASTERY, kaboom',
  'entities.letters.prof_tier_leatherworking_tailoring_1.body':
    '[IT] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully.',
  'entities.letters.prof_tier_leatherworking_tailoring_1.sender': '[IT] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_1.subject': '[IT] An even first row',
  'entities.letters.prof_tier_leatherworking_tailoring_2.body':
    '[IT] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased.',
  'entities.letters.prof_tier_leatherworking_tailoring_2.sender': '[IT] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_2.subject': '[IT] Rare work, well measured',
  'entities.letters.prof_tier_leatherworking_tailoring_3.body':
    '[IT] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice.',
  'entities.letters.prof_tier_leatherworking_tailoring_3.sender': '[IT] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_3.subject': '[IT] The pattern comes clear',
  'entities.letters.prof_tier_leatherworking_tailoring_4.body':
    '[IT] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now.',
  'entities.letters.prof_tier_leatherworking_tailoring_4.sender': '[IT] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_4.subject': '[IT] One row from the top',
  'entities.letters.prof_tier_leatherworking_tailoring_5.body':
    '[IT] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly.',
  'entities.letters.prof_tier_leatherworking_tailoring_5.sender': '[IT] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_5.subject': '[IT] The last stitch',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.body':
    '[IT] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.sender': '[IT] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.subject': '[IT] A spark worth noting',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.body':
    '[IT] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.sender': '[IT] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.subject': '[IT] Rare work, and earned',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_3.body':
    '[IT] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_3.sender': '[IT] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_3.subject': '[IT] The metal answers you now',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_4.body':
    '[IT] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_4.sender': '[IT] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_4.subject': '[IT] Near the top of the ladder',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.body':
    '[IT] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.sender': '[IT] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.subject': '[IT] Mastery, at last',
  'entities.quests.q_prof_amends_apothecary.completion':
    '[IT] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.',
  'entities.quests.q_prof_amends_apothecary.objectives.0.label': '[IT] Wild Boar hunted',
  'entities.quests.q_prof_amends_apothecary.text':
    '[IT] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.',
  'entities.quests.q_prof_amends_apothecary.title': '[IT] Back on the Stove',
  'entities.quests.q_prof_amends_bombardier.completion':
    '[IT] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?',
  'entities.quests.q_prof_amends_bombardier.objectives.0.label': '[IT] Tunnel Rat exterminated',
  'entities.quests.q_prof_amends_bombardier.text':
    '[IT] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.',
  'entities.quests.q_prof_amends_bombardier.title': '[IT] The Ledger Grows',
  'entities.quests.q_prof_amends_outfitter.completion':
    '[IT] Steady again. Leatherworking and Tailoring return to your hands as majors. Measure twice this time before you wander.',
  'entities.quests.q_prof_amends_outfitter.objectives.0.label': '[IT] Webwood Spider culled',
  'entities.quests.q_prof_amends_outfitter.text':
    '[IT] Back at my loom after all. I hold no grudge, {playerName}, but the thread remembers a hand that let it go, and the cost of taking it up again is measured out longer each time. Cull the webwood spiders crowding the western woods, and the labor will settle your hands before they touch good silk again.',
  'entities.quests.q_prof_amends_outfitter.title': '[IT] Threads Rejoined',
  'entities.quests.q_prof_amends_smith.completion':
    '[IT] The rhythm is back in your hands. Weaponcrafting and Armorcrafting are your majors once more. Do not make a habit of leaving.',
  'entities.quests.q_prof_amends_smith.objectives.0.label': '[IT] Forest Wolf slain',
  ...
  'entities.quests.q_prof_amends_smith.title': '[IT] Back to the Forge',
  'entities.quests.q_prof_attune_apothecary.completion':
    '[IT] Now that is a start with some meat on it. Alchemy and Cooking are yours to cook as high as you like. Come back hungry.',
  'entities.quests.q_prof_attune_apothecary.objectives.0.label': '[IT] Wild Boar hunted',
  'entities.quests.q_prof_attune_apothecary.text':
    '[IT] Every good dish is two flavors that belong together, and so is a good craft, {playerName}. Sit with me and Alchemy and Cooking become your two majors, the two you may simmer past rare work; the craft on the far side of the wheel is your hobby, seasoned up to rare and no hotter. The rest of your trades keep in the pantry, dormant, not spoiled, ready whenever you fetch them back. Fair warning while the pot is still cold: wander off to another pair and coming home is a chore that grows, five beasts seen to the first time, eight the next, eleven the time after, heavier with every helping. Still hungry for it? Then hunt me four wild boars, because a kitchen worth its salt starts with good meat.',
  'entities.quests.q_prof_attune_apothecary.title': '[IT] A Recipe Worth Keeping',
  'entities.quests.q_prof_attune_bombardier.completion':
    '[IT] HA. Reagents, real ones, and all your fingers still attached, good, good. Engineering and Alchemy, yours, go make something that regrets it. Off you go.',
  'entities.quests.q_prof_attune_bombardier.objectives.0.label': '[IT] Herb patch harvested',
  'entities.quests.q_prof_attune_bombardier.text':
    '[IT] Oh, oh, you want the good stuff, the loud stuff, yes? Listen, listen, before you touch anything that ticks: say the word and Engineering and Alchemy become your two majors, the only two you get to push past rare work (that is where it gets FUN, trust me). The craft opposite goes in your pocket as a hobby, rare and no further, do not pout. Your other trades? Not gone, {playerName}, just napping, dormant, wake them whenever you like. But (there is always a but, hold the fuse) ditch this pair and waddle back later and it costs you sweat that piles up, five things put down the first time, eight the next, eleven after, more, more, every single time you get cold feet. Yes? YES? Then go pick me three patches of herbs, the volatile ones, do not ask which, they are all a little volatile if you believe hard enough.',
  'entities.quests.q_prof_attune_bombardier.title': '[IT] A Volatile Arrangement',
  'entities.quests.q_prof_attune_outfitter.completion':
    '[IT] Even thread, even hand. Leatherworking and Tailoring are yours to carry as far as your skill will reach. Measure twice, and they will not fail you.',
  'entities.quests.q_prof_attune_outfitter.objectives.0.label': '[IT] Webwood Spider culled',
  'entities.quests.q_prof_attune_outfitter.text':
    '[IT] Measure the cost before you cut, that is the first rule at my loom. Choose me and Leatherworking and Tailoring become your two majors, the pair you may carry beyond rare work; the craft opposite them settles in as your hobby, taken to rare and left there. The trades you set aside are not unravelled, {playerName}, only folded away, dormant until you take them up again. Be certain, though: should you leave this pair and later want it back, the way home is paid in labor that lengthens each time, five culled at first, then eight, then eleven, always a little more. If your mind is made, cull four webwood spiders and bring their silk to the loom, for good thread starts every good garment.',
  'entities.quests.q_prof_attune_outfitter.title': '[IT] The Outfitter\'s Measure',
  'entities.quests.q_prof_attune_smith.completion':
    '[IT] Good ore, and good hands to work it. Weaponcrafting and Armorcrafting are yours to master now. Earn the rest.',
  'entities.quests.q_prof_attune_smith.objectives.0.label': '[IT] Ore vein harvested',
  'entities.quests.q_prof_attune_smith.text':
    '[IT] Steel does not forgive a wandering hand, so I will tell you plain before you swear anything. Bind yourself to my forge and Weaponcrafting and Armorcrafting become your two majors, the only crafts you may carry past rare work. The craft across the wheel from them settles in as your hobby, worked to rare and no further. Your other trades do not burn away, {playerName}: they simply go quiet, dormant until you call them back. And know this before the hammer falls: leave this pair for another and you will crawl back through honest labor to return to it, five foes put down the first time you come home, eight the next, eleven after that, more each time you stray. Still standing here? Then bring me three veins of ore worked from the Vale with your own hands, and we will call the promise struck.',
  'entities.quests.q_prof_attune_smith.title': '[IT] The Smith\'s Promise',
  'entities.quests.q_prof_workorder_apothecary.completion':
    '[IT] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.',
  'entities.quests.q_prof_workorder_apothecary.objectives.0.label': '[IT] Goldleaf Herb delivered',
  'entities.quests.q_prof_workorder_apothecary.text':
    '[IT] My shelves require goldleaf, and the market\'s stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.',
  'entities.quests.q_prof_workorder_apothecary.title': '[IT] Apothecary Work Order',
  'entities.quests.q_prof_workorder_forge.completion': '[IT] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.',
  'entities.quests.q_prof_workorder_forge.objectives.0.label': '[IT] Copper Ore delivered',
  'entities.quests.q_prof_workorder_forge.text':
    '[IT] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.',
  'entities.quests.q_prof_workorder_forge.title': '[IT] Forge Work Order',
  'entities.quests.q_prof_workorder_kitchens.completion': '[IT] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.',
  'entities.quests.q_prof_workorder_kitchens.objectives.0.label': '[IT] Game Meat delivered',
  'entities.quests.q_prof_workorder_kitchens.text':
    '[IT] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.',
  'entities.quests.q_prof_workorder_kitchens.title': '[IT] Kitchens Work Order',
  'entities.quests.q_prof_workorder_loom.completion': '[IT] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.',
  'entities.quests.q_prof_workorder_loom.objectives.0.label': '[IT] Spider Silk delivered',
  'entities.quests.q_prof_workorder_loom.text':
    '[IT] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.',
  'entities.quests.q_prof_workorder_loom.title': '[IT] Loom Work Order',
  'entities.quests.q_prof_workorder_tannery.completion': '[IT] Good hides. Fair pay. Again when you have more.',
  'entities.quests.q_prof_workorder_tannery.objectives.0.label': '[IT] Rough Hide delivered',
  'entities.quests.q_prof_workorder_tannery.text': '[IT] Vats are empty. Bring eight rough hides. Coin when you do.',
  'entities.quests.q_prof_workorder_tannery.title': '[IT] Tannery Work Order',
  'entities.quests.q_prof_workorder_toolworks.completion':
    '[IT] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.',
  'entities.quests.q_prof_workorder_toolworks.objectives.0.label': '[IT] Ironbark Log delivered',
  'entities.quests.q_prof_workorder_toolworks.text':
    '[IT] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.',
  'entities.quests.q_prof_workorder_toolworks.title': '[IT] Toolworks Work Order',
  'hudChrome.bags.itemAriaInstanced': '[IT] {item}, quantity {count}, maker-marked copy',
  'hudChrome.charSheet.defense': '[IT] Defense',
  'hudChrome.charSheet.offense': '[IT] Offense',
  'hudChrome.corpseHarvest.harvestTooltip':
    '[IT] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.',
  'hudChrome.crafting.attunedBanner': '[IT] Attuned: {title}',
  'hudChrome.crafting.attunedZoneLine': '[IT] {name} has attuned as {archetype}!',
  'hudChrome.crafting.attunementReturnCost': '[IT] If you leave this pair, returning to it later costs {cost} make-amends tasks.',
  'hudChrome.crafting.difficultyMinimal': '[IT] Minimal skill gain',
  'hudChrome.crafting.gatheredBy': '[IT] Gathered by {name}',
  'hudChrome.crafting.learnMoreAtStation': '[IT] {master} at the {station} can teach you more {craft} recipes.',
  'hudChrome.crafting.tierTutorial.dismiss': '[IT] Got it',
  'hudChrome.crafting.tierTutorial.masters':
    '[IT] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.',
  'hudChrome.crafting.tierTutorial.radar':
    '[IT] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.',
  'hudChrome.crafting.tierTutorial.tierCap':
    '[IT] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.',
  'hudChrome.crafting.tierTutorial.title': '[IT] Your First Tier',
  'hudChrome.crafting.trendNudge': '[IT] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.',
  'hudChrome.crafting.trendNudgeNoMaster': '[IT] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.',
  'hudChrome.enchantName.enchant_chest_armor': '[IT] Enchant Chest - Reinforcement',
  'hudChrome.enchantName.enchant_chest_greater_stamina': '[IT] Enchant Chest - Greater Stamina',
  'hudChrome.enchantName.enchant_chest_runeweave': '[IT] Enchant Chest - Runeweave',
  'hudChrome.enchantName.enchant_chest_spirit': '[IT] Enchant Chest - Spirit',
  'hudChrome.enchantName.enchant_chest_stamina': '[IT] Enchant Chest - Stamina',
  'hudChrome.enchantName.enchant_feet_agility': '[IT] Enchant Boots - Agility',
  'hudChrome.enchantName.enchant_feet_stamina': '[IT] Enchant Boots - Stamina',
  'hudChrome.enchantName.enchant_feet_strength': '[IT] Enchant Boots - Strength',
  'hudChrome.enchantName.enchant_gloves_agility': '[IT] Enchant Gloves - Agility',
  'hudChrome.enchantName.enchant_gloves_greater_agility': '[IT] Enchant Gloves - Greater Agility',
  'hudChrome.enchantName.enchant_gloves_intellect': '[IT] Enchant Gloves - Spellpower',
  'hudChrome.enchantName.enchant_gloves_strength': '[IT] Enchant Gloves - Strength',
  'hudChrome.enchantName.enchant_helmet_armor': '[IT] Enchant Helmet - Reinforcement',
  'hudChrome.enchantName.enchant_helmet_fortitude': '[IT] Enchant Helmet - Fortitude',
  'hudChrome.enchantName.enchant_helmet_greater_fortitude': '[IT] Enchant Helmet - Greater Fortitude',
  'hudChrome.enchantName.enchant_helmet_intellect': '[IT] Enchant Helmet - Intellect',
  'hudChrome.enchantName.enchant_helmet_runed_links': '[IT] Enchant Helmet - Runed Links',
  'hudChrome.enchantName.enchant_legs_greater_stamina': '[IT] Enchant Legs - Greater Stamina',
  'hudChrome.enchantName.enchant_legs_intellect': '[IT] Enchant Legs - Intellect',
  'hudChrome.enchantName.enchant_legs_runed_hide': '[IT] Enchant Legs - Runed Hide',
  'hudChrome.enchantName.enchant_legs_stamina': '[IT] Enchant Legs - Stamina',
  'hudChrome.enchantName.enchant_neck_agility': '[IT] Enchant Necklace - Agility',
  'hudChrome.enchantName.enchant_neck_intellect': '[IT] Enchant Necklace - Intellect',
  'hudChrome.enchantName.enchant_neck_spirit': '[IT] Enchant Necklace - Spirit',
  'hudChrome.enchantName.enchant_ring_agility': '[IT] Enchant Ring - Agility',
  'hudChrome.enchantName.enchant_ring_intellect': '[IT] Enchant Ring - Intellect',
  'hudChrome.enchantName.enchant_ring_spirit': '[IT] Enchant Ring - Spirit',
  'hudChrome.enchantName.enchant_ring_strength': '[IT] Enchant Ring - Strength',
  'hudChrome.enchantName.enchant_shoulder_agility': '[IT] Enchant Shoulders - Agility',
  'hudChrome.enchantName.enchant_shoulder_intellect': '[IT] Enchant Shoulders - Intellect',
  'hudChrome.enchantName.enchant_shoulder_strength': '[IT] Enchant Shoulders - Strength',
  'hudChrome.enchantName.enchant_waist_agility': '[IT] Enchant Belt - Agility',
  'hudChrome.enchantName.enchant_waist_stamina': '[IT] Enchant Belt - Stamina',
  'hudChrome.enchantName.enchant_waist_strength': '[IT] Enchant Belt - Strength',
  'hudChrome.enchantName.enchant_weapon_agility': '[IT] Enchant Weapon - Agility',
  'hudChrome.enchantName.enchant_weapon_greater_might': '[IT] Enchant Weapon - Greater Might',
  'hudChrome.enchantName.enchant_weapon_greater_spellpower': '[IT] Enchant Weapon - Greater Spellpower',
  'hudChrome.enchantName.enchant_weapon_intellect': '[IT] Enchant Weapon - Spellpower',
  'hudChrome.enchantName.enchant_weapon_might': '[IT] Enchant Weapon - Might',
  'hudChrome.enchantName.enchant_weapon_runed_edge': '[IT] Enchant Weapon - Runed Edge',
  'hudChrome.enchantName.enchant_weapon_runed_focus': '[IT] Enchant Weapon - Runed Focus',
  'hudChrome.enchanting.disenchantConfirmBody': '[IT] This destroys {item} and yields arcane materials. This cannot be undone.',
  'hudChrome.enchanting.disenchantConfirmBodySpecial':
    '[IT] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.',
  'hudChrome.enchanting.disenchantConfirmTitle': '[IT] Disenchant {item}?',
  'hudChrome.enchanting.disenchantThrottled': '[IT] You are disenchanting too quickly. Wait a moment and try again.',
  'hudChrome.enchanting.disenchantedLine': '[IT] You disenchant {item}.',
  'hudChrome.enchanting.enchantAppliedLine': '[IT] You enchant {item} with {enchant}.',
  'hudChrome.enchanting.enchantInsufficient': '[IT] You do not have the materials for that enchant.',
  'hudChrome.enchanting.enchantThrottled': '[IT] You are enchanting too quickly. Wait a moment and try again.',
  'hudChrome.enchanting.enchantUnknown': '[IT] That enchant does not exist.',
  'hudChrome.enchanting.enchantWrongSlot': '[IT] That enchant cannot be applied to that item.',
  'hudChrome.enchanting.noEnchants': '[IT] No enchant uses this reagent.',
  'hudChrome.enchanting.noTargets': '[IT] No eligible item to enchant.',
  'hudChrome.enchanting.notDisenchantable': '[IT] You cannot disenchant that.',
  'hudChrome.enchanting.notHeld': '[IT] You do not have that item.',
  'hudChrome.enchanting.notSalvageable': '[IT] You cannot salvage that.',
  'hudChrome.enchanting.pickerTitle': '[IT] Apply Enchant',
  'hudChrome.enchanting.salvageConfirmBody': '[IT] This destroys {item} and yields crafting materials. This cannot be undone.',
  'hudChrome.enchanting.salvageConfirmBodySpecial':
    '[IT] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.',
  'hudChrome.enchanting.salvageConfirmTitle': '[IT] Salvage {item}?',
  'hudChrome.enchanting.salvageThrottled': '[IT] You are salvaging too quickly. Wait a moment and try again.',
  'hudChrome.enchanting.salvagedLine': '[IT] You salvage {item}.',
  'hudChrome.enchanting.targetTitle': '[IT] Choose an item to enchant',
  'hudChrome.gathering.biteLine': '[IT] Something takes the bait!',
  'hudChrome.gathering.catchLine': '[IT] You reel in: {name}',
  'hudChrome.gathering.downgradeFind': '[IT] Bags full: a pristine find slipped away.',
  'hudChrome.gathering.downgradeMark': '[IT] Bags full: the find was stored without its gatherer\'s mark.',
  'hudChrome.gathering.fishing': '[IT] Fishing',
  'hudChrome.gathering.gotAwayLine': '[IT] It got away.',
  'hudChrome.gathering.nodeName.herb': '[IT] Herb Patch',
  'hudChrome.gathering.nodeName.ore': '[IT] Ore Vein',
  'hudChrome.gathering.nodeName.wood': '[IT] Timber Stand',
  'hudChrome.gathering.stateCooldown': '[IT] Respawning',
  'hudChrome.gathering.stateReady': '[IT] Ready',
  'hudChrome.gathering.tierRequired.herbalism': '[IT] Requires a tier {tier} herbalism sickle',
  'hudChrome.gathering.tierRequired.logging': '[IT] Requires a tier {tier} logging axe',
  'hudChrome.gathering.tierRequired.mining': '[IT] Requires a tier {tier} mining pick',
  'hudChrome.gathering.toolTierUnmet.herbalism': '[IT] You need a tier {tier} herbalism sickle to gather this patch.',
  'hudChrome.gathering.toolTierUnmet.logging': '[IT] You need a tier {tier} logging axe to fell this stand.',
  'hudChrome.gathering.toolTierUnmet.mining': '[IT] You need a tier {tier} mining pick to harvest this vein.',
  'hudChrome.gathering.toolTierUnmetCorpse': '[IT] You need a tier {tier} gathering tool to recover the finest materials.',
  'hudChrome.interfaceTabs.chat': '[IT] Chat',
  'hudChrome.interfaceTabs.combat': '[IT] Combat',
  'hudChrome.interfaceTabs.frames': '[IT] Frames',
  'hudChrome.interfaceTabs.general': '[IT] General',
  'hudChrome.itemMenu.applyEnchant': '[IT] Apply Enchant',
  'hudChrome.itemMenu.disenchant': '[IT] Disenchant',
  'hudChrome.itemMenu.equip': '[IT] Equip',
  'hudChrome.itemMenu.salvage': '[IT] Salvage',
  'hudChrome.itemMenu.use': '[IT] Use',
  'hudChrome.loot.takeLootButton': '[IT] Take Loot',
  'hudChrome.loot.takeLootTooltip': '[IT] Takes the coins and dropped items. Does not use up the harvest.',
  'hudChrome.loot.unifiedPressHint': '[IT] The interact key loots and harvests in one press, using your town focus.',
  'hudChrome.nameplate.afkTag': '[IT] AFK',
  'hudChrome.professions.nextUnlockMastered': '[IT] Mastered, for now',
  'hudChrome.social.hideOffline': '[IT] Hide offline',
  'hudChrome.social.hideOfflineTitle': '[IT] Hide offline guild members',
  'hudChrome.social.offlineHeader': '[IT] Offline ({n})',
  'hudChrome.social.onlineHeader': '[IT] Online ({n})',
  'hudChrome.townFocus.tierHint':
    '[IT] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.',
  'hudChrome.townFocus.townOnlyHint': '[IT] Focus can only be changed while you are in town.',
};
