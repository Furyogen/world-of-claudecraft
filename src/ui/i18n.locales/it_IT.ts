...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[IT] Buy',
  'delveUi.shop.buyConfirmBody':
    '[IT] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[IT] Cancel',
  'delveUi.shop.buyConfirmTitle': '[IT] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[IT] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[IT] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[IT] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[IT] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[IT] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[IT] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[IT] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[IT] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[IT] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[IT] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[IT] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[IT] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[IT] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[IT] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[IT] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[IT] Frostgill Chowder',
  'entities.items.game_meat.name': '[IT] Game Meat',
  'entities.items.glass_vial.name': '[IT] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[IT] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[IT] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[IT] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[IT] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[IT] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[IT] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[IT] Homespun Cloth',
  'entities.items.homespun_hood.name': '[IT] Homespun Hood',
  'entities.items.homespun_mitts.name': '[IT] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[IT] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[IT] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[IT] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[IT] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[IT] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[IT] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[IT] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[IT] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[IT] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[IT] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[IT] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[IT] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[IT] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[IT] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[IT] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[IT] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[IT] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[IT] Prime Cut',
  'entities.items.pristine_hide.name': '[IT] Pristine Hide',
  'entities.items.pristine_silk.name': '[IT] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[IT] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[IT] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[IT] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[IT] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[IT] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[IT] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[IT] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[IT] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[IT] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[IT] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[IT] Smithing Flux',
  'entities.items.spider_silk.name': '[IT] Spider Silk',
  'entities.items.spool_of_thread.name': '[IT] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[IT] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[IT] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[IT] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[IT] Sunweave Treads',
  'entities.items.tanning_agent.name': '[IT] Tanning Agent',
  'entities.items.thorium_warblade.name': '[IT] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[IT] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[IT] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[IT] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[IT] Venom Gland',
  'entities.items.venomfire_elixir.name': '[IT] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[IT] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[IT] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[IT] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[IT] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[IT] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[IT] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[IT] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[IT] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[IT] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[IT] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[IT] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[IT] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[IT] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[IT] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[IT] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[IT] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[IT] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[IT] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[IT] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[IT] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[IT] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[IT] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[IT] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[IT] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[IT] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[IT] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[IT] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[IT] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[IT] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[IT] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[IT] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[IT] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[IT] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[IT] Buy',
  'heroicShop.buyConfirmBody':
    '[IT] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[IT] Cancel',
  'heroicShop.buyConfirmTitle': '[IT] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[IT] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[IT] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[IT] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[IT] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[IT] Enchanted',
  'hudChrome.crafting.makersMark': '[IT] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[IT] Masterwork',
  'hudChrome.crafting.masterworkToast': '[IT] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[IT] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[IT] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[IT] Station',
  'hudChrome.crafting.stationName.apothecary': '[IT] Apothecary',
  'hudChrome.crafting.stationName.forge': '[IT] Forge',
  'hudChrome.crafting.stationName.kitchens': '[IT] Kitchens',
  'hudChrome.crafting.stationName.loom': '[IT] Loom',
  'hudChrome.crafting.stationName.tannery': '[IT] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[IT] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[IT] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[IT] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[IT] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[IT] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[IT] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[IT] Cancel',
  'hudChrome.death.healerConfirmTitle': "[IT] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[IT] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[IT] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[IT] Professions',
  'hudChrome.options.showThirdActionBar': '[IT] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[IT] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[IT] Common cap',
  'hudChrome.professions.ceilingRare': '[IT] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[IT] No empowerment cap',
  'hudChrome.professions.close': '[IT] Close professions',
  'hudChrome.professions.ctaHeader': '[IT] Next step',
  'hudChrome.professions.ctaRaise':
    '[IT] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[IT] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[IT] Gathering',
  'hudChrome.professions.hobbyLabel': '[IT] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[IT] Identity',
  'hudChrome.professions.majorsLabel': '[IT] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[IT] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[IT] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[IT] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[IT] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[IT] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[IT] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[IT] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[IT] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[IT] Perks',
  'hudChrome.professions.returnsLabel': '[IT] Returns: {count}',
  'hudChrome.professions.ringAria': '[IT] Craft wheel',
  'hudChrome.professions.roleDormant': '[IT] Dormant',
  'hudChrome.professions.roleHobby': '[IT] Hobby',
  'hudChrome.professions.roleMajor': '[IT] Major',
  'hudChrome.professions.roleUnattuned': '[IT] Unattuned',
  'hudChrome.professions.skillValue': '[IT] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[IT] Craft skills',
  'hudChrome.professions.switchCost': '[IT] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[IT] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[IT] Tier {tier}',
  'hudChrome.professions.title': '[IT] Professions',
  'hudChrome.professions.tutorialLine':
    '[IT] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[IT] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[IT] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[IT] You cannot afford that training.',
  'hudChrome.training.close': '[IT] Close training',
  'hudChrome.training.dialogOption': '[IT] Training',
  'hudChrome.training.dialogOptionAria': '[IT] Browse training from {name}',
  'hudChrome.training.empty': '[IT] This master has nothing to teach.',
  'hudChrome.training.free': '[IT] Free',
  'hudChrome.training.learned': '[IT] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[IT] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[IT] You must be at the station to train.',
  'hudChrome.training.requirement': '[IT] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[IT] Known',
  'hudChrome.training.stateLocked': '[IT] Locked',
  'hudChrome.training.stateTeachable': '[IT] Available',
  'hudChrome.training.tierUnmet': '[IT] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[IT] Training: {name}',
  'hudChrome.training.trainAria': '[IT] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[IT] Legendary',
  'loading.reconnectingAttempt':
    '[IT] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[IT] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[IT] This is taking longer than usual. Check your internet connection.',
};
