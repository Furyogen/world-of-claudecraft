...
export const cs_CZ: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[CS] Buy',
  'delveUi.shop.buyConfirmBody':
    '[CS] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[CS] Cancel',
  'delveUi.shop.buyConfirmTitle': '[CS] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[CS] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[CS] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[CS] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[CS] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[CS] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[CS] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[CS] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[CS] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[CS] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[CS] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[CS] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[CS] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[CS] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[CS] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[CS] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[CS] Frostgill Chowder',
  'entities.items.game_meat.name': '[CS] Game Meat',
  'entities.items.glass_vial.name': '[CS] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[CS] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[CS] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[CS] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[CS] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[CS] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[CS] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[CS] Homespun Cloth',
  'entities.items.homespun_hood.name': '[CS] Homespun Hood',
  'entities.items.homespun_mitts.name': '[CS] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[CS] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[CS] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[CS] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[CS] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[CS] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[CS] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[CS] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[CS] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[CS] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[CS] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[CS] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[CS] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[CS] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[CS] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[CS] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[CS] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[CS] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[CS] Prime Cut',
  'entities.items.pristine_hide.name': '[CS] Pristine Hide',
  'entities.items.pristine_silk.name': '[CS] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[CS] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[CS] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[CS] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[CS] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[CS] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[CS] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[CS] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[CS] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[CS] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[CS] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[CS] Smithing Flux',
  'entities.items.spider_silk.name': '[CS] Spider Silk',
  'entities.items.spool_of_thread.name': '[CS] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[CS] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[CS] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[CS] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[CS] Sunweave Treads',
  'entities.items.tanning_agent.name': '[CS] Tanning Agent',
  'entities.items.thorium_warblade.name': '[CS] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[CS] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[CS] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[CS] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[CS] Venom Gland',
  'entities.items.venomfire_elixir.name': '[CS] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[CS] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[CS] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[CS] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[CS] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[CS] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[CS] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[CS] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[CS] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[CS] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[CS] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[CS] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[CS] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[CS] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[CS] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[CS] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[CS] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[CS] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[CS] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[CS] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[CS] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[CS] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[CS] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[CS] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[CS] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[CS] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[CS] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[CS] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[CS] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[CS] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[CS] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[CS] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[CS] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[CS] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[CS] Buy',
  'heroicShop.buyConfirmBody':
    '[CS] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[CS] Cancel',
  'heroicShop.buyConfirmTitle': '[CS] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[CS] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[CS] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[CS] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[CS] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[CS] Enchanted',
  'hudChrome.crafting.makersMark': '[CS] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[CS] Masterwork',
  'hudChrome.crafting.masterworkToast': '[CS] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[CS] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[CS] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[CS] Station',
  'hudChrome.crafting.stationName.apothecary': '[CS] Apothecary',
  'hudChrome.crafting.stationName.forge': '[CS] Forge',
  'hudChrome.crafting.stationName.kitchens': '[CS] Kitchens',
  'hudChrome.crafting.stationName.loom': '[CS] Loom',
  'hudChrome.crafting.stationName.tannery': '[CS] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[CS] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[CS] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[CS] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[CS] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[CS] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[CS] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[CS] Cancel',
  'hudChrome.death.healerConfirmTitle': "[CS] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[CS] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[CS] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[CS] Professions',
  'hudChrome.options.showThirdActionBar': '[CS] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[CS] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[CS] Common cap',
  'hudChrome.professions.ceilingRare': '[CS] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[CS] No empowerment cap',
  'hudChrome.professions.close': '[CS] Close professions',
  'hudChrome.professions.ctaHeader': '[CS] Next step',
  'hudChrome.professions.ctaRaise':
    '[CS] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[CS] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[CS] Gathering',
  'hudChrome.professions.hobbyLabel': '[CS] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[CS] Identity',
  'hudChrome.professions.majorsLabel': '[CS] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[CS] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[CS] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[CS] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[CS] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[CS] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[CS] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[CS] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[CS] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[CS] Perks',
  'hudChrome.professions.returnsLabel': '[CS] Returns: {count}',
  'hudChrome.professions.ringAria': '[CS] Craft wheel',
  'hudChrome.professions.roleDormant': '[CS] Dormant',
  'hudChrome.professions.roleHobby': '[CS] Hobby',
  'hudChrome.professions.roleMajor': '[CS] Major',
  'hudChrome.professions.roleUnattuned': '[CS] Unattuned',
  'hudChrome.professions.skillValue': '[CS] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[CS] Craft skills',
  'hudChrome.professions.switchCost': '[CS] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[CS] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[CS] Tier {tier}',
  'hudChrome.professions.title': '[CS] Professions',
  'hudChrome.professions.tutorialLine':
    '[CS] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[CS] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[CS] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[CS] You cannot afford that training.',
  'hudChrome.training.close': '[CS] Close training',
  'hudChrome.training.dialogOption': '[CS] Training',
  'hudChrome.training.dialogOptionAria': '[CS] Browse training from {name}',
  'hudChrome.training.empty': '[CS] This master has nothing to teach.',
  'hudChrome.training.free': '[CS] Free',
  'hudChrome.training.learned': '[CS] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[CS] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[CS] You must be at the station to train.',
  'hudChrome.training.requirement': '[CS] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[CS] Known',
  'hudChrome.training.stateLocked': '[CS] Locked',
  'hudChrome.training.stateTeachable': '[CS] Available',
  'hudChrome.training.tierUnmet': '[CS] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[CS] Training: {name}',
  'hudChrome.training.trainAria': '[CS] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[CS] Legendary',
  'loading.reconnectingAttempt':
    '[CS] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[CS] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[CS] This is taking longer than usual. Check your internet connection.',
};
