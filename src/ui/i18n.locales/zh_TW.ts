...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.keyboardMap.hint': '正在使用的按鍵依類別著色。將滑鼠懸停或聚焦到某個按鍵即可查看其全部綁定。',
  'hudChrome.keyboardMap.hintInteractive': '正在使用的按鍵依類別著色。點擊某個按鍵可更改其功能；將滑鼠懸停或聚焦到按鍵上可查看其全部綁定。',
  ...
  'hudChrome.fullTransfer.intro': '將此裝置上儲存的全部偏好匯出為一段代碼，並在其他裝置或瀏覽器上貼上匯入：圖形、音訊、介面、主題、框體配置、每個角色的按鍵綁定、控制器與十字快捷列綁定、聊天、視窗篩選、語言以及已關閉的提示。',
  'hudChrome.fullTransfer.excluded': '絕不包含：您的登入、帳號、錢包或購買資料。動作列配置儲存在您的帳號中，會隨帳號同步。',
  ...
  'hudChrome.raidBossGuide.nythraxis.overview': '大祭司馬爾里克不願讓他的國王死去，而喚起尼思拉克西斯的儀式將整個王庭都束縛在墓穴之中。這場戰鬥考驗嚴謹的坦克輪換、迅速轉火骨刺、遠離燃燒地面的走位，以及王座陷落後協同引導護符石。',
  'hudChrome.raidBossGuide.nythraxis.phaseThroneName': '王座',
  'hudChrome.raidBossGuide.nythraxis.phaseThroneSummary': '尼思拉克西斯坐鎮王座廳，施展蓄力正面順劈、恐懼詛咒坦克輪換、穿刺團隊的骨刺，以及留下燃燒地面的墓穴爆發。',
  'hudChrome.raidBossGuide.nythraxis.phaseWardstonesName': '護符石',
  'hudChrome.raidBossGuide.nythraxis.phaseWardstonesSummary': '生命值降至{health}時，震顫踐踏會定住全團，此時奧德里克修士抵達並點燃護符石。所有尖刺隨即碎裂，地面停止燃燒，接著靈魂撕裂與不死之怒將加入王座階段的機制。',
  'hudChrome.raidBossGuide.nythraxis.phaseKingsWrathName': '國王之怒',
  'hudChrome.raidBossGuide.nythraxis.phaseKingsWrathSummary': '生命值降至{health}時，尼思拉克西斯咆哮著進入國王之怒，此後在普通難度獲得{bonusNormal}傷害，英雄難度則為{bonusHeroic}，直到戰鬥結束。墓穴爆發的間隔縮短至每{eruptionEveryNormal}秒一次（英雄難度{eruptionEveryHeroic}秒），墓火則縮短至每{gravefireEveryNormal}秒一次（英雄難度{gravefireEveryHeroic}秒）。其餘機制節奏不變。',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerName': '碎墓打擊',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerSummary': '每{seconds}秒，尼思拉克西斯會蓄力下一次命中的揮擊。他的目標只承受揮擊本身的傷害，但站在他正面{arc}度扇形範圍{range}碼內的其他人，都會承受該次揮擊{splash}的物理傷害，並依自身護甲減免。',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerResponse': '坦克讓尼思拉克西斯始終背對團隊。其餘人留在他的側面或背後，絕不進入扇形範圍。',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseName': '恐懼詛咒',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseSummary': '每{every}秒，尼思拉克西斯會對目前的坦克造成相當於最大生命值{hitNormal}的暗影傷害，並疊加一層恐懼詛咒。在{duration}秒內，每層都會使該坦克受到尼思拉克西斯的傷害提高{perStackNormal}，最多疊加{max}層。',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseHeroicSummary': '每{every}秒，尼思拉克西斯會對目前的坦克造成相當於最大生命值{hitHeroic}的暗影傷害，並疊加一層恐懼詛咒。在{duration}秒內，每層都會使該坦克受到尼思拉克西斯的傷害提高{perStackHeroic}，最多疊加{max}層。',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseResponse': '坦克在{stacks}層時換坦：另一名坦克嘲諷仇恨，受詛咒的坦克則留在碎墓打擊扇形範圍外，直到層數消退。治療應在換坦前為即將接怪的坦克做好準備。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeName': '骨刺',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeSummary': '每{everyNormal}秒，尼思拉克西斯會將{victimsNormal}名非目前目標的團員穿刺在骨刺上。被穿刺的團員無法行動，並且每秒流失相當於最大生命值{drainNormal}的生命，直到該尖刺被摧毀。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeHeroicSummary': '每{everyHeroic}秒，尼思拉克西斯會將{victimsHeroic}名非目前目標的團員穿刺在骨刺上。被穿刺的團員無法行動，並且每秒流失相當於最大生命值{drainHeroic}的生命，直到該尖刺被摧毀。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeResponse': '輸出職業應立即轉火骨刺並將其摧毀，以解救被穿刺的團員。治療則在尖刺被擊破前維持被穿刺者的生命。',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionName': '墓穴爆發',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionSummary': '每{everyNormal}秒，骸骨之手會在{countNormal}名團員腳下標記半徑{radius}碼的圓圈。{warning}秒後，每個圓圈都會爆發，造成相當於最大生命值{burstNormal}的暗影傷害，隨後化為墓焰燃燒{flameNormal}秒，對站在其中的人每秒造成相當於最大生命值{tickNormal}的傷害。',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionHeroicSummary': '每{everyHeroic}秒，骸骨之手會在{countHeroic}名團員腳下標記半徑{radius}碼的圓圈。{warning}秒後，每個圓圈都會爆發，造成相當於最大生命值{burstHeroic}的暗影傷害，隨後化為墓焰燃燒{flameHeroic}秒，對站在其中的人每秒造成相當於最大生命值{tickHeroic}的傷害。',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionResponse': '在每個警示圈爆發前離開範圍，並遠離燃燒地面。坦克應將尼思拉克西斯拉離火場，讓近戰保有輸出空間。',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilName': '束縛印記',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilSummary': '每{everyNormal}秒，一枚承載古老守印的印記會在尼思拉克西斯周圍{minDist}至{maxDist}碼的地面上浮現，同時他開始不死昇華，每{ascensionEvery}秒獲得{ascensionNormal}傷害與攻擊速度。若他在{bindNormal}秒內站上印記，便會被束縛：不死昇華遭淨化，他被暈眩{stunNormal}秒，並在{boundNormal}秒內多承受{vulnerability}傷害。否則每名團員都會承受相當於最大生命值{unboundHitNormal}的暗影傷害，且他會保有{unboundBonusNormal}傷害提升，直到下一次束縛為止。',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilHeroicSummary': '每{everyHeroic}秒，一枚承載古老守印的印記會在尼思拉克西斯周圍{minDist}至{maxDist}碼的地面上浮現，同時他開始不死昇華，每{ascensionEvery}秒獲得{ascensionHeroic}傷害與攻擊速度。若他在{bindHeroic}秒內站上印記，便會被束縛：不死昇華遭淨化，他被暈眩{stunHeroic}秒，並在{boundHeroic}秒內多承受{vulnerability}傷害。否則每名團員都會承受相當於最大生命值{unboundHitHeroic}的暗影傷害，且他會保有{unboundBonusHeroic}傷害提升，直到下一次束縛為止。',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilResponse': '坦克應立即將尼思拉克西斯拖上印記，即使得穿過團隊留下的火焰也在所不惜。近戰跟隨拖行路線，遠程則避開新的碎墓打擊扇形範圍。他被束縛期間，全員集火。',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenName': '亡者復生',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenSummary': '在王座階段中，尼思拉克西斯每{every}秒會在他身後喚起復甦王室衛兵。牠們會衝向他目前的目標，戰鬥至被摧毀為止。',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenResponse': '副坦應在每一波衛兵出現時接怪。輸出職業應在骨刺間隙清理衛兵，避免波次在王座階段結束前堆積。',
  'hudChrome.raidBossGuide.nythraxis.soulRendSummary': '尼思拉克西斯會為{marksNormal}名非目前目標的團員標記靈魂撕裂。{fuse}秒後，每個標記都會對其承載者造成相當於其全部最大生命值的暗影傷害，並依{range}碼內被標記團員的人數分攤。',
  'hudChrome.raidBossGuide.nythraxis.soulRendHeroicSummary': '尼思拉克西斯會為{marksHeroic}名非目前目標的團員標記靈魂撕裂。{fuse}秒後，每個標記都會對其承載者造成相當於其最大生命值{damageHeroic}的暗影傷害，並依{range}碼內被標記團員的人數分攤。若標記單獨引爆，將必定致命。',
  'hudChrome.raidBossGuide.nythraxis.soulRendResponse': '每名被標記的團員都應在{fuse}秒的引爆倒數結束前，跑到集合點並站在其他標記{range}碼內。治療應在標記引爆時將團隊生命補滿。',
  'hudChrome.raidBossGuide.nythraxis.soulfireName': '魂火',
  'hudChrome.raidBossGuide.nythraxis.soulfireSummary': '每次靈魂撕裂引爆，都會在每個標記所在處留下一灘半徑{radius}碼的紫色烈焰，燃燒{seconds}秒，每秒造成相當於最大生命值{tickNormal}的傷害。火池重疊時，站在裡面會分別承受各灘火池的傷害。火池絕不會在護符石{clearance}碼內形成。',
  'hudChrome.raidBossGuide.nythraxis.soulfireHeroicSummary': '每次靈魂撕裂引爆，每一組聚集的標記只會留下一灘半徑{radius}碼的紫色烈焰，燃燒{secondsHeroic}秒，每秒造成相當於最大生命值{tickHeroic}的傷害。火池重疊時只會承受一次傷害，不會疊加。火池絕不會在護符石{clearance}碼內形成。',
  'hudChrome.raidBossGuide.nythraxis.soulfireResponse': '標記引爆後應立刻離開紫色火池。選擇下一個集合點時，務必避開仍在燃燒的火焰。',
  'hudChrome.raidBossGuide.nythraxis.gravefireName': '墓火',
  'hudChrome.raidBossGuide.nythraxis.gravefireSummary': '每{everyNormal}秒，一道紫色墓火會從尼思拉克西斯朝一名團員延伸，每秒延長{speed}碼，最長至{length}碼。每一碼都會燃燒{burnNormal}秒，對站在其中的人每秒造成相當於最大生命值{tickNormal}的傷害。',
  'hudChrome.raidBossGuide.nythraxis.gravefireHeroicSummary': '每{everyHeroic}秒，一道紫色墓火會從尼思拉克西斯朝一名團員延伸，每秒延長{speed}碼，最長至{length}碼。每一碼都會燃燒{burnHeroic}秒，對站在其中的人每秒造成相當於最大生命值{tickHeroic}的傷害。',
  'hudChrome.raidBossGuide.nythraxis.gravefireResponse': '看到火線逼近時側身閃避：它很窄且不會轉向。遠程團員應持續移動，而非停在原地。',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageName': '不死之怒',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageSummary': '每{every}秒，尼思拉克西斯會施展{cast}秒的不死之怒。施法期間，每座已點亮的護符石都能由一名團員引導{channel}秒。若在施法結束前，有三名不同的團員各自完成一座護符石的引導，此次狂怒便會被打斷，尼思拉克西斯將被暈眩{stun}秒。否則每名團員都會承受相當於最大生命值{damageNormal}的暗影傷害。',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageHeroicSummary': '每{every}秒，尼思拉克西斯會施展{cast}秒的不死之怒。施法期間，每座已點亮的護符石都能由一名團員引導{channel}秒。若在施法結束前，有三名不同的團員各自完成一座護符石的引導，此次狂怒便會被打斷，尼思拉克西斯將被暈眩{stun}秒。否則每名團員都會承受相當於最大生命值{damageHeroic}的暗影傷害，沒有任何生命值能撐過這一擊。',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageResponse': '開戰前為每座護符石指派一名團員。施法開始時，各自跑向自己的護符石並持續引導直到完成。暈眩、離開範圍或死亡都會中斷引導，因此務必保護引導者安全，且絕不可指派正被穿刺的團員負責引導。',
  'hudChrome.raidBossGuide.nythraxis.courtName': '不死宮廷',
  'hudChrome.raidBossGuide.nythraxis.courtSummary': '在英雄難度中，只要前一批王庭已被擊敗，尼思拉克西斯便會在每次不死之怒後（無論是否被打斷）喚起他的王庭。奧德倫的亡魂會以王室順劈橫掃其目標附近的所有人。馬爾里克的亡魂會引導馬爾里克的修復，每次施放都能為尼思拉克西斯恢復更多生命。沃斯的亡魂無視嘲諷，並專門獵殺團隊。',
  'hudChrome.raidBossGuide.nythraxis.courtResponse': '坦克應接下奧德倫，並讓他的順劈背對團隊。馬爾里克的修復一開始施放，就立即暈眩或沉默他，並優先將他擊殺；接著使用定身或暈眩把沃斯拉離治療，因為他無法被嘲諷，隨後將他解決。',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathName': '國王之怒',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathSummary': '尼思拉克西斯此後在普通難度造成{bonusNormal}更多傷害，英雄難度則為{bonusHeroic}，直到戰鬥結束。墓穴爆發每{eruptionEveryNormal}秒發生一次（英雄難度{eruptionEveryHeroic}秒），墓火每{gravefireEveryNormal}秒發生一次（英雄難度{gravefireEveryHeroic}秒）。',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathResponse': '為無法避免的傷害使用剩餘的防禦技能冷卻。在團隊結束這場戰鬥前，持續乾淨地應對先前所有機制。',
  'hudChrome.raidBossGuide.nythraxis.boneStormName': '骨風暴',
  'hudChrome.raidBossGuide.nythraxis.boneStormSummary': '自國王之怒開始後{first}秒，以及此後每{everyNormal}秒，尼思拉克西斯都會展開持續{duration}秒的骨風暴。他會無視仇恨，以{speed}倍的正常速度移動，並進行{charges}次各持續{chargeSeconds}秒的衝撞。他的橫掃每秒對{radius}碼內造成相當於最大生命值{whirlNormal}的傷害。每次衝撞結束時都會在同樣範圍內施展骨擊，造成相當於最大生命值{slamNormal}的傷害。他會在風暴開始後{spikeAt}秒施放骨刺，並在風暴結束{rearm}秒後重新啟用碎墓打擊。',
  'hudChrome.raidBossGuide.nythraxis.boneStormHeroicSummary': '自國王之怒開始後{first}秒，以及此後每{everyHeroic}秒，尼思拉克西斯都會展開持續{duration}秒的骨風暴。他會無視仇恨，以{speed}倍的正常速度移動，並進行{charges}次各持續{chargeSeconds}秒的衝撞。他的橫掃每秒對{radius}碼內造成相當於最大生命值{whirlHeroic}的傷害。每次衝撞結束時都會在同樣範圍內施展骨擊，造成相當於最大生命值{slamHeroic}的傷害。他會在風暴開始後{spikeAt}秒施放骨刺，並在風暴結束{rearm}秒後重新啟用碎墓打擊。',
  'hudChrome.raidBossGuide.nythraxis.boneStormResponse': '分散站位並持續遠離尼思拉克西斯。被鎖定衝撞的團員應遠離逃跑，其餘人則在衝撞路徑周圍留出空間，風暴結束後由坦克接回仇恨。',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresName': '王冠永存',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresSummary': '從開戰起算{enrageNormal}秒後（在奧德里克修士於70%生命值進場期間，計時會暫停），王冠永存會觸發成硬狂暴。尼思拉克西斯獲得{damage}更多傷害與{haste}更快的攻擊速度，此後每{rampEveryNormal}秒再增加{rampStep}傷害。畫面上沒有計時條，警告會以喊話形式在剩餘{warn60}、{warn30}與{warn10}秒時發出。',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresHeroicSummary': '從開戰起算{enrageHeroic}秒後（在奧德里克修士於70%生命值進場期間，計時會暫停），王冠永存會觸發成硬狂暴。尼思拉克西斯獲得{damage}更多傷害與{haste}更快的攻擊速度，此後每{rampEveryHeroic}秒再增加{rampStep}傷害。畫面上沒有計時條，警告會以喊話形式在剩餘{warn60}、{warn30}與{warn10}秒時發出。',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresResponse': '將第一次警告視為最終爆發階段的開始。保留走位與防禦技能冷卻應對剩餘機制，並在狂暴前擊敗尼思拉克西斯。',
  ...
  'entities.itemSets.bramblehide.bonus4': '攻擊強度提高 25 點。你的武器致命一擊有 50% 的機率觸發「墓塚之力」，使攻擊強度提高 40 點，持續 10 秒。',
  'entities.itemSets.bramblehide.bonus6': '攻擊與施法速度提高 4%，命中提高 3%。你的武器致命一擊會使目標產生「骨刺」，每 2 秒流血 5 點傷害，持續 12 秒。最多疊加 3 層。',
  ...
  'hudChrome.bank.logSearchNoMatch': '已載入的公會銀行操作中沒有符合搜尋的結果。顯示更早的紀錄以擴大範圍。',
  ...
  'hudChrome.auraEffect.nythraxisKingsWrath': '國王之怒：尼思拉克西斯此後造成的傷害提高{pct}%，直到戰鬥結束。',
  'hudChrome.auraEffect.nythraxisBoneStorm': '骨風暴：尼思拉克西斯無視仇恨，每秒對{radius}碼內造成相當於最大生命值{tick}%的橫掃傷害，並衝撞團員。請分散並奔跑。',
  'hudChrome.auraEffect.nythraxisCrownEndures': '王冠永存：{stacks}層，傷害提高{pct}%，攻擊速度提高{haste}%。團隊已經沒有時間了。',
