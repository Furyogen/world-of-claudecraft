...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.chat.categories.hide': '在「全部」檢視中隱藏{category}訊息',
  'hudChrome.chat.categories.show': '在「全部」檢視中顯示{category}訊息',
  'hudChrome.chat.categories.game': '遊戲',
  'hudChrome.chat.categories.loot': '拾取',
  'hudChrome.chat.categories.xp': '經驗',
  'hudChrome.chat.categories.quest': '任務',
  'hudChrome.chat.categories.event': '活動',
  'hudChrome.chat.categories.public': '公共',
  'hudChrome.chat.categories.party': '隊伍',
  'hudChrome.chat.categories.guild': '公會',
  'hudChrome.chat.categories.channels': '頻道',
  'hudChrome.chat.categories.whispers': '密語',
