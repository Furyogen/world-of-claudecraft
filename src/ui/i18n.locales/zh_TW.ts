...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.disclosure':
    '克勞迪姆是一種單向軟通貨：用錢購買，用於外觀裝飾。不可贖回、轉讓或兌現。',
  'hudChrome.claudium.buyTitle': '購買克勞迪姆',
  'hudChrome.claudium.railLabel': '付款方式',
  'hudChrome.claudium.railStripe': '信用卡',
  'hudChrome.claudium.railWocUnavailable': 'WOC 價格目前無法使用。',
  'hudChrome.claudium.amountLabel': '金額',
  'hudChrome.claudium.skuRow': '{usd} 兌換 {claudium} 克勞迪姆',
  'hudChrome.claudium.buyButton': '購買',
  'hudChrome.claudium.buyUnavailable': '購買目前無法使用。',
  'hudChrome.claudium.storeTitle': '外觀商店',
  'hudChrome.claudium.storeEmpty': '目前沒有可用的外觀裝飾。',
  'hudChrome.claudium.storeCost': '{amount} 克勞迪姆',
  'hudChrome.claudium.spendButton': '兌換',
  'hudChrome.claudium.kindCosmetic': '外觀',
  'hudChrome.claudium.kindSkin': '造型',
  'hudChrome.claudium.kindItem': '物品',
  'hudChrome.claudium.tabsLabel': '克勞迪姆分頁',
  'hudChrome.claudium.tabBuy': '購買',
  'hudChrome.claudium.tabRedeem': '兌換',
  'hudChrome.claudium.railDisabled': '此付款方式目前無法使用。',
  'hudChrome.claudium.oracleUnavailable': '即時價格目前無法使用。請稍後再試。',
  'hudChrome.claudium.quoteButton': '取得報價',
  'hudChrome.claudium.amountRow': '{usd} 兌換 {claudium} 克勞迪姆',
  'hudChrome.claudium.sendExactly': '精確傳送 {amount} {rail}',
  'hudChrome.claudium.addressLabel': '傳送至',
  'hudChrome.claudium.memoLabel': '備註 (必填)',
  'hudChrome.claudium.splitBurn': '銷毀 {amount} {rail}',
  'hudChrome.claudium.splitTreasury': '{amount} {rail} 進入金庫',
  'hudChrome.claudium.expiresIn': '報價將在 {time} 後過期',
  'hudChrome.claudium.quoteExpired': '此報價已過期。請重新取得。',
  'hudChrome.claudium.payNote':
    '從你自己的錢包傳送帶備註的精確金額，然後貼上交易簽章以確認。服務會在鏈上驗證後才入帳。',
  'hudChrome.claudium.signatureLabel': '交易簽章',
  'hudChrome.claudium.signaturePlaceholder': '貼上簽章',
  'hudChrome.claudium.confirmButton': '確認付款',
  'hudChrome.claudium.confirmCredited': '已入帳 {amount} 克勞迪姆。',
  'hudChrome.claudium.confirmFailed': '暫時無法確認此筆付款。請稍後再試。',
  'hudChrome.claudium.redeemTitle': '兌換禮品卡',
  'hudChrome.claudium.enterCode': '輸入你的禮品卡代碼',
  'hudChrome.claudium.redeemButton': '兌換',
  'hudChrome.claudium.redeemed': '已兌換 {amount} 克勞迪姆。新餘額：{balance}。',
  'hudChrome.claudium.redeemFailed': '無法兌換此代碼。請檢查代碼後重試。',
  'hudChrome.claudium.back': '返回',
  'hudChrome.claudium.tabHistory': '歷史記錄',
  'hudChrome.claudium.giftTitle': '贈送禮品卡',
  'hudChrome.claudium.giftDenominationLabel': '面額',
  'hudChrome.claudium.giftRecipientLabel': '收件人',
  'hudChrome.claudium.giftToSelf': '給我自己',
  'hudChrome.claudium.giftToOther': '給其他人',
  'hudChrome.claudium.giftEmailLabel': '收件人電子郵件',
  'hudChrome.claudium.giftEmailInvalid': '請輸入有效的電子郵件地址。',
  'hudChrome.claudium.giftOccasionLabel': '場合',
  'hudChrome.claudium.giftMessageLabel': '個人留言',
  'hudChrome.claudium.giftMessagePlaceholder': '新增簡短留言 (選填)',
  'hudChrome.claudium.giftDeliveryLabel': '送達方式',
  'hudChrome.claudium.giftScheduleLabel': '安排送達時間 (選填)',
  'hudChrome.claudium.giftReviewButton': '核對禮品',
  'hudChrome.claudium.giftReviewSelf': '這張禮品卡將由你自己兌換。',
  'hudChrome.claudium.giftReviewEmail': '我們會將這張禮品卡寄送至 {email}。',
  'hudChrome.claudium.giftReviewShared': '你將取得一個連結來分享這張禮品卡。',
  'hudChrome.claudium.giftReviewScheduled': '將於你選擇的日期送達。',
  'hudChrome.claudium.giftConfirmButton': '確認並付款',
  'hudChrome.claudium.giftAnotherButton': '再贈送一張',
  'hudChrome.claudium.giftPending': '正在開立你的禮品卡。這可能需要一點時間。',
  'hudChrome.claudium.giftIssued': '你的禮品卡已可分享。',
  'hudChrome.claudium.giftFailed': '無法開立該禮品卡。請稍後再試。',
  'hudChrome.claudium.giftDeclined': '付款遭拒。未開立禮品卡。',
  'hudChrome.claudium.giftLinkLabel': '禮品卡連結',
  'hudChrome.claudium.giftQrAlt': '禮品卡兌換連結的 QR code',
  'hudChrome.claudium.giftTerms': '禮品卡僅可兌換克勞迪姆。不可兌換現金，且不可退款。',
  'hudChrome.claudium.deliveryEmail': '電子郵件',
  'hudChrome.claudium.deliveryLink': '分享連結',
  'hudChrome.claudium.deliveryReveal': '立即顯示',
  'hudChrome.claudium.occasionBirthday': '生日',
  'hudChrome.claudium.occasionHoliday': '節日',
  'hudChrome.claudium.occasionCongrats': '祝賀',
  'hudChrome.claudium.occasionThankyou': '感謝',
  'hudChrome.claudium.occasionGeneric': '隨心贈送',
  'hudChrome.claudium.reasonPurchaseStripe': '購買 (信用卡)',
  'hudChrome.claudium.reasonPurchaseSol': '購買 (SOL)',
  'hudChrome.claudium.reasonPurchaseUsdc': '購買 (USDC)',
  'hudChrome.claudium.reasonPurchaseWoc': '購買 (WOC)',
  'hudChrome.claudium.reasonGiftcardRedeem': '禮品卡已兌換',
  'hudChrome.claudium.reasonSpend': '購買裝飾',
  'hudChrome.claudium.reasonRefund': '退款',
  'hudChrome.claudium.reasonChargeback': '拒付',
  'hudChrome.claudium.reasonGiftcardVoid': '禮品卡已作廢',
  'hudChrome.claudium.historyTitle': '交易記錄',
  'hudChrome.claudium.historyLoading': '正在載入你的記錄...',
  'hudChrome.claudium.historyError': '無法載入你的記錄。請重試。',
  'hudChrome.claudium.historyEmpty': '你還沒有任何克勞迪姆交易。',
  'hudChrome.claudium.historyLoadMore': '載入更多',
  'hudChrome.claudium.historyFilterLabel': '依類型篩選',
  'hudChrome.claudium.historyFilterAll': '所有類型',
  'hudChrome.claudium.historyExplorer': '在 Solana Explorer 上檢視',
  'hudChrome.claudium.historyReceipt': '信用卡購買',
  'hudChrome.claudium.historyGiftNote': '禮品卡',
  'hudChrome.claudium.timeJustNow': '剛剛',
  'hudChrome.claudium.discountLabel': '折扣',
  'hudChrome.claudium.discountSummary': '按有效錨定價格立減 {percent}%',
