...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.gauntlet.survivorsAria': '{total} 人中還有 {count} 人存活',
  'hudChrome.gauntlet.prizeAria': '獎金池:{amount}',
  ...
  'hudChrome.gauntlet.roleAttacker': '進攻方',
  'hudChrome.gauntlet.roleDefender': '防守方',
  ...
  'hudChrome.gauntlet.hint.court': '光環閃起時點擊對手,將其推出場外。',
