...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.skillTracker.managerButton': '技能管理器',
  'hudChrome.skillTracker.managerButtonOnAria': '技能管理器已開啟。關閉後將隱藏所有追蹤框和條。',
  'hudChrome.skillTracker.managerButtonOffAria': '技能管理器已關閉。開啟後可選擇要追蹤的法術。',
  'hudChrome.skillTracker.lockButton': '鎖定',
  'hudChrome.skillTracker.lockButtonOnAria': '追蹤框已鎖定。解鎖後可拖曳。',
  'hudChrome.skillTracker.lockButtonOffAria': '追蹤框已解鎖。鎖定後將固定位置。',
  'hudChrome.skillTracker.managerHint': '選擇要在目標上追蹤的法術。已追蹤 {count} 個。',
  'hudChrome.skillTracker.displayOn': '開',
  'hudChrome.skillTracker.displayOff': '關',
  'hudChrome.skillTracker.displayAria': '追蹤{name}',
  'hudChrome.skillTracker.typeSquare': '方塊',
  'hudChrome.skillTracker.typeBar': '條',
  'hudChrome.skillTracker.typeAria': '{name}的追蹤樣式：{type}',
  'hudChrome.skillTracker.tooltipTarget': '在你的目標身上',
  'hudChrome.skillTracker.tooltipSelf': '在你身上',
  'hudChrome.skillTracker.tooltipCooldown': '冷卻',
  'hudChrome.skillTracker.dragHandle': '拖曳以移動追蹤框',
  'hudChrome.skillTracker.groupSquares': '法術追蹤圖示',
  'hudChrome.skillTracker.groupBars': '法術追蹤條',
