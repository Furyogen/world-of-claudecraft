...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.forgekeepersWrath': '鑄爐守衛之怒',
  'abilityUi.cast.azazelApocalypseFlame': '天啟之焰',
  ...
  'guide.dungeonsPage.abyssBody':
    '風暴峭壁之下的灼熱裂隙，被鎖鏈束縛的軍團在此為煉獄之主鼓動熔爐。唯一的出路是向下：越過熔岩與深淵巨口，直抵深淵之心。',
  ...
  'entities.items.infernal_slag.name': '煉獄熔渣',
  'entities.items.charred_legion_tablet.name': '焦黑軍團石板',
  'entities.items.brands_of_the_first_flame.name': '第一烈焰的烙印',
  'entities.items.forgekeepers_ledger.name': '鑄爐守衛的帳簿',
  'entities.items.azazels_broken_covenant.name': '阿撒茲勒的破碎契約',
  'entities.items.emberforged_vambraces.name': '燼鑄臂甲',
  'entities.items.cinderthread_mantle.name': '灰線披肩',
  'entities.items.hellstalker_boots.name': '地獄獵手之靴',
  'entities.items.forgekeepers_warhammer.name': '鑄爐守衛的戰錘',
  'entities.items.forgekeepers_runestaff.name': '鑄爐守衛的符文杖',
  'entities.items.forgekeepers_fang.name': '鑄爐守衛之牙',
  'entities.items.azazels_ruinblade.name': '阿撒茲勒的毀滅之刃',
  'entities.items.azazels_soulstaff.name': '阿撒茲勒的靈魂法杖',
  'entities.items.azazels_emberfang.name': '阿撒茲勒的餘燼之牙',
  'entities.items.hellforged_bulwark.name': '獄火壁壘',
  'entities.items.cinderseer_raiment.name': '燼視者法衣',
  'entities.items.abysswalker_harness.name': '深淵行者甲冑',
  'entities.mobs.abyssal_legionnaire.name': '深淵軍團士兵',
  'entities.mobs.cinder_magus.name': '灰燼法師',
  'entities.mobs.molten_hellhound.name': '熔火地獄犬',
  'entities.mobs.flamebound_smith.name': '縛焰鐵匠',
  'entities.mobs.abyssal_gladiator.name': '深淵角鬥士',
  'entities.mobs.infernal_cinderling.name': '煉獄燼靈',
  'entities.mobs.forgekeeper.name': '鑄爐守衛',
  'entities.mobs.pyre_golem.name': '火葬魔像',
  'entities.mobs.azazel_infernal_lord.name': '煉獄之主阿撒茲勒',
  'entities.quests.q_infernal_abyss_echoes.title': '風暴峭壁之下的回響',
  'entities.quests.q_infernal_abyss_echoes.text':
    '風暴峭壁並非誕生於風暴，{playerName}。最古老的石板稱它為一只蓋子，錘打在一團從世界之外墜落的烈火之上。東部峭壁下方裂開了一道新縫隙。與四名盟友一同進入，找回軍團石板，以及刻在第一團烈焰旁的烙印。',
  'entities.quests.q_infernal_abyss_echoes.completion':
    '石板記載著一支自願踏入烈火的大軍。烙印則揭示了他們侍奉的力量：阿撒茲勒。這從來不是為了把惡魔擋在外面的監牢，{playerName}。這是一扇讓他們的領主進入此世的大門。',
  'entities.quests.q_infernal_abyss_echoes.objectives.0.label': '已解讀焦黑軍團石板',
  'entities.quests.q_infernal_abyss_echoes.objectives.1.label': '已研究第一烈焰的烙印',
  'entities.quests.q_infernal_abyss_covenant.title': '破碎的契約',
  'entities.quests.q_infernal_abyss_covenant.text':
    '軍團的誓言許諾為阿撒茲勒打開一條通往我們世界的道路，但每份契約都有代價，也有破綻。返回煉獄深淵。找到鑄爐守衛的帳簿，以及深淵巨口附近的破碎契約。若能弄清束縛他的力量，我們或許就能知道如何殺死他。',
  'entities.quests.q_infernal_abyss_covenant.completion':
    '破綻就在這裡：阿撒茲勒以自己軍團成員的名字為大門供能。每吞噬一名僕從，他都會變得更強，卻也將自己的性命繫在了下方的熔爐上。在那座熔爐的核心擊潰領主，大門也必將隨他一同消亡。',
  'entities.quests.q_infernal_abyss_covenant.objectives.0.label': '已找回鑄爐守衛的帳簿',
  'entities.quests.q_infernal_abyss_covenant.objectives.1.label': '已閱讀阿撒茲勒的破碎契約',
  'entities.quests.q_infernal_abyss_azazel.title': '煉獄深淵之主',
  'entities.quests.q_infernal_abyss_azazel.text':
    '這份契約只給了我們一次機會，{playerName}。與值得信賴的同伴一同越過熔爐和深淵巨口，繼續向下。在第一烈焰觸及我們世界之處直面阿撒茲勒，抵擋他的軍團，並在風暴峭壁成為他敞開的大門之前熄滅這位煉獄之主。',
  'entities.quests.q_infernal_abyss_azazel.completion':
    '山中寂靜無聲。不是沉睡，不是等待，只是徹底安靜。阿撒茲勒用偷來的名字鑄成永恆，而你用自己的一個凡人名字終結了它。高崗城會記住這個名字，{playerName}。',
  'entities.quests.q_infernal_abyss_azazel.objectives.0.label': '已擊殺煉獄之主阿撒茲勒',
  'entities.dungeons.infernal_abyss.name': '煉獄深淵',
  'entities.dungeons.infernal_abyss.enterText': '你深入風暴峭壁之下，進入煉獄深淵。',
  'entities.dungeons.infernal_abyss.leaveText': '你從爐火般的黑暗中攀出，回到山風之中。',
};
