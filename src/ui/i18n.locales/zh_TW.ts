...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.howto':
    '衝過城堡試煉:躲開鏈錘,穿過轉木,算準巨斧,踏上吊橋,躲開滾石。第一個衝線者奪得王冠。摔落只會耽誤時間。',
  ...
  'hudChrome.hc.section.flail_bridge': '鏈錘橋',
  'hudChrome.hc.section.log_court': '轉木廣場',
  'hudChrome.hc.section.axe_walk': '巨斧迴廊',
  'hudChrome.hc.section.drawspan': '升降吊橋',
  'hudChrome.hc.section.boulder_alley': '滾石巷',
  ...
  'guide.hodricsCastlePage.courseHeading': '試煉賽道',
  'guide.hodricsCastlePage.courseBody':
    '賽道從起點廣場出發,穿過鏈錘橋、轉木廣場、巨斧迴廊、升降吊橋、滾石巷,最後沿赤紅坡道衝向終點主堡。每個機關都按自己固定的節奏擺動、旋轉或滾動,絕非隨機,細心觀察總能找到安全的時機。',
  ...
  'guide.hodricsCastlePage.fallsBody':
    '被機關擊中或跌入深淵,只會送你回到上一個檢查點。沒人會死在這條通道上:摔落唯一的代價就是追趕失去的那幾秒。',
  'guide.hodricsCastlePage.standingsHeading': '王冠',
  'guide.hodricsCastlePage.standingsBody':
    '第一個衝過終點線的人奪得那場比賽的霍德里克王冠。你的參賽次數、勝場與最佳成績會隨著每次參賽不斷累積。',
