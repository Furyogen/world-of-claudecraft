...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ring_of_the_nine.name': '九人之戒',
  'entities.items.nielas_band.name': '妮拉之環',
  ...
  'entities.items.band_of_the_architect.name': '建築師之環',
  'entities.items.swiftstride_pendant.name': '疾行者吊墜',
