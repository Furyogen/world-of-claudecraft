...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': '靜音',
  'hudChrome.playerMenu.unmute': '取消靜音',
  ...
  'hudChrome.social.mutedSection': '已靜音',
  'hudChrome.social.blockedSection': '已封鎖',
  'hudChrome.social.stopMutingTitle': '取消對 {name} 的靜音',
