...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.gauntlet.phaseTrialWager': '看守人的賭局開始',
  ...
  'hudChrome.gauntlet.pull': '拉',
  'hudChrome.gauntlet.pullRope': '繩位',
  'hudChrome.gauntlet.shove': '推',
  'hudChrome.gauntlet.roleAttacker': '進攻方',
  'hudChrome.gauntlet.roleDefender': '防守方',
  'hudChrome.gauntlet.sigilsTitle': '描摹符文',
  'hudChrome.gauntlet.sigilsHint': '沿著蝕刻的紋路描摹,別讓它碎裂。',
  'hudChrome.gauntlet.cracks': '裂痕',
  'hudChrome.gauntlet.traced': '完成度',
  'hudChrome.gauntlet.sigilsShattered': '糖玻璃碎了!',
  'hudChrome.gauntlet.wagerTitle': '看守人的賭局',
  'hudChrome.gauntlet.wagerYours': '你的:{count}',
  'hudChrome.gauntlet.wagerPartner': '{name}:{count}',
  'hudChrome.gauntlet.wagerRound': '本輪:{seconds}秒',
  'hudChrome.gauntlet.wagerStake': '賭注',
  'hudChrome.gauntlet.stakeDown': '降低賭注',
  'hudChrome.gauntlet.stakeUp': '提高賭注',
  'hudChrome.gauntlet.wagerHide': '藏起你的彈珠',
  'hudChrome.gauntlet.wagerGuess': '單還是雙?',
  'hudChrome.gauntlet.odd': '單',
  'hudChrome.gauntlet.even': '雙',
  'hudChrome.gauntlet.wagerWon': '你贏下了這場對決。',
  'hudChrome.gauntlet.wagerLost': '你輸掉了這場對決。',
