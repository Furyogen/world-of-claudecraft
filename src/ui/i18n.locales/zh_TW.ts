...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.title': '霍德里克城堡',
  'hudChrome.hc.close': '關閉試煉之門視窗',
  'hudChrome.hc.zoneName': '霍德里克城堡',
  'hudChrome.hc.offlineNote': '試煉之門尚未同步,請稍候。',
  'hudChrome.hc.joinQueue': '加入試煉',
  'hudChrome.hc.leaveQueue': '離開隊列',
  'hudChrome.hc.queuedAt': '排隊中,位置 {position}。湊滿十人即開賽。',
  'hudChrome.hc.inMatchNote': '比賽進行中,全力衝刺!',
  'hudChrome.hc.practice': '與試煉騎士練習',
  'hudChrome.hc.practiceNote': '挑戰霍德里克領主的騎士團:九名對手,無需等待。',
  'hudChrome.hc.record': '奪冠 {wins} / 參賽 {races}',
  'hudChrome.hc.bestTime': '最佳成績 {seconds}秒',
  'hudChrome.hc.bestNone': '尚無完賽紀錄',
  'hudChrome.hc.rank': '排名 {rank} / {total}',
  'hudChrome.hc.finishPlace': '完賽第 {place} 名',
  'hudChrome.hc.overWon': '王冠歸你所有!',
  'hudChrome.hc.overPlaced': '比賽結束:第 {place} 名',
  'hudChrome.hc.howto':
    '三個回合,十名選手,一頂王冠。霍德里克大人每回合都會重建他的闖關賽道:每次挺過淘汰(六人晉級,再三人),贏下決賽。跌落只損失時間。',
  'hudChrome.hc.round': '回合 {round}/{rounds}',
  'hudChrome.hc.advance': '{count}人晉級',
  'hudChrome.hc.spectating': '正在看台觀戰',
  'hudChrome.hc.intermissionRebuild': '霍德里克大人正在重建賽道!',
  'hudChrome.hc.intermissionQualified': '晉級成功,下一回合即將開始。',
  'hudChrome.hc.intermissionEliminated': '被淘汰了!請欣賞看台風景。',
  'hudChrome.hc.section.hammer_bridge': '鐵鎚橋',
  'hudChrome.hc.section.rotor_court': '旋木庭院',
  'hudChrome.hc.section.boulder_climb': '滾石坡',
  'hudChrome.hc.section.piston_ledge': '活塞窄道',
  'hudChrome.hc.section.spinner_court': '轉盤廣場',
  'hudChrome.hc.section.landing': '平臺',
  'hudChrome.hc.banner.round': '第{round}回合!',
  'hudChrome.hc.banner.qualified': '晉級!',
  'hudChrome.hc.banner.eliminated': '淘汰',
  'hudChrome.hc.log.qualified': '你晉級下一回合。',
  'hudChrome.hc.log.eliminated': '在第{round}回合被淘汰。看台上有小吃。',
  'hudChrome.hc.flavor.rebuild': '霍德里克大人重建了賽道。新賽道,同一頂王冠!',
  'hudChrome.hc.section.start_yard': '起點廣場',
  'hudChrome.hc.section.axe_walk': '巨斧迴廊',
  'hudChrome.hc.section.drawspan': '升降吊橋',
  'hudChrome.hc.section.red_ascent': '赤紅坡道',
  'hudChrome.hc.section.finish_keep': '終點主堡',
  'hudChrome.hc.banner.found': '試煉召喚而來!',
  'hudChrome.hc.banner.go': '出發!',
  'hudChrome.hc.banner.finish': '完賽第 {place} 名!',
  'hudChrome.hc.banner.crown': '你奪得了霍德里克的王冠!',
  'hudChrome.hc.log.queued': '你加入試煉隊列(位置 {position})。',
  'hudChrome.hc.log.unqueued': '你離開了試煉隊列。',
  'hudChrome.hc.log.fall': '深淵吞沒了你,返回檢查點。',
  'hudChrome.hc.log.checkpoint': '已通過檢查點 {index}。',
  'hudChrome.hc.log.placed': '你以第 {place} 名完成試煉。',
  'hudChrome.hub.enter': '你穿過閃爍的傳送門，進入試煉場。',
  'hudChrome.hub.leave': '你回到了東溪谷。',
  'hudChrome.hub.zoneName': '試煉藏書閣',
  'hudChrome.hc.flavor.queueJoin': '你加入試煉隊列。霍德里克領主為你上油鏈錘,以示敬意。',
  'hudChrome.hc.flavor.gatesOpen': '霍德里克城堡的大門緩緩開啟,衝向王冠吧!',
  'hudChrome.hc.flavor.go': '出發!試煉之門已開!',
  'hudChrome.hc.err.legsOnly': '試煉中只能靠雙腿:禁止使用技能。',
  'hudChrome.hc.err.inMatch': '你已經在參加試煉了。',
  'hudChrome.hc.err.dead': '死亡狀態下無法加入試煉隊列。',
  'hudChrome.hc.err.arenaConflict': '請先離開競技場再參加試煉。',
  ...
  'entities.npcs.hodrics_herald.name': '傳令官奧斯里克',
  'entities.npcs.hodrics_herald.title': '霍德里克試煉傳令官',
  'entities.npcs.hodrics_herald.greeting':
    '霍德里克領主向所有來客敞開通道!參加試煉,躲開鏈錘,奪得王冠!',
  ...
  'guide.nav.hodricsCastle': '霍德里克城堡',
  'guide.hodricsCastlePage.heading': '霍德里克城堡',
  'guide.hodricsCastlePage.intro':
    '霍德里克領主向任何挑戰者敞開城堡通道。衝過他舊日防線的試煉,奪得王冠,不論你是誰,不論你的等級如何。',
  'guide.hodricsCastlePage.heraldHeading': '傳令官',
  'guide.hodricsCastlePage.heraldBody':
    '前往伊斯特布魯克邊緣找傳令官奧斯里克,加入試煉隊列。湊滿十名挑戰者(真實玩家與霍德里克宮廷的騎士皆可)即開賽,所以比賽總是很快開始。',
  'guide.hodricsCastlePage.courseHeading': '三個回合,一頂王冠',
  'guide.hodricsCastlePage.courseBody':
    '闖關賽是一場淘汰秀:十名選手開跑,六人挺過首輪,三人進入決賽,一人加冕。霍德里克大人每回合都會重建賽道,所以沒有兩場相同的比賽:鐵鎚橋、旋木庭院、斧刃迴廊、滑動吊橋、滾石坡、活塞窄道、旋轉平臺,順序全憑大人當天的興致。每個機關都按自己固定的發條節奏擺動、旋轉、滾動,絕無隨機,細心的眼睛總能找到安全的空檔。',
  'guide.hodricsCastlePage.fairnessHeading': '只靠雙腿',
  'guide.hodricsCastlePage.fairnessBody':
    '這裡沒人施法:整場比賽禁止使用技能,每位選手速度相同。試煉勝負只看膽識與時機,與裝備或等級無關。',
  'guide.hodricsCastlePage.fallsHeading': '摔落只耽誤時間,不會喪命',
  'guide.hodricsCastlePage.fallsBody':
    '被機關擊中或跌入深淵,只會把你送回上一個檢查點。堤道上沒有人會死:跌落的唯一代價是追趕的那幾秒。回合結束被淘汰的選手會被氣派地拋上看台包廂,在那裡就著小吃看完剩下的比賽。',
  'guide.hodricsCastlePage.standingsHeading': '王冠',
  'guide.hodricsCastlePage.standingsBody':
    '決賽回合率先衝線者贏得本場霍德里克王冠。你的出場數、奪冠數和決賽最佳成績,每次排隊都在累積。',
  ...
  'hudChrome.gauntlet.joinQueue': '加入佇列',
  'hudChrome.gauntlet.leaveQueue': '離開佇列',
  'hudChrome.gauntlet.queuePosition': '佇列位置：{n}',
  'hudChrome.gauntlet.spectate': '觀戰',
  'hudChrome.gauntlet.stopSpectating': '停止觀戰',
  'hudChrome.gauntlet.practice': '練習',
  'hudChrome.gauntlet.eventClosedNote': '賽事目前未開放，佇列與觀戰暫時關閉。練習隨時開放。',
  'hudChrome.gauntlet.practicePickTitle': '選擇要練習的項目',
  'hudChrome.gauntlet.practiceFull': '完整試煉迴廊',
  'hudChrome.gauntlet.trialNames.sentinel': '哨衛橫渡',
  'hudChrome.gauntlet.trialNames.sigils': '糖玻璃符印',
  'hudChrome.gauntlet.trialNames.pull': '拔河大賽',
  'hudChrome.gauntlet.trialNames.echo': '看守人的回響',
  ...
  'hudChrome.gauntlet.phaseLobby': '召集挑戰者',
  'hudChrome.gauntlet.phaseStaging': '各就各位',
  'hudChrome.gauntlet.phaseTrial': '橫渡開始',
  'hudChrome.gauntlet.phaseTrialSigils': '蝕刻開始',
  'hudChrome.gauntlet.phaseTrialPull': '握緊長繩',
  'hudChrome.gauntlet.phaseTrialEcho': '看守人的回響開始',
  'hudChrome.gauntlet.phaseTrialSpan': '踏上脆橋',
  'hudChrome.gauntlet.phaseTrialCourt': '終局之場',
  'hudChrome.gauntlet.phaseInterlude': '試煉通過',
  'hudChrome.gauntlet.phasePodium': '試煉迴廊已定勝負',
  'hudChrome.gauntlet.greenLight': '綠燈!',
  'hudChrome.gauntlet.redLight': '紅燈!',
  'hudChrome.gauntlet.vitalityLost': '你失去了 {amount} 點生命力。',
  'hudChrome.gauntlet.survivorsLeft': '還有 {count} 人存活',
  'hudChrome.gauntlet.spectating': '觀戰中',
  'hudChrome.gauntlet.leave': '離開',
  'hudChrome.gauntlet.victory': '勝利',
  'hudChrome.gauntlet.podiumTitle': '最終排名',
  ...
  'hudChrome.gauntlet.hint.court': '與對手決鬥:抵達盡頭的王冠,或將其推出場外。角色會定時輪換。',
  'entities.npcs.gauntlet_recruiter.title': '試煉迴廊傳令官',
  'entities.npcs.gauntlet_recruiter.greeting':
    '和其他人一起踏上沙場吧,{className}。熬過每一場試煉,頒獎台就是你的。',
  'entities.npcs.gauntlet_watcher.name': '石之守望者',
  'entities.npcs.gauntlet_watcher.title': '橫渡守護者',
  'entities.npcs.gauntlet_watcher.greeting': '守望者從不眨眼。',
  'entities.npcs.gauntlet_contestant.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant.title': '參賽者',
  'entities.npcs.gauntlet_contestant.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_warrior.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_warrior.title': '參賽者',
  'entities.npcs.gauntlet_contestant_warrior.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_paladin.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_paladin.title': '參賽者',
  'entities.npcs.gauntlet_contestant_paladin.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_hunter.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_hunter.title': '參賽者',
  'entities.npcs.gauntlet_contestant_hunter.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_rogue.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_rogue.title': '參賽者',
  'entities.npcs.gauntlet_contestant_rogue.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_priest.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_priest.title': '參賽者',
  'entities.npcs.gauntlet_contestant_priest.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_mage.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_mage.title': '參賽者',
  'entities.npcs.gauntlet_contestant_mage.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_warlock.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_warlock.title': '參賽者',
  'entities.npcs.gauntlet_contestant_warlock.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_shaman.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_shaman.title': '參賽者',
  'entities.npcs.gauntlet_contestant_shaman.greeting': '目視前方。守望者正盯著你。',
  'entities.npcs.gauntlet_contestant_druid.name': '試煉參賽者',
  'entities.npcs.gauntlet_contestant_druid.title': '參賽者',
  'entities.npcs.gauntlet_contestant_druid.greeting': '目視前方。守望者正盯著你。',
