...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.eyebrow': '精選系列',
  'hudChrome.wocStore.featuredTitle': '邊疆之外鍛造的武器',
  'hudChrome.wocStore.featuredBody': '使用 Claudium 取得高級武器外觀。外觀物品不會改變戰鬥能力。',
  'hudChrome.wocStore.balance': 'Claudium 餘額',
  'hudChrome.wocStore.buyClaudium': '購買 Claudium',
  'hudChrome.wocStore.category': '外觀物品',
  'hudChrome.wocStore.weapons': '武器系列',
  'hudChrome.wocStore.empty': '目前沒有可用的武器外觀。',
  'hudChrome.wocStore.weaponCosmetic': '武器外觀',
  'hudChrome.wocStore.purchaseAria': '用 {cost} Claudium 購買 {item}',
  'hudChrome.wocStore.owned': '已擁有',
  'hudChrome.wocStore.ownedAria': '已擁有 {item}',
  ...
  'hudChrome.wocStore.armoryBody': '第一賽季兵器庫限定武器外觀。全帳號通用，純裝飾性，周圍所有玩家都能看到。',
  ...
  'hudChrome.wocStore.usdApprox': '約 {usd} 美元',
