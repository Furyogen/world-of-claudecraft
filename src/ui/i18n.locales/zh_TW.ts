...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': '潮汐之門',
  'entities.zones.atlantis.name': '亞特蘭提斯',
  'entities.zones.atlantis.welcome': '穹頂仍在歌唱，亞特蘭提斯於底潮之下長存。',
  'entities.zones.atlantis.pois.0.label': '亞特蘭提斯',
  'entities.zones.atlantis.pois.1.label': '潮門廣場',
  'entities.zones.atlantis.pois.2.label': '流明之冠',
  'entities.zones.atlantis.pois.3.label': '珍珠市集',
  'entities.zones.atlantis.pois.4.label': '沉沒檔案館',
  'entities.zones.atlantis.pois.5.label': '巨藻守衛附樓',
  'entities.mobs.glimmerfin_eel.name': '閃鰭鰻',
  'entities.mobs.pearlshell_skitterer.name': '珠殼疾行蟹',
  'entities.mobs.kelpshade_lurker.name': '藻影潛伏者',
  'entities.mobs.undertow_maw.name': '底潮巨口',
  'entities.npcs.keeper_nerissa.name': '守護者奈瑞莎',
  'entities.npcs.keeper_nerissa.title': '流明之冠守衛',
  'entities.npcs.keeper_nerissa.greeting': '小心這片玻璃，水面來的客人。它撐過了一個時代——幫我們讓它繼續撐下去。',
  'entities.npcs.tidewright_ollo.name': '潮匠奧洛',
  'entities.npcs.tidewright_ollo.title': '珍珠市集潮匠',
  'entities.npcs.tidewright_ollo.greeting': '深淵裡最後幾座乾燥蒸餾器的新貨。先付錢，再聽故事。',
