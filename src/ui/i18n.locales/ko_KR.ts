...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.gauntlet.eventClosedNote':
    '지금은 대회가 열려 있지 않아 대기열과 관전을 이용할 수 없습니다. 연습은 언제든 가능합니다.',
  'hudChrome.gauntlet.practicePickTitle': '연습할 종목을 선택하세요',
  'hudChrome.gauntlet.practiceFull': '시련의 관문 전체',
  'hudChrome.gauntlet.trialNames.sentinel': '보초의 횡단',
  'hudChrome.gauntlet.trialNames.sigils': '설탕유리 인장',
  'hudChrome.gauntlet.trialNames.pull': '줄다리기 대전',
  'hudChrome.gauntlet.trialNames.echo': '파수꾼의 메아리',
