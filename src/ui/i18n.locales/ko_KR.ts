...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ring_of_the_nine.name': '아홉의 반지',
  'entities.items.nielas_band.name': '니엘라의 고리',
  'entities.items.sutils_fortune.name': '수틸의 행운',
  'entities.items.arthurs_round_band.name': '아서의 둥근 반지',
  'entities.items.signet_of_zyzz.name': '지즈의 인장',
  'entities.items.band_of_the_architect.name': '건축가의 고리',
  'entities.items.swiftstride_pendant.name': '질주의 펜던트',
  'entities.items.yumis_best_pendant.name': '유미의 소중한 펜던트',
  'entities.items.zense_meridian.name': '젠세의 자오선',
  'entities.items.pendant_of_endless_profit.name': '끝없는 이득의 펜던트',
