...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': '조수의 문',
  'entities.zones.atlantis.name': '아틀란티스',
  'entities.zones.atlantis.welcome': '돔은 아직 노래하고, 아틀란티스는 저층 조류 아래에서 버티고 있다.',
  'entities.zones.atlantis.pois.0.label': '아틀란티스',
  'entities.zones.atlantis.pois.1.label': '조수문 광장',
  'entities.zones.atlantis.pois.2.label': '루멘 왕관',
  'entities.zones.atlantis.pois.3.label': '진주 시장',
  'entities.zones.atlantis.pois.4.label': '수몰된 기록고',
  'entities.zones.atlantis.pois.5.label': '켈프 파수꾼 별관',
  'entities.mobs.glimmerfin_eel.name': '반짝지느러미 장어',
  'entities.mobs.pearlshell_skitterer.name': '진주껍질 종종게',
  'entities.mobs.kelpshade_lurker.name': '켈프그늘 잠복꾼',
  'entities.mobs.undertow_maw.name': '저층 조류의 아가리',
  'entities.npcs.keeper_nerissa.name': '수호자 네리사',
  'entities.npcs.keeper_nerissa.title': '루멘 왕관의 파수꾼',
  'entities.npcs.keeper_nerissa.greeting': '유리 조심하게, 물 위 사람. 한 시대를 버텨 온 것이니 — 계속 버티게 도와주게.',
  'entities.npcs.tidewright_ollo.name': '조수장인 올로',
  'entities.npcs.tidewright_ollo.title': '진주 시장의 조수장인',
  'entities.npcs.tidewright_ollo.greeting': '깊은 곳에 남은 마지막 마른 증류기에서 갓 꺼낸 것들이라네. 돈이 먼저, 이야기는 그다음.',
