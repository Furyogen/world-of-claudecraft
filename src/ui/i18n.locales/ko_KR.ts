...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.dread_sentinel_c.greeting': '돌아가라. 검은 유리는 산 자를 위한 것이 아니다... 우리를 위한 것도 결코 아니었다.',
  'entities.quests.q_gargoyle_south.title': '감시자의 통행료',
  'entities.quests.q_gargoyle_south.text': '어른거림이 네 눈 뒤에서 말이 된다: 수확자들이 내 유리를 메우고 있다, {playerName}. 그들을 솎아내라, 그러면 Highwatch로 가는 길이 네 것이 되리라.',
  'entities.quests.q_gargoyle_south.completion': '돌이 한 번 만족스레 울린다. 그 뒤로 거울이, 마침내 놓아준 참았던 숨결처럼 맑아진다.',
  'entities.quests.q_gargoyle_south.objectives.0.label': '수확자 처치',
  'entities.quests.q_gargoyle_west.title': '천의 통행료',
  'entities.quests.q_gargoyle_west.text': '어른거림이 네 눈 뒤에서 말이 된다: 가난한 죽은 자들에게서 흰 천 넷을 가져오라, {playerName}. 천으로 값을 치르는 자에게 Eastbrook으로 가는 길이 열린다.',
  'entities.quests.q_gargoyle_west.completion': '천이 돌 속으로 가라앉아 사라진다. 그 뒤의 거울이 빛과 함께 깨어난다.',
  'entities.quests.q_gargoyle_west.objectives.0.label': '흰 천',
  'entities.quests.q_gargoyle_north.title': '거두어진 광휘',
  'entities.quests.q_gargoyle_north.text': '어른거림이 네 눈 뒤에서 말이 된다: 영혼의 무리가 유리에게는 너무 밝게 탄다, {playerName}. 다섯을 솎아내라, 그러면 Fenbridge가 한 걸음이다.',
  'entities.quests.q_gargoyle_north.completion': '돌이 네가 흘린 빛을 마신다. 그 뒤의 거울이 눈처럼 열린다.',
  ...
  'entities.npcs.keeper_nerissa.greeting': '나는 살아서 루멘 왕관을 지켰고, 왕관은 이 유리를 정직하게 지킨다 - 이 골짜기의 모든 거울은 진실을 비추나, 오직 하나만은 아니다. 죽음도 나를 이 자리에서 놓아주지 않았다, {playerName}, 그 하나가 아직 밀어붙이기를 멈추지 않았기에. 왕관의 빛이 사위어 가고, 그 빛이 스러지는 곳에서 골짜기가 배어 나온다. 유리의 어느 쪽을 걷는지 마음 쓰라. 요즘은 그조차 분간하기 어려우니.',
  ...
  'entities.quests.q_the_failing_radiance.text': '그대는 나의 냉기를 느끼고 나를 옛이야기로 여기지. 나는 하나의 초소다, {playerName}. 내가 지킨 루멘 왕관은 황금 고리가 아니라 이곳 모든 거울에 깃든 빛, 산 자와 죽은 자를 서로 다른 상(像)에 붙들어 어느 쪽도 다른 쪽을 삼키지 못하게 하는 이음매다. 그 빛이 스러지고, 그것은 거울결속 파수병들에게서 보인다. 한때는 왕관의 광휘 그 자체가 보초를 섰으나, 이제는 훔친 빛으로 가득 찬 유리일 뿐, 이음매가 더는 설 자리를 일러 주지 않아 북쪽 폐허에 몰려 있다. 여덟을 부수어라. 그대가 흩뜨리는 파편 하나하나가 돌아온 한 줌의 빛이요, 나머지를 그대에게 맡겨도 좋다는 한 줌의 증거다.',
  'entities.quests.q_the_failing_radiance.completion': '파편들이 위로 내리는 눈처럼 우물 쪽으로 떠 돌아가고, 한 호흡 동안 골짜기 전체가 한 결 밝아진다. 오래가진 않으리. 허나 그대는 이음매를 끊는 대신 꿰맨다, {playerName} - 이곳에선 그대 생각보다 드문 일이다. 그대는 다른 왕관도 부수었지? 손피크 아래의 무쇠 왕관을. 그렇다면 삼백 년 만에 처음으로, 이 빛이 돌아올지도 모른다. 머물러라. 이 골짜기는 상처를 닫는 손을 오래 기다려 왔다.',
  ...
  'entities.quests.q_what_the_poor_keep.text': '남쪽 물가의 가난한 망령들은 살아서 아무것도 없었다, {playerName} - 교구가 관을 마련할 수 없어 그들을 감싼 수의 말고는 아무것도. 이제 왕관의 빛이 너무 여려 그들의 움켜쥠을 풀지 못하고, 그들은 한때나마 제 것이었던 단 하나를 부여잡고 떠돈다. 이를 잔혹이라 여기지 마라; 둘 곳 없는 사랑이니. 그들의 수의 다섯을 가져오라. 하나씩 우물에 뉘고, 새겨지기엔 너무 가난했던 이름을 부르리라. 의식의 전부가 그것이다 - 가난하고, 죽었으되, 여전히 이름으로 불리는 것.',
  'entities.quests.q_what_the_poor_keep.completion': '수의 다섯, 이름 다섯. 그것을 우물에 대고 읊으니, 물은 잠든 아이에게서 어미가 외투를 걷어 올리듯 그것을 받아 간다. 물가의 망령들이 오늘 밤 줄었다, {playerName} - 죽인 게 아니라 놓아준 것이다. 온전했던 왕관이 하던 일이 이것이었다: 놓아줄 수 있을 만큼 죽은 자를 가까이 붙든 것. 이제는 손으로 한다, 그대와 내가, 한 번에 다섯 이름씩. 더디다. 허나 헛되지는 않다.',
  'entities.quests.q_what_the_poor_keep.objectives.0.label': '하얀 수의',
  'entities.quests.q_the_wardens_names.title': '파수꾼들의 이름',
  'entities.quests.q_the_wardens_names.text': '검은 협곡을 거니는 셋을, 그들에게서 달아나는 자들은 공포의 파수병이라 부른다. 한때 나는 그들을 이름으로 불렀다 - 그들은 나의 기사단이었다, {playerName}, 살아서 검은담비 거울의 둑길을 지킨 마지막 사내들. 심장이 멈춘 뒤에도 자리를 뜨지 않았다. 이제 어떤 칼도 그들을 놓아주지 못한다; 검은 유리가 너무 깊이 올라타 쓰러질 수조차 없다. 허나 그 유리가 파수꾼들에게서 둑길에 몰린 사신들에게로 번졌고, 긴 세월 사신들은 파수꾼의 인장을 뜯어냈다. 협곡의 사신에게서 벤 셋을 가져오라. 세 이름을 마지막으로 소리 내어 부를 수 있도록.',
  'entities.quests.q_the_wardens_names.completion': '코윈. 앨더스. 브레나. 이로써 - 말해졌다. 그리고 말하는 일은, 여태 붙들고 있던 것보다 훨씬 가볍다. 머지않아 그들은 멈출 수 있으리; 그건 내가 맡으마. 허나 다가오는 것을 경계하라, {playerName}: 인장이 뜯겨 나갔다는 건 저 둑길의 유리가 얇아지고 있다는 뜻이요, 그 끝의 상처는 바로 이때를 기다려 왔다. 저편의 무언가가 문이 훤히 드러난 걸 알아채기 전에, 나는 왕관에 다시 불을 밝히고 검은담비 거울을 받쳐야 한다. 마지막으로 필요한 것이 하나 있다 - 검은 물 아래에 잠겨 있지.',
  'entities.quests.q_the_wardens_names.objectives.0.label': '파수꾼의 인장',
  'entities.quests.q_what_the_glass_wants.title': '유리가 원하는 것',
  'entities.quests.q_what_the_glass_wants.text': '그대는 자신의 메아리를 이기고 그것을 스스로에 대한 시험이라 여겼지, {playerName}. 아니었다. 나는 수의와 뿔과 두건으로 깊은 꿈을 빚지만, 그대의 꿈이 거울을 들이댄 대상, 그대의 얼굴을 쓰고 들어온 그것은 내가 빚은 게 아니다. 그것은 협곡의 검은 유리에서 스며든다. 협곡 어귀에 몰린 사신들은 같은 새어듦으로 짙어져 있다; 여덟을 쓰러뜨리고 그 그림자가 어느 쪽으로 기어가는지 보라. 그러면 나는 네리사 자신의 눈에, 그녀의 상처가 참으로 어디서 피 흘리는지를 보여 주리라.',
  'entities.quests.q_what_the_glass_wants.completion': '북동쪽으로. 언제나 북동쪽으로, 언제나 검은담비 거울 쪽으로 — 보았는가? 그대의 메아리는 그대가 아니었다, 나그네여. 그것은 저 문 너머에 사는 그 무엇의 파편이요, 훔칠 수 있는 가장 가까운 반영, 곧 그대의 모습을 걸친 것이었다. 꿈은 그 새어듦이 찾아낸 가장 얇은 자리일 뿐이요; 협곡이 가장 넓은 자리다. 네리사에게 전하라. 그녀는 그 진실을 누릴 자격이 있고, 그대 또한 그러하다.',
  ...
  'entities.quests.q_relight_the_lumen_crown.text': '파수꾼들의 이름이 불렸고 둑길은 얇아지니, 이제 나는 죽은 이래 미뤄 온 일을 해야 한다: 루멘 왕관에 마지막으로 불을 밝히고, 이쪽에서 검은담비 거울을 눌러 닫는 일. 왕관의 마지막 참된 불꽃은 어스름 아가리가 못에 빠질 때 삼켰다 — 그래서 그것이 안에서부터 빛나는 것이다. 그 빛을 도로 도려내라, {playerName}. 검은 유리는 의식을 막으려 음울한 거구들을 보낼 것이다; 넷을 쓰러뜨려라. 내가 아직 불꽃 쥐는 법을 기억할 동안, 가라앉은 불꽃 하나를 가져오라. 지킴이의 마지막 소임은, 더는 지킬 필요가 없는 이가 되는 것이다.',
  'entities.quests.q_relight_the_lumen_crown.completion': '타오른다. 이 모든 어둠 뒤에도, 아직 내 손을 알아본다. 보라: 유리가 다시 참되다; 물 너머에 고동이 없고, 한 세계와 그 반영 사이에 잃어버린 혼도 없다. 그리고 짐이 마침내 내게서 내려졌다. 나는 스러지는 게 아니다, {playerName}; 나는 교대되는 것이다. 이는 검은담비 거울을 깨뜨림이 아니라, 다만 붙듦이다; 저기서 기다리는 것을 깨뜨릴 힘이 내겐 없고, 감히 그러지도 않으리. 허나 한 시대를 더 붙들었다면, 붙든 것이다. 언젠가 우리보다 용맹한 무리가 마침내 저 문 안으로 들어설 때, 그들은 저편이 준비되어 있음을 보리라. 하이워치에 전하라 - 그들의 지킴이가 끝까지 밤을 지켰고, 그러고서 놓여났다고. 유리는 그대를 기억하리라. 비출 만한 무언가를 그것에 주도록 하라.',
  ...
  'entities.npcs.veilwright_ollo.greeting': '죽은 이의 외투, 병에 담긴 한숨, 정직한 값 - 장막이 내어주지. 내 좌판의 것은 모두 이제 아무것도 지니지 못한 이가 내려놓은 것. 요령은 죽은 자가 끝낸 것과 아직 움켜쥔 것을 가려내는 데 있다. 틀리면 한밤에 좌판으로 찾아오지. 슬픈 이야기가 궁금하거든 우물의 빛에 대해 파수꾼께 여쭤라. 나는 그저 외투를 팔 뿐이다.',
  ...
  'entities.npcs.mistwitch_morwen.greeting': '안개는 너희 대부분을 잠들지 못하게 하지. 나는 다른 종류의 잠을 빚어 줄 수 있어 — 대답하는 잠 말이야.',
  'entities.quests.q_deepdream_recipe.title': '깊은 잠의 조리법',
  'entities.quests.q_deepdream_recipe.text': '물약에는 세 가지 목소리가 필요하다, {playerName}. 가진 것이라고는 그것뿐인 가난의 유령에게서 흰 천 두 장, 어스름을 뜯는 영혼 유니콘의 뿔 두 개, 그리고 순환로를 지키는 수확자에게서 잘라낸 두건 두 개. 가져오면 이빨 달린 잠을 끓여 주지.',
  'entities.quests.q_deepdream_recipe.completion': '천, 뿔, 두건 — 가난한 자, 빛나는 자, 참을성 있는 자. 솥이 널 마음에 들어 하는군. 푹신한 곳에서 마시게, 방랑자여. 줄곧 짊어지고 다니던 이를 만나게 될 테니.',
  ...
  'entities.quests.q_face_your_echo.text': '물약을 마시면 꿈이 네 앞에 거울을 세울 것이다 — 너의 메아리, 네 모든 흉터와 모든 수법이 그 건너편에 있다. 네가 무엇인지 이겨 내라, {playerName}, 그리고 그때의 표정을 내게 가져오라.',
  'entities.quests.q_face_your_echo.completion': '너는 돌아왔고, 거울은 돌아오지 못했군. 그것이 네 손에 남긴 것은 네 것이다 — 꿈은 그 값을 단 한 번만 치른다.',
