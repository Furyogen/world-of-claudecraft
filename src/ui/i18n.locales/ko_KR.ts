...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.reins_pet_boulder.name': '애완 바위의 고삐',
  ...
  'hudChrome.mounts.name_pet_boulder': '애완 바위 롤로',
  ...
  'hudChrome.mounts.desc_pet_boulder':
    '자신을 계속 밀어 준 이에게 정이 든 균열 밀기 퍼즐의 바위로, 빌린 말과 똑같은 속도로 당신을 태우고 갈려 나아갑니다.',
