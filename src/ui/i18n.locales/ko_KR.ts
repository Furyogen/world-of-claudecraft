...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.weapons': '무기 컬렉션',
  'hudChrome.wocStore.empty': '현재 이용 가능한 무기 외형이 없습니다.',
  'hudChrome.wocStore.weaponCosmetic': '무기 외형',
  'hudChrome.wocStore.purchaseAria': '{item}을(를) {cost} Claudium으로 구매',
  'hudChrome.wocStore.owned': '보유 중',
  'hudChrome.wocStore.ownedAria': '{item}은(는) 이미 보유 중입니다',
  ...
  'hudChrome.wocStore.usdApprox': '약 {usd} 달러',
