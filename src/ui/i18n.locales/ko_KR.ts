...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.howto':
    '성의 시련을 돌파하라: 도리깨를 피하고, 통나무를 헤치고, 도끼 타이밍을 맞추고, 도개교를 건너고, 바위를 피하라. 결승선을 가장 먼저 통과한 자가 왕관을 차지한다. 추락해도 시간만 잃을 뿐이다.',
  ...
  'hudChrome.hc.section.flail_bridge': '도리깨 다리',
  'hudChrome.hc.section.log_court': '통나무 광장',
  'hudChrome.hc.section.axe_walk': '도끼 회랑',
  'hudChrome.hc.section.drawspan': '도개교',
  'hudChrome.hc.section.boulder_alley': '바위 골목',
  ...
  'guide.hodricsCastlePage.courseHeading': '건틀릿 코스',
  'guide.hodricsCastlePage.courseBody':
    '코스는 출발 광장에서 시작해 도리깨 다리, 통나무 광장, 도끼 회랑, 도개교, 바위 골목을 지나 붉은 경사로를 따라 결승 성채까지 이어집니다. 모든 장치는 무작위가 아니라 각자 정해진 리듬으로 흔들리고, 돌고, 구르므로 주의 깊게 보면 언제나 안전한 순간을 찾을 수 있습니다.',
  ...
  'guide.hodricsCastlePage.fallsBody':
    '장치에 맞거나 심연으로 떨어져도 마지막 체크포인트로 돌아갈 뿐입니다. 이 통로에서 죽는 사람은 없습니다: 추락의 진짜 대가는 잃어버린 몇 초를 따라잡는 시간뿐입니다.',
  'guide.hodricsCastlePage.standingsHeading': '왕관',
  'guide.hodricsCastlePage.standingsBody':
    '결승선을 가장 먼저 통과한 사람이 그 경주의 호드릭 왕관을 차지합니다. 참가 횟수, 승수, 최고 기록은 참가할 때마다 계속 쌓여갑니다.',
