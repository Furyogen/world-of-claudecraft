...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': '음소거',
  'hudChrome.playerMenu.unmute': '음소거 해제',
  ...
  'hudChrome.social.mutedSection': '음소거됨',
  'hudChrome.social.blockedSection': '차단됨',
  'hudChrome.social.stopMutingTitle': '{name} 님 음소거 해제',
