...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.skillTracker.displayAria': '{name} 추적',
  'hudChrome.skillTracker.typeSquare': '사각형',
  'hudChrome.skillTracker.typeBar': '바',
  'hudChrome.skillTracker.typeAria': '{name}의 추적 형태: {type}',
  'hudChrome.skillTracker.tooltipTarget': '대상에게 적용 중',
  'hudChrome.skillTracker.tooltipSelf': '나에게 적용 중',
  'hudChrome.skillTracker.tooltipCooldown': '재사용 대기시간',
  'hudChrome.skillTracker.dragHandle': '끌어서 추적 창 이동',
  'hudChrome.skillTracker.groupSquares': '주문 추적 아이콘',
  'hudChrome.skillTracker.groupBars': '주문 추적 바',
