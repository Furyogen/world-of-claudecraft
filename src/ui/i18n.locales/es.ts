...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[ES] Buy',
  'delveUi.shop.buyConfirmBody':
    '[ES] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[ES] Cancel',
  'delveUi.shop.buyConfirmTitle': '[ES] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[ES] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[ES] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[ES] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[ES] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[ES] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[ES] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[ES] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[ES] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[ES] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[ES] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[ES] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[ES] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[ES] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[ES] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[ES] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[ES] Frostgill Chowder',
  'entities.items.game_meat.name': '[ES] Game Meat',
  'entities.items.glass_vial.name': '[ES] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[ES] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[ES] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[ES] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[ES] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[ES] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[ES] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[ES] Homespun Cloth',
  'entities.items.homespun_hood.name': '[ES] Homespun Hood',
  'entities.items.homespun_mitts.name': '[ES] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[ES] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[ES] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[ES] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[ES] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[ES] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[ES] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[ES] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[ES] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[ES] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[ES] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[ES] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[ES] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[ES] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[ES] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[ES] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[ES] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[ES] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[ES] Prime Cut',
  'entities.items.pristine_hide.name': '[ES] Pristine Hide',
  'entities.items.pristine_silk.name': '[ES] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[ES] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[ES] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[ES] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[ES] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[ES] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[ES] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[ES] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[ES] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[ES] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[ES] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[ES] Smithing Flux',
  'entities.items.spider_silk.name': '[ES] Spider Silk',
  'entities.items.spool_of_thread.name': '[ES] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[ES] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[ES] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[ES] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[ES] Sunweave Treads',
  'entities.items.tanning_agent.name': '[ES] Tanning Agent',
  'entities.items.thorium_warblade.name': '[ES] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[ES] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[ES] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[ES] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[ES] Venom Gland',
  'entities.items.venomfire_elixir.name': '[ES] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[ES] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[ES] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[ES] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[ES] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[ES] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[ES] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[ES] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[ES] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[ES] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[ES] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[ES] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[ES] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[ES] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[ES] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[ES] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[ES] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[ES] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[ES] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[ES] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[ES] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[ES] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[ES] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[ES] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[ES] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[ES] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[ES] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[ES] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[ES] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[ES] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[ES] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[ES] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[ES] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[ES] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[ES] Buy',
  'heroicShop.buyConfirmBody':
    '[ES] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[ES] Cancel',
  'heroicShop.buyConfirmTitle': '[ES] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[ES] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[ES] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[ES] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[ES] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[ES] Enchanted',
  'hudChrome.crafting.makersMark': '[ES] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[ES] Masterwork',
  'hudChrome.crafting.masterworkToast': '[ES] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[ES] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[ES] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[ES] Station',
  'hudChrome.crafting.stationName.apothecary': '[ES] Apothecary',
  'hudChrome.crafting.stationName.forge': '[ES] Forge',
  'hudChrome.crafting.stationName.kitchens': '[ES] Kitchens',
  'hudChrome.crafting.stationName.loom': '[ES] Loom',
  'hudChrome.crafting.stationName.tannery': '[ES] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[ES] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[ES] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[ES] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[ES] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[ES] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[ES] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[ES] Cancel',
  'hudChrome.death.healerConfirmTitle': "[ES] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[ES] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[ES] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[ES] Professions',
  'hudChrome.options.showThirdActionBar': '[ES] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[ES] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[ES] Common cap',
  'hudChrome.professions.ceilingRare': '[ES] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[ES] No empowerment cap',
  'hudChrome.professions.close': '[ES] Close professions',
  'hudChrome.professions.ctaHeader': '[ES] Next step',
  'hudChrome.professions.ctaRaise':
    '[ES] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[ES] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[ES] Gathering',
  'hudChrome.professions.hobbyLabel': '[ES] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[ES] Identity',
  'hudChrome.professions.majorsLabel': '[ES] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[ES] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[ES] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[ES] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[ES] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[ES] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[ES] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[ES] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[ES] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[ES] Perks',
  'hudChrome.professions.returnsLabel': '[ES] Returns: {count}',
  'hudChrome.professions.ringAria': '[ES] Craft wheel',
  'hudChrome.professions.roleDormant': '[ES] Dormant',
  'hudChrome.professions.roleHobby': '[ES] Hobby',
  'hudChrome.professions.roleMajor': '[ES] Major',
  'hudChrome.professions.roleUnattuned': '[ES] Unattuned',
  'hudChrome.professions.skillValue': '[ES] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[ES] Craft skills',
  'hudChrome.professions.switchCost': '[ES] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[ES] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[ES] Tier {tier}',
  'hudChrome.professions.title': '[ES] Professions',
  'hudChrome.professions.tutorialLine':
    '[ES] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[ES] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[ES] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[ES] You cannot afford that training.',
  'hudChrome.training.close': '[ES] Close training',
  'hudChrome.training.dialogOption': '[ES] Training',
  'hudChrome.training.dialogOptionAria': '[ES] Browse training from {name}',
  'hudChrome.training.empty': '[ES] This master has nothing to teach.',
  'hudChrome.training.free': '[ES] Free',
  'hudChrome.training.learned': '[ES] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[ES] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[ES] You must be at the station to train.',
  'hudChrome.training.requirement': '[ES] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[ES] Known',
  'hudChrome.training.stateLocked': '[ES] Locked',
  'hudChrome.training.stateTeachable': '[ES] Available',
  'hudChrome.training.tierUnmet': '[ES] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[ES] Training: {name}',
  'hudChrome.training.trainAria': '[ES] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[ES] Legendary',
  'loading.reconnectingAttempt':
    '[ES] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[ES] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[ES] This is taking longer than usual. Check your internet connection.',
};
