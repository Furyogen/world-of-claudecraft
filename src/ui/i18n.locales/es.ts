...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'Silenciar',
  'hudChrome.playerMenu.unmute': 'Dejar de silenciar',
  ...
  'hudChrome.social.mutedSection': 'Silenciados',
  'hudChrome.social.blockedSection': 'Bloqueados',
  'hudChrome.social.stopMutingTitle': 'Dejar de silenciar a {name}',
