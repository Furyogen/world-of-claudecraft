...
export const nl_NL: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[NL] Buy',
  'delveUi.shop.buyConfirmBody':
    '[NL] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[NL] Cancel',
  'delveUi.shop.buyConfirmTitle': '[NL] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[NL] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[NL] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[NL] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[NL] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[NL] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[NL] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[NL] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[NL] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[NL] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[NL] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[NL] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[NL] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[NL] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[NL] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[NL] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[NL] Frostgill Chowder',
  'entities.items.game_meat.name': '[NL] Game Meat',
  'entities.items.glass_vial.name': '[NL] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[NL] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[NL] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[NL] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[NL] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[NL] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[NL] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[NL] Homespun Cloth',
  'entities.items.homespun_hood.name': '[NL] Homespun Hood',
  'entities.items.homespun_mitts.name': '[NL] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[NL] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[NL] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[NL] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[NL] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[NL] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[NL] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[NL] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[NL] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[NL] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[NL] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[NL] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[NL] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[NL] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[NL] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[NL] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[NL] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[NL] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[NL] Prime Cut',
  'entities.items.pristine_hide.name': '[NL] Pristine Hide',
  'entities.items.pristine_silk.name': '[NL] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[NL] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[NL] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[NL] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[NL] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[NL] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[NL] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[NL] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[NL] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[NL] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[NL] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[NL] Smithing Flux',
  'entities.items.spider_silk.name': '[NL] Spider Silk',
  'entities.items.spool_of_thread.name': '[NL] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[NL] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[NL] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[NL] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[NL] Sunweave Treads',
  'entities.items.tanning_agent.name': '[NL] Tanning Agent',
  'entities.items.thorium_warblade.name': '[NL] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[NL] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[NL] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[NL] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[NL] Venom Gland',
  'entities.items.venomfire_elixir.name': '[NL] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[NL] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[NL] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[NL] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[NL] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[NL] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[NL] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[NL] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[NL] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[NL] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[NL] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[NL] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[NL] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[NL] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[NL] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[NL] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[NL] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[NL] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[NL] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[NL] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[NL] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[NL] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[NL] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[NL] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[NL] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[NL] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[NL] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[NL] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[NL] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[NL] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[NL] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[NL] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[NL] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[NL] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[NL] Buy',
  'heroicShop.buyConfirmBody':
    '[NL] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[NL] Cancel',
  'heroicShop.buyConfirmTitle': '[NL] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[NL] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[NL] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[NL] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[NL] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[NL] Enchanted',
  'hudChrome.crafting.makersMark': '[NL] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[NL] Masterwork',
  'hudChrome.crafting.masterworkToast': '[NL] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[NL] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[NL] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[NL] Station',
  'hudChrome.crafting.stationName.apothecary': '[NL] Apothecary',
  'hudChrome.crafting.stationName.forge': '[NL] Forge',
  'hudChrome.crafting.stationName.kitchens': '[NL] Kitchens',
  'hudChrome.crafting.stationName.loom': '[NL] Loom',
  'hudChrome.crafting.stationName.tannery': '[NL] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[NL] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[NL] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[NL] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[NL] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[NL] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[NL] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[NL] Cancel',
  'hudChrome.death.healerConfirmTitle': "[NL] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[NL] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[NL] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[NL] Professions',
  'hudChrome.options.showThirdActionBar': '[NL] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[NL] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[NL] Common cap',
  'hudChrome.professions.ceilingRare': '[NL] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[NL] No empowerment cap',
  'hudChrome.professions.close': '[NL] Close professions',
  'hudChrome.professions.ctaHeader': '[NL] Next step',
  'hudChrome.professions.ctaRaise':
    '[NL] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[NL] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[NL] Gathering',
  'hudChrome.professions.hobbyLabel': '[NL] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[NL] Identity',
  'hudChrome.professions.majorsLabel': '[NL] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[NL] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[NL] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[NL] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[NL] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[NL] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[NL] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[NL] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[NL] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[NL] Perks',
  'hudChrome.professions.returnsLabel': '[NL] Returns: {count}',
  'hudChrome.professions.ringAria': '[NL] Craft wheel',
  'hudChrome.professions.roleDormant': '[NL] Dormant',
  'hudChrome.professions.roleHobby': '[NL] Hobby',
  'hudChrome.professions.roleMajor': '[NL] Major',
  'hudChrome.professions.roleUnattuned': '[NL] Unattuned',
  'hudChrome.professions.skillValue': '[NL] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[NL] Craft skills',
  'hudChrome.professions.switchCost': '[NL] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[NL] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[NL] Tier {tier}',
  'hudChrome.professions.title': '[NL] Professions',
  'hudChrome.professions.tutorialLine':
    '[NL] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[NL] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[NL] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[NL] You cannot afford that training.',
  'hudChrome.training.close': '[NL] Close training',
  'hudChrome.training.dialogOption': '[NL] Training',
  'hudChrome.training.dialogOptionAria': '[NL] Browse training from {name}',
  'hudChrome.training.empty': '[NL] This master has nothing to teach.',
  'hudChrome.training.free': '[NL] Free',
  'hudChrome.training.learned': '[NL] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[NL] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[NL] You must be at the station to train.',
  'hudChrome.training.requirement': '[NL] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[NL] Known',
  'hudChrome.training.stateLocked': '[NL] Locked',
  'hudChrome.training.stateTeachable': '[NL] Available',
  'hudChrome.training.tierUnmet': '[NL] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[NL] Training: {name}',
  'hudChrome.training.trainAria': '[NL] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[NL] Legendary',
  'loading.reconnectingAttempt':
    '[NL] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[NL] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[NL] This is taking longer than usual. Check your internet connection.',
};
