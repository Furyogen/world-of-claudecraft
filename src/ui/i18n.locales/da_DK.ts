...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.gathering': '[DA] Gathering',
  'hud.errors.tradeBound': '[DA] That item is bound and cannot be traded.',
  'hud.social.status.afk': '[DA] Away',
  'stats.charactersCreated': '[DA] Characters Created',
  'entities.items.acolyte_chain_grips.name': '[DA] Acolyte Chain Grips',
  'entities.items.briarroot_staff.name': '[DA] Briarroot Staff',
  'entities.items.cragprowl_belt.name': '[DA] Cragprowl Belt',
  'entities.items.cragthorn_greatstaff.name': '[DA] Cragthorn Greatstaff',
  'entities.items.cragward_pauldrons.name': '[DA] Cragward Pauldrons',
  'entities.items.cryptbloom_shoulderguards.name': '[DA] Cryptbloom Shoulderguards',
  'entities.items.dreamroot_boots.name': '[DA] Dreamroot Boots',
  'entities.items.duskthorn_mantle.name': '[DA] Duskthorn Mantle',
  'entities.items.fenbark_leggings.name': '[DA] Fenbark Leggings',
  'entities.items.fenshadow_maul.name': '[DA] Fenshadow Maul',
  'entities.items.fenwarden_sabatons.name': '[DA] Fenwarden Sabatons',
  'entities.items.gravewyrm_thornmaul.name': '[DA] Gravewyrm Thornmaul',
  'entities.items.grovewardens_grips.name': '[DA] Grovewarden\'s Grips',
  'entities.items.lunarward_cinch.name': '[DA] Lunarward Cinch',
  'entities.items.marshlight_hauberk.name': '[DA] Marshlight Hauberk',
  'entities.items.maul_of_the_scourged_wilds.name': '[DA] Maul of the Scourged Wilds',
  'entities.items.mirebloom_treads.name': '[DA] Mirebloom Treads',
  'entities.items.moonbark_vestments.name': '[DA] Moonbark Vestments',
  'entities.items.mosshide_vest.name': '[DA] Mosshide Vest',
  'entities.items.nightfangs_greatstaff.name': '[DA] Nightfang\'s Greatstaff',
  'entities.items.peaksong_helm.name': '[DA] Peaksong Helm',
  'entities.items.pearlward_aegis.name': '[DA] Pearlward Aegis',
  'entities.items.resonant_hide.name': '[DA] Resonant Hide',
  'entities.items.resonant_links.name': '[DA] Resonant Links',
  'entities.items.resonant_steel.name': '[DA] Resonant Steel',
  'entities.items.resonant_thread.name': '[DA] Resonant Thread',
  'entities.items.resonant_timber.name': '[DA] Resonant Timber',
  'entities.items.revenantstep_treads.name': '[DA] Revenantstep Treads',
  'entities.items.shardfang_grips.name': '[DA] Shardfang Grips',
  'entities.items.shardsong_mantle.name': '[DA] Shardsong Mantle',
  'entities.items.stormbark_mantle.name': '[DA] Stormbark Mantle',
  'entities.items.stormchant_gauntlets.name': '[DA] Stormchant Gauntlets',
  'entities.items.stormroot_cowl.name': '[DA] Stormroot Cowl',
  'entities.items.stormvotive_hauberk.name': '[DA] Stormvotive Hauberk',
  'entities.items.thornling_grips.name': '[DA] Thornling Grips',
  'entities.items.thornpeak_wildwraps.name': '[DA] Thornpeak Wildwraps',
  'entities.items.thunderward_legguards.name': '[DA] Thunderward Legguards',
  'entities.items.tidehymn_slippers.name': '[DA] Tidehymn Slippers',
  'entities.items.valefire_lantern.name': '[DA] Valefire Lantern',
  'entities.items.verdant_walkers.name': '[DA] Verdant Walkers',
  'entities.items.vestments_of_the_waking_grove.name': '[DA] Vestments of the Waking Grove',
  'entities.items.votive_chain_belt.name': '[DA] Votive Chain Belt',
  'entities.items.wildgrove_cinch.name': '[DA] Wildgrove Cinch',
  'entities.items.wildgrowth_leggings.name': '[DA] Wildgrowth Leggings',
  'entities.items.wildsoul_maul.name': '[DA] Wildsoul Maul',
  'entities.items.wyrmcult_spellgrips.name': '[DA] Wyrmcult Spellgrips',
  ...
  'entities.letters.mastery_reset_notice.sender': '[DA] The Guildhall',
  'entities.letters.mastery_reset_notice.subject': '[DA] Your craft, made honest',
  'entities.letters.prof_tier_alchemy_cooking_1.body':
    '[DA] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving.',
  'entities.letters.prof_tier_alchemy_cooking_1.sender': '[DA] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_1.subject': '[DA] A taste of things to come',
  'entities.letters.prof_tier_alchemy_cooking_2.body':
    '[DA] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long.',
  'entities.letters.prof_tier_alchemy_cooking_2.sender': '[DA] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_2.subject': '[DA] Rare work, and no burnt edges',
  'entities.letters.prof_tier_alchemy_cooking_3.body':
    '[DA] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting.',
  'entities.letters.prof_tier_alchemy_cooking_3.sender': '[DA] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_3.subject': '[DA] Now you are cooking',
  'entities.letters.prof_tier_alchemy_cooking_4.body':
    '[DA] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle.',
  'entities.letters.prof_tier_alchemy_cooking_4.sender': '[DA] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_4.subject': '[DA] One course from the feast',
  'entities.letters.prof_tier_alchemy_cooking_5.body':
    '[DA] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table.',
  'entities.letters.prof_tier_alchemy_cooking_5.sender': '[DA] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_5.subject': '[DA] Mastery, served hot',
  'entities.letters.prof_tier_engineering_alchemy_1.body':
    '[DA] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go.',
  'entities.letters.prof_tier_engineering_alchemy_1.sender': '[DA] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_1.subject': '[DA] FIRST spark, ha',
  'entities.letters.prof_tier_engineering_alchemy_2.body':
    '[DA] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA.',
  'entities.letters.prof_tier_engineering_alchemy_2.sender': '[DA] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_2.subject': '[DA] Rare, oh, RARE',
  'entities.letters.prof_tier_engineering_alchemy_3.body':
    '[DA] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses.',
  'entities.letters.prof_tier_engineering_alchemy_3.sender': '[DA] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_3.subject': '[DA] Now it gets loud',
  'entities.letters.prof_tier_engineering_alchemy_4.body':
    '[DA] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink.',
  'entities.letters.prof_tier_engineering_alchemy_4.sender': '[DA] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_4.subject': '[DA] One rung, ONE, from the top',
  'entities.letters.prof_tier_engineering_alchemy_5.body':
    '[DA] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous.',
  'entities.letters.prof_tier_engineering_alchemy_5.sender': '[DA] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_5.subject': '[DA] MASTERY, kaboom',
  'entities.letters.prof_tier_leatherworking_tailoring_1.body':
    '[DA] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully.',
  'entities.letters.prof_tier_leatherworking_tailoring_1.sender': '[DA] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_1.subject': '[DA] An even first row',
  'entities.letters.prof_tier_leatherworking_tailoring_2.body':
    '[DA] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased.',
  'entities.letters.prof_tier_leatherworking_tailoring_2.sender': '[DA] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_2.subject': '[DA] Rare work, well measured',
  'entities.letters.prof_tier_leatherworking_tailoring_3.body':
    '[DA] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice.',
  'entities.letters.prof_tier_leatherworking_tailoring_3.sender': '[DA] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_3.subject': '[DA] The pattern comes clear',
  'entities.letters.prof_tier_leatherworking_tailoring_4.body':
    '[DA] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now.',
  'entities.letters.prof_tier_leatherworking_tailoring_4.sender': '[DA] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_4.subject': '[DA] One row from the top',
  'entities.letters.prof_tier_leatherworking_tailoring_5.body':
    '[DA] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly.',
  'entities.letters.prof_tier_leatherworking_tailoring_5.sender': '[DA] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_5.subject': '[DA] The last stitch',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.body':
    '[DA] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.sender': '[DA] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.subject': '[DA] A spark worth noting',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.body':
    '[DA] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.sender': '[DA] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.subject': '[DA] Rare work, and earned',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_3.body':
    '[DA] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_3.sender': '[DA] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_3.subject': '[DA] The metal answers you now',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_4.body':
    '[DA] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_4.sender': '[DA] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_4.subject': '[DA] Near the top of the ladder',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.body':
    '[DA] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.sender': '[DA] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.subject': '[DA] Mastery, at last',
  'entities.quests.q_prof_amends_apothecary.completion':
    '[DA] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.',
  'entities.quests.q_prof_amends_apothecary.objectives.0.label': '[DA] Wild Boar hunted',
  'entities.quests.q_prof_amends_apothecary.text':
    '[DA] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.',
  'entities.quests.q_prof_amends_apothecary.title': '[DA] Back on the Stove',
  'entities.quests.q_prof_amends_bombardier.completion':
    '[DA] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?',
  'entities.quests.q_prof_amends_bombardier.objectives.0.label': '[DA] Tunnel Rat exterminated',
  'entities.quests.q_prof_amends_bombardier.text':
    '[DA] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.',
  'entities.quests.q_prof_amends_bombardier.title': '[DA] The Ledger Grows',
  'entities.quests.q_prof_amends_outfitter.completion':
    '[DA] Steady again. Leatherworking and Tailoring return to your hands as majors. Measure twice this time before you wander.',
  'entities.quests.q_prof_amends_outfitter.objectives.0.label': '[DA] Webwood Spider culled',
  'entities.quests.q_prof_amends_outfitter.text':
    '[DA] Back at my loom after all. I hold no grudge, {playerName}, but the thread remembers a hand that let it go, and the cost of taking it up again is measured out longer each time. Cull the webwood spiders crowding the western woods, and the labor will settle your hands before they touch good silk again.',
  'entities.quests.q_prof_amends_outfitter.title': '[DA] Threads Rejoined',
  'entities.quests.q_prof_amends_smith.completion':
    '[DA] The rhythm is back in your hands. Weaponcrafting and Armorcrafting are your majors once more. Do not make a habit of leaving.',
  'entities.quests.q_prof_amends_smith.objectives.0.label': '[DA] Forest Wolf slain',
  ...
  'entities.quests.q_prof_amends_smith.title': '[DA] Back to the Forge',
  'entities.quests.q_prof_attune_apothecary.completion':
    '[DA] Now that is a start with some meat on it. Alchemy and Cooking are yours to cook as high as you like. Come back hungry.',
  'entities.quests.q_prof_attune_apothecary.objectives.0.label': '[DA] Wild Boar hunted',
  'entities.quests.q_prof_attune_apothecary.text':
    '[DA] Every good dish is two flavors that belong together, and so is a good craft, {playerName}. Sit with me and Alchemy and Cooking become your two majors, the two you may simmer past rare work; the craft on the far side of the wheel is your hobby, seasoned up to rare and no hotter. The rest of your trades keep in the pantry, dormant, not spoiled, ready whenever you fetch them back. Fair warning while the pot is still cold: wander off to another pair and coming home is a chore that grows, five beasts seen to the first time, eight the next, eleven the time after, heavier with every helping. Still hungry for it? Then hunt me four wild boars, because a kitchen worth its salt starts with good meat.',
  'entities.quests.q_prof_attune_apothecary.title': '[DA] A Recipe Worth Keeping',
  'entities.quests.q_prof_attune_bombardier.completion':
    '[DA] HA. Reagents, real ones, and all your fingers still attached, good, good. Engineering and Alchemy, yours, go make something that regrets it. Off you go.',
  'entities.quests.q_prof_attune_bombardier.objectives.0.label': '[DA] Herb patch harvested',
  'entities.quests.q_prof_attune_bombardier.text':
    '[DA] Oh, oh, you want the good stuff, the loud stuff, yes? Listen, listen, before you touch anything that ticks: say the word and Engineering and Alchemy become your two majors, the only two you get to push past rare work (that is where it gets FUN, trust me). The craft opposite goes in your pocket as a hobby, rare and no further, do not pout. Your other trades? Not gone, {playerName}, just napping, dormant, wake them whenever you like. But (there is always a but, hold the fuse) ditch this pair and waddle back later and it costs you sweat that piles up, five things put down the first time, eight the next, eleven after, more, more, every single time you get cold feet. Yes? YES? Then go pick me three patches of herbs, the volatile ones, do not ask which, they are all a little volatile if you believe hard enough.',
  'entities.quests.q_prof_attune_bombardier.title': '[DA] A Volatile Arrangement',
  'entities.quests.q_prof_attune_outfitter.completion':
    '[DA] Even thread, even hand. Leatherworking and Tailoring are yours to carry as far as your skill will reach. Measure twice, and they will not fail you.',
  'entities.quests.q_prof_attune_outfitter.objectives.0.label': '[DA] Webwood Spider culled',
  'entities.quests.q_prof_attune_outfitter.text':
    '[DA] Measure the cost before you cut, that is the first rule at my loom. Choose me and Leatherworking and Tailoring become your two majors, the pair you may carry beyond rare work; the craft opposite them settles in as your hobby, taken to rare and left there. The trades you set aside are not unravelled, {playerName}, only folded away, dormant until you take them up again. Be certain, though: should you leave this pair and later want it back, the way home is paid in labor that lengthens each time, five culled at first, then eight, then eleven, always a little more. If your mind is made, cull four webwood spiders and bring their silk to the loom, for good thread starts every good garment.',
  'entities.quests.q_prof_attune_outfitter.title': '[DA] The Outfitter\'s Measure',
  'entities.quests.q_prof_attune_smith.completion':
    '[DA] Good ore, and good hands to work it. Weaponcrafting and Armorcrafting are yours to master now. Earn the rest.',
  'entities.quests.q_prof_attune_smith.objectives.0.label': '[DA] Ore vein harvested',
  'entities.quests.q_prof_attune_smith.text':
    '[DA] Steel does not forgive a wandering hand, so I will tell you plain before you swear anything. Bind yourself to my forge and Weaponcrafting and Armorcrafting become your two majors, the only crafts you may carry past rare work. The craft across the wheel from them settles in as your hobby, worked to rare and no further. Your other trades do not burn away, {playerName}: they simply go quiet, dormant until you call them back. And know this before the hammer falls: leave this pair for another and you will crawl back through honest labor to return to it, five foes put down the first time you come home, eight the next, eleven after that, more each time you stray. Still standing here? Then bring me three veins of ore worked from the Vale with your own hands, and we will call the promise struck.',
  'entities.quests.q_prof_attune_smith.title': '[DA] The Smith\'s Promise',
  'entities.quests.q_prof_workorder_apothecary.completion':
    '[DA] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.',
  'entities.quests.q_prof_workorder_apothecary.objectives.0.label': '[DA] Goldleaf Herb delivered',
  'entities.quests.q_prof_workorder_apothecary.text':
    '[DA] My shelves require goldleaf, and the market\'s stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.',
  'entities.quests.q_prof_workorder_apothecary.title': '[DA] Apothecary Work Order',
  'entities.quests.q_prof_workorder_forge.completion': '[DA] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.',
  'entities.quests.q_prof_workorder_forge.objectives.0.label': '[DA] Copper Ore delivered',
  'entities.quests.q_prof_workorder_forge.text':
    '[DA] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.',
  'entities.quests.q_prof_workorder_forge.title': '[DA] Forge Work Order',
  'entities.quests.q_prof_workorder_kitchens.completion': '[DA] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.',
  'entities.quests.q_prof_workorder_kitchens.objectives.0.label': '[DA] Game Meat delivered',
  'entities.quests.q_prof_workorder_kitchens.text':
    '[DA] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.',
  'entities.quests.q_prof_workorder_kitchens.title': '[DA] Kitchens Work Order',
  'entities.quests.q_prof_workorder_loom.completion': '[DA] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.',
  'entities.quests.q_prof_workorder_loom.objectives.0.label': '[DA] Spider Silk delivered',
  'entities.quests.q_prof_workorder_loom.text':
    '[DA] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.',
  'entities.quests.q_prof_workorder_loom.title': '[DA] Loom Work Order',
  'entities.quests.q_prof_workorder_tannery.completion': '[DA] Good hides. Fair pay. Again when you have more.',
  'entities.quests.q_prof_workorder_tannery.objectives.0.label': '[DA] Rough Hide delivered',
  'entities.quests.q_prof_workorder_tannery.text': '[DA] Vats are empty. Bring eight rough hides. Coin when you do.',
  'entities.quests.q_prof_workorder_tannery.title': '[DA] Tannery Work Order',
  'entities.quests.q_prof_workorder_toolworks.completion':
    '[DA] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.',
  'entities.quests.q_prof_workorder_toolworks.objectives.0.label': '[DA] Ironbark Log delivered',
  'entities.quests.q_prof_workorder_toolworks.text':
    '[DA] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.',
  'entities.quests.q_prof_workorder_toolworks.title': '[DA] Toolworks Work Order',
  'hudChrome.bags.itemAriaInstanced': '[DA] {item}, quantity {count}, maker-marked copy',
  'hudChrome.charSheet.defense': '[DA] Defense',
  'hudChrome.charSheet.offense': '[DA] Offense',
  'hudChrome.corpseHarvest.harvestTooltip':
    '[DA] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.',
  'hudChrome.crafting.attunedBanner': '[DA] Attuned: {title}',
  'hudChrome.crafting.attunedZoneLine': '[DA] {name} has attuned as {archetype}!',
  'hudChrome.crafting.attunementReturnCost': '[DA] If you leave this pair, returning to it later costs {cost} make-amends tasks.',
  'hudChrome.crafting.difficultyMinimal': '[DA] Minimal skill gain',
  'hudChrome.crafting.gatheredBy': '[DA] Gathered by {name}',
  'hudChrome.crafting.learnMoreAtStation': '[DA] {master} at the {station} can teach you more {craft} recipes.',
  'hudChrome.crafting.tierTutorial.dismiss': '[DA] Got it',
  'hudChrome.crafting.tierTutorial.masters':
    '[DA] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.',
  'hudChrome.crafting.tierTutorial.radar':
    '[DA] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.',
  'hudChrome.crafting.tierTutorial.tierCap':
    '[DA] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.',
  'hudChrome.crafting.tierTutorial.title': '[DA] Your First Tier',
  'hudChrome.crafting.trendNudge': '[DA] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.',
  'hudChrome.crafting.trendNudgeNoMaster': '[DA] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.',
  'hudChrome.enchantName.enchant_chest_armor': '[DA] Enchant Chest - Reinforcement',
  'hudChrome.enchantName.enchant_chest_greater_stamina': '[DA] Enchant Chest - Greater Stamina',
  'hudChrome.enchantName.enchant_chest_runeweave': '[DA] Enchant Chest - Runeweave',
  'hudChrome.enchantName.enchant_chest_spirit': '[DA] Enchant Chest - Spirit',
  'hudChrome.enchantName.enchant_chest_stamina': '[DA] Enchant Chest - Stamina',
  'hudChrome.enchantName.enchant_feet_agility': '[DA] Enchant Boots - Agility',
  'hudChrome.enchantName.enchant_feet_stamina': '[DA] Enchant Boots - Stamina',
  'hudChrome.enchantName.enchant_feet_strength': '[DA] Enchant Boots - Strength',
  'hudChrome.enchantName.enchant_gloves_agility': '[DA] Enchant Gloves - Agility',
  'hudChrome.enchantName.enchant_gloves_greater_agility': '[DA] Enchant Gloves - Greater Agility',
  'hudChrome.enchantName.enchant_gloves_intellect': '[DA] Enchant Gloves - Spellpower',
  'hudChrome.enchantName.enchant_gloves_strength': '[DA] Enchant Gloves - Strength',
  'hudChrome.enchantName.enchant_helmet_armor': '[DA] Enchant Helmet - Reinforcement',
  'hudChrome.enchantName.enchant_helmet_fortitude': '[DA] Enchant Helmet - Fortitude',
  'hudChrome.enchantName.enchant_helmet_greater_fortitude': '[DA] Enchant Helmet - Greater Fortitude',
  'hudChrome.enchantName.enchant_helmet_intellect': '[DA] Enchant Helmet - Intellect',
  'hudChrome.enchantName.enchant_helmet_runed_links': '[DA] Enchant Helmet - Runed Links',
  'hudChrome.enchantName.enchant_legs_greater_stamina': '[DA] Enchant Legs - Greater Stamina',
  'hudChrome.enchantName.enchant_legs_intellect': '[DA] Enchant Legs - Intellect',
  'hudChrome.enchantName.enchant_legs_runed_hide': '[DA] Enchant Legs - Runed Hide',
  'hudChrome.enchantName.enchant_legs_stamina': '[DA] Enchant Legs - Stamina',
  'hudChrome.enchantName.enchant_neck_agility': '[DA] Enchant Necklace - Agility',
  'hudChrome.enchantName.enchant_neck_intellect': '[DA] Enchant Necklace - Intellect',
  'hudChrome.enchantName.enchant_neck_spirit': '[DA] Enchant Necklace - Spirit',
  'hudChrome.enchantName.enchant_ring_agility': '[DA] Enchant Ring - Agility',
  'hudChrome.enchantName.enchant_ring_intellect': '[DA] Enchant Ring - Intellect',
  'hudChrome.enchantName.enchant_ring_spirit': '[DA] Enchant Ring - Spirit',
  'hudChrome.enchantName.enchant_ring_strength': '[DA] Enchant Ring - Strength',
  'hudChrome.enchantName.enchant_shoulder_agility': '[DA] Enchant Shoulders - Agility',
  'hudChrome.enchantName.enchant_shoulder_intellect': '[DA] Enchant Shoulders - Intellect',
  'hudChrome.enchantName.enchant_shoulder_strength': '[DA] Enchant Shoulders - Strength',
  'hudChrome.enchantName.enchant_waist_agility': '[DA] Enchant Belt - Agility',
  'hudChrome.enchantName.enchant_waist_stamina': '[DA] Enchant Belt - Stamina',
  'hudChrome.enchantName.enchant_waist_strength': '[DA] Enchant Belt - Strength',
  'hudChrome.enchantName.enchant_weapon_agility': '[DA] Enchant Weapon - Agility',
  'hudChrome.enchantName.enchant_weapon_greater_might': '[DA] Enchant Weapon - Greater Might',
  'hudChrome.enchantName.enchant_weapon_greater_spellpower': '[DA] Enchant Weapon - Greater Spellpower',
  'hudChrome.enchantName.enchant_weapon_intellect': '[DA] Enchant Weapon - Spellpower',
  'hudChrome.enchantName.enchant_weapon_might': '[DA] Enchant Weapon - Might',
  'hudChrome.enchantName.enchant_weapon_runed_edge': '[DA] Enchant Weapon - Runed Edge',
  'hudChrome.enchantName.enchant_weapon_runed_focus': '[DA] Enchant Weapon - Runed Focus',
  'hudChrome.enchanting.disenchantConfirmBody': '[DA] This destroys {item} and yields arcane materials. This cannot be undone.',
  'hudChrome.enchanting.disenchantConfirmBodySpecial':
    '[DA] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.',
  'hudChrome.enchanting.disenchantConfirmTitle': '[DA] Disenchant {item}?',
  'hudChrome.enchanting.disenchantThrottled': '[DA] You are disenchanting too quickly. Wait a moment and try again.',
  'hudChrome.enchanting.disenchantedLine': '[DA] You disenchant {item}.',
  'hudChrome.enchanting.enchantAppliedLine': '[DA] You enchant {item} with {enchant}.',
  'hudChrome.enchanting.enchantInsufficient': '[DA] You do not have the materials for that enchant.',
  'hudChrome.enchanting.enchantThrottled': '[DA] You are enchanting too quickly. Wait a moment and try again.',
  'hudChrome.enchanting.enchantUnknown': '[DA] That enchant does not exist.',
  'hudChrome.enchanting.enchantWrongSlot': '[DA] That enchant cannot be applied to that item.',
  'hudChrome.enchanting.noEnchants': '[DA] No enchant uses this reagent.',
  'hudChrome.enchanting.noTargets': '[DA] No eligible item to enchant.',
  'hudChrome.enchanting.notDisenchantable': '[DA] You cannot disenchant that.',
  'hudChrome.enchanting.notHeld': '[DA] You do not have that item.',
  'hudChrome.enchanting.notSalvageable': '[DA] You cannot salvage that.',
  'hudChrome.enchanting.pickerTitle': '[DA] Apply Enchant',
  'hudChrome.enchanting.salvageConfirmBody': '[DA] This destroys {item} and yields crafting materials. This cannot be undone.',
  'hudChrome.enchanting.salvageConfirmBodySpecial':
    '[DA] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.',
  'hudChrome.enchanting.salvageConfirmTitle': '[DA] Salvage {item}?',
  'hudChrome.enchanting.salvageThrottled': '[DA] You are salvaging too quickly. Wait a moment and try again.',
  'hudChrome.enchanting.salvagedLine': '[DA] You salvage {item}.',
  'hudChrome.enchanting.targetTitle': '[DA] Choose an item to enchant',
  'hudChrome.gathering.biteLine': '[DA] Something takes the bait!',
  'hudChrome.gathering.catchLine': '[DA] You reel in: {name}',
  'hudChrome.gathering.downgradeFind': '[DA] Bags full: a pristine find slipped away.',
  'hudChrome.gathering.downgradeMark': '[DA] Bags full: the find was stored without its gatherer\'s mark.',
  'hudChrome.gathering.fishing': '[DA] Fishing',
  'hudChrome.gathering.gotAwayLine': '[DA] It got away.',
  'hudChrome.gathering.nodeName.herb': '[DA] Herb Patch',
  'hudChrome.gathering.nodeName.ore': '[DA] Ore Vein',
  'hudChrome.gathering.nodeName.wood': '[DA] Timber Stand',
  'hudChrome.gathering.stateCooldown': '[DA] Respawning',
  'hudChrome.gathering.stateReady': '[DA] Ready',
  'hudChrome.gathering.tierRequired.herbalism': '[DA] Requires a tier {tier} herbalism sickle',
  'hudChrome.gathering.tierRequired.logging': '[DA] Requires a tier {tier} logging axe',
  'hudChrome.gathering.tierRequired.mining': '[DA] Requires a tier {tier} mining pick',
  'hudChrome.gathering.toolTierUnmet.herbalism': '[DA] You need a tier {tier} herbalism sickle to gather this patch.',
  'hudChrome.gathering.toolTierUnmet.logging': '[DA] You need a tier {tier} logging axe to fell this stand.',
  'hudChrome.gathering.toolTierUnmet.mining': '[DA] You need a tier {tier} mining pick to harvest this vein.',
  'hudChrome.gathering.toolTierUnmetCorpse': '[DA] You need a tier {tier} gathering tool to recover the finest materials.',
  'hudChrome.interfaceTabs.chat': '[DA] Chat',
  'hudChrome.interfaceTabs.combat': '[DA] Combat',
  'hudChrome.interfaceTabs.frames': '[DA] Frames',
  'hudChrome.interfaceTabs.general': '[DA] General',
  'hudChrome.itemMenu.applyEnchant': '[DA] Apply Enchant',
  'hudChrome.itemMenu.disenchant': '[DA] Disenchant',
  'hudChrome.itemMenu.equip': '[DA] Equip',
  'hudChrome.itemMenu.salvage': '[DA] Salvage',
  'hudChrome.itemMenu.use': '[DA] Use',
  'hudChrome.loot.takeLootButton': '[DA] Take Loot',
  'hudChrome.loot.takeLootTooltip': '[DA] Takes the coins and dropped items. Does not use up the harvest.',
  'hudChrome.loot.unifiedPressHint': '[DA] The interact key loots and harvests in one press, using your town focus.',
  'hudChrome.nameplate.afkTag': '[DA] AFK',
  'hudChrome.professions.nextUnlockMastered': '[DA] Mastered, for now',
  'hudChrome.social.hideOffline': '[DA] Hide offline',
  'hudChrome.social.hideOfflineTitle': '[DA] Hide offline guild members',
  'hudChrome.social.offlineHeader': '[DA] Offline ({n})',
  'hudChrome.social.onlineHeader': '[DA] Online ({n})',
  'hudChrome.townFocus.tierHint':
    '[DA] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.',
  'hudChrome.townFocus.townOnlyHint': '[DA] Focus can only be changed while you are in town.',
};
