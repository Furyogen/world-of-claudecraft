...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.emailPlaceholder': "dig@example.com",
  'auth.recovery.body': "Angiv en e-mailadresse, så du kan gendanne din konto. Vi bruger den kun til at bekræfte, at kontoen er din, hvis du får brug for at nulstille adgangskoden.",
  ...
  'entities.quests.q_old_cragmaw.completion': "Endelig nede. Bjergfolket svor, at katten ville overleve selve muren. Stalkerne holder sig til deres høje sne nu, {playerName}, og mine patruljer kan gå vejen uden at bløde for det. Hele ryggen er mere stille efter dit arbejde.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Gamle Cragmaw dræbt",
  'entities.quests.q_old_cragmaw.text': "Bjergfolket satte navn på de spor, min spejder fandt: Gamle Cragmaw, en arret katte-tyran, der har overlevet tre generationer af sin egen flok. Den er grunden til, at stalkerne oversvømmer min vej, {playerName}. Dens hule ligger på den vestlige kam over vejen mod syd. Tag en ven med, og fæld den gamle djævel.",
  'entities.quests.q_old_cragmaw.title': "Gamle Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Ti gode pelse, tykke som nogen jeg har... nej, se på dem, {playerName}. Revne, halvdelen af dem, og ikke af klinge eller spyd. Klomærker brede som min hånd, lige gennem vinterpelsen. Noget på den ryg flår sine egne.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Rygstalker-pels",
  'entities.quests.q_stalker_cloaks.text': "Otte pelse forede officerernes kapper, og nu vil hver soldat på muren have det samme, {playerName}. De har ret: vinteren tager fingre først, og undskyldninger varmer ikke. Ti pelse mere fra ryggene syd for porten, så sover hele vagten varmt.",
  'entities.quests.q_stalker_cloaks.title': "Kapper til vagten",
  'entities.quests.q_stalkers_return.completion': "Fjorten mere, og mine patruljer tæller stadig friske spor om morgenen. Min spejder kom tilbage fra den høje ryg hvid som snelinjen: aftryk på størrelse med et skjold, siger hun, og gamle drab ingen stalker ville efterlade. Hvad end der går deroppe, er det ingen almindelig kat.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Rygstalker dræbt",
  'entities.quests.q_stalkers_return.text': "Tolv døde, og ryggen kravler tættere end den dag, du begyndte, {playerName}. Dyr kaster sig ikke mod en mur af sult. Noget oppe på den høje ryg presser dem ned, og indtil jeg ved hvad, stopper nedskæringen ikke. Fjorten mere.",
  'entities.quests.q_stalkers_return.title': "Stalkerne vender tilbage",
  'hudChrome.dailyRewards.pointsGained': "{points} daglige belønningspoint opnået.",
  ...
  'hudChrome.discord.roleTag.admin': "Administrator",
  ...
  'hudChrome.options.showOwnNameplate': "Vis min navneplade",
  'hudChrome.options.walkByAutoloot': "Automatisk plyndring ved passage",
  'hudChrome.targetFrame.lock': "Lås målramme",
  'hudChrome.targetFrame.unlock': "Flyt målramme",
  'hudChrome.worldBoss.spawn': "{name} rejser sig over Thornpeak Heights!",
  'wallet.extensionHelp': "For at se en wallet her skal du holde en browser-walletudvidelse som Solflare Wallet aktiv.",
};
