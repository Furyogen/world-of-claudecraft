...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Tidevandsporten',
  'entities.zones.atlantis.name': 'Atlantis',
  'entities.zones.atlantis.welcome': 'Kuplen synger stadig, og Atlantis består under Undertiden.',
  'entities.zones.atlantis.pois.0.label': 'Atlantis',
  'entities.zones.atlantis.pois.1.label': 'Tidevandsportens Plads',
  'entities.zones.atlantis.pois.2.label': 'Lumenkronen',
  'entities.zones.atlantis.pois.3.label': 'Perlemarkedet',
  'entities.zones.atlantis.pois.4.label': 'Det Druknede Arkiv',
  'entities.zones.atlantis.pois.5.label': 'Tangvogternes Anneks',
  'entities.mobs.glimmerfin_eel.name': 'Glimmerfinne-ål',
  'entities.mobs.pearlshell_skitterer.name': 'Perleskals-kravler',
  'entities.mobs.kelpshade_lurker.name': 'Tangskygge-lurer',
  'entities.mobs.undertow_maw.name': 'Understrømmens Gab',
  'entities.npcs.keeper_nerissa.name': 'Vogter Nerissa',
  'entities.npcs.keeper_nerissa.title': 'Lumenkronens Vogter',
  'entities.npcs.keeper_nerissa.greeting': 'Pas på glasset, overflademenneske. Det har holdt i en evighed — hjælp os med at holde det sådan.',
  'entities.npcs.tidewright_ollo.name': 'Tidesmed Ollo',
  'entities.npcs.tidewright_ollo.title': 'Perlemarkedets Tidesmed',
  'entities.npcs.tidewright_ollo.greeting': 'Friskt fra de sidste tørre destillerier i dybet. Mønter først, historier bagefter.',
