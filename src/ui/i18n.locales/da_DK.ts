...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[DA] Buy',
  'delveUi.shop.buyConfirmBody':
    '[DA] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[DA] Cancel',
  'delveUi.shop.buyConfirmTitle': '[DA] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[DA] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[DA] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[DA] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[DA] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[DA] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[DA] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[DA] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[DA] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[DA] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[DA] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[DA] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[DA] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[DA] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[DA] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[DA] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[DA] Frostgill Chowder',
  'entities.items.game_meat.name': '[DA] Game Meat',
  'entities.items.glass_vial.name': '[DA] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[DA] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[DA] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[DA] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[DA] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[DA] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[DA] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[DA] Homespun Cloth',
  'entities.items.homespun_hood.name': '[DA] Homespun Hood',
  'entities.items.homespun_mitts.name': '[DA] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[DA] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[DA] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[DA] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[DA] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[DA] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[DA] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[DA] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[DA] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[DA] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[DA] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[DA] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[DA] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[DA] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[DA] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[DA] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[DA] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[DA] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[DA] Prime Cut',
  'entities.items.pristine_hide.name': '[DA] Pristine Hide',
  'entities.items.pristine_silk.name': '[DA] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[DA] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[DA] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[DA] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[DA] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[DA] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[DA] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[DA] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[DA] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[DA] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[DA] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[DA] Smithing Flux',
  'entities.items.spider_silk.name': '[DA] Spider Silk',
  'entities.items.spool_of_thread.name': '[DA] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[DA] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[DA] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[DA] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[DA] Sunweave Treads',
  'entities.items.tanning_agent.name': '[DA] Tanning Agent',
  'entities.items.thorium_warblade.name': '[DA] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[DA] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[DA] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[DA] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[DA] Venom Gland',
  'entities.items.venomfire_elixir.name': '[DA] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[DA] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[DA] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[DA] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[DA] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[DA] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[DA] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[DA] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[DA] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[DA] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[DA] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[DA] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[DA] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[DA] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[DA] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[DA] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[DA] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[DA] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[DA] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[DA] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[DA] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[DA] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[DA] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[DA] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[DA] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[DA] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[DA] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[DA] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[DA] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[DA] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[DA] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[DA] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[DA] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[DA] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[DA] Buy',
  'heroicShop.buyConfirmBody':
    '[DA] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[DA] Cancel',
  'heroicShop.buyConfirmTitle': '[DA] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[DA] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[DA] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[DA] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[DA] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[DA] Enchanted',
  'hudChrome.crafting.makersMark': '[DA] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[DA] Masterwork',
  'hudChrome.crafting.masterworkToast': '[DA] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[DA] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[DA] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[DA] Station',
  'hudChrome.crafting.stationName.apothecary': '[DA] Apothecary',
  'hudChrome.crafting.stationName.forge': '[DA] Forge',
  'hudChrome.crafting.stationName.kitchens': '[DA] Kitchens',
  'hudChrome.crafting.stationName.loom': '[DA] Loom',
  'hudChrome.crafting.stationName.tannery': '[DA] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[DA] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[DA] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[DA] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[DA] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[DA] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[DA] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[DA] Cancel',
  'hudChrome.death.healerConfirmTitle': "[DA] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[DA] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[DA] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[DA] Professions',
  'hudChrome.options.showThirdActionBar': '[DA] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[DA] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[DA] Common cap',
  'hudChrome.professions.ceilingRare': '[DA] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[DA] No empowerment cap',
  'hudChrome.professions.close': '[DA] Close professions',
  'hudChrome.professions.ctaHeader': '[DA] Next step',
  'hudChrome.professions.ctaRaise':
    '[DA] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[DA] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[DA] Gathering',
  'hudChrome.professions.hobbyLabel': '[DA] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[DA] Identity',
  'hudChrome.professions.majorsLabel': '[DA] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[DA] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[DA] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[DA] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[DA] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[DA] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[DA] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[DA] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[DA] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[DA] Perks',
  'hudChrome.professions.returnsLabel': '[DA] Returns: {count}',
  'hudChrome.professions.ringAria': '[DA] Craft wheel',
  'hudChrome.professions.roleDormant': '[DA] Dormant',
  'hudChrome.professions.roleHobby': '[DA] Hobby',
  'hudChrome.professions.roleMajor': '[DA] Major',
  'hudChrome.professions.roleUnattuned': '[DA] Unattuned',
  'hudChrome.professions.skillValue': '[DA] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[DA] Craft skills',
  'hudChrome.professions.switchCost': '[DA] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[DA] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[DA] Tier {tier}',
  'hudChrome.professions.title': '[DA] Professions',
  'hudChrome.professions.tutorialLine':
    '[DA] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[DA] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[DA] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[DA] You cannot afford that training.',
  'hudChrome.training.close': '[DA] Close training',
  'hudChrome.training.dialogOption': '[DA] Training',
  'hudChrome.training.dialogOptionAria': '[DA] Browse training from {name}',
  'hudChrome.training.empty': '[DA] This master has nothing to teach.',
  'hudChrome.training.free': '[DA] Free',
  'hudChrome.training.learned': '[DA] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[DA] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[DA] You must be at the station to train.',
  'hudChrome.training.requirement': '[DA] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[DA] Known',
  'hudChrome.training.stateLocked': '[DA] Locked',
  'hudChrome.training.stateTeachable': '[DA] Available',
  'hudChrome.training.tierUnmet': '[DA] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[DA] Training: {name}',
  'hudChrome.training.trainAria': '[DA] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[DA] Legendary',
  'loading.reconnectingAttempt':
    '[DA] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[DA] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[DA] This is taking longer than usual. Check your internet connection.',
};
