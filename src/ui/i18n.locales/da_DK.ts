...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'Slå fra',
  'hudChrome.playerMenu.unmute': 'Slå til',
  ...
  'hudChrome.social.mutedSection': 'Slået fra',
  'hudChrome.social.blockedSection': 'Blokerede',
  'hudChrome.social.stopMutingTitle': 'Slå {name} til igen',
