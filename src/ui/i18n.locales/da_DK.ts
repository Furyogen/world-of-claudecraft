...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Spejlporten',
  'entities.zones.mirror_world.name': 'Spejlverdenen',
  'entities.zones.mirror_world.welcome': 'Glasset husker dig. Pas på, hvilken side af det du går på.',
  'entities.zones.mirror_world.pois.0.label': 'Spejlverdenen',
  'entities.zones.mirror_world.pois.1.label': 'Spejlportens Plads',
  'entities.zones.mirror_world.pois.2.label': 'Lumenkronen',
  'entities.zones.mirror_world.pois.3.label': 'Det Tilslørede Marked',
  'entities.zones.mirror_world.pois.4.label': 'Det Tavse Arkiv',
  'entities.zones.mirror_world.pois.5.label': 'Spejlsøen',
  'entities.zones.mirror_world.pois.6.label': 'Tågekæret',
  'entities.zones.mirror_world.pois.7.label': 'Heksens Lavning',
  'entities.zones.mirror_world.pois.8.label': 'Eastbrooks Spejl',
  'entities.zones.mirror_world.pois.9.label': 'Fenbridges Spejl',
  'entities.mobs.poverty_ghost.name': 'Fattigdomsspøgelse',
  'entities.mobs.spirit_unicorn.name': 'Åndeenhjørning',
  'entities.mobs.hooded_reaper.name': 'Høstmand',
  'entities.mobs.gloomhulk.name': 'Dysterkolos',
  'entities.mobs.mirrorbound_sentry.name': 'Spejlbunden Vagt',
  'entities.mobs.voidfang_stalker.name': 'Blegtand-Stalker',
  'entities.npcs.dread_sentinel_a.name': 'Rædselsvagt',
  'entities.npcs.dread_sentinel_a.title': 'Vogter af Skyggespejlet',
  'entities.npcs.dread_sentinel_a.greeting': 'Din død venter dig.',
  'entities.npcs.dread_sentinel_b.name': 'Rædselsvagt',
  'entities.npcs.dread_sentinel_b.title': 'Vogter af Skyggespejlet',
  'entities.npcs.dread_sentinel_b.greeting': 'I livet holdt vi dæmningsvejen. Vi holder den endnu.',
  'entities.npcs.dread_sentinel_c.name': 'Rædselsvagt',
  'entities.npcs.dread_sentinel_c.title': 'Vogter af Skyggespejlet',
  'entities.npcs.dread_sentinel_c.greeting': 'Vend om. Det sorte glas er ikke for de levende - og var det aldrig for os.',
  'entities.quests.q_gargoyle_south.title': 'Vogterens Told',
  'entities.quests.q_gargoyle_south.text': 'Skæret bliver til ord bag dine øjne: høstmændene trænges om mit glas, {playerName}. Tynd dem ud, og vejen til Highwatch er din.',
  'entities.quests.q_gargoyle_south.completion': 'Stenen brummer én gang, tilfreds. Bag den klarer spejlet op som et endelig sluppet, holdt vejr.',
  'entities.quests.q_gargoyle_south.objectives.0.label': 'Høstmand fældet',
  'entities.quests.q_gargoyle_west.title': 'En Told af Lagner',
  'entities.quests.q_gargoyle_west.text': 'Skæret bliver til ord bag dine øjne: bring mig fire hvide lagner fra de fattige døde, {playerName}. Vejen til Eastbrook åbner sig for den, der betaler i klæde.',
  'entities.quests.q_gargoyle_west.completion': 'Lagnerne synker ned i stenen og er væk. Spejlet bag den vågner med lys.',
  'entities.quests.q_gargoyle_west.objectives.0.label': 'Hvidt Lagen',
  'entities.quests.q_gargoyle_north.title': 'Høstet Stråleglans',
  'entities.quests.q_gargoyle_north.text': 'Skæret bliver til ord bag dine øjne: åndehjordene brænder for klart for glasset, {playerName}. Fæld fem, og Fenbridge er kun et skridt væk.',
  'entities.quests.q_gargoyle_north.completion': 'Stenen drikker det lys, du spildte. Spejlet bag den åbner sig som et øje.',
  'entities.quests.q_gargoyle_north.objectives.0.label': 'Åndeenhjørning fældet',
  'entities.zones.mirror_world.pois.10.label': 'Den Sorte Kløft',
  'entities.mobs.gargoyle_awakened.name': 'Gargoilvagt',
  'entities.mobs.mistshade_lurker.name': 'Tågeskygge-lurer',
  'entities.mobs.gloaming_maw.name': 'Tusmørkegabet',
  'entities.mobs.player_echo.name': 'Ekko',
  'entities.npcs.keeper_nerissa.name': 'Nerissa den Hvileløse',
  'entities.npcs.keeper_nerissa.title': 'Spøgelsesvogter af Lumenkronen',
  'entities.npcs.keeper_nerissa.greeting': 'Jeg bar Lumenkronen i livet, og Kronen holder glasset ærligt - hvert spejl i denne dal viser noget sandt, på nær ét. Døden har ikke fritaget mig fra posten, {playerName}, for det ene holder ikke op med at presse. Kronens lys svigter, og hvor det svigter, siver dalen igennem. Pas på hvilken side af glasset du går på. På det seneste har det svært ved at se det.',
  'entities.items.warden_sigil.name': 'Vogtersegl',
  'entities.items.drowned_lumen.name': 'Druknet lumen',
  'entities.quests.q_the_failing_radiance.title': 'Den svindende stråleglans',
  'entities.quests.q_the_failing_radiance.text': 'Du mærker min kulde og tror, jeg er et sagn. Jeg er en post, {playerName}. Lumenkronen, jeg vogtede, er ingen guldring: den er lyset i hvert spejl her, sømmen der holder levende og døde i adskilte spejlbilleder, så det ene ikke drukner det andet. Det lys svigter, og du ser det på de Spejlbundne vagter: engang Kronens egen stråleglans på vagt, nu glas fyldt af stjålet lys, der trænges i de nordlige ruiner, fordi sømmen ikke længere siger dem, hvor de skal stå. Knus otte. Hver skår, du spreder, er en smule lys givet tilbage, og en smule bevis på, at man kan betro dig resten.',
  'entities.quests.q_the_failing_radiance.completion': 'Skårene driver tilbage mod brønden som sne, der falder opad, og et åndedrag lang er hele dalen en nuance lysere. Det varer ikke. Men du reparerer sømme i stedet for at skære dem over, {playerName}: det er sjældnere her, end du tror. Du knuste også den ANDEN krone, ikke sandt? Jernkronen, under Thornpeak. Så kan dette lys for første gang i tre hundrede år vende tilbage. Bliv. Dalen har længe ventet på hænder, der lukker sår.',
  'entities.quests.q_the_failing_radiance.objectives.0.label': 'Spejlbunden vagt knust',
  'entities.quests.q_what_the_poor_keep.title': 'Hvad de fattige stadig gemmer',
  'entities.quests.q_what_the_poor_keep.text': 'De Fattige genfærd ved sydbredden ejede intet i livet, {playerName}: intet uden lagenet, de blev begravet i, for sognet havde ikke råd til en kiste. Nu er Kronens lys for tyndt til at løsne deres greb, og de vandrer og klamrer sig til det eneste, der nogensinde var deres. Tag det ikke for grusomhed; det er kærlighed uden sted at gøre af sig. Bring mig fem af deres lagner. Jeg lægger hvert i brønden og siger navnet, der var for fattigt til at hugges i sten. Deri består hele riten: at være fattig, og død, og dog kaldt ved navn.',
  'entities.quests.q_what_the_poor_keep.completion': 'Fem lagner, fem navne. Jeg siger dem i brønden, og vandet tager dem, som en mor løfter en frakke af et sovende barn. Genfærdene ved bredden er færre i nat, {playerName}: ikke dræbte, befriede. Dette gjorde hele Kronen: den holdt de døde nær nok til at kunne slippe dem. Nu gør vi det med hånden, du og jeg, fem navne ad gangen. Det er langsommere. Det er ikke ingenting.',
  'entities.quests.q_what_the_poor_keep.objectives.0.label': 'Hvidt lagen',
  'entities.quests.q_the_wardens_names.title': 'Vogternes navne',
  'entities.quests.q_the_wardens_names.text': 'De tre, der vandrer Sorte Kløft, kaldes Rædselsvogtere af dem, der flygter for dem. Jeg kaldte dem engang ved navn: de var min orden, {playerName}, de sidste mænd, der i livet holdt Sabelspejlets dæmningsvej, og de veg aldrig, ikke engang da deres hjerter gjorde det. Ingen klinge befrier dem mere; det sorte glas rider dem for dybt til at falde. Men det glas er krøbet fra vogterne til høstmændene, der trænges på dæmningen, og gennem de lange år har høstmændene revet vogternes segl løs. Bring mig tre, taget fra kløftens høstmænd, så jeg kan sige de tre navne højt en sidste gang.',
  'entities.quests.q_the_wardens_names.completion': 'Corwin. Aldous. Brenna. Sådan: sagt, og at sige dem vejer lettere, end det at holde dem nogensinde gjorde. Snart må de holde op; det skal jeg sørge for. Men agt på det, der nærmer sig, {playerName}: de løsrevne segl betyder, at glasset på den dæmning tyndes, og såret ved dens ende har ventet på netop dette. Jeg må genantænde Kronen og støtte Sablen, før noget på den anden side mærker, at døren ligger blottet. Der er en sidste ting, jeg behøver - og den ligger under det sorte vand.',
  'entities.quests.q_the_wardens_names.objectives.0.label': 'Vogtersegl',
  'entities.quests.q_what_the_glass_wants.title': 'Hvad glasset vil',
  'entities.quests.q_what_the_glass_wants.text': 'Du besejrede din Ekko og troede, det var en prøve på dig selv, {playerName}. Det var det ikke. Jeg brygger Dybdrømmen af lagen, horn og hætte, men det, din drøm rejste et spejl imod, tingen der kom ind i dit ansigt, det brygger jeg ikke. Det siver ind fra kløftens sorte glas. Høstmændene, der trænges ved kløftmundingen, er tætte af samme lækage; fæld otte og se, hvorhen deres skygger kryber. Så viser jeg Nerissas egne øjne, hvor hendes sår i sandhed bløder.',
  'entities.quests.q_what_the_glass_wants.completion': 'Mod nordøst. Altid mod nordøst, altid mod Sablen — så du det? Din Ekko var ikke DIG, vandrer. Den var et skår af hvad end der bor bag den port, klædt i det nærmeste spejlbillede, den kunne stjæle: dit. Drømmen er blot det tyndeste sted, lækagen har fundet; kløften det bredeste. Sig det til Nerissa. Hun har fortjent sandheden om det, og det har du med.',
  ...
  'entities.quests.q_relight_the_lumen_crown.text': 'Vogterne har navn, og dæmningen tyndes, så nu må jeg gøre det, jeg har udskudt, siden jeg døde: tænde Lumenkronen en sidste gang og presse Sablen lukket fra denne side. Kronens sidste sande gnist blev slugt af Tusmørkegabet, da det faldt i dammen — derfor gløder tingen indefra. Skær lyset ud af det igen, {playerName}. Det sorte glas sender sine dysterkolosser for at standse riten; fæld fire. Bring mig en druknet gnist, mens jeg endnu husker, hvordan man holder en. En vogters sidste pligt er at blive en, der ikke længere behøver at vogte.',
  'entities.quests.q_relight_the_lumen_crown.completion': 'Den brænder. Efter alt dette mørke kender den endnu min hånd. Se: glasset er SANDT igen; ingen hjerteslag bag vandet, ingen sjæl fortabt mellem en verden og dens spejlbillede. Og vægten har endelig forladt mig. Jeg svinder ikke, {playerName}; jeg bliver AFLØST. Dette er ikke at bryde Sablen, kun at holde den; jeg har ikke kraften til at bryde det, der venter dér, og jeg ville ikke vove det. Men holdt en tidsalder til, er den holdt. Når et modigere følge end vi til sidst går IND gennem den port, skal de finde den anden side rede. Sig i Highwatch, at deres vogter holdt vagten til det sidste og så blev afløst. Glasset vil huske dig. Sørg for at give det noget værd at spejle.',
  'entities.quests.q_relight_the_lumen_crown.objectives.0.label': 'Tusmørkegabet fældet',
  'entities.quests.q_relight_the_lumen_crown.objectives.1.label': 'Druknet lumen',
  'entities.quests.q_relight_the_lumen_crown.objectives.2.label': 'Dysterkolos knust',
  'entities.npcs.veilwright_ollo.name': 'Slørvæver Ollo',
  'entities.npcs.veilwright_ollo.title': 'Handlende på Slørmarkedet',
  'entities.npcs.veilwright_ollo.greeting': 'Døde mænds frakker, sukke på flaske, ærlige priser - sløret sørger for det. Alt på mit bord blev lagt fra af nogen, der nu intet ejer; kunsten er at skelne, hvad de døde er færdige med, fra hvad de stadig klamrer sig til. Tag fejl, og de kommer til boden ved midnat. Spørg Vogteren om lyset i brønden, vil du have den triste version. Jeg sælger kun frakkerne.',
  'entities.npcs.gargoyle_sentinel_south.name': 'Gargoilvagt',
  'entities.npcs.gargoyle_sentinel_south.title': 'Spejlets Vogter',
  'entities.npcs.gargoyle_sentinel_south.greeting': 'Stenøjne knirker hen imod dig. Den lytter.',
  'entities.npcs.gargoyle_sentinel_west.name': 'Gargoilvagt',
  'entities.npcs.gargoyle_sentinel_west.title': 'Spejlets Vogter',
  'entities.npcs.gargoyle_sentinel_west.greeting': 'Stenøjne knirker hen imod dig. Den lytter.',
  'entities.npcs.gargoyle_sentinel_north.name': 'Gargoilvagt',
  'entities.npcs.gargoyle_sentinel_north.title': 'Spejlets Vogter',
  'entities.npcs.gargoyle_sentinel_north.greeting': 'Stenøjne knirker hen imod dig. Den lytter.',
  'entities.npcs.mistwitch_morwen.name': 'Morwen Tågeheksen',
  'entities.npcs.mistwitch_morwen.title': 'Lavningens drømmebrygger',
  'entities.npcs.mistwitch_morwen.greeting': 'Tågen holder de fleste af jer vågne. Jeg kan brygge dig den anden slags søvn — den slags, der svarer igen.',
  'entities.quests.q_deepdream_recipe.title': 'En opskrift på dyb søvn',
  'entities.quests.q_deepdream_recipe.text': 'Brygget kræver tre stemmer, {playerName}: to hvide lagner fra fattigdomsspøgelserne, der intet andet ejer, to horn fra åndeenhjørningerne, der græsser i mørket, og to hætter skåret af høstmændene, der vogter bæltet. Bring dem, så brygger jeg dig en søvn med tænder.',
  'entities.quests.q_deepdream_recipe.completion': 'Lagen, horn, hætte — de fattige, de strålende, de tålmodige. Kedlen kan lide dig. Drik det et blødt sted, vandringsmand: du vil møde den, du har båret på.',
  ...
  'entities.quests.q_face_your_echo.text': 'Drik brygget, og drømmen stiller et spejl foran dig — dit Ekko, hvert ar og hvert af dine tricks på den anden side. Besejr det, du er, {playerName}, og bring mig dit ansigt bagefter.',
  'entities.quests.q_face_your_echo.completion': 'Du kom tilbage, og det gjorde spejlet ikke. Hvad det efterlod i din hånd, er dit — drømmen betaler kun den pris én gang.',
  ...
  'entities.items.black_hood.name': 'Sort Hætte',
  'entities.items.deepdream_draught.name': 'Dybdrøm-eliksir',
  'entities.items.mirror_shard.name': 'Spejlskår',
  'entities.items.ghostly_mirrorblade.name': 'Spøgelses-spejlklinge',
  'entities.items.ghostly_shroudmantle.name': 'Spøgelses-ligklædekappe',
  'entities.items.ghostly_wraithjerkin.name': 'Spøgelses-genfærdstrøje',
  'entities.items.ghostly_palegrips.name': 'Spøgelses-blege greb',
  'entities.items.ghostly_hushboots.name': 'Spøgelses-tavse støvler',
  'entities.items.ghostly_glasscord.name': 'Spøgelses-glassnor',
  ...
  'questUi.dialog.brewDraught': 'Bryg mig en Dybdrøm-eliksir.',
  'questUi.dialog.brewDraughtAria': 'Bed {name} om at brygge en Dybdrøm-eliksir',
  'questUi.dialog.gargoyleBow': 'Buk dig.',
  'questUi.dialog.gargoyleBowAria': 'Buk for {name}',
  'questUi.dialog.gargoyleAttack': 'Angrib.',
  'questUi.dialog.gargoyleAttackAria': 'Angrib {name}',
  'questUi.dialog.gargoyleShimmer': 'Statuen flimrer af energi...',
  'hud.core.deepdreamZone': 'Dybdrømmen',
