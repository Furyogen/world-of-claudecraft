...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.mirror_world.welcome':
    'Glasset husker dig. Pas på, hvilken side af det du går på.',
  ...
  'entities.npcs.dread_sentinel_c.greeting':
    'Vend om. Det sorte glas er ikke for de levende - og var det aldrig for os.',
  'entities.quests.q_gargoyle_south.title': 'Vogterens Told',
  'entities.quests.q_gargoyle_south.text':
    'Skæret bliver til ord bag dine øjne: høstmændene trænges om mit glas, {playerName}. Tynd dem ud, og vejen til Highwatch er din.',
  'entities.quests.q_gargoyle_south.completion':
    'Stenen brummer én gang, tilfreds. Bag den klarer spejlet op som et endelig sluppet, holdt vejr.',
  ...
  'entities.quests.q_gargoyle_west.text':
    'Skæret bliver til ord bag dine øjne: bring mig fire hvide lagner fra de fattige døde, {playerName}. Vejen til Eastbrook åbner sig for den, der betaler i klæde.',
  'entities.quests.q_gargoyle_west.completion':
    'Lagnerne synker ned i stenen og er væk. Spejlet bag den vågner med lys.',
  ...
  'entities.quests.q_gargoyle_north.text':
    'Skæret bliver til ord bag dine øjne: åndehjordene brænder for klart for glasset, {playerName}. Fæld fem, og Fenbridge er kun et skridt væk.',
  'entities.quests.q_gargoyle_north.completion':
    'Stenen drikker det lys, du spildte. Spejlet bag den åbner sig som et øje.',
  ...
  'entities.quests.q_what_the_poor_keep.text':
    'De Fattige genfærd ved sydbredden ejede intet i livet, {playerName}: intet uden lagenet, de blev begravet i, for sognet havde ikke råd til en kiste. Nu er Kronens lys for tyndt til at løsne deres greb, og de vandrer og klamrer sig til det eneste, der nogensinde var deres. Tag det ikke for grusomhed; det er kærlighed uden sted at gøre af sig. Bring mig fem af deres lagner. Jeg lægger hvert i brønden og siger navnet, der var for fattigt til at hugges i sten. Deri består hele riten: at være fattig, og død, og dog kaldt ved navn.',
  'entities.quests.q_what_the_poor_keep.completion':
    'Fem lagner, fem navne. Jeg siger dem i brønden, og vandet tager dem, som en mor løfter en frakke af et sovende barn. Genfærdene ved bredden er færre i nat, {playerName}: ikke dræbte, befriede. Dette gjorde hele Kronen: den holdt de døde nær nok til at kunne slippe dem. Nu gør vi det med hånden, du og jeg, fem navne ad gangen. Det er langsommere. Det er ikke ingenting.',
