...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.recovery.failed': "Indtast en gyldig e-mailadresse.",
  'auth.recovery.invalid': "Indtast en gyldig e-mailadresse.",
  'auth.recovery.logOut': "Log ud",
  'auth.recovery.save': "Gem e-mail",
  'auth.recovery.title': "Tilføj gendannelses-e-mail",
  'entities.quests.q_old_cragmaw.completion': "Gamle Cragmaw is gevallen, {playerName}. De patrouilles kunnen de weg weer gebruiken en de kam is rustiger door je werk.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Gamle Cragmaw dræbt",
  'entities.quests.q_old_cragmaw.text': "Gamle Cragmaw: de sporen leiden naar de westelijke kam boven de zuidweg, {playerName}. Neem hulp mee en versla het oude beest.",
  'entities.quests.q_old_cragmaw.title': "Gamle Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Tien goede huiden, maar veel zijn verscheurd, {playerName}. Iets op de kam valt zijn eigen soort aan.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Rygstalker-skind",
  'entities.quests.q_stalker_cloaks.text': "De wacht heeft warme mantels nodig, {playerName}. Verzamel tien huiden van de stalkers op de kam ten zuiden van de poort.",
  'entities.quests.q_stalker_cloaks.title': "Kapper til vagten",
  'entities.quests.q_stalkers_return.completion': "Nog veertien, en elke ochtend zijn er verse sporen. Wat daarboven loopt is geen gewone kat.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Rygstalker dræbt",
  'entities.quests.q_stalkers_return.text': "Twaalf dood en de kam blijft vol, {playerName}. Iets drijft de beesten naar de muur. Versla er nog veertien.",
  'entities.quests.q_stalkers_return.title': "Stalkerne vender tilbage",
  'hudChrome.dailyRewards.pointsGained': "{points} point til daglige belønninger optjent.",
  'hudChrome.dailyRewards.taskMultiplier': "Multiplikator x{multiplier}",
  ...
  'hudChrome.options.walkByAutoloot': "Automatisk loot ved forbipassage",
  ...
  'questUi.tracker.hideFromMap': "Skjul {name} fra kortet",
