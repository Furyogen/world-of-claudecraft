...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[TR] Buy',
  'delveUi.shop.buyConfirmBody':
    '[TR] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[TR] Cancel',
  'delveUi.shop.buyConfirmTitle': '[TR] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[TR] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[TR] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[TR] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[TR] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[TR] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[TR] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[TR] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[TR] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[TR] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[TR] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[TR] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[TR] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[TR] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[TR] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[TR] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[TR] Frostgill Chowder',
  'entities.items.game_meat.name': '[TR] Game Meat',
  'entities.items.glass_vial.name': '[TR] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[TR] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[TR] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[TR] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[TR] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[TR] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[TR] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[TR] Homespun Cloth',
  'entities.items.homespun_hood.name': '[TR] Homespun Hood',
  'entities.items.homespun_mitts.name': '[TR] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[TR] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[TR] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[TR] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[TR] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[TR] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[TR] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[TR] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[TR] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[TR] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[TR] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[TR] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[TR] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[TR] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[TR] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[TR] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[TR] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[TR] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[TR] Prime Cut',
  'entities.items.pristine_hide.name': '[TR] Pristine Hide',
  'entities.items.pristine_silk.name': '[TR] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[TR] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[TR] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[TR] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[TR] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[TR] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[TR] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[TR] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[TR] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[TR] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[TR] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[TR] Smithing Flux',
  'entities.items.spider_silk.name': '[TR] Spider Silk',
  'entities.items.spool_of_thread.name': '[TR] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[TR] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[TR] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[TR] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[TR] Sunweave Treads',
  'entities.items.tanning_agent.name': '[TR] Tanning Agent',
  'entities.items.thorium_warblade.name': '[TR] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[TR] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[TR] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[TR] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[TR] Venom Gland',
  'entities.items.venomfire_elixir.name': '[TR] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[TR] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[TR] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[TR] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[TR] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[TR] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[TR] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[TR] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[TR] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[TR] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[TR] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[TR] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[TR] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[TR] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[TR] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[TR] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[TR] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[TR] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[TR] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[TR] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[TR] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[TR] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[TR] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[TR] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[TR] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[TR] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[TR] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[TR] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[TR] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[TR] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[TR] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[TR] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[TR] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[TR] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[TR] Buy',
  'heroicShop.buyConfirmBody':
    '[TR] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[TR] Cancel',
  'heroicShop.buyConfirmTitle': '[TR] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[TR] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[TR] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[TR] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[TR] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[TR] Enchanted',
  'hudChrome.crafting.makersMark': '[TR] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[TR] Masterwork',
  'hudChrome.crafting.masterworkToast': '[TR] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[TR] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[TR] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[TR] Station',
  'hudChrome.crafting.stationName.apothecary': '[TR] Apothecary',
  'hudChrome.crafting.stationName.forge': '[TR] Forge',
  'hudChrome.crafting.stationName.kitchens': '[TR] Kitchens',
  'hudChrome.crafting.stationName.loom': '[TR] Loom',
  'hudChrome.crafting.stationName.tannery': '[TR] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[TR] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[TR] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[TR] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[TR] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[TR] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[TR] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[TR] Cancel',
  'hudChrome.death.healerConfirmTitle': "[TR] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[TR] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[TR] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[TR] Professions',
  'hudChrome.options.showThirdActionBar': '[TR] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[TR] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[TR] Common cap',
  'hudChrome.professions.ceilingRare': '[TR] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[TR] No empowerment cap',
  'hudChrome.professions.close': '[TR] Close professions',
  'hudChrome.professions.ctaHeader': '[TR] Next step',
  'hudChrome.professions.ctaRaise':
    '[TR] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[TR] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[TR] Gathering',
  'hudChrome.professions.hobbyLabel': '[TR] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[TR] Identity',
  'hudChrome.professions.majorsLabel': '[TR] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[TR] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[TR] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[TR] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[TR] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[TR] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[TR] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[TR] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[TR] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[TR] Perks',
  'hudChrome.professions.returnsLabel': '[TR] Returns: {count}',
  'hudChrome.professions.ringAria': '[TR] Craft wheel',
  'hudChrome.professions.roleDormant': '[TR] Dormant',
  'hudChrome.professions.roleHobby': '[TR] Hobby',
  'hudChrome.professions.roleMajor': '[TR] Major',
  'hudChrome.professions.roleUnattuned': '[TR] Unattuned',
  'hudChrome.professions.skillValue': '[TR] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[TR] Craft skills',
  'hudChrome.professions.switchCost': '[TR] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[TR] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[TR] Tier {tier}',
  'hudChrome.professions.title': '[TR] Professions',
  'hudChrome.professions.tutorialLine':
    '[TR] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[TR] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[TR] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[TR] You cannot afford that training.',
  'hudChrome.training.close': '[TR] Close training',
  'hudChrome.training.dialogOption': '[TR] Training',
  'hudChrome.training.dialogOptionAria': '[TR] Browse training from {name}',
  'hudChrome.training.empty': '[TR] This master has nothing to teach.',
  'hudChrome.training.free': '[TR] Free',
  'hudChrome.training.learned': '[TR] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[TR] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[TR] You must be at the station to train.',
  'hudChrome.training.requirement': '[TR] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[TR] Known',
  'hudChrome.training.stateLocked': '[TR] Locked',
  'hudChrome.training.stateTeachable': '[TR] Available',
  'hudChrome.training.tierUnmet': '[TR] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[TR] Training: {name}',
  'hudChrome.training.trainAria': '[TR] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[TR] Legendary',
  'loading.reconnectingAttempt':
    '[TR] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[TR] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[TR] This is taking longer than usual. Check your internet connection.',
};
