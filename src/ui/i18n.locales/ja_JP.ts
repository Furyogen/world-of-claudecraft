...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.chat.categories.hide': '「全体」表示で{category}の行を非表示にする',
  'hudChrome.chat.categories.show': '「全体」表示で{category}の行を表示する',
  'hudChrome.chat.categories.game': 'ゲーム',
  'hudChrome.chat.categories.loot': '戦利品',
  'hudChrome.chat.categories.xp': '経験値',
  'hudChrome.chat.categories.quest': 'クエスト',
  'hudChrome.chat.categories.event': 'イベント',
  'hudChrome.chat.categories.public': '公開',
  'hudChrome.chat.categories.party': 'パーティー',
  'hudChrome.chat.categories.guild': 'ギルド',
  'hudChrome.chat.categories.channels': 'チャンネル',
  'hudChrome.chat.categories.whispers': 'ささやき',
