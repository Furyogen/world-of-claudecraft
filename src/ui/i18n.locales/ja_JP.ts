...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.title': 'クラウジウム',
  ...
  'hudChrome.claudium.confirmRequote':
    '価格が変動しました。新しい見積もりを取得して再試行してください。',
  ...
  'hudChrome.claudium.disclosure':
    'クラウジウムは一方向のソフト通貨です。お金で購入し、コスメティックに使用します。換金、送金、払い戻しはできません。',
  'hudChrome.claudium.buyTitle': 'クラウジウムを購入',
  'hudChrome.claudium.railLabel': '支払い方法',
  'hudChrome.claudium.railStripe': 'カード',
  'hudChrome.claudium.railWocUnavailable': 'WOCの価格は現在利用できません。',
  'hudChrome.claudium.amountLabel': '金額',
  'hudChrome.claudium.skuRow': '{usd} で {claudium} クラウジウム',
  'hudChrome.claudium.buyButton': '購入',
  'hudChrome.claudium.buyUnavailable': '購入は現在利用できません。',
  'hudChrome.claudium.storeTitle': 'コスメティックストア',
  'hudChrome.claudium.storeEmpty': '現在利用できるコスメティックはありません。',
  'hudChrome.claudium.storeCost': '{amount} クラウジウム',
  ...
  'hudChrome.claudium.tabsLabel': 'クラウジウムのタブ',
  'hudChrome.claudium.tabBuy': '購入',
  'hudChrome.claudium.tabRedeem': '引き換え',
  'hudChrome.claudium.railDisabled': 'この支払い方法は現在利用できません。',
  'hudChrome.claudium.oracleUnavailable':
    'ライブ価格は現在利用できません。しばらくしてから再度お試しください。',
  'hudChrome.claudium.quoteButton': '見積もりを取得',
  'hudChrome.claudium.amountRow': '{usd} で {claudium} クラウジウム',
  'hudChrome.claudium.sendExactly': '正確に {amount} {rail} を送金',
  'hudChrome.claudium.addressLabel': '送金先',
  'hudChrome.claudium.memoLabel': 'メモ (必須)',
  'hudChrome.claudium.splitBurn': '{amount} {rail} をバーン',
  'hudChrome.claudium.splitTreasury': '{amount} {rail} を財務庫へ',
  'hudChrome.claudium.expiresIn': '見積もりは {time} で失効します',
  'hudChrome.claudium.quoteExpired': 'この見積もりは失効しました。新しく取得してください。',
  'hudChrome.claudium.payNote':
    '自分のウォレットからメモを付けて正確な金額を送金し、取引の署名を貼り付けて確認してください。サービスがオンチェーンで検証してから残高に反映します。',
  'hudChrome.claudium.signatureLabel': '取引の署名',
  'hudChrome.claudium.signaturePlaceholder': '署名を貼り付け',
  'hudChrome.claudium.confirmButton': '支払いを確認',
  'hudChrome.claudium.confirmCredited': '{amount} クラウジウムを付与しました。',
  'hudChrome.claudium.confirmFailed':
    'この支払いはまだ確認できませんでした。しばらくしてから再度お試しください。',
  'hudChrome.claudium.redeemTitle': 'ギフトカードを引き換え',
  'hudChrome.claudium.enterCode': 'ギフトカードのコードを入力',
  'hudChrome.claudium.redeemButton': '引き換え',
  'hudChrome.claudium.redeemed': '{amount} クラウジウムを引き換えました。新しい残高: {balance}。',
  'hudChrome.claudium.redeemFailed':
    'このコードは引き換えできませんでした。コードを確認して再度お試しください。',
  'hudChrome.claudium.back': '戻る',
  'hudChrome.claudium.tabHistory': '履歴',
  'hudChrome.claudium.giftTitle': 'ギフトカードを贈る',
  'hudChrome.claudium.giftDenominationLabel': '額面',
  'hudChrome.claudium.giftRecipientLabel': '受取人',
  'hudChrome.claudium.giftToSelf': '自分用',
  'hudChrome.claudium.giftToOther': '他の人へ',
  'hudChrome.claudium.giftEmailLabel': '受取人のメール',
  'hudChrome.claudium.giftEmailInvalid': '有効なメールアドレスを入力してください。',
  'hudChrome.claudium.giftOccasionLabel': 'シーン',
  'hudChrome.claudium.giftMessageLabel': 'メッセージ',
  'hudChrome.claudium.giftMessagePlaceholder': '短いメッセージを追加 (任意)',
  'hudChrome.claudium.giftDeliveryLabel': '受け渡し方法',
  'hudChrome.claudium.giftScheduleLabel': '受け渡しを予約 (任意)',
  'hudChrome.claudium.giftReviewButton': 'ギフトを確認',
  'hudChrome.claudium.giftReviewSelf': 'このギフトカードはあなた自身が引き換えできます。',
  'hudChrome.claudium.giftReviewEmail': 'このギフトカードを {email} に送信します。',
  'hudChrome.claudium.giftReviewShared': 'このギフトカードを共有するためのリンクが発行されます。',
  'hudChrome.claudium.giftReviewScheduled': '選択した日付に受け渡されます。',
  'hudChrome.claudium.giftConfirmButton': '確認して支払う',
  'hudChrome.claudium.giftAnotherButton': 'もう一枚贈る',
  'hudChrome.claudium.giftPending': 'ギフトカードを発行しています。少々お待ちください。',
  'hudChrome.claudium.giftIssued': 'ギフトカードを共有できます。',
  'hudChrome.claudium.giftFailed':
    'ギフトカードを発行できませんでした。しばらくしてから再度お試しください。',
  'hudChrome.claudium.giftDeclined': '支払いが拒否されました。ギフトカードは発行されていません。',
  'hudChrome.claudium.giftLinkLabel': 'ギフトカードのリンク',
  'hudChrome.claudium.giftQrAlt': 'ギフトカード引き換えリンクのQRコード',
  'hudChrome.claudium.giftTerms':
    'ギフトカードはクラウジウムとの引き換えのみ可能です。現金との交換や返金はできません。',
  'hudChrome.claudium.deliveryEmail': 'メール',
  'hudChrome.claudium.deliveryLink': 'リンクを共有',
  'hudChrome.claudium.deliveryReveal': '今すぐ表示',
  'hudChrome.claudium.occasionBirthday': '誕生日',
  'hudChrome.claudium.occasionHoliday': '祝日',
  'hudChrome.claudium.occasionCongrats': 'お祝い',
  'hudChrome.claudium.occasionThankyou': '感謝',
  'hudChrome.claudium.occasionGeneric': '気軽に',
  'hudChrome.claudium.reasonPurchaseStripe': '購入 (カード)',
  'hudChrome.claudium.reasonPurchaseSol': '購入 (SOL)',
  'hudChrome.claudium.reasonPurchaseUsdc': '購入 (USDC)',
  'hudChrome.claudium.reasonPurchaseWoc': '購入 (WOC)',
  'hudChrome.claudium.reasonGiftcardRedeem': 'ギフトカード引き換え',
  'hudChrome.claudium.reasonSpend': '装飾の購入',
  'hudChrome.claudium.reasonRefund': '返金',
  'hudChrome.claudium.reasonChargeback': 'チャージバック',
  'hudChrome.claudium.reasonGiftcardVoid': 'ギフトカード無効化',
  'hudChrome.claudium.historyTitle': '取引履歴',
  'hudChrome.claudium.historyLoading': '履歴を読み込んでいます...',
  'hudChrome.claudium.historyError': '履歴を読み込めませんでした。もう一度お試しください。',
  'hudChrome.claudium.historyEmpty': 'クラウジウムの取引はまだありません。',
  'hudChrome.claudium.historyLoadMore': 'さらに読み込む',
  'hudChrome.claudium.historyFilterLabel': '種類で絞り込む',
  'hudChrome.claudium.historyFilterAll': 'すべての種類',
  'hudChrome.claudium.historyExplorer': 'Solana Explorer で表示',
  'hudChrome.claudium.historyReceipt': 'カード購入',
  'hudChrome.claudium.historyGiftNote': 'ギフトカード',
  'hudChrome.claudium.timeJustNow': 'たった今',
