...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.skillTracker.typeSquare': '四角',
  'hudChrome.skillTracker.typeBar': 'バー',
  'hudChrome.skillTracker.typeAria': '{name}のトラッカー種類：{type}',
  'hudChrome.skillTracker.tooltipTarget': 'ターゲットに付与中',
  'hudChrome.skillTracker.tooltipSelf': '自分に付与中',
  'hudChrome.skillTracker.tooltipCooldown': 'クールダウン',
  'hudChrome.skillTracker.dragHandle': 'ドラッグしてトラッカー枠を移動',
  'hudChrome.skillTracker.groupSquares': '呪文トラッカーのアイコン',
  'hudChrome.skillTracker.groupBars': '呪文トラッカーのバー',
