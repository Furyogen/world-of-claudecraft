...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': '潮の門',
  'entities.zones.atlantis.name': 'アトランティス',
  'entities.zones.atlantis.welcome': 'ドームは今も歌い、アトランティスは底潮の下で生き続けている。',
  'entities.zones.atlantis.pois.0.label': 'アトランティス',
  'entities.zones.atlantis.pois.1.label': '潮門広場',
  'entities.zones.atlantis.pois.2.label': 'ルーメンの王冠',
  'entities.zones.atlantis.pois.3.label': '真珠市場',
  'entities.zones.atlantis.pois.4.label': '水没書庫',
  'entities.zones.atlantis.pois.5.label': 'ケルプ番の別館',
  'entities.mobs.glimmerfin_eel.name': '輝きヒレウナギ',
  'entities.mobs.pearlshell_skitterer.name': '真珠殻ガニ',
  'entities.mobs.kelpshade_lurker.name': 'ケルプ影の潜み手',
  'entities.mobs.undertow_maw.name': '底潮の大顎',
  'entities.npcs.keeper_nerissa.name': '番人ネリッサ',
  'entities.npcs.keeper_nerissa.title': 'ルーメンの王冠の守り手',
  'entities.npcs.keeper_nerissa.greeting': 'ガラスに気をつけな、地上の者よ。一つの時代を耐えてきたんだ――このまま保つのを手伝っておくれ。',
  'entities.npcs.tidewright_ollo.name': '潮鍛冶オロ',
  'entities.npcs.tidewright_ollo.title': '真珠市場の潮鍛冶',
  'entities.npcs.tidewright_ollo.greeting': '深みに残った最後の乾いた蒸留器から採れたてだよ。金が先、話は後だ。',
