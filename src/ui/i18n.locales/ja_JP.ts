...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'ミュート',
  'hudChrome.playerMenu.unmute': 'ミュート解除',
  ...
  'hudChrome.social.mutedSection': 'ミュート中',
  'hudChrome.social.blockedSection': 'ブロック中',
  'hudChrome.social.stopMutingTitle': '{name} のミュートを解除',
