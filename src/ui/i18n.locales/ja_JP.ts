...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.title': 'ホドリック城',
  'hudChrome.hc.close': 'ガントレットウィンドウを閉じる',
  'hudChrome.hc.zoneName': 'ホドリック城',
  'hudChrome.hc.offlineNote': 'ガントレット受付がまだ同期していません。少々お待ちください。',
  'hudChrome.hc.joinQueue': 'ガントレットに参加',
  'hudChrome.hc.leaveQueue': '列を離れる',
  'hudChrome.hc.queuedAt': '待機中、順位 {position}。十人揃うとレース開始。',
  'hudChrome.hc.inMatchNote': 'レース中だ。前だけを見ろ!',
  'hudChrome.hc.practice': '宮廷と練習する',
  'hudChrome.hc.practiceNote': 'ホドリック卿の宮廷と対戦:九人の挑戦者、待ち時間なし。',
  'hudChrome.hc.record': '優勝 {wins} / 出走 {races}',
  'hudChrome.hc.bestTime': '自己ベスト {seconds}秒',
  'hudChrome.hc.bestNone': 'まだ完走記録がありません',
  'hudChrome.hc.rank': '順位 {rank} / {total}',
  'hudChrome.hc.finishPlace': '{place}位でゴール',
  'hudChrome.hc.overWon': '王冠はあなたのものだ!',
  'hudChrome.hc.overPlaced': 'レース終了:{place}位',
  'hudChrome.hc.howto':
    '3ラウンド、10人のレーサー、栄冠はひとつ。ホドリック卿は毎ラウンド、ガントレットを作り替える。各ラウンドの脱落を生き延び(6人通過、次は3人)、決勝を制せ。落下は時間のロスだけだ。',
  'hudChrome.hc.round': 'ラウンド {round}/{rounds}',
  'hudChrome.hc.advance': '{count}人通過',
  'hudChrome.hc.spectating': 'ギャラリーから観戦中',
  'hudChrome.hc.intermissionRebuild': 'ホドリック卿がガントレットを作り替える!',
  'hudChrome.hc.intermissionQualified': '通過!まもなく次のラウンド。',
  'hudChrome.hc.intermissionEliminated': '脱落!ギャラリーからの眺めをどうぞ。',
  'hudChrome.hc.section.hammer_bridge': 'ハンマー橋',
  'hudChrome.hc.section.rotor_court': '回転丸太の中庭',
  'hudChrome.hc.section.boulder_climb': '大岩の坂',
  'hudChrome.hc.section.piston_ledge': 'ピストンの棚道',
  'hudChrome.hc.section.spinner_court': '回転盤の広場',
  'hudChrome.hc.section.landing': '踊り場',
  'hudChrome.hc.banner.round': 'ラウンド {round}!',
  'hudChrome.hc.banner.qualified': '通過!',
  'hudChrome.hc.banner.eliminated': '脱落',
  'hudChrome.hc.log.qualified': '次のラウンドへ進出した。',
  'hudChrome.hc.log.eliminated': 'ラウンド{round}で脱落。ギャラリーには軽食があるらしい。',
  'hudChrome.hc.flavor.rebuild':
    'ホドリック卿がガントレットを作り替えた。コースは新しく、栄冠はひとつ!',
  'hudChrome.hc.section.start_yard': 'スタート広場',
  'hudChrome.hc.section.axe_walk': '斧の回廊',
  'hudChrome.hc.section.drawspan': '跳ね橋',
  'hudChrome.hc.section.red_ascent': '紅の坂道',
  'hudChrome.hc.section.finish_keep': 'ゴールの主塔',
  'hudChrome.hc.banner.found': 'ガントレットが呼んでいる!',
  'hudChrome.hc.banner.go': 'スタート!',
  'hudChrome.hc.banner.finish': '{place}位でゴール!',
  'hudChrome.hc.banner.crown': 'ホドリックの王冠を手にした!',
  'hudChrome.hc.log.queued': 'ガントレットの列に並んだ(順位 {position})。',
  'hudChrome.hc.log.unqueued': 'ガントレットの列を離れた。',
  'hudChrome.hc.log.fall': '深淵に落ちた。チェックポイントへ戻る。',
  'hudChrome.hc.log.checkpoint': 'チェックポイント {index} を通過。',
  'hudChrome.hc.log.placed': 'ガントレットを{place}位で完走した。',
  'hudChrome.hub.enter': '揺らめく門をくぐり、試練場へと足を踏み入れる。',
  'hudChrome.hub.leave': 'あなたはイーストブルック渓谷へと戻る。',
  'hudChrome.hub.zoneName': '試練の書院',
  'hudChrome.hc.flavor.queueJoin':
    'ガントレットの列に並んだ。ホドリック卿があなたに敬意を表しフレイルに油を差す。',
  'hudChrome.hc.flavor.gatesOpen': 'ホドリック城の門がきしみながら開く。王冠へ向かって走れ!',
  'hudChrome.hc.flavor.go': 'スタート!ガントレットが開いた!',
  'hudChrome.hc.err.legsOnly': 'ガントレット中は脚のみ:スキル使用は禁止されている。',
  'hudChrome.hc.err.inMatch': 'すでにガントレットに参加中です。',
  'hudChrome.hc.err.dead': '死亡中はガントレットに参加できません。',
  'hudChrome.hc.err.arenaConflict': 'ガントレットに参加する前に闘技場を離れてください。',
  ...
  'entities.npcs.hodrics_herald.name': '伝令オズリック',
  'entities.npcs.hodrics_herald.title': 'ホドリックのガントレット伝令',
  'entities.npcs.hodrics_herald.greeting':
    'ホドリック卿はすべての挑戦者に道を開く!ガントレットに挑み、フレイルをかわし、王冠を勝ち取れ!',
  ...
  'guide.nav.hodricsCastle': 'ホドリック城',
  'guide.hodricsCastlePage.heading': 'ホドリック城',
  'guide.hodricsCastlePage.intro':
    'ホドリック卿は城の道をあらゆる挑戦者に開放している。彼の旧防衛線の試練を駆け抜け、王冠を勝ち取れ。あなたが誰であろうと、レベルが何であろうと関係ない。',
  'guide.hodricsCastlePage.heraldHeading': '伝令',
  'guide.hodricsCastlePage.heraldBody':
    'イーストブルックの端にいる伝令オズリックを訪ねてガントレットの列に並ぼう。十人の挑戦者(実際のプレイヤーとホドリック卿の宮廷の騎士の両方)が揃うとレースが始まるので、レースはいつもすぐに始まる。',
  'guide.hodricsCastlePage.courseHeading': '3ラウンド、栄冠はひとつ',
  'guide.hodricsCastlePage.courseBody':
    'ガントレットは勝ち抜きショーだ。第1ラウンドは10人で始まり、6人が生き残り、3人が決勝へ進み、1人が王冠を戴く。ホドリック卿はラウンドごとにコースを作り替えるため、同じ走りは二度とない。ハンマー橋、回転丸太の中庭、斧の回廊、跳ね橋、大岩の坂、ピストンの棚道、回転盤など、その日の卿の気分次第の順番だ。どの仕掛けも決まった時計仕掛けのリズムで揺れ、回り、転がる。乱数は一切ないので、注意深い目は必ず安全な間合いを見つけられる。',
  'guide.hodricsCastlePage.fairnessHeading': '脚だけが頼り',
  'guide.hodricsCastlePage.fairnessBody':
    'ここでは誰も呪文を唱えない。レース中はスキルの使用が全面的に禁止され、全選手が同じ速度で走る。ガントレットを決めるのは度胸とタイミングだけで、装備やレベルは関係ない。',
  'guide.hodricsCastlePage.fallsHeading': '転落は時間を失うだけ',
  'guide.hodricsCastlePage.fallsBody':
    '仕掛けの一撃や深淵への転落は、最後のチェックポイントへ戻されるだけ。この城で死ぬ者はいない。転落の代償は、追いつくまでの数秒だけだ。ラウンド終了で脱落した者は華麗にギャラリーへ打ち上げられ、軽食とともに残りのショーを観戦する。',
  'guide.hodricsCastlePage.standingsHeading': '王冠',
  'guide.hodricsCastlePage.standingsBody':
    '決勝ラウンドのゴールを最初に駆け抜けた者が、そのショーのホドリックの王冠を手にする。出走数、優勝数、決勝ベストタイムは、並ぶたびに積み上がっていく。',
  ...
  'hudChrome.gauntlet.joinQueue': '待機列に参加',
  'hudChrome.gauntlet.leaveQueue': '待機列から退出',
  'hudChrome.gauntlet.queuePosition': '待機順: {n}',
  'hudChrome.gauntlet.spectate': '観戦',
  'hudChrome.gauntlet.stopSpectating': '観戦をやめる',
  'hudChrome.gauntlet.practice': '練習',
  'hudChrome.gauntlet.eventClosedNote':
    '現在イベントは開催されていないため、待機列と観戦は利用できません。練習はいつでも可能です。',
  'hudChrome.gauntlet.practicePickTitle': '練習する種目を選ぼう',
  'hudChrome.gauntlet.practiceFull': 'ガントレット全試練',
  'hudChrome.gauntlet.trialNames.sentinel': '歩哨の横断',
  'hudChrome.gauntlet.trialNames.sigils': '飴ガラスの印章',
  'hudChrome.gauntlet.trialNames.pull': '大綱引き',
  'hudChrome.gauntlet.trialNames.echo': '番人の残響',
  ...
  'hudChrome.gauntlet.phaseLobby': '挑戦者を募集中',
  'hudChrome.gauntlet.phaseStaging': '位置につけ',
  'hudChrome.gauntlet.phaseTrial': '横断開始',
  'hudChrome.gauntlet.phaseTrialSigils': '刻印開始',
  'hudChrome.gauntlet.phaseTrialPull': '綱を取れ',
  'hudChrome.gauntlet.phaseTrialEcho': '番人の残響が始まる',
  'hudChrome.gauntlet.phaseTrialSpan': '脆き橋を渡れ',
  'hudChrome.gauntlet.phaseTrialCourt': '最終決戦の場',
  'hudChrome.gauntlet.phaseInterlude': '試練クリア',
  'hudChrome.gauntlet.phasePodium': 'ガントレットの勝者が決した',
  'hudChrome.gauntlet.greenLight': '青信号!',
  'hudChrome.gauntlet.redLight': '赤信号!',
  'hudChrome.gauntlet.vitalityLost': '生命力を {amount} 失った。',
  'hudChrome.gauntlet.survivorsLeft': '残り {count} 人',
  'hudChrome.gauntlet.spectating': '観戦中',
  'hudChrome.gauntlet.leave': '退出',
  'hudChrome.gauntlet.victory': '勝利',
  'hudChrome.gauntlet.podiumTitle': '最終順位',
  ...
  'hudChrome.gauntlet.hint.court':
    '相手と決闘だ。奥の王冠にたどり着くか、相手をリング外へ突き飛ばせ。役割は一定時間で入れ替わる。',
  ...
  'entities.npcs.gauntlet_watcher.name': '石の番人',
  'entities.npcs.gauntlet_watcher.title': '横断の守り手',
  'entities.npcs.gauntlet_watcher.greeting': '番人はまばたきひとつしない。',
  'entities.npcs.gauntlet_contestant.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant.title': '参加者',
  'entities.npcs.gauntlet_contestant.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_warrior.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_warrior.title': '参加者',
  'entities.npcs.gauntlet_contestant_warrior.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_paladin.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_paladin.title': '参加者',
  'entities.npcs.gauntlet_contestant_paladin.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_hunter.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_hunter.title': '参加者',
  'entities.npcs.gauntlet_contestant_hunter.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_rogue.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_rogue.title': '参加者',
  'entities.npcs.gauntlet_contestant_rogue.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_priest.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_priest.title': '参加者',
  'entities.npcs.gauntlet_contestant_priest.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_mage.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_mage.title': '参加者',
  'entities.npcs.gauntlet_contestant_mage.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_warlock.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_warlock.title': '参加者',
  'entities.npcs.gauntlet_contestant_warlock.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_shaman.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_shaman.title': '参加者',
  'entities.npcs.gauntlet_contestant_shaman.greeting': '前を向け。番人が見ている。',
  'entities.npcs.gauntlet_contestant_druid.name': 'ガントレット参加者',
  'entities.npcs.gauntlet_contestant_druid.title': '参加者',
  'entities.npcs.gauntlet_contestant_druid.greeting': '前を向け。番人が見ている。',
