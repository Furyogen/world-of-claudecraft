...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ring_of_the_nine.name': '九人の指輪',
  'entities.items.nielas_band.name': 'ニエラの指輪',
  'entities.items.sutils_fortune.name': 'スティルの幸運',
  'entities.items.arthurs_round_band.name': 'アーサーの丸き指輪',
  'entities.items.signet_of_zyzz.name': 'ジズの印章指輪',
  'entities.items.band_of_the_architect.name': 'アーキテクトの指輪',
  'entities.items.swiftstride_pendant.name': '疾駆のペンダント',
  'entities.items.yumis_best_pendant.name': 'ユミの一番のペンダント',
  'entities.items.zense_meridian.name': 'ゼンセの子午線',
  'entities.items.pendant_of_endless_profit.name': '無限の利益のペンダント',
