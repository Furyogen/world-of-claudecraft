...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.mirror_world.welcome':
    'ガラスはお前を覚えている。その、どちら側を歩くかに気をつけよ。',
  ...
  'entities.npcs.keeper_nerissa.greeting':
    '私は生前ルーメンの冠を守り、冠はこの硝子を正直に保つ――この谷のどの鏡も真実を映す、ただ一枚を除いて。死をもってしても私はこの務めを解かれぬ、{playerName}、あの一枚がなお押し続けているゆえに。冠の光は衰え、それが尽きるところで谷が滲み出す。硝子のどちら側を歩いているか、心せよ。近ごろは、それすら見分けがつきにくいのだ。',
  ...
  'entities.quests.q_the_failing_radiance.text':
    'わたしの冷たさに触れ、あなたはわたしを昔語りだと思う。わたしは一つの持ち場だ、{playerName}。守り続けたルーメンの冠は金の輪ではない――ここのどの鏡にも宿る光、生者と死者を別々の像に保ち、互いに溺れさせぬための継ぎ目だ。その光が衰え、それは鏡縛の番兵に見てとれる。かつては冠の光輝そのものが見張りに立っていたが、今や盗まれた光に満ちた硝子にすぎず、継ぎ目がもはや立つ場所を告げぬゆえ北の廃墟にひしめいている。八体を砕け。あなたが散らす欠片の一つひとつが、返された僅かな光であり、残りを託せるという僅かな証しなのだ。',
  'entities.quests.q_the_failing_radiance.completion':
    '欠片は上へ降る雪のように井戸へと漂い戻り、ひと息のあいだ谷全体が一段明るくなる。長くは続くまい。だがあなたは継ぎ目を断つのではなく繕う、{playerName}――それはここでは思うより稀なことだ。あなたはもう一つの冠も砕いたのだろう？ソーンピークの下の、鉄の冠を。ならば三百年で初めて、この光は戻るやもしれぬ。留まれ。この谷は、傷を閉じる手を長く待っていたのだ。',
  ...
  'entities.quests.q_what_the_poor_keep.text':
    '南の岸の貧しき亡霊たちは、生前なにも持たなかった、{playerName}――教区が棺を賄えず、包まれて葬られた経帷子のほかは何も。今や冠の光は細りすぎて彼らの握りをほどけず、かつて確かに己のものであった唯ひとつを抱いてさまよう。これを残酷と思うな。行き場のない愛なのだ。彼らの経帷子を五枚持ってきておくれ。一枚ずつ井戸に横たえ、刻まれるにも貧しすぎた名を唱えよう。儀式のすべてはこれに尽きる――貧しく、死してなお、名で呼ばれること。',
  'entities.quests.q_what_the_poor_keep.completion':
    '経帷子が五枚、名が五つ。それを井戸へ唱えると、水は眠る子から母が外套を持ち上げるようにそれを受け取る。岸の亡霊は今宵、数を減らした、{playerName}――討たれたのではなく、解き放たれたのだ。冠が満ちていた頃はこうしていた――手放せるほどに死者を近くに抱いていた。今はこの手でやる、あなたとわたしとで、一度に五つの名を。遅い。だが、無ではない。',
  ...
  'entities.quests.q_the_wardens_names.text':
    '黒峡谷を行き来する三体を、逃げる者たちは畏怖の番兵と呼ぶ。かつてわたしは彼らを名で呼んだ――彼らはわたしの騎士団だ、{playerName}、生前、黒貂の鏡の堤道を守り抜いた最後の者たち。心の臓が止まってなお、持ち場を退かなかった。もはやいかなる刃も彼らを解けぬ。黒硝子が深く乗りすぎて、倒れることさえできぬのだ。だがその硝子は番兵から、堤道にひしめく死神たちへと移り、長い歳月のうちに死神たちは番兵の紋章をもぎ取ってきた。峡谷の死神から切り取った三つを持ってきておくれ。三つの名を、いま一度だけ声に出して言えるように。',
  'entities.quests.q_the_wardens_names.completion':
    'コーウィン。アルダス。ブレナ。これで――言われた。そして言うことは、抱え続けることよりずっと軽い。じきに彼らは止まれる。わたしが取り計らおう。だが近づくものに気をつけよ、{playerName}。紋章がもぎ取られたということは、あの堤道の硝子が薄れているということ、その果ての傷は、まさにこれを待っていた。向こう側の何かが扉が無防備だと気づく前に、わたしは冠を灯し直し、黒貂の鏡を支えねばならぬ。あと一つだけ要るものがある――それは黒い水の底にある。',
  ...
  'entities.npcs.mistwitch_morwen.greeting':
    '霧はお前たちをなかなか眠らせない。あたしはもう一つの眠りを醸せる――答えを返す眠りをね。',
  ...
  'entities.quests.q_face_your_echo.text':
    '薬を飲めば、夢がお前の前に鏡を立てる――お前のエコー、お前の傷跡も手癖も全部、鏡の向こう側だ。己というものを打ち倒して、{playerName}、その時の顔をあたしに見せに戻っておいで。',
  'entities.quests.q_face_your_echo.completion':
    'お前は帰ってきて、鏡は帰らなかった。その手に残されたものはお前のものだ――夢がその代価を払うのは一度きりだよ。',
