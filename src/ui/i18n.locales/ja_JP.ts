...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.interfaceUnlock.frameNames.delveTracker': 'デルヴトラッカー',
  'hudChrome.interfaceUnlock.frameNames.riftTracker': 'リフトトラッカー',
  'hudChrome.interfaceUnlock.frameNames.targetDots': 'ターゲットデバフ',
  ...
  'hudChrome.fullTransfer.intro': 'この端末に保存されたすべての設定を1つのコードとしてエクスポートし、別の端末やブラウザに貼り付けてインポートできます。対象: グラフィック、オーディオ、インターフェース、テーマ、フレーム配置、全キャラクターのキー設定、コントローラーとクロスホットバーの設定、チャット、ウィンドウのフィルター、言語、閉じたヒント。',
  'hudChrome.fullTransfer.excluded': '含まれないもの: ログイン、アカウント、ウォレット、購入データ。アクションバーの配置はアカウントに保存され、アカウントと共に引き継がれます。',
  ...
  'entities.npcs.riftwright_maelis.name': 'リフトライトのマエリス',
  'entities.npcs.riftwright_maelis.title': 'リフト鍛冶の親方',
  'entities.npcs.riftwright_maelis.greeting':
    'リフトバウンドリングは、自分を生んだ裂け目を覚えている、{className}。リングと、裂け目が落とすエッセンスを持ってくれば、もっと多くを覚えさせてやろう。',
  ...
  'hudChrome.nythraxisCallout.sigilAppears': '拘束の印が光った！その上へナイスラクシスを引きずり込め！',
  ...
  'hudChrome.raidBossGuide.nythraxis.phaseKingsWrathSummary': '体力{health}で、ナイスラクシスは王の怒りとともに咆哮し、以後戦闘終了まで通常で{bonusNormal}、英雄で{bonusHeroic}のダメージを得る。墓所の噴出は{eruptionEveryNormal}秒ごと（英雄は{eruptionEveryHeroic}秒ごと）に、紫炎は{gravefireEveryNormal}秒ごと（英雄は{gravefireEveryHeroic}秒ごと）に短縮される。他のメカニクスの周期は変わらない。',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerName': 'グレイブブレイカー',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerSummary': '{seconds}秒ごとに、ナイスラクシスは次の一撃を溜める。対象はその一撃のみを受けるが、彼の前方{arc}度・{range}ヤード以内にいる他の全員は、その一撃の{splash}を物理ダメージとして受ける（各自の防御力により軽減される）。',
  'hudChrome.raidBossGuide.nythraxis.gravebreakerResponse': 'タンクはナイスラクシスをレイドに向けさせないよう位置取りする。それ以外の全員は彼の後方か側面に留まり、扇形範囲を横切らない。',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseName': 'ドレッドカース',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseSummary': '{every}秒ごとに、ナイスラクシスは現在のタンクへ最大体力の{hitNormal}を闇ダメージとして与え、ドレッドカースを1スタック追加する。{duration}秒間、スタックごとにそのタンクがナイスラクシスから受けるダメージが{perStackNormal}増加し、最大{max}スタックまで蓄積する。',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseHeroicSummary': '{every}秒ごとに、ナイスラクシスは現在のタンクへ最大体力の{hitHeroic}を闇ダメージとして与え、ドレッドカースを1スタック追加する。{duration}秒間、スタックごとにそのタンクがナイスラクシスから受けるダメージが{perStackHeroic}増加し、最大{max}スタックまで蓄積する。',
  'hudChrome.raidBossGuide.nythraxis.dreadCurseResponse': 'タンクは{stacks}スタックで交代する：もう一方のタンクが挑発し、呪われたタンクはスタックが消えるまでグレイブブレイカーの扇形範囲外に留まる。ヒーラーは交代前に次のタンクへ備える。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeName': '骨の棘',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeSummary': '{everyNormal}秒ごとに、ナイスラクシスは現在の対象以外のレイドメンバー{victimsNormal}人を骨の棘で串刺しにする。串刺しにされたレイドメンバーは行動不能になり、棘が破壊されるまで毎秒最大体力の{drainNormal}を失う。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeHeroicSummary': '{everyHeroic}秒ごとに、ナイスラクシスは現在の対象以外のレイドメンバー{victimsHeroic}人を骨の棘で串刺しにする。串刺しにされたレイドメンバーは行動不能になり、棘が破壊されるまで毎秒最大体力の{drainHeroic}を失う。',
  'hudChrome.raidBossGuide.nythraxis.boneSpikeResponse': 'ダメージディーラーは直ちに骨の棘へ切り替え、破壊して串刺しにされたレイドメンバーを解放する。ヒーラーは棘が壊されるまで串刺しにされた者を生かし続ける。',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionName': '墓所の噴出',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionSummary': '{everyNormal}秒ごとに、骸骨の手がレイドメンバーの足元に{radius}ヤードの円を{countNormal}個描く。{warning}秒後、各円は最大体力の{burstNormal}を闇ダメージとして噴出させ、その後{flameNormal}秒間墓炎として燃え続け、中に立つ者へ毎秒最大体力の{tickNormal}を与える。',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionHeroicSummary': '{everyHeroic}秒ごとに、骸骨の手がレイドメンバーの足元に{radius}ヤードの円を{countHeroic}個描く。{warning}秒後、各円は最大体力の{burstHeroic}を闇ダメージとして噴出させ、その後{flameHeroic}秒間墓炎として燃え続け、中に立つ者へ毎秒最大体力の{tickHeroic}を与える。',
  'hudChrome.raidBossGuide.nythraxis.graveEruptionResponse': '噴出する前にすべての警告円から外へ出て、燃える地面を避け続ける。タンクはナイスラクシスを炎から引き離し、近接が動ける余地を確保する。',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilName': '拘束の印',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilSummary': '{everyNormal}秒ごとに、旧き結界の印がナイスラクシスから{minDist}から{maxDist}ヤードの床に光り、彼は不死の高揚を開始し、{ascensionEvery}秒ごとにダメージと攻撃速度が{ascensionNormal}上昇していく。{bindNormal}秒以内に印の上に立てば拘束状態になる：高揚は解除され、{stunNormal}秒間スタンし、{boundNormal}秒間受けるダメージが{vulnerability}増加する。立たなければレイド全員が最大体力の{unboundHitNormal}を闇ダメージとして受け、彼は次の拘束まで{unboundBonusNormal}多いダメージを保つ。',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilHeroicSummary': '{everyHeroic}秒ごとに、旧き結界の印がナイスラクシスから{minDist}から{maxDist}ヤードの床に光り、彼は不死の高揚を開始し、{ascensionEvery}秒ごとにダメージと攻撃速度が{ascensionHeroic}上昇していく。{bindHeroic}秒以内に印の上に立てば拘束状態になる：高揚は解除され、{stunHeroic}秒間スタンし、{boundHeroic}秒間受けるダメージが{vulnerability}増加する。立たなければレイド全員が最大体力の{unboundHitHeroic}を闇ダメージとして受け、彼は次の拘束まで{unboundBonusHeroic}多いダメージを保つ。',
  'hudChrome.raidBossGuide.nythraxis.bindingSigilResponse': 'タンクはレイドが残した炎の中であっても、直ちにナイスラクシスを印の上へ引きずり込む。近接はその移動に追従し、遠隔は新しいグレイブブレイカーの扇形範囲を避ける。拘束されている間は全員で総攻撃を加える。',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenName': '死者蘇生',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenSummary': '玉座の段階では、{every}秒ごとにナイスラクシスは背後で蘇った王家の衛兵を呼び起こす。彼らは現在の対象へ突進し、倒されるまで戦い続ける。',
  'hudChrome.raidBossGuide.nythraxis.raiseFallenResponse': 'オフタンクは湧いた衛兵を都度確保する。ダメージディーラーは骨の棘の合間に衛兵を掃討し、玉座の段階が終わる前に波が積み重ならないようにする。',
  'hudChrome.raidBossGuide.nythraxis.soulRendSummary': 'ナイスラクシスは現在の対象以外のレイドメンバー{marksNormal}人にソウルレンドの印を付ける。{fuse}秒後、各印は対象者の最大体力の全量を闇ダメージとして与え、その者から{range}ヤード以内にいる印を受けたレイドメンバーの人数で分割される。',
  'hudChrome.raidBossGuide.nythraxis.soulRendHeroicSummary': 'ナイスラクシスは現在の対象以外のレイドメンバー{marksHeroic}人にソウルレンドの印を付ける。{fuse}秒後、各印は対象者の最大体力の{damageHeroic}を闇ダメージとして与え、その者から{range}ヤード以内にいる印を受けたレイドメンバーの人数で分割される。単独で発動した印は致命的となる。',
  'hudChrome.raidBossGuide.nythraxis.soulRendResponse': '印を受けたレイドメンバーは全員、{fuse}秒の導火線が尽きる前に集合地点へ走り、他の印から{range}ヤード以内に立つ。ヒーラーは印が発動する際にグループの体力を満たしておく。',
  'hudChrome.raidBossGuide.nythraxis.soulfireName': 'ソウルファイア',
  'hudChrome.raidBossGuide.nythraxis.soulfireSummary': 'ソウルレンドが発動するたびに、各印があった場所に半径{radius}ヤードの紫色の炎の水たまりが残り、{seconds}秒間、毎秒最大体力の{tickNormal}のダメージを与えながら燃え続ける。水たまりが重なる場所ではそれぞれから1回ずつダメージを受ける。水たまりはウォードストーンから{clearance}ヤード以内には出現しない。',
  'hudChrome.raidBossGuide.nythraxis.soulfireHeroicSummary': 'ソウルレンドが発動するたびに、重なり合った印の集団ごとに半径{radius}ヤードの紫色の炎の水たまりが1つだけ残り、{secondsHeroic}秒間、毎秒最大体力の{tickHeroic}のダメージを与えながら燃え続ける。水たまりが重なっても受けるダメージは1回分だけで、重複しない。水たまりはウォードストーンから{clearance}ヤード以内には出現しない。',
  'hudChrome.raidBossGuide.nythraxis.soulfireResponse': '印が発動したらすぐに紫色の水たまりから離れる。次の集合地点は燃えている炎から離れた場所を選ぶこと。',
  'hudChrome.raidBossGuide.nythraxis.gravefireName': '紫炎',
  'hudChrome.raidBossGuide.nythraxis.gravefireSummary': '{everyNormal}秒ごとに、ナイスラクシスからレイドメンバーへ向けて紫炎の線が伸びていき、毎秒{speed}ヤードずつ{length}ヤードまで伸びる。伸びた地点はそれぞれ{burnNormal}秒間燃え続け、中に立つ者へ毎秒最大体力の{tickNormal}を与える。',
  'hudChrome.raidBossGuide.nythraxis.gravefireHeroicSummary': '{everyHeroic}秒ごとに、ナイスラクシスからレイドメンバーへ向けて紫炎の線が伸びていき、毎秒{speed}ヤードずつ{length}ヤードまで伸びる。伸びた地点はそれぞれ{burnHeroic}秒間燃え続け、中に立つ者へ毎秒最大体力の{tickHeroic}を与える。',
  'hudChrome.raidBossGuide.nythraxis.gravefireResponse': '線が迫ってきたら横に避ける：幅は狭く、曲がることはない。遠隔レイドメンバーは一箇所に留まらず動き続ける。',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageName': '不死の憤怒',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageSummary': '{every}秒ごとに、ナイスラクシスは{cast}秒かけて不死の憤怒を詠唱する。詠唱中、点火された各ウォードストーンは1人のレイドメンバーが{channel}秒かけて詠唱できる。詠唱終了前に3人がそれぞれ別のウォードストーンを完了させれば、憤怒は中断され、ナイスラクシスは{stun}秒間スタンする。完了しなければレイド全員が最大体力の{damageNormal}を闇ダメージとして受ける。',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageHeroicSummary': '{every}秒ごとに、ナイスラクシスは{cast}秒かけて不死の憤怒を詠唱する。詠唱中、点火された各ウォードストーンは1人のレイドメンバーが{channel}秒かけて詠唱できる。詠唱終了前に3人がそれぞれ別のウォードストーンを完了させれば、憤怒は中断され、ナイスラクシスは{stun}秒間スタンする。完了しなければレイド全員が最大体力の{damageHeroic}を闇ダメージとして受け、これに耐えられる体力は存在しない。',
  'hudChrome.raidBossGuide.nythraxis.deathlessRageResponse': '開始前に各ウォードストーンへ担当者を1人ずつ割り当てる。詠唱が始まったら、各担当者は自分の石へ走り、完了するまで詠唱を続ける。スタン、石から離れること、死亡は詠唱を中断させるため、担当者を安全に保ち、串刺しにされているレイドメンバーを割り当てないこと。',
  'hudChrome.raidBossGuide.nythraxis.courtName': '不死の宮廷',
  'hudChrome.raidBossGuide.nythraxis.courtSummary': '英雄では、前回の不死の宮廷が倒れていれば、中断の有無にかかわらず不死の憤怒のたびにナイスラクシスは新たな廷臣たちを呼び起こす。オルドレンの魂は王家の斬撃で対象付近の全員を斬りつける。マルリックの魂はマルリックの治癒を詠唱し、詠唱するたびにナイスラクシスの回復量を増やしていく。ヴォスの魂は挑発を無視してレイドを狩る。',
  'hudChrome.raidBossGuide.nythraxis.courtResponse': 'タンクはオルドレンを確保し、斬撃をレイドから逸らす。マルリックの治癒が始まった瞬間にマルリックをスタンかサイレンスで止め、最優先で倒す。続いて、挑発が効かないヴォスをヒーラーから引き離すよう根縛りかスタンで止め、次に倒す。',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathName': '王の怒り',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathSummary': 'ナイスラクシスは以後戦闘終了まで、通常で{bonusNormal}、英雄で{bonusHeroic}多いダメージを与える。墓所の噴出は{eruptionEveryNormal}秒ごと（英雄は{eruptionEveryHeroic}秒ごと）、紫炎は{gravefireEveryNormal}秒ごと（英雄は{gravefireEveryHeroic}秒ごと）に発生する。',
  'hudChrome.raidBossGuide.nythraxis.kingsWrathResponse': '回避できないダメージには残っている防御クールダウンを使う。戦闘を終えるまで、それまでのメカニクスを引き続き丁寧に処理する。',
  'hudChrome.raidBossGuide.nythraxis.boneStormName': '骨の嵐',
  'hudChrome.raidBossGuide.nythraxis.boneStormSummary': '王の怒りの開始から{first}秒後、以降{everyNormal}秒ごとに、ナイスラクシスは{duration}秒間骨の嵐を始める。彼はヘイトを無視し、通常の{speed}倍の速度で移動し、それぞれ{chargeSeconds}秒続く突進を{charges}回行う。彼の旋風は{radius}ヤード以内へ毎秒最大体力の{whirlNormal}を与える。各突進の終わりには同じ範囲内で骨の一撃が発生し、最大体力の{slamNormal}を与える。嵐が始まってから{spikeAt}秒後に骨の棘を詠唱し、嵐が終わってから{rearm}秒後にグレイブブレイカーが再び使用可能になる。',
  'hudChrome.raidBossGuide.nythraxis.boneStormHeroicSummary': '王の怒りの開始から{first}秒後、以降{everyHeroic}秒ごとに、ナイスラクシスは{duration}秒間骨の嵐を始める。彼はヘイトを無視し、通常の{speed}倍の速度で移動し、それぞれ{chargeSeconds}秒続く突進を{charges}回行う。彼の旋風は{radius}ヤード以内へ毎秒最大体力の{whirlHeroic}を与える。各突進の終わりには同じ範囲内で骨の一撃が発生し、最大体力の{slamHeroic}を与える。嵐が始まってから{spikeAt}秒後に骨の棘を詠唱し、嵐が終わってから{rearm}秒後にグレイブブレイカーが再び使用可能になる。',
  'hudChrome.raidBossGuide.nythraxis.boneStormResponse': '散開し、ナイスラクシスから走って逃げ続ける。突進の対象になったレイドメンバーは走って逃げ、他の全員は突進経路の周囲に空間を空ける。嵐が終わったらタンクが確保する。',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresName': '王冠不滅',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresSummary': '開始から{enrageNormal}秒で（体力70%でアルドリック修道士が登場する間は時間が止まる）、王冠不滅がハードエンレイジとして発動する。ナイスラクシスは{damage}多いダメージと{haste}速い攻撃速度を得て、その後は{rampEveryNormal}秒ごとにさらに{rampStep}のダメージを得ていく。タイマーバーは表示されない。警告は残り{warn60}秒、{warn30}秒、{warn10}秒の時点で叫びとして発せられる。',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresHeroicSummary': '開始から{enrageHeroic}秒で（体力70%でアルドリック修道士が登場する間は時間が止まる）、王冠不滅がハードエンレイジとして発動する。ナイスラクシスは{damage}多いダメージと{haste}速い攻撃速度を得て、その後は{rampEveryHeroic}秒ごとにさらに{rampStep}のダメージを得ていく。タイマーバーは表示されない。警告は残り{warn60}秒、{warn30}秒、{warn10}秒の時点で叫びとして発せられる。',
  'hudChrome.raidBossGuide.nythraxis.crownEnduresResponse': '最初の警告を最後の全力攻撃の合図として扱う。残りのメカニクスに備えて移動と防御のクールダウンを温存し、エンレイジ前にナイスラクシスを倒す。',
  ...
  'entities.itemSets.bramblehide.name': 'ルーツのブランブルハイド',
  'entities.itemSets.bramblehide.bonus2': '筋力が10、スタミナが10上昇します。',
  'entities.itemSets.bramblehide.bonus4': '攻撃力が25上昇します。武器のクリティカルヒット時に50%の確率で「グレイブマイト」が発動し、攻撃力が10秒間40上昇します。',
  'entities.itemSets.bramblehide.bonus6': '攻撃速度と詠唱速度が4%、命中が3%上昇します。武器のクリティカルヒットで対象に「ボーンスプリンター」を刻み、2秒ごとに5ダメージの出血を12秒間与えます。最大3回まで累積します。',
  'entities.items.bramblehide_crown.name': 'ルーツのブランブルハイドの冠',
  'entities.items.bramblehide_mantle.name': 'ルーツのブランブルハイドの肩当て',
  'entities.items.bramblehide_harness.name': 'ルーツのブランブルハイドの胴当て',
  'entities.items.bramblehide_cinch.name': 'ルーツのブランブルハイドの帯',
  'entities.items.bramblehide_legguards.name': 'ルーツのブランブルハイドの脚甲',
  'entities.items.bramblehide_grips.name': 'ルーツのブランブルハイドの握り',
  'entities.items.bramblehide_treads.name': 'ルーツのブランブルハイドの靴',
  'entities.items.courtiers_bonefang.name': '廷臣の骨牙',
  'entities.items.thornpeak_wardblade.name': 'ソーンピークの守護刃',
  'entities.items.gravecourt_hewer.name': '墓廷の斬斧',
  'entities.items.votive_ward_of_the_deathless_court.name': '不死の宮廷の奉納の盾',
  'entities.items.thornpeak_moonhide_cowl.name': 'ソーンピークの月皮のフード',
  'entities.items.stormhymn_chain_grips.name': '嵐の賛歌の鎖の握り',
  'entities.items.stormhymn_chain_treads.name': '嵐の賛歌の鎖の靴',
  ...
  'hudChrome.bank.guildHistoryTab': '履歴',
  'hudChrome.bank.logShowing': 'ギルド銀行の操作 {count} 件を新しい順に表示しています。',
  'hudChrome.bank.logFilterAria': 'ギルド銀行の履歴を絞り込む',
  'hudChrome.bank.logFilterAll': 'すべて',
  'hudChrome.bank.logFilterItems': 'アイテム',
  'hudChrome.bank.logFilterMoney': 'お金',
  'hudChrome.bank.logOlder': '以前の履歴を表示',
  'hudChrome.bank.logOlderLoading': '以前の操作を読み込んでいます...',
  'hudChrome.bank.logEnd': 'これがギルド銀行の全履歴です。',
  'hudChrome.bank.logEmptyFiltered': 'この絞り込みに一致するギルド銀行の操作はありません。',
  'hudChrome.bank.logColTime': '日時',
  'hudChrome.bank.logColMember': 'メンバー',
  'hudChrome.bank.logColAction': '操作',
  'hudChrome.bank.logColDetail': '詳細',
  'hudChrome.bank.logActionDeposit': '預けた',
  'hudChrome.bank.logActionWithdraw': '引き出した',
  'hudChrome.bank.logActionBuySlots': '拡張を購入した',
  'hudChrome.bank.logActionOpenBank': '銀行を開設した',
  'hudChrome.bank.logActionCharterFee': '設立費用を支払った',
  'hudChrome.bank.logActionAdminPurge': '削除した',
  'hudChrome.bank.logActorAdmin': '管理者',
  'hudChrome.bank.logDetailItem': '{item} x{count}',
  'hudChrome.bank.logSearchPlaceholder': 'この履歴を検索',
  'hudChrome.bank.logSearchAria': '読み込み済みのギルド銀行の操作をメンバー、操作、アイテムで検索',
  'hudChrome.bank.logShowingMatched': '読み込み済みのギルド銀行の操作 {count} 件のうち {matched} 件を表示しています。',
  'hudChrome.bank.logSearchNoMatch': '検索に一致する読み込み済みの操作はありません。以前の履歴を表示して範囲を広げてください。',
  ...
  'hudChrome.riftForge.refused': '炉に拒まれました。リフトライトのそばに立ってやり直してください。',
  'hudChrome.riftForge.reason.notFound': 'そのリングはカバンにありません。',
  'hudChrome.riftForge.reason.notRiftGear': '炉にかけられるのはリフトバウンドリングだけです。',
  'hudChrome.riftForge.reason.maxUpgrade': 'そのリングは強化しきっています。',
  'hudChrome.riftForge.reason.insufficientEssence': 'リフトのエッセンスが足りません。',
  'hudChrome.riftForge.reason.invalidGem': 'そのリフトの宝石を持っていません。',
  'hudChrome.riftForge.reason.dead': '死亡中はできません。',
  ...
  'sim.rift.forgeGemReplaced': '{name} のリフトの宝石を交換しました。{gem} は破壊されました。',
  ...
  'hudChrome.finder.mech.dread_curse': 'ドレッドカース（タンク交代用の累積デバフ、2スタックで交代）',
  'hudChrome.finder.mech.bone_spike': '骨の棘（串刺しにされた者は棘が壊れるまで体力を失う）',
  'hudChrome.finder.mech.grave_eruption': '墓所の噴出（燃える地面を残す警告円）',
  'hudChrome.finder.mech.binding_sigil': '拘束の印（ボスを印の上へ引きずり込まないとレイドが代償を払う）',
  ...
  'hudChrome.finder.mech.deathless_court': '不死の宮廷（英雄限定、不死の憤怒の後に王家の廷臣が蘇る）',
  ...
  'guide.riftsPage.forgeHeading': 'リフトの炉',
  'guide.riftsPage.forgeBody':
    'ランク付きリフトの初回踏破で鋳造されるリングは、受け取った時点では完成していません。ファーショアのウォッチメドウ、カモメ港から岸を上った破れの学者の隣で炉を守るリフトライトのマエリスが、アイテムレベルを一段ずつ引き上げ、リフトが落とす色とりどりの宝石をソケットにはめ込んでくれます。宝石の色はそれぞれひとつの戦闘レーティングです。ソケットが埋まったリングは新しい宝石を最も古いものと入れ替えるので、あとから調整し直せます。その代価はすべてリフトのエッセンスとリフトの宝石。リフトのボスから落ち、自由に取引できる炉の通貨なので、足りないぶんは仲間から分けてもらえます。持ち込む前にリングは外しておきましょう。彼女が扱うのはカバンの中のものだけで、しかも彼女の炉のそばに立っていなければ何もしてくれません。',
  ...
  'hudChrome.auraEffect.nythraxisKingsWrath': '王の怒り：ナイスラクシスの与えるダメージが、以後戦闘終了まで{pct}%増加する。',
  'hudChrome.auraEffect.nythraxisBoneStorm': '骨の嵐：ナイスラクシスはヘイトを無視し、{radius}ヤード以内へ毎秒最大体力の{tick}%の旋風ダメージを与えながらレイドに突進する。散開して走れ。',
  'hudChrome.auraEffect.nythraxisCrownEndures': '王冠不滅：{stacks}スタック、ダメージが{pct}%、攻撃速度が{haste}%上昇。レイドに残された時間はない。',
