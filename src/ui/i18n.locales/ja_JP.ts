...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.weapons': '武器コレクション',
  'hudChrome.wocStore.empty': '現在利用できる武器外見はありません。',
  'hudChrome.wocStore.weaponCosmetic': '武器外見',
  'hudChrome.wocStore.purchaseAria': '{item}を{cost} Claudiumで購入',
  'hudChrome.wocStore.owned': '所有済み',
  'hudChrome.wocStore.ownedAria': '{item}はすでに所有しています',
  ...
  'hudChrome.wocStore.usdApprox': '約{usd}米ドル',
