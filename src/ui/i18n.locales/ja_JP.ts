...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.keybinds.battleground': 'バトルグラウンド（グレイヴマーチ）',
  'hudChrome.bg.zoneName': 'グレイヴマーチ',
  'hudChrome.bg.teamA': 'エンバー中隊',
  'hudChrome.bg.teamB': 'ペイル中隊',
  'hudChrome.bg.mobileLabel': '戦場',
  'hudChrome.bg.indicator.queued': 'グレイヴマーチ待機中',
  'hudChrome.bg.indicator.queuedDetail': '{position} 番目、待ち時間 {time}',
  'hudChrome.bg.indicator.queuedAria':
    'グレイヴマーチ待機中：{position} 番目、待ち時間 {time}。バトルグラウンドを開く。',
  'hudChrome.bg.indicator.live': 'グレイヴマーチで戦闘進行中',
  'hudChrome.bg.indicator.liveDetail': '{time}、{killsA} 対 {killsB}',
  'hudChrome.bg.indicator.liveAria':
    'グレイヴマーチで戦闘が進行中：{time}、{killsA} 対 {killsB}。バトルグラウンドを開いて観戦。',
  'hudChrome.bg.indicator.watch': '観戦',
  'hudChrome.bg.window.title': 'バトルグラウンド',
  'hudChrome.bg.window.subtitle': 'グレイヴマーチ：二本の道、四つの防塁、一つのウォーストーン。',
  'hudChrome.bg.window.close': 'バトルグラウンドを閉じる',
  'hudChrome.bg.window.offlineNote':
    '陣営はまだ集結中。レルムに接続するとバトルグラウンドが開きます。',
  'hudChrome.bg.window.enterQueue': 'グレイヴマーチに参加',
  'hudChrome.bg.window.leaveQueue': 'キューを離れる',
  'hudChrome.bg.window.queued': '{position} 番目、待ち時間 {time}（{count} 名集結）',
  'hudChrome.bg.window.queueNote':
    'すべての戦士は戦場標準のレベルとクラス既定ビルドで戦います。ソロで並ぶか、最大五人のパーティをリーダーが率いて並びます。',
  'hudChrome.bg.window.partyNote': '{count} 人のパーティがまとめてキューに入ります。',
  'hudChrome.bg.window.leaderNote': 'パーティをキューに入れられるのはリーダーだけです。',
  'hudChrome.bg.window.deserter': '脱走者の弔鐘があなたに鳴っています。{time} 後に再び並べます。',
  'hudChrome.bg.window.inMatch': '戦いは始まっている。',
  'hudChrome.bg.window.liveHeading': '進行中の戦い',
  'hudChrome.bg.window.matchLine':
    '{teamA} {killsA} 対 {teamB} {killsB}、{time}、{players} 名交戦中',
  'hudChrome.bg.window.watch': '観戦',
  'hudChrome.bg.window.watchAria': '進行中の戦いを観戦（{time}）',
  'hudChrome.bg.window.noLive': '今は戦いがありません。',
  'hudChrome.bg.window.practice': 'グレイヴマーチで練習',
  'hudChrome.bg.window.practiceNote':
    '訓練されたボットの全隊を集め、道を覚えましょう。練習戦はレートに影響しません。',
  'hudChrome.bg.spectate.stop': '観戦をやめる',
  'hudChrome.bg.hud.knellUp': '弔鐘の番人が立っている',
  'hudChrome.bg.hud.knellSpawns': '弔鐘の番人まで {time}',
  'hudChrome.bg.hud.knellSilenced': '{team}が弔鐘を沈黙させた、{seconds}秒',
  'hudChrome.bg.hud.stripAria': '{teamA} {killsA}、{teamB} {killsB}、残り {time}',
  'hudChrome.bg.hud.countdownTitle': '死者が隊列を組む',
  'hudChrome.bg.hud.respawnTitle': 'あなたは倒れた。',
  'hudChrome.bg.hud.respawnSub': '戦場はまだあなたを離さない。',
  'hudChrome.bg.hud.returning': '{seconds} 秒後に世界へ帰還',
  'hudChrome.bg.banner.found': 'グレイヴマーチに戦いが集う！',
  'hudChrome.bg.banner.countdown': '戦闘開始まで {seconds} 秒…',
  'hudChrome.bg.banner.start': '軍旗が揚がる。戦え！',
  'hudChrome.bg.banner.bulwarkWestOuter': '{team}の西路外側の防塁が落ちた。',
  'hudChrome.bg.banner.bulwarkWestInner': '{team}の西路内側の防塁が落ちた。',
  'hudChrome.bg.banner.bulwarkEastOuter': '{team}の東路外側の防塁が落ちた。',
  'hudChrome.bg.banner.bulwarkEastInner': '{team}の東路内側の防塁が落ちた。',
  'hudChrome.bg.banner.warstoneDown': '{team}のウォーストーンが砕かれた！',
  'hudChrome.bg.banner.knell': '{team}が弔鐘を沈黙させた！',
  'hudChrome.bg.banner.warstoneThreat': '味方のウォーストーンが攻撃されている！',
  'hudChrome.bg.log.queued': 'グレイヴマーチのキューに入りました（{position} 番目）。',
  'hudChrome.bg.log.unqueued': 'グレイヴマーチのキューを離れました。',
  'hudChrome.bg.log.roster': '{team}が集結：{allies} 対 {enemies}。',
  'hudChrome.bg.log.kill': '{killer} が {victim} を討ち取った！',
  'hudChrome.bg.log.down': 'あなたは倒れた。{seconds} 秒後にウォーストーンへ送り返されます。',
  'hudChrome.bg.end.win': '勝利！敵のウォーストーンは砕かれた。',
  'hudChrome.bg.end.loss': '敗北。味方のウォーストーンは砕かれた。',
  'hudChrome.bg.end.draw': '戦場は静まり返った。引き分け。',
  'hudChrome.bg.end.rating': 'レート {rating}（{delta}）。',
  'hudChrome.bg.err.level10': 'グレイヴマーチに参加するにはレベル 10 以上が必要です。',
  'hudChrome.bg.err.deserter': '脱走者の弔鐘が鳴っている間はキューに入れません。',
  ...
  'guide.bgPage.intro':
    'グレイヴマーチは五対五のバトルグラウンド。二つの中隊が蘇った兵の縦隊を二本の古道に進ませ、敵の塔を砕き、敵軍を歩ませ続けるウォーストーンを打ち砕きます。どこからでも並べて、あとは戦場が整えてくれます。',
  'guide.bgPage.storyHeading': '眠らぬ戦場',
  'guide.bgPage.storyBody':
    '墓ワームの聖所の下に広がるレヴナントの野には、ソーンピークを攻めた最後の軍の先鋒が眠っています。夕暮れごとに古い戦が目を覚まし、灰燼の闘技場の守り手たちは、軍旗を掲げた者がその死者を統べることを見出しました。こうして闘技場は戦争遊戯を認可したのです：グレイヴマーチでは誰も本当には死なない。戦場そのものがそれを拒むのだから。',
  'guide.bgPage.companiesHeading': '二つの中隊、それぞれの旗',
  'guide.bgPage.companiesBody':
    '戦士はエンバー中隊かペイル中隊の旗を掲げます。ソロでもパーティでも並べば、戦場が五人の中隊に編成します。陣営は闘技場と同じく一時的なもの：恒久的な勢力はなく、対人戦は常に自分で選ぶものです。',
  'guide.bgPage.fairNote':
    'グレイヴマーチは設計から公平です。すべての戦士が戦場標準のレベルとクラス既定ビルドで戦うため、勝負を決めるのは装備やレベルではなく腕前です。',
  'guide.bgPage.fieldHeading': '戦場を読む',
  'guide.bgPage.fieldBody':
    '二つの本拠の間には、西の盾の道、東の槍の道、その間に崩れた塚地が広がり、中心には壊れた鐘の礼拝堂が立ちます。図式マップには道、塔、味方、そして弔鐘が示されます。',
  'guide.bgPage.roadsTitle': '二本の道',
  'guide.bgPage.roadsBody':
    '骨まといの亡霊の縦隊が各道を敵本拠へと進みます。立ちはだかる者と戦い、防備を叩く。縦隊とともに進むことが、地を取るということです。',
  'guide.bgPage.bulwarksTitle': '防塁',
  'guide.bgPage.bulwarksBody':
    'それぞれの道は重厚な塔の守り手が見張り、各中隊に外側と内側の一基ずつ。守るべき者をいじめる戦士を罰し、外側が落ちるまで内側には触れられません。道を一本こじ開ければ、敵のウォーストーンは裸になります。',
  'guide.bgPage.knellTitle': '弔鐘',
  'guide.bgPage.knellBody':
    '礼拝堂にはこの軍を起こした鐘、弔鐘と、その番人たる弔鐘の番人が待ちます。番人を討った中隊は弔鐘をしばし沈黙させ、その縦隊はいっそう猛く進軍します。',
  'guide.bgPage.deathHeading': 'グレイヴマーチに倒れる',
  'guide.bgPage.deathBody':
    '戦場は死を拒みます。倒れた戦士はしばし退場し、やがて自軍のウォーストーンで目覚めます。目覚めは少しずつ遅くなりますが、死体回収はなく、失うものもありません。代価は戦場を離れる時間だけです。',
  'guide.bgPage.watchHeading': '戦いを観る',
  'guide.bgPage.watchBody':
    'レルムで進行中の戦いはどれでも観戦できます。ミニマップ脇のバッジが戦いを知らせ、バトルグラウンドウィンドウには各試合と観戦ボタンが並びます。観戦者は中隊とともに移動し、試合表示を見ながら、いつでも観戦をやめられます。',
  'guide.bgPage.ladderHeading': 'ラダー',
  'guide.bgPage.ladderBody':
    'レート戦のグレイヴマーチは闘技場と同じく独自の順位を持ちます。バトルグラウンドウィンドウにはレート、戦績、オンラインのレート戦士のラダーが表示されます。ボットが補充した試合はレート対象外で、オフライン練習も同様です。',
};
