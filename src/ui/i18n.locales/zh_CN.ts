...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.eyebrow': '精选系列',
  'hudChrome.wocStore.featuredTitle': '边疆之外锻造的武器',
  'hudChrome.wocStore.featuredBody': '使用 Claudium 获取高级武器外观。外观物品不会改变战斗能力。',
  'hudChrome.wocStore.balance': 'Claudium 余额',
  'hudChrome.wocStore.buyClaudium': '购买 Claudium',
  'hudChrome.wocStore.category': '外观物品',
  'hudChrome.wocStore.weapons': '武器系列',
  'hudChrome.wocStore.empty': '目前没有可用的武器外观。',
  'hudChrome.wocStore.weaponCosmetic': '武器外观',
  'hudChrome.wocStore.purchaseAria': '用 {cost} Claudium 购买 {item}',
  'hudChrome.wocStore.owned': '已拥有',
  'hudChrome.wocStore.ownedAria': '已拥有 {item}',
  ...
  'hudChrome.wocStore.usdApprox': '约 {usd} 美元',
