...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': '静音',
  'hudChrome.playerMenu.unmute': '取消静音',
  ...
  'hudChrome.social.mutedSection': '已静音',
  'hudChrome.social.blockedSection': '已屏蔽',
  'hudChrome.social.stopMutingTitle': '取消对 {name} 的静音',
