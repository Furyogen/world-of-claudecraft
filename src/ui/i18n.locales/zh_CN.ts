...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.howto':
    '冲过城堡试炼:躲开链锤,穿过转木,算准巨斧,踏上吊桥,躲开滚石。第一个冲线者夺得王冠。摔落只会耽误时间。',
  ...
  'hudChrome.hc.section.flail_bridge': '链锤桥',
  'hudChrome.hc.section.log_court': '转木广场',
  'hudChrome.hc.section.axe_walk': '巨斧回廊',
  'hudChrome.hc.section.drawspan': '升降吊桥',
  'hudChrome.hc.section.boulder_alley': '滚石巷',
  ...
  'guide.hodricsCastlePage.courseHeading': '试炼赛道',
  'guide.hodricsCastlePage.courseBody':
    '赛道从起点广场出发,穿过链锤桥、转木广场、巨斧回廊、升降吊桥、滚石巷,最后沿赤红坡道冲向终点主堡。每个机关都按自己固定的节奏摆动、旋转或滚动,绝非随机,细心观察总能找到安全的时机。',
  ...
  'guide.hodricsCastlePage.fallsBody':
    '被机关击中或跌入深渊,只会送你回到上一个检查点。没人会死在这条通道上:摔落唯一的代价就是追赶失去的那几秒。',
  'guide.hodricsCastlePage.standingsHeading': '王冠',
  'guide.hodricsCastlePage.standingsBody':
    '第一个冲过终点线的人夺得那场比赛的霍德里克王冠。你的参赛次数、胜场与最佳成绩会随着每次参赛不断累积。',
