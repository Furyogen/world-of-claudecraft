...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.duskmane_prowler.name': '暮鬃潜行兽',
  'entities.mobs.glasscarab.name': '玻璃甲虫',
  'entities.mobs.duneblade_marauder.name': '沙丘之刃劫掠者',
  'entities.mobs.karesh_the_parched.name': '焦渴者卡雷什',
  'entities.mobs.vigil_sentinel.name': '守夜哨卫',
  'entities.mobs.sunbaked_revenant.name': '日炙亡魂',
  'entities.mobs.ashen_courtier.name': '灰烬廷臣',
  'entities.mobs.sunspeaker_atharis.name': '太阳代言人阿塔里斯',
  'entities.mobs.emberveil_zealot.name': '烬纱狂热者',
  'entities.mobs.emberveil_pyromancer.name': '烬纱炎术师',
  'entities.mobs.cinder_elemental.name': '烬火元素',
  'entities.mobs.moltenheart_colossus.name': '熔心巨像',
  'entities.mobs.cinder_wisp.name': '烬火幽光',
  'entities.mobs.ember_of_korzul.name': '初烬',
  'entities.npcs.caravan_master_saffa.name': '商队总管萨法',
  'entities.npcs.caravan_master_saffa.title': '最后之井的守护者',
  'entities.npcs.caravan_master_saffa.greeting':
    '在这里，水是唯一的钱币，朋友。高望派我们来精打细算地花——而这片荒原一心想让我们破产。',
  'entities.npcs.scout_maren_wastes.name': '玛伦斥候',
  'entities.npcs.scout_maren_wastes.title': '元帅的斥候',
  'entities.npcs.scout_maren_wastes.greeting':
    '我在泥沼湿地追过泥泞，也在荆峰高地踏过雪。沙子更糟。沙子记得你走过的每一步。',
  'entities.npcs.loremaster_caddis_wastes.name': '凯迪斯博学者',
  'entities.npcs.loremaster_caddis_wastes.title': '沉没王冠学者',
  'entities.npcs.loremaster_caddis_wastes.greeting':
    '扎凯斯一夜之间倾覆，{playerName}——整整一个王国，话说到一半就熔成了玻璃。我等了一辈子，就想听完那半句话。',
  'entities.npcs.brother_aldric_wastes.name': '奥德里克修士',
  'entities.npcs.brother_aldric_wastes.title': '山谷牧师',
  'entities.npcs.brother_aldric_wastes.greeting':
    '墓龙的热度连这里都在渗透，{playerName}——隔着靴底我都能感觉到。不管邪教在那片玻璃里挖什么，绝不能让他们带回去。',
  'entities.npcs.old_haruk.name': '老哈鲁克',
  'entities.npcs.old_haruk.title': '心泉守望者',
  'entities.npcs.old_haruk.greeting':
    '早在这眼泉水需要人看守之前，我家就世代守着它了。九位国王饮过泉水。第十位却想把它一口喝干。',
  'entities.npcs.provisioner_ashka.name': '补给官阿什卡',
  'entities.npcs.provisioner_ashka.title': '商队补给官',
  'entities.npcs.provisioner_ashka.greeting':
    '薄饼、椰枣酒，还有没泡过尸体的清水。全荒原最好的货色。',
  'entities.npcs.forgemaster_derin.name': '锻造大师德林',
  'entities.npcs.forgemaster_derin.title': '商队铁匠',
  'entities.npcs.forgemaster_derin.greeting':
    '炉膛里是沙，淬火桶里是沙，牙缝里还是沙。这份怨气全打进了刀刃——反倒更锋利了。',
  'entities.npcs.auctioneer_zeph.name': '拍卖师泽夫',
  'entities.npcs.auctioneer_zeph.title': '世界市场管理人',
  'entities.npcs.auctioneer_zeph.greeting':
    '世界市场连最后之井都能触及，朋友。金子在哪片沙漠里都一样沉。',
  'entities.npcs.wellwatch_hana.name': '井卫哈娜',
  'entities.npcs.wellwatch_hana.title': '商队卫士',
  'entities.npcs.wellwatch_hana.greeting': '带着水进来，带着水出去。中间发生的一切，都归我管。',
  'entities.npcs.wellwatch_toma.name': '井卫托马',
  'entities.npcs.wellwatch_toma.title': '商队卫士',
  'entities.npcs.wellwatch_toma.greeting': '安静的一班岗。在这儿，“安静”只是说沙子嚼得慢了些。',
  'entities.npcs.drover_pell.name': '驮夫佩尔',
  'entities.npcs.drover_pell.title': '骡队驮夫',
  'entities.npcs.drover_pell.greeting': '骡子先喝水。商队的规矩。你要想跟骡子讲道理，请自便。',
  'entities.npcs.dowser_emrys.name': '寻水者埃姆里斯',
  'entities.npcs.dowser_emrys.title': '寻水人',
  'entities.npcs.dowser_emrys.greeting':
    '我的探水杖在瀑布那儿弯成了两折，可方圆四十里再没别处有反应。这片土地离坟场，只差一眼泉水。',
  'entities.quests.q_sw_arrival.title': '最后之井',
  'entities.quests.q_sw_arrival.text':
    '欢迎来到地图的尽头，{playerName}。高望管这趟行动叫“南方远征”；我管它叫四十条人命和一眼泉水。别的都往后放——先取水。去营地以北的心泉水池灌满四只水囊，好让我知道通往瀑布的这条线走得安全。',
  'entities.quests.q_sw_arrival.completion':
    '清冽、干净，你身上也没插着箭——这是最后之井整季听到的最好的消息。',
  'entities.quests.q_sw_arrival.objectives.0.label': '满溢水囊',
  'entities.quests.q_sw_prowlers.title': '暮色之牙',
  'entities.quests.q_sw_prowlers.text':
    '暮鬃兽已经听熟了我们水车的声音，{playerName}。每到黄昏它们就逼近一分，昨夜一头竟连着挽具把一头骡子拖走了。去营地以南的骨风平原削减兽群，带八张兽皮回来，证明这一课它们记住了。',
  'entities.quests.q_sw_prowlers.completion':
    '八张皮，桩线边就少了八道影子。骡子们总算能睡了——比我睡得还多。',
  'entities.quests.q_sw_prowlers.objectives.0.label': '击败暮鬃潜行兽',
  'entities.quests.q_sw_prowlers.objectives.1.label': '暮鬃兽皮',
  'entities.quests.q_sw_carrion_glass.title': '食腐之玻',
  'entities.quests.q_sw_carrion_glass.text':
    '驮夫们管它们叫玻璃甲虫——猎犬那么大的甲虫，壳是熔成的玻璃，正从东边的焦地里成群涌出。德林发誓那壳能把刀刃磨得比任何磨石都利。敲碎八只甲虫，带回六只完整的壳；小心壳上的亮光，那说明它们正在硬化。',
  'entities.quests.q_sw_carrion_glass.completion':
    '瞧瞧这刃口的光！德林欠我一辈子的磨刀钱，而东边的路欠你一段更安静的旅程。',
  'entities.quests.q_sw_carrion_glass.objectives.0.label': '击败玻璃甲虫',
  'entities.quests.q_sw_carrion_glass.objectives.1.label': '玻璃甲虫壳',
  'entities.quests.q_sw_lost_caravan.title': '沙丘所藏',
  'entities.quests.q_sw_lost_caravan.text':
    '有三辆货车没能抵达水井，{playerName}——粮食、工具，还有赶头车的人，我妹妹的丈夫。风暴把它们吹散在西南的沙丘里。找到残骸，仔细搜一遍。我需要货单来清点损失……我还得知道，有没有人活着走了出去。',
  'entities.quests.q_sw_lost_caravan.completion':
    '靴印朝着远离残骸的方向延伸——然后就只剩劫掠者的足迹了。他们把车夫活着带走了。那要么是慈悲，要么是算计，而在这片荒原上，我知道该赌哪一个。',
  'entities.quests.q_sw_lost_caravan.objectives.0.label': '已搜查货车残骸',
  'entities.quests.q_sw_marauders.title': '水税',
  'entities.quests.q_sw_marauders.text':
    '沙丘之刃管这叫收税：要么交水，要么流血，见面即付。他们在沙丘西南的洼地里扎着营，围着我们被抢的篝火，喝着我们被抢的水囊。打垮他们，{playerName}。放倒十个劫掠者，再带回五只水囊——那一张张皮革里装的，是我们的人命。',
  'entities.quests.q_sw_marauders.completion':
    '你带回的每一只水囊，都是这口井边有人多活的一天。沙丘之刃会记住向我们收税的代价。',
  'entities.quests.q_sw_marauders.objectives.0.label': '击败沙丘之刃劫掠者',
  'entities.quests.q_sw_marauders.objectives.1.label': '失窃水囊',
  'entities.quests.q_sw_karesh.title': '焦渴之王',
  'entities.quests.q_sw_karesh.text':
    '他们的头目自封“焦渴者卡雷什”——他喝干了自己的蓄水池，还往残渣里撒盐，免得对手跟上来。一个能对自家水井下此狠手的人，对我们的井只会更狠。他在西面山脊下的卡雷什洼地里称王。终结他的统治，{playerName}，再把他私藏的最后一只水囊带回来。',
  'entities.quests.q_sw_karesh.completion':
    '这就是焦渴之王的最后一囊水了。萨法会把它倒回井里——一滴不少，这是原则。',
  'entities.quests.q_sw_karesh.objectives.0.label': '击败焦渴者卡雷什',
  'entities.quests.q_sw_karesh.objectives.1.label': '卡雷什的最后水囊',
  'entities.quests.q_sw_survey.title': '未竟之句',
  'entities.quests.q_sw_survey.text':
    '既然水井暂时用不上你——就陪我走一趟历史吧，{playerName}。太阳王庭留下了壁画：一幅在渡槽之脊下，一幅在平顶山脚，还有一幅在绿洲废墟的双塔旁。把三幅都拓下来。扎凯斯死在半句话上，而我打算读完剩下的半句。',
  'entities.quests.q_sw_survey.completion':
    '看——句子接上了：“当王冠烫得再也戴不住时，诸王登上平顶山，把火焰还了回去。”一场弃绝之仪，借方尖碑而行——先晨，再午，后暮。这顺序很要紧，{playerName}。仪式向来讲究顺序。',
  'entities.quests.q_sw_survey.objectives.0.label': '已拓取壁画',
  'entities.quests.q_sw_vigil_dawn.title': '守夜之仪：晨',
  'entities.quests.q_sw_vigil_dawn.text':
    '营地以西的平顶山正是“守夜台”本身——诸王的弃绝之路。晨曦方尖碑立在第一层台地上，那是太阳最先照到的地方。攀上盘山道，把手按上去。晨曦最先苏醒；壁画对这一点相当固执。',
  'entities.quests.q_sw_vigil_dawn.completion':
    '你感到它在嗡鸣了？妙极。两个纪元过去，仪式的力量竟还在。晨已点亮——午在上方等着。',
  'entities.quests.q_sw_vigil_dawn.objectives.0.label': '从方尖碑取得晨火印记',
  'entities.quests.q_sw_vigil_noon.title': '守夜之仪：午',
  'entities.quests.q_sw_vigil_noon.text':
    '正午加冕于峰顶——第二座方尖碑立在平顶山的最高处，在那里，太阳独占整片天空。攀登本身就是仪式的一部分，{playerName}：诸王当年是顶着王冠一步一步爬上去的。去唤醒正午方尖碑。',
  'entities.quests.q_sw_vigil_noon.completion':
    '先晨，后午。仪式只剩最后一个时辰了——而守夜台已经开始注意到我们。',
  'entities.quests.q_sw_vigil_noon.objectives.0.label': '从方尖碑取得午火印记',
  'entities.quests.q_sw_vigil_dusk.title': '守夜之仪：暮',
  'entities.quests.q_sw_vigil_dusk.text':
    '黄昏总是最后一个到场——它的方尖碑立在西面的山嘴上，俯瞰峡谷。但你要明白这仪式的本质，{playerName}：弃绝，必须有见证。王庭以活的山岩铸了一尊哨卫来作见证，当暮火点亮，它便会醒来，审判你是真心弃绝，还是只想索取。说服它。彻底地说服。',
  'entities.quests.q_sw_vigil_dusk.completion':
    '哨卫判定你配得上——或者判定你杀不死，对一块石头来说，这是同一个结论。守夜之仪已成，扎凯斯的每一扇门，如今都成了值得一问的问题。',
  'entities.quests.q_sw_vigil_dusk.objectives.0.label': '黄昏方尖碑已唤醒',
  'entities.quests.q_sw_vigil_dusk.objectives.1.label': '击败守夜哨卫',
  'entities.quests.q_sw_revenants.title': '死者的岗哨',
  'entities.quests.q_sw_revenants.text':
    '扎凯斯的士兵从没听说战争打输了——更没听说战争只打了一夜。他们在瀑布以北的外城废墟里游荡，甲胄熔进了骨头，向过路人索要早已无人记得的口令。送十二个亡魂安息，{playerName}，再收集他们的卫队印信；有了印，我们才能进到城市更深处。',
  'entities.quests.q_sw_revenants.completion':
    '每一枚印信都还是温的——至死效忠，死后犹然。维系他们岗哨的东西还在更深处，而现在，我们的官阶比它高了。',
  'entities.quests.q_sw_revenants.objectives.0.label': '击败日炙亡魂',
  'entities.quests.q_sw_revenants.objectives.1.label': '王冠卫队之印',
  'entities.quests.q_sw_courtiers.title': '灰烬王庭',
  'entities.quests.q_sw_courtiers.text':
    '再往深处，王庭本身仍在开庭——内侍与诵经士守着一位死去国王的礼制，对着一座熔渣王座诵读诗篇。他们的诗篇集里记着圣殿的礼文，而礼文里藏着点燃王冠火盆的仪式。去搅散这场朝会，{playerName}，给我带回一本书页完好的诗篇集。',
  'entities.quests.q_sw_courtiers.completion':
    '哦，这可是绝妙的手笔——整套火盆仪轨，出自一位死去领唱人的笔下。他们对着一座空王座，把它唱了两百年。我几乎要可怜他们了。几乎。',
  'entities.quests.q_sw_courtiers.objectives.0.label': '击败灰烬廷臣',
  'entities.quests.q_sw_courtiers.objectives.1.label': '灰烬诗篇',
  'entities.quests.q_sw_braziers.title': '燃起的王冠',
  'entities.quests.q_sw_braziers.text':
    '诗篇在诸塔之间点出了三座王冠火盆——三座齐燃，内圣殿便会自行开启，一如当年的加冕礼。我已把仪文用粉笔抄在了你的护手上，{playerName}；尽量别出汗。先把丑话说在前头：点亮的王冠，是看得见的王冠。第三簇火苗燃起的那一刻，全城的东西都会知道。',
  'entities.quests.q_sw_braziers.completion':
    '我们在井边看着塔楼一座接一座亮起——萨法哭了，而我承认，这回我没教训任何人。圣殿的门开了。里面有什么东西，正在唱和。',
  'entities.quests.q_sw_braziers.objectives.0.label': '已点燃王冠火盆',
  'entities.quests.q_sw_sunspeaker.title': '第十次加冕',
  'entities.quests.q_sw_sunspeaker.text':
    '圣殿里的声音属于太阳代言人阿塔里斯——扎凯斯九王皆由他加冕。诗篇称他为王庭活着的记忆，而他用两个纪元筹备着第十次加冕：为火焰本身加冕。他就站在双塔之间的太阳王座前。废黜他，{playerName}，赶在他完成一场全沙漠都会后悔的仪式之前。',
  'entities.quests.q_sw_sunspeaker.completion':
    '九顶王冠，他戴上了九个额头；而第十顶，本要烧尽整个世界才戴得下。史书将记载：是你宣布扎凯斯王庭休庭。我会亲自盯着史书，一字不差地这么写。',
  'entities.quests.q_sw_sunspeaker.objectives.0.label': '太阳代言人阿塔里斯已被废黜',
  'entities.quests.q_sw_emberveil.title': '烬纱',
  'entities.quests.q_sw_emberveil.text':
    '你已经见过东边崖沿那些蒙纱的营地了，{playerName}。他们是龙教——一支分裂出来的教派，自称烬纱，趁高望死盯着圣所大门时翻过了山口。母教高歌着要唤醒墓龙，这一支却在挖东西，想武装它。他们的狂热者和炎术师正把那片玻璃翻了个遍。趁他们还没找到，削减他们的人手。',
  'entities.quests.q_sw_emberveil.completion':
    '那片玻璃里少了十六把铲子。可挖掘昼夜不停——他们已经不是在找了，{playerName}。他们是在开掘。',
  'entities.quests.q_sw_emberveil.objectives.0.label': '击败烬纱狂热者',
  'entities.quests.q_sw_emberveil.objectives.1.label': '击败烬纱炎术师',
  'entities.quests.q_sw_writs.title': '烬纱教令',
  'entities.quests.q_sw_writs.text':
    '他们的头目身上带着教令——用母教密文写就的指令。那套密文我在高望破解过一次，在这里就能再破解一次。给我带来五份烬纱教令，{playerName}，我们就能读到他们被派来取的究竟是什么。',
  'entities.quests.q_sw_writs.completion':
    '正如我所惧。“寻回初烬——诸太阳王窃取并锁住的、主上之火的碎片。将它送至圣所之门；封印绝不会容忍出自它自身的火焰。”他们要用墓龙自己被窃的火，烧开墓龙的门，{playerName}。',
  'entities.quests.q_sw_writs.objectives.0.label': '烬纱教令',
  'entities.quests.q_sw_glasscut.title': '天空燃烧之地',
  'entities.quests.q_sw_glasscut.text':
    '玻璃裂谷正是初烬坠落之处——就在它毁灭扎凯斯的那一夜。地面至今滚烫，烬火元素在那里游走，像一簇簇从未落地的火星。初烬正在苏醒，{playerName}；邪教挖得越近，它的火星就越胆大。驱散八个元素，再给我带来五枚活烬。我必须掂一掂我们将要面对的这团火。',
  'entities.quests.q_sw_glasscut.completion':
    '泡在祝福过的盐里，它们还在扭动……这是龙火，如今再无可疑。初烬不是遗物，{playerName}，它是残躯——科祖尔怒火上活生生的一块，而且它还记得自己曾被当作王冠佩戴。',
  'entities.quests.q_sw_glasscut.objectives.0.label': '击败烬火元素',
  'entities.quests.q_sw_glasscut.objectives.1.label': '活烬',
  'entities.quests.q_sw_offering.title': '心泉不忘',
  'entities.quests.q_sw_offering.text':
    '牧师打算直面那团火，还要带上你。那就先听一句守井人的智慧吧，{playerName}：心泉自墓龙牢狱的正下方涌起，而从一物之下流过的水，最了解那一物。带上我的供碗，去瀑布顶端的水池，倾倒，然后聆听。这眼泉水曾经溺熄过这团火。去讨火烧之前，先让泉水祝福你。',
  'entities.quests.q_sw_offering.completion':
    '你也听见了——深处的水，在世界之下流动。把那声音当铠甲穿上吧，{playerName}。火焰喧嚣，可泉水先于它存在，也会在它熄灭之后长存。',
  'entities.quests.q_sw_offering.objectives.0.label': '已在心泉倾倒供品',
  'entities.quests.q_sw_first_ember.title': '初烬',
  'entities.quests.q_sw_first_ember.text':
    '它出土了，{playerName}。邪教的矿坑在黎明破开，玻璃裂谷从内部亮起——初烬立在它两个纪元前砸出的坑里，把火焰穿成一身王袍，烬纱信徒成排朝它跪拜。一旦它抵达圣所之门，高望流过的每一滴血都将化为灰烬。你身上有泉水的祝福，也有守夜台的见证。下到玻璃里去，替扎凯斯写完那半句话：火焰，还回去。',
  'entities.quests.q_sw_first_ember.completion':
    '它死去的那一刻，瀑布骤然湍急明亮——那是泉水，把宿敌收入水底。你做到了九位国王没能做到的事，{playerName}：你把火还了回去。坐下吧，喝口水。今晚的水最甜。',
  'entities.quests.q_sw_first_ember.objectives.0.label': '初烬已被熄灭',
  'entities.quests.q_sw_afterglow.title': '水归生者',
  'entities.quests.q_sw_afterglow.text':
    '哈鲁克说，泉水如今唱低了一个音，像一笔还清的债。烬纱或成灰或远遁，王庭已休庭，我的账本上终于是水多过愁。最后一件事，{playerName}——在营地里走一圈，让玛伦、凯迪斯和奥德里克修士好好向你道一声谢。他们挣得了这个机会，你也一样。',
  'entities.quests.q_sw_afterglow.completion':
    '那么一切都结束了，最后之井也终于只是……一口井。若是这个老商队头儿说了还算数，它将是一条活路上众多水井中的第一口。灼热荒原会记住你的名字，{playerName}——水记得一切。',
  'entities.quests.q_sw_afterglow.objectives.0.label': '已与玛伦斥候交谈',
  'entities.quests.q_sw_afterglow.objectives.1.label': '已与凯迪斯博学者交谈',
  'entities.quests.q_sw_afterglow.objectives.2.label': '已与奥德里克修士交谈',
  ...
  'entities.items.ashen_psalter.name': '灰烬诗篇',
  'entities.items.brimming_waterskin.name': '满溢水囊',
  'entities.items.cactus_pressed_water.name': '仙人掌榨水',
  'entities.items.caravan_guard_mail.name': '商队卫士锁甲',
  'entities.items.caravan_manifest.name': '水渍货单',
  'entities.items.cinder_soaked_veil.name': '浸烬面纱',
  'entities.items.crown_brazier.name': '王冠火盆',
  'entities.items.crown_guard_seal.name': '王冠卫队之印',
  'entities.items.duneblade_token.name': '沙丘之刃令牌',
  'entities.items.duneforged_warblade.name': '沙丘锻造战刃',
  'entities.items.dunewatch_sash.name': '沙丘守望腰带',
  'entities.items.duskmane_pelt.name': '暮鬃兽皮',
  'entities.items.emberbound_leggings.name': '缚烬护腿',
  'entities.items.emberglass_scepter.name': '烬玻权杖',
  'entities.items.emberveil_writ.name': '烬纱教令',
  'entities.items.glasscarab_shell.name': '玻璃甲虫壳',
  'entities.items.glasscut_dirk.name': '玻璃裂谷匕首',
  'entities.items.heart_of_the_first_ember.name': '初烬之心',
  'entities.items.heartspring_offering.name': '心泉供碗',
  'entities.items.kareshs_last_skin.name': '卡雷什的最后水囊',
  'entities.items.lastwell_datewine.name': '最后之井椰枣酒',
  'entities.items.living_cinder.name': '活烬',
  'entities.items.moltenheart_girdle.name': '熔心束带',
  'entities.items.moltenheart_slagcore.name': '熔心渣核',
  'entities.items.mural_rubbing.name': '壁画拓片',
  'entities.items.parched_kings_goblet.name': '焦渴之王的酒杯',
  'entities.items.prowler_fang.name': '潜行兽獠牙',
  'entities.items.sentinel_core_stone.name': '哨卫核心石',
  'entities.items.springheart_blessing.name': '心泉祝福',
  'entities.items.stolen_waterskin.name': '失窃水囊',
  'entities.items.sunbaked_flatbread.name': '日烤薄饼',
  'entities.items.sunbleached_bone.name': '日晒白骨',
  'entities.items.sunbleached_staff.name': '日晒法杖',
  'entities.items.sunglass_shard.name': '阳玻碎片',
  'entities.items.sunspeakers_ash_crown.name': '太阳代言人的灰烬之冠',
  'entities.items.vestment_of_the_sunken_crown.name': '沉没王冠法衣',
  'entities.items.vigil_obelisk_dawn.name': '晨火印记',
  'entities.items.vigil_obelisk_dusk.name': '暮火印记',
  'entities.items.vigil_obelisk_noon.name': '午火印记',
  'entities.items.wastes_relic_cache.name': '太阳王庭遗物箱',
