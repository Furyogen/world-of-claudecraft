...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': '潮汐之门',
  'entities.zones.atlantis.name': '亚特兰蒂斯',
  'entities.zones.atlantis.welcome': '穹顶仍在歌唱，亚特兰蒂斯在底潮之下生生不息。',
  'entities.zones.atlantis.pois.0.label': '亚特兰蒂斯',
  'entities.zones.atlantis.pois.1.label': '潮门广场',
  'entities.zones.atlantis.pois.2.label': '流明之冠',
  'entities.zones.atlantis.pois.3.label': '珍珠集市',
  'entities.zones.atlantis.pois.4.label': '沉没档案馆',
  'entities.zones.atlantis.pois.5.label': '巨藻卫者附楼',
  'entities.mobs.glimmerfin_eel.name': '闪鳍鳗',
  'entities.mobs.pearlshell_skitterer.name': '珠壳疾行蟹',
  'entities.mobs.kelpshade_lurker.name': '藻影潜伏者',
  'entities.mobs.undertow_maw.name': '底潮巨口',
  'entities.npcs.keeper_nerissa.name': '守护者奈瑞莎',
  'entities.npcs.keeper_nerissa.title': '流明之冠守卫',
  'entities.npcs.keeper_nerissa.greeting': '当心这层玻璃，水面来客。它撑过了一个时代——帮我们让它继续撑下去。',
  'entities.npcs.tidewright_ollo.name': '潮匠奥洛',
  'entities.npcs.tidewright_ollo.title': '珍珠集市潮匠',
  'entities.npcs.tidewright_ollo.greeting': '深渊里最后几座干燥蒸馏器的新货。先付钱，后听故事。',
