...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.gauntlet.eventClosedNote': '赛事目前未开放，队列与观战暂时关闭。练习随时开放。',
  'hudChrome.gauntlet.practicePickTitle': '选择要练习的项目',
  'hudChrome.gauntlet.practiceFull': '完整试炼回廊',
  'hudChrome.gauntlet.trialNames.sentinel': '哨卫横渡',
  'hudChrome.gauntlet.trialNames.sigils': '糖玻璃符印',
  'hudChrome.gauntlet.trialNames.pull': '拔河大赛',
  'hudChrome.gauntlet.trialNames.echo': '看守人的回响',
