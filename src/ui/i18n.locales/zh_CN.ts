...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.skillTracker.managerButtonOnAria': '技能管理器已开启。关闭后将隐藏所有追踪框和条。',
  'hudChrome.skillTracker.managerButtonOffAria': '技能管理器已关闭。开启后可选择要追踪的法术。',
  'hudChrome.skillTracker.lockButton': '锁定',
  'hudChrome.skillTracker.lockButtonOnAria': '追踪框已锁定。解锁后可拖动。',
  'hudChrome.skillTracker.lockButtonOffAria': '追踪框已解锁。锁定后将固定位置。',
  'hudChrome.skillTracker.managerHint': '选择要在目标上追踪的法术。已追踪 {count} 个。',
  'hudChrome.skillTracker.displayOn': '开',
  'hudChrome.skillTracker.displayOff': '关',
  'hudChrome.skillTracker.displayAria': '追踪{name}',
  'hudChrome.skillTracker.typeSquare': '方块',
  'hudChrome.skillTracker.typeBar': '条',
  'hudChrome.skillTracker.typeAria': '{name}的追踪样式：{type}',
  'hudChrome.skillTracker.tooltipTarget': '在你的目标身上',
  'hudChrome.skillTracker.tooltipSelf': '在你身上',
  'hudChrome.skillTracker.tooltipCooldown': '冷却',
  'hudChrome.skillTracker.dragHandle': '拖动以移动追踪框',
  'hudChrome.skillTracker.groupSquares': '法术追踪图标',
  'hudChrome.skillTracker.groupBars': '法术追踪条',
