...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.gauntlet.survivorsAria': '{total} 人中还有 {count} 人存活',
  'hudChrome.gauntlet.prizeAria': '奖金池:{amount}',
  ...
  'hudChrome.gauntlet.phaseTrialWager': '看守人的赌局开始',
  ...
  'hudChrome.gauntlet.even': '双',
  'hudChrome.gauntlet.wagerWon': '你赢下了这场对决。',
  'hudChrome.gauntlet.wagerLost': '你输掉了这场对决。',
