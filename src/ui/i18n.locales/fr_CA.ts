...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.recovery.body': "Définissez une adresse e-mail afin de pouvoir récupérer votre compte. Nous l’utilisons seulement pour confirmer que ce compte vous appartient si vous devez réinitialiser votre mot de passe.",
  ...
  'entities.quests.q_old_cragmaw.completion': "Enfin abattu. Les gens de la montagne juraient que ce chat survivrait au mur lui-même. Les traqueurs resteront dans leurs hautes neiges maintenant, {playerName}, et mes patrouilles marcheront sur la route sans y saigner. Toute la crête est plus calme grâce à ton travail.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Vieux Cragmaw tué",
  'entities.quests.q_old_cragmaw.text': "Les gens de la montagne ont donné un nom aux traces trouvées par mon éclaireuse : Vieux Cragmaw, un tyran félin au pelage balafré qui a survécu à trois générations de sa propre meute. C’est pour lui que les traqueurs envahissent ma route, {playerName}. Son antre se trouve sur la crête ouest au-dessus de la route du sud. Amène un ami et abats ce vieux démon.",
  'entities.quests.q_old_cragmaw.title': "Vieux Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Dix bonnes peaux, épaisses comme toutes celles que j’ai... non, regarde ça, {playerName}. Déchirées, la moitié, et par aucune lame ni lance. Des marques de griffes larges comme ma main, au travers du pelage d’hiver. Quelque chose sur cette crête massacre les siens.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Peau de traqueur de crête",
  'entities.quests.q_stalker_cloaks.text': "Huit peaux doublaient les capes des officiers, et maintenant chaque soldat sur le mur veut la même chose, {playerName}. Ils ont raison : l’hiver prend les doigts en premier, et les excuses ne tiennent pas chaud. Dix autres peaux des crêtes au sud de la porte, et toute la garde dormira au chaud.",
  'entities.quests.q_stalker_cloaks.title': "Des capes pour la garde",
  'entities.quests.q_stalkers_return.completion': "Quatorze de plus, et mes patrouilles comptent encore des traces fraîches au matin. Mon éclaireuse est revenue de la haute crête blanche comme la ligne des neiges : des empreintes grandes comme un bouclier, dit-elle, et de vieilles proies qu’aucun traqueur ne laisserait. Ce qui marche là-haut n’est pas un chat ordinaire.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Traqueur de crête tué",
  'entities.quests.q_stalkers_return.text': "Douze morts, et la crête grouille plus encore que le jour où tu as commencé, {playerName}. Les bêtes ne se jettent pas contre un mur par faim. Quelque chose sur la haute crête les pousse vers le bas, et tant que je ne saurai pas quoi, l’abattage continue. Quatorze de plus.",
  ...
  'hudChrome.discord.roleTag.admin': "Administrateur",
  ...
  'hudChrome.targetFrame.lock': "Verrouiller le cadre de cible",
  'hudChrome.targetFrame.unlock': "Déplacer le cadre de cible",
