...
export const fr_CA: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.email': "E-mail",
  'auth.emailError': "Saisissez une adresse e-mail valide.",
  ...
  'auth.recovery.failed': "Saisissez une adresse e-mail e.",
  'auth.recovery.invalid': "Saisissez une adresse e-mail valide.",
  ...
  'entities.quests.q_old_cragmaw.completion': "Enfin tombé. Les rôdeurs retourneront aux hautes neiges, {playerName}, et mes patrouilles marcheront sans saigner. La crête est plus calme grâce à vous.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Vieux Cragmaw abattu",
  'entities.quests.q_old_cragmaw.text': "Les montagnards ont nommé les traces : Vieux Cragmaw. Sa tanière se trouve sur la crête ouest au-dessus de la route du sud, {playerName}. Prenez un allié et abattez la vieille bête.",
  'entities.quests.q_old_cragmaw.title': "Vieux Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Dix bonnes peaux, mais beaucoup sont déchirées, {playerName}. Quelque chose sur cette crête attaque les siens.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Peau de rôdeur des crêtes",
  'entities.quests.q_stalker_cloaks.text': "Les soldats du mur ont besoin de capes chaudes, {playerName}. Rapportez dix peaux de rôdeurs des crêtes au sud de la porte.",
  'entities.quests.q_stalker_cloaks.title': "Des capes pour la garde",
  'entities.quests.q_stalkers_return.completion': "Quatorze de plus, et il y a encore des traces fraîches chaque matin. Ce qui marche là-haut n’est pas un félin ordinaire.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Rôdeur des crêtes abattu",
  'entities.quests.q_stalkers_return.text': "Douze morts et la crête reste pleine, {playerName}. Quelque chose pousse les bêtes vers le mur. Abattez-en quatorze de plus.",
  'entities.quests.q_stalkers_return.title': "Le retour des rôdeurs",
  ...
  'hudChrome.options.walkByAutoloot': "Butin auto au passage",
  'hudChrome.targetFrame.lock': "Verrouiller le cadre de cible",
  'hudChrome.targetFrame.unlock': "Déplacer le cadre de cible",
  'hudChrome.worldBoss.spawn': "{name} se dresse au-dessus de Thornpeak Heights!",
  ...
  'entities.mobs.thunzharr_stormling.name': "Tempête éveillée",
