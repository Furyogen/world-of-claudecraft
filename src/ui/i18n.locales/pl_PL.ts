...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[PL] Buy',
  'delveUi.shop.buyConfirmBody':
    '[PL] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[PL] Cancel',
  'delveUi.shop.buyConfirmTitle': '[PL] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[PL] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[PL] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[PL] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[PL] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[PL] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[PL] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[PL] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[PL] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[PL] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[PL] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[PL] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[PL] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[PL] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[PL] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[PL] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[PL] Frostgill Chowder',
  'entities.items.game_meat.name': '[PL] Game Meat',
  'entities.items.glass_vial.name': '[PL] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[PL] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[PL] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[PL] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[PL] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[PL] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[PL] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[PL] Homespun Cloth',
  'entities.items.homespun_hood.name': '[PL] Homespun Hood',
  'entities.items.homespun_mitts.name': '[PL] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[PL] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[PL] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[PL] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[PL] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[PL] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[PL] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[PL] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[PL] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[PL] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[PL] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[PL] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[PL] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[PL] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[PL] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[PL] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[PL] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[PL] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[PL] Prime Cut',
  'entities.items.pristine_hide.name': '[PL] Pristine Hide',
  'entities.items.pristine_silk.name': '[PL] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[PL] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[PL] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[PL] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[PL] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[PL] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[PL] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[PL] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[PL] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[PL] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[PL] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[PL] Smithing Flux',
  'entities.items.spider_silk.name': '[PL] Spider Silk',
  'entities.items.spool_of_thread.name': '[PL] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[PL] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[PL] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[PL] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[PL] Sunweave Treads',
  'entities.items.tanning_agent.name': '[PL] Tanning Agent',
  'entities.items.thorium_warblade.name': '[PL] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[PL] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[PL] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[PL] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[PL] Venom Gland',
  'entities.items.venomfire_elixir.name': '[PL] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[PL] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[PL] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[PL] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[PL] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[PL] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[PL] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[PL] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[PL] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[PL] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[PL] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[PL] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[PL] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[PL] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[PL] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[PL] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[PL] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[PL] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[PL] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[PL] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[PL] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[PL] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[PL] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[PL] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[PL] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[PL] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[PL] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[PL] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[PL] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[PL] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[PL] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[PL] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[PL] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[PL] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[PL] Buy',
  'heroicShop.buyConfirmBody':
    '[PL] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[PL] Cancel',
  'heroicShop.buyConfirmTitle': '[PL] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[PL] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[PL] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[PL] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[PL] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[PL] Enchanted',
  'hudChrome.crafting.makersMark': '[PL] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[PL] Masterwork',
  'hudChrome.crafting.masterworkToast': '[PL] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[PL] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[PL] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[PL] Station',
  'hudChrome.crafting.stationName.apothecary': '[PL] Apothecary',
  'hudChrome.crafting.stationName.forge': '[PL] Forge',
  'hudChrome.crafting.stationName.kitchens': '[PL] Kitchens',
  'hudChrome.crafting.stationName.loom': '[PL] Loom',
  'hudChrome.crafting.stationName.tannery': '[PL] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[PL] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[PL] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[PL] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[PL] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[PL] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[PL] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[PL] Cancel',
  'hudChrome.death.healerConfirmTitle': "[PL] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[PL] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[PL] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[PL] Professions',
  'hudChrome.options.showThirdActionBar': '[PL] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[PL] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[PL] Common cap',
  'hudChrome.professions.ceilingRare': '[PL] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[PL] No empowerment cap',
  'hudChrome.professions.close': '[PL] Close professions',
  'hudChrome.professions.ctaHeader': '[PL] Next step',
  'hudChrome.professions.ctaRaise':
    '[PL] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[PL] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[PL] Gathering',
  'hudChrome.professions.hobbyLabel': '[PL] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[PL] Identity',
  'hudChrome.professions.majorsLabel': '[PL] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[PL] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[PL] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[PL] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[PL] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[PL] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[PL] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[PL] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[PL] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[PL] Perks',
  'hudChrome.professions.returnsLabel': '[PL] Returns: {count}',
  'hudChrome.professions.ringAria': '[PL] Craft wheel',
  'hudChrome.professions.roleDormant': '[PL] Dormant',
  'hudChrome.professions.roleHobby': '[PL] Hobby',
  'hudChrome.professions.roleMajor': '[PL] Major',
  'hudChrome.professions.roleUnattuned': '[PL] Unattuned',
  'hudChrome.professions.skillValue': '[PL] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[PL] Craft skills',
  'hudChrome.professions.switchCost': '[PL] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[PL] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[PL] Tier {tier}',
  'hudChrome.professions.title': '[PL] Professions',
  'hudChrome.professions.tutorialLine':
    '[PL] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[PL] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[PL] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[PL] You cannot afford that training.',
  'hudChrome.training.close': '[PL] Close training',
  'hudChrome.training.dialogOption': '[PL] Training',
  'hudChrome.training.dialogOptionAria': '[PL] Browse training from {name}',
  'hudChrome.training.empty': '[PL] This master has nothing to teach.',
  'hudChrome.training.free': '[PL] Free',
  'hudChrome.training.learned': '[PL] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[PL] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[PL] You must be at the station to train.',
  'hudChrome.training.requirement': '[PL] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[PL] Known',
  'hudChrome.training.stateLocked': '[PL] Locked',
  'hudChrome.training.stateTeachable': '[PL] Available',
  'hudChrome.training.tierUnmet': '[PL] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[PL] Training: {name}',
  'hudChrome.training.trainAria': '[PL] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[PL] Legendary',
  'loading.reconnectingAttempt':
    '[PL] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[PL] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[PL] This is taking longer than usual. Check your internet connection.',
};
