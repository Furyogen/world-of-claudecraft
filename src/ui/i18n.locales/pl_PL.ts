...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'abilityUi.cast.gathering': '[PL] Gathering',
  'hud.errors.tradeBound': '[PL] That item is bound and cannot be traded.',
  'hud.social.status.afk': '[PL] Away',
  'stats.charactersCreated': '[PL] Characters Created',
  'entities.items.acolyte_chain_grips.name': '[PL] Acolyte Chain Grips',
  'entities.items.briarroot_staff.name': '[PL] Briarroot Staff',
  'entities.items.cragprowl_belt.name': '[PL] Cragprowl Belt',
  'entities.items.cragthorn_greatstaff.name': '[PL] Cragthorn Greatstaff',
  'entities.items.cragward_pauldrons.name': '[PL] Cragward Pauldrons',
  'entities.items.cryptbloom_shoulderguards.name': '[PL] Cryptbloom Shoulderguards',
  'entities.items.dreamroot_boots.name': '[PL] Dreamroot Boots',
  'entities.items.duskthorn_mantle.name': '[PL] Duskthorn Mantle',
  'entities.items.fenbark_leggings.name': '[PL] Fenbark Leggings',
  ...
  'entities.items.resonant_links.name': '[PL] Resonant Links',
  'entities.items.resonant_steel.name': '[PL] Resonant Steel',
  'entities.items.resonant_thread.name': '[PL] Resonant Thread',
  'entities.items.resonant_timber.name': '[PL] Resonant Timber',
  'entities.items.revenantstep_treads.name': '[PL] Revenantstep Treads',
  'entities.items.shardfang_grips.name': '[PL] Shardfang Grips',
  'entities.items.shardsong_mantle.name': '[PL] Shardsong Mantle',
  'entities.items.stormbark_mantle.name': '[PL] Stormbark Mantle',
  'entities.items.stormchant_gauntlets.name': '[PL] Stormchant Gauntlets',
  'entities.items.stormroot_cowl.name': '[PL] Stormroot Cowl',
  'entities.items.stormvotive_hauberk.name': '[PL] Stormvotive Hauberk',
  'entities.items.thornling_grips.name': '[PL] Thornling Grips',
  'entities.items.thornpeak_wildwraps.name': '[PL] Thornpeak Wildwraps',
  'entities.items.thunderward_legguards.name': '[PL] Thunderward Legguards',
  'entities.items.tidehymn_slippers.name': '[PL] Tidehymn Slippers',
  'entities.items.valefire_lantern.name': '[PL] Valefire Lantern',
  'entities.items.verdant_walkers.name': '[PL] Verdant Walkers',
  'entities.items.vestments_of_the_waking_grove.name': '[PL] Vestments of the Waking Grove',
  'entities.items.votive_chain_belt.name': '[PL] Votive Chain Belt',
  'entities.items.wildgrove_cinch.name': '[PL] Wildgrove Cinch',
  'entities.items.wildgrowth_leggings.name': '[PL] Wildgrowth Leggings',
  'entities.items.wildsoul_maul.name': '[PL] Wildsoul Maul',
  'entities.items.wyrmcult_spellgrips.name': '[PL] Wyrmcult Spellgrips',
  ...
  'entities.letters.mastery_reset_notice.sender': '[PL] The Guildhall',
  'entities.letters.mastery_reset_notice.subject': '[PL] Your craft, made honest',
  'entities.letters.prof_tier_alchemy_cooking_1.body':
    '[PL] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving.',
  'entities.letters.prof_tier_alchemy_cooking_1.sender': '[PL] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_1.subject': '[PL] A taste of things to come',
  'entities.letters.prof_tier_alchemy_cooking_2.body':
    '[PL] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long.',
  'entities.letters.prof_tier_alchemy_cooking_2.sender': '[PL] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_2.subject': '[PL] Rare work, and no burnt edges',
  'entities.letters.prof_tier_alchemy_cooking_3.body':
    '[PL] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting.',
  'entities.letters.prof_tier_alchemy_cooking_3.sender': '[PL] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_3.subject': '[PL] Now you are cooking',
  'entities.letters.prof_tier_alchemy_cooking_4.body':
    '[PL] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle.',
  'entities.letters.prof_tier_alchemy_cooking_4.sender': '[PL] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_4.subject': '[PL] One course from the feast',
  'entities.letters.prof_tier_alchemy_cooking_5.body':
    '[PL] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table.',
  'entities.letters.prof_tier_alchemy_cooking_5.sender': '[PL] Cook Marlow',
  'entities.letters.prof_tier_alchemy_cooking_5.subject': '[PL] Mastery, served hot',
  'entities.letters.prof_tier_engineering_alchemy_1.body':
    '[PL] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go.',
  'entities.letters.prof_tier_engineering_alchemy_1.sender': '[PL] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_1.subject': '[PL] FIRST spark, ha',
  'entities.letters.prof_tier_engineering_alchemy_2.body':
    '[PL] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA.',
  'entities.letters.prof_tier_engineering_alchemy_2.sender': '[PL] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_2.subject': '[PL] Rare, oh, RARE',
  'entities.letters.prof_tier_engineering_alchemy_3.body':
    '[PL] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses.',
  'entities.letters.prof_tier_engineering_alchemy_3.sender': '[PL] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_3.subject': '[PL] Now it gets loud',
  'entities.letters.prof_tier_engineering_alchemy_4.body':
    '[PL] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink.',
  'entities.letters.prof_tier_engineering_alchemy_4.sender': '[PL] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_4.subject': '[PL] One rung, ONE, from the top',
  'entities.letters.prof_tier_engineering_alchemy_5.body':
    '[PL] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous.',
  'entities.letters.prof_tier_engineering_alchemy_5.sender': '[PL] Tinker Gizzel',
  'entities.letters.prof_tier_engineering_alchemy_5.subject': '[PL] MASTERY, kaboom',
  'entities.letters.prof_tier_leatherworking_tailoring_1.body':
    '[PL] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully.',
  'entities.letters.prof_tier_leatherworking_tailoring_1.sender': '[PL] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_1.subject': '[PL] An even first row',
  'entities.letters.prof_tier_leatherworking_tailoring_2.body':
    '[PL] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased.',
  'entities.letters.prof_tier_leatherworking_tailoring_2.sender': '[PL] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_2.subject': '[PL] Rare work, well measured',
  'entities.letters.prof_tier_leatherworking_tailoring_3.body':
    '[PL] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice.',
  'entities.letters.prof_tier_leatherworking_tailoring_3.sender': '[PL] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_3.subject': '[PL] The pattern comes clear',
  'entities.letters.prof_tier_leatherworking_tailoring_4.body':
    '[PL] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now.',
  'entities.letters.prof_tier_leatherworking_tailoring_4.sender': '[PL] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_4.subject': '[PL] One row from the top',
  'entities.letters.prof_tier_leatherworking_tailoring_5.body':
    '[PL] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly.',
  'entities.letters.prof_tier_leatherworking_tailoring_5.sender': '[PL] Weaver Ottilie',
  'entities.letters.prof_tier_leatherworking_tailoring_5.subject': '[PL] The last stitch',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.body':
    '[PL] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.sender': '[PL] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_1.subject': '[PL] A spark worth noting',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.body':
    '[PL] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good.',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.sender': '[PL] Forgemistress Darva',
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_2.subject': '[PL] Rare work, and earned',
  ...
  'entities.letters.prof_tier_weaponcrafting_armorcrafting_5.subject': '[PL] Mastery, at last',
  'entities.quests.q_prof_amends_apothecary.completion':
    '[PL] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.',
  'entities.quests.q_prof_amends_apothecary.objectives.0.label': '[PL] Wild Boar hunted',
  'entities.quests.q_prof_amends_apothecary.text':
    '[PL] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.',
  'entities.quests.q_prof_amends_apothecary.title': '[PL] Back on the Stove',
  'entities.quests.q_prof_amends_bombardier.completion':
    '[PL] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?',
  'entities.quests.q_prof_amends_bombardier.objectives.0.label': '[PL] Tunnel Rat exterminated',
  'entities.quests.q_prof_amends_bombardier.text':
    '[PL] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.',
  'entities.quests.q_prof_amends_bombardier.title': '[PL] The Ledger Grows',
  'entities.quests.q_prof_amends_outfitter.completion':
    '[PL] Steady again. Leatherworking and Tailoring return to your hands as majors. Measure twice this time before you wander.',
  'entities.quests.q_prof_amends_outfitter.objectives.0.label': '[PL] Webwood Spider culled',
  'entities.quests.q_prof_amends_outfitter.text':
    '[PL] Back at my loom after all. I hold no grudge, {playerName}, but the thread remembers a hand that let it go, and the cost of taking it up again is measured out longer each time. Cull the webwood spiders crowding the western woods, and the labor will settle your hands before they touch good silk again.',
  'entities.quests.q_prof_amends_outfitter.title': '[PL] Threads Rejoined',
  'entities.quests.q_prof_amends_smith.completion':
    '[PL] The rhythm is back in your hands. Weaponcrafting and Armorcrafting are your majors once more. Do not make a habit of leaving.',
  'entities.quests.q_prof_amends_smith.objectives.0.label': '[PL] Forest Wolf slain',
  ...
  'entities.quests.q_prof_workorder_toolworks.objectives.0.label': '[PL] Ironbark Log delivered',
  'entities.quests.q_prof_workorder_toolworks.text':
    '[PL] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.',
  'entities.quests.q_prof_workorder_toolworks.title': '[PL] Toolworks Work Order',
  'hudChrome.bags.itemAriaInstanced': '[PL] {item}, quantity {count}, maker-marked copy',
  'hudChrome.charSheet.defense': '[PL] Defense',
  'hudChrome.charSheet.offense': '[PL] Offense',
  ...
  'hudChrome.crafting.tierTutorial.radar':
    '[PL] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.',
  ...
  'hudChrome.enchantName.enchant_chest_spirit': '[PL] Enchant Chest - Spirit',
  'hudChrome.enchantName.enchant_chest_stamina': '[PL] Enchant Chest - Stamina',
  'hudChrome.enchantName.enchant_feet_agility': '[PL] Enchant Boots - Agility',
  'hudChrome.enchantName.enchant_feet_stamina': '[PL] Enchant Boots - Stamina',
  'hudChrome.enchantName.enchant_feet_strength': '[PL] Enchant Boots - Strength',
  'hudChrome.enchantName.enchant_gloves_agility': '[PL] Enchant Gloves - Agility',
  'hudChrome.enchantName.enchant_gloves_greater_agility': '[PL] Enchant Gloves - Greater Agility',
  'hudChrome.enchantName.enchant_gloves_intellect': '[PL] Enchant Gloves - Spellpower',
  ...
  'hudChrome.enchantName.enchant_legs_intellect': '[PL] Enchant Legs - Intellect',
  'hudChrome.enchantName.enchant_legs_runed_hide': '[PL] Enchant Legs - Runed Hide',
  'hudChrome.enchantName.enchant_legs_stamina': '[PL] Enchant Legs - Stamina',
  'hudChrome.enchantName.enchant_neck_agility': '[PL] Enchant Necklace - Agility',
  'hudChrome.enchantName.enchant_neck_intellect': '[PL] Enchant Necklace - Intellect',
  'hudChrome.enchantName.enchant_neck_spirit': '[PL] Enchant Necklace - Spirit',
  'hudChrome.enchantName.enchant_ring_agility': '[PL] Enchant Ring - Agility',
  'hudChrome.enchantName.enchant_ring_intellect': '[PL] Enchant Ring - Intellect',
  'hudChrome.enchantName.enchant_ring_spirit': '[PL] Enchant Ring - Spirit',
  'hudChrome.enchantName.enchant_ring_strength': '[PL] Enchant Ring - Strength',
  'hudChrome.enchantName.enchant_shoulder_agility': '[PL] Enchant Shoulders - Agility',
  'hudChrome.enchantName.enchant_shoulder_intellect': '[PL] Enchant Shoulders - Intellect',
  'hudChrome.enchantName.enchant_shoulder_strength': '[PL] Enchant Shoulders - Strength',
  'hudChrome.enchantName.enchant_waist_agility': '[PL] Enchant Belt - Agility',
  'hudChrome.enchantName.enchant_waist_stamina': '[PL] Enchant Belt - Stamina',
  ...
  'hudChrome.enchanting.noTargets': '[PL] No eligible item to enchant.',
  'hudChrome.enchanting.notDisenchantable': '[PL] You cannot disenchant that.',
  ...
  'hudChrome.gathering.nodeName.ore': '[PL] Ore Vein',
  'hudChrome.gathering.nodeName.wood': '[PL] Timber Stand',
  'hudChrome.gathering.stateCooldown': '[PL] Respawning',
  'hudChrome.gathering.stateReady': '[PL] Ready',
  ...
  'hudChrome.interfaceTabs.general': '[PL] General',
  'hudChrome.itemMenu.applyEnchant': '[PL] Apply Enchant',
  'hudChrome.itemMenu.disenchant': '[PL] Disenchant',
  'hudChrome.itemMenu.equip': '[PL] Equip',
  'hudChrome.itemMenu.salvage': '[PL] Salvage',
  'hudChrome.itemMenu.use': '[PL] Use',
  ...
  'hudChrome.nameplate.afkTag': '[PL] AFK',
  'hudChrome.professions.nextUnlockMastered': '[PL] Mastered, for now',
  'hudChrome.social.hideOffline': '[PL] Hide offline',
  'hudChrome.social.hideOfflineTitle': '[PL] Hide offline guild members',
  'hudChrome.social.offlineHeader': '[PL] Offline ({n})',
  'hudChrome.social.onlineHeader': '[PL] Online ({n})',
  'hudChrome.townFocus.tierHint':
    '[PL] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.',
  'hudChrome.townFocus.townOnlyHint': '[PL] Focus can only be changed while you are in town.',
};
