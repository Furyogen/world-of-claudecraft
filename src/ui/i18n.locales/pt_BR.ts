...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[PT-BR] Buy',
  'delveUi.shop.buyConfirmBody':
    '[PT-BR] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[PT-BR] Cancel',
  'delveUi.shop.buyConfirmTitle': '[PT-BR] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[PT-BR] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[PT-BR] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[PT-BR] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[PT-BR] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[PT-BR] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[PT-BR] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[PT-BR] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[PT-BR] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[PT-BR] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[PT-BR] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[PT-BR] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[PT-BR] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[PT-BR] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[PT-BR] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[PT-BR] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[PT-BR] Frostgill Chowder',
  'entities.items.game_meat.name': '[PT-BR] Game Meat',
  'entities.items.glass_vial.name': '[PT-BR] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[PT-BR] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[PT-BR] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[PT-BR] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[PT-BR] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[PT-BR] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[PT-BR] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[PT-BR] Homespun Cloth',
  'entities.items.homespun_hood.name': '[PT-BR] Homespun Hood',
  'entities.items.homespun_mitts.name': '[PT-BR] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[PT-BR] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[PT-BR] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[PT-BR] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[PT-BR] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[PT-BR] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[PT-BR] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[PT-BR] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[PT-BR] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[PT-BR] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[PT-BR] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[PT-BR] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[PT-BR] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[PT-BR] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[PT-BR] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[PT-BR] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[PT-BR] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[PT-BR] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[PT-BR] Prime Cut',
  'entities.items.pristine_hide.name': '[PT-BR] Pristine Hide',
  'entities.items.pristine_silk.name': '[PT-BR] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[PT-BR] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[PT-BR] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[PT-BR] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[PT-BR] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[PT-BR] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[PT-BR] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[PT-BR] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[PT-BR] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[PT-BR] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[PT-BR] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[PT-BR] Smithing Flux',
  'entities.items.spider_silk.name': '[PT-BR] Spider Silk',
  'entities.items.spool_of_thread.name': '[PT-BR] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[PT-BR] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[PT-BR] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[PT-BR] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[PT-BR] Sunweave Treads',
  'entities.items.tanning_agent.name': '[PT-BR] Tanning Agent',
  'entities.items.thorium_warblade.name': '[PT-BR] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[PT-BR] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[PT-BR] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[PT-BR] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[PT-BR] Venom Gland',
  'entities.items.venomfire_elixir.name': '[PT-BR] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[PT-BR] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject':
    '[PT-BR] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[PT-BR] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[PT-BR] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[PT-BR] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[PT-BR] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[PT-BR] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[PT-BR] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[PT-BR] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[PT-BR] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[PT-BR] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[PT-BR] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[PT-BR] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[PT-BR] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[PT-BR] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[PT-BR] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[PT-BR] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[PT-BR] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[PT-BR] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[PT-BR] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[PT-BR] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[PT-BR] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[PT-BR] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[PT-BR] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[PT-BR] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[PT-BR] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[PT-BR] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[PT-BR] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[PT-BR] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[PT-BR] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[PT-BR] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[PT-BR] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[PT-BR] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[PT-BR] Buy',
  'heroicShop.buyConfirmBody':
    '[PT-BR] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[PT-BR] Cancel',
  'heroicShop.buyConfirmTitle': '[PT-BR] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[PT-BR] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[PT-BR] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[PT-BR] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[PT-BR] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[PT-BR] Enchanted',
  'hudChrome.crafting.makersMark': '[PT-BR] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[PT-BR] Masterwork',
  'hudChrome.crafting.masterworkToast': '[PT-BR] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[PT-BR] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[PT-BR] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[PT-BR] Station',
  'hudChrome.crafting.stationName.apothecary': '[PT-BR] Apothecary',
  'hudChrome.crafting.stationName.forge': '[PT-BR] Forge',
  'hudChrome.crafting.stationName.kitchens': '[PT-BR] Kitchens',
  'hudChrome.crafting.stationName.loom': '[PT-BR] Loom',
  'hudChrome.crafting.stationName.tannery': '[PT-BR] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[PT-BR] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[PT-BR] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[PT-BR] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[PT-BR] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[PT-BR] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[PT-BR] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[PT-BR] Cancel',
  'hudChrome.death.healerConfirmTitle': "[PT-BR] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[PT-BR] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[PT-BR] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[PT-BR] Professions',
  'hudChrome.options.showThirdActionBar': '[PT-BR] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[PT-BR] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[PT-BR] Common cap',
  'hudChrome.professions.ceilingRare': '[PT-BR] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[PT-BR] No empowerment cap',
  'hudChrome.professions.close': '[PT-BR] Close professions',
  'hudChrome.professions.ctaHeader': '[PT-BR] Next step',
  'hudChrome.professions.ctaRaise':
    '[PT-BR] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[PT-BR] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[PT-BR] Gathering',
  'hudChrome.professions.hobbyLabel': '[PT-BR] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[PT-BR] Identity',
  'hudChrome.professions.majorsLabel': '[PT-BR] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[PT-BR] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[PT-BR] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[PT-BR] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[PT-BR] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[PT-BR] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[PT-BR] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[PT-BR] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine':
    '[PT-BR] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[PT-BR] Perks',
  'hudChrome.professions.returnsLabel': '[PT-BR] Returns: {count}',
  'hudChrome.professions.ringAria': '[PT-BR] Craft wheel',
  'hudChrome.professions.roleDormant': '[PT-BR] Dormant',
  'hudChrome.professions.roleHobby': '[PT-BR] Hobby',
  'hudChrome.professions.roleMajor': '[PT-BR] Major',
  'hudChrome.professions.roleUnattuned': '[PT-BR] Unattuned',
  'hudChrome.professions.skillValue': '[PT-BR] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[PT-BR] Craft skills',
  'hudChrome.professions.switchCost': '[PT-BR] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[PT-BR] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[PT-BR] Tier {tier}',
  'hudChrome.professions.title': '[PT-BR] Professions',
  'hudChrome.professions.tutorialLine':
    '[PT-BR] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[PT-BR] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[PT-BR] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[PT-BR] You cannot afford that training.',
  'hudChrome.training.close': '[PT-BR] Close training',
  'hudChrome.training.dialogOption': '[PT-BR] Training',
  'hudChrome.training.dialogOptionAria': '[PT-BR] Browse training from {name}',
  'hudChrome.training.empty': '[PT-BR] This master has nothing to teach.',
  'hudChrome.training.free': '[PT-BR] Free',
  'hudChrome.training.learned': '[PT-BR] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[PT-BR] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[PT-BR] You must be at the station to train.',
  'hudChrome.training.requirement': '[PT-BR] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[PT-BR] Known',
  'hudChrome.training.stateLocked': '[PT-BR] Locked',
  'hudChrome.training.stateTeachable': '[PT-BR] Available',
  'hudChrome.training.tierUnmet': '[PT-BR] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[PT-BR] Training: {name}',
  'hudChrome.training.trainAria': '[PT-BR] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[PT-BR] Legendary',
  'loading.reconnectingAttempt':
    '[PT-BR] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[PT-BR] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[PT-BR] This is taking longer than usual. Check your internet connection.',
};
