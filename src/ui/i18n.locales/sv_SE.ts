...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'delveUi.shop.buyConfirmAccept': '[SV] Buy',
  'delveUi.shop.buyConfirmBody':
    '[SV] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.',
  'delveUi.shop.buyConfirmCancel': '[SV] Cancel',
  'delveUi.shop.buyConfirmTitle': '[SV] Confirm Purchase',
  'entities.items.anglers_feast_platter.name': "[SV] Angler's Feast Platter",
  'entities.items.arcanite_war_axe.name': '[SV] Arcanite War Axe',
  'entities.items.ashwood_smoked_eel.name': '[SV] Ashwood Smoked Eel',
  'entities.items.cooking_salt.name': '[SV] Cooking Salt',
  'entities.items.copper_bearded_axe.name': '[SV] Copper Bearded Axe',
  'entities.items.copper_flanged_mace.name': '[SV] Copper Flanged Mace',
  'entities.items.copper_ore.name': '[SV] Copper Ore',
  'entities.items.coppermail_gauntlets.name': '[SV] Coppermail Gauntlets',
  'entities.items.coppermail_sabatons.name': '[SV] Coppermail Sabatons',
  'entities.items.elderwood_battle_staff.name': '[SV] Elderwood Battle Staff',
  'entities.items.elixir_of_the_boar.name': '[SV] Elixir of the Boar',
  'entities.items.elixir_of_the_serpent.name': '[SV] Elixir of the Serpent',
  'entities.items.fenbridge_hide_belt.name': '[SV] Fenbridge Hide Belt',
  'entities.items.fenbridge_hide_boots.name': '[SV] Fenbridge Hide Boots',
  'entities.items.fenbridge_hide_leggings.name': '[SV] Fenbridge Hide Leggings',
  'entities.items.frostgill_chowder.name': '[SV] Frostgill Chowder',
  'entities.items.game_meat.name': '[SV] Game Meat',
  'entities.items.glass_vial.name': '[SV] Glass Vial',
  'entities.items.goldleaf_game_stew.name': '[SV] Goldleaf Game Stew',
  'entities.items.goldleaf_healing_draught.name': '[SV] Goldleaf Healing Draught',
  'entities.items.goldleaf_mana_draught.name': '[SV] Goldleaf Mana Draught',
  'entities.items.goldweave_leggings.name': '[SV] Goldweave Leggings',
  'entities.items.goldweave_robe.name': '[SV] Goldweave Robe',
  'entities.items.herbed_marsh_pike.name': '[SV] Herbed Marsh Pike',
  'entities.items.homespun_cloth.name': '[SV] Homespun Cloth',
  'entities.items.homespun_hood.name': '[SV] Homespun Hood',
  'entities.items.homespun_mitts.name': '[SV] Homespun Mitts',
  'entities.items.hunters_game_skewer.name': "[SV] Hunter's Game Skewer",
  'entities.items.iron_ore.name': '[SV] Iron Ore',
  'entities.items.ironbark_boar_spear.name': '[SV] Ironbark Boar Spear',
  'entities.items.ironbark_log.name': '[SV] Ironbark Log',
  'entities.items.ironedge_longsword.name': '[SV] Ironedge Longsword',
  'entities.items.ironlink_hauberk.name': '[SV] Ironlink Hauberk',
  'entities.items.ironlink_legguards.name': '[SV] Ironlink Legguards',
  'entities.items.ironlink_spaulders.name': '[SV] Ironlink Spaulders',
  'entities.items.ironshod_maul.name': '[SV] Ironshod Maul',
  'entities.items.marlows_grand_roast.name': "[SV] Marlow's Grand Roast",
  'entities.items.marshstalker_hood.name': '[SV] Marshstalker Hood',
  'entities.items.marshstalker_jerkin.name': '[SV] Marshstalker Jerkin',
  'entities.items.marshstalker_spaulders.name': '[SV] Marshstalker Spaulders',
  'entities.items.mirewarden_jerkin.name': '[SV] Mirewarden Jerkin',
  'entities.items.mirewarden_leggings.name': '[SV] Mirewarden Leggings',
  'entities.items.mirewarden_treads.name': '[SV] Mirewarden Treads',
  'entities.items.pan_seared_perch.name': '[SV] Pan-Seared River Perch',
  'entities.items.prime_cut.name': '[SV] Prime Cut',
  'entities.items.pristine_hide.name': '[SV] Pristine Hide',
  'entities.items.pristine_silk.name': '[SV] Pristine Silk',
  'entities.items.pristine_venom_gland.name': '[SV] Pristine Venom Gland',
  'entities.items.riveted_copper_girdle.name': '[SV] Riveted Copper Girdle',
  'entities.items.rough_hide.name': '[SV] Rough Hide',
  'entities.items.silkbinders_raiment.name': "[SV] Silkbinder's Raiment",
  'entities.items.silkspun_satchel.name': '[SV] Silkspun Satchel',
  'entities.items.silvered_carp_supper.name': '[SV] Silvered Carp Supper',
  'entities.items.silverleaf_healing_draught.name': '[SV] Silverleaf Healing Draught',
  'entities.items.silverleaf_herb.name': '[SV] Silverleaf Herb',
  'entities.items.silverleaf_mana_draught.name': '[SV] Silverleaf Mana Draught',
  'entities.items.silverthread_slippers.name': '[SV] Silverthread Slippers',
  'entities.items.smithing_flux.name': '[SV] Smithing Flux',
  'entities.items.spider_silk.name': '[SV] Spider Silk',
  'entities.items.spool_of_thread.name': '[SV] Spool of Thread',
  'entities.items.sunpetal_healing_draught.name': '[SV] Sunpetal Healing Draught',
  'entities.items.sunpetal_mana_draught.name': '[SV] Sunpetal Mana Draught',
  'entities.items.sunweave_mantle.name': '[SV] Sunweave Mantle',
  'entities.items.sunweave_treads.name': '[SV] Sunweave Treads',
  'entities.items.tanning_agent.name': '[SV] Tanning Agent',
  'entities.items.thorium_warblade.name': '[SV] Thorium Warblade',
  'entities.items.thoriumscale_cuirass.name': '[SV] Thoriumscale Cuirass',
  'entities.items.thoriumscale_greathelm.name': '[SV] Thoriumscale Greathelm',
  'entities.items.thoriumscale_leggings.name': '[SV] Thoriumscale Leggings',
  'entities.items.venom_gland.name': '[SV] Venom Gland',
  'entities.items.venomfire_elixir.name': '[SV] Venomfire Elixir',
  'entities.items.whetted_iron_dirk.name': '[SV] Whetted Iron Dirk',
  ...
  'entities.letters.guild_trend_alchemy_cooking.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_alchemy_cooking.subject': '[SV] Your work in Alchemy and Cooking',
  ...
  'entities.letters.guild_trend_armorcrafting_engineering.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_armorcrafting_engineering.subject':
    '[SV] Your work in Armorcrafting and Engineering',
  ...
  'entities.letters.guild_trend_cooking_leatherworking.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_cooking_leatherworking.subject':
    '[SV] Your work in Cooking and Leatherworking',
  ...
  'entities.letters.guild_trend_enchanting_jewelcrafting.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_enchanting_jewelcrafting.subject':
    '[SV] Your work in Enchanting and Jewelcrafting',
  ...
  'entities.letters.guild_trend_engineering_alchemy.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_engineering_alchemy.subject':
    '[SV] Your work in Engineering and Alchemy',
  ...
  'entities.letters.guild_trend_inscription_enchanting.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_inscription_enchanting.subject':
    '[SV] Your work in Inscription and Enchanting',
  ...
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_jewelcrafting_weaponcrafting.subject':
    '[SV] Your work in Jewelcrafting and Weaponcrafting',
  ...
  'entities.letters.guild_trend_leatherworking_tailoring.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_leatherworking_tailoring.subject':
    '[SV] Your work in Leatherworking and Tailoring',
  ...
  'entities.letters.guild_trend_tailoring_inscription.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_tailoring_inscription.subject':
    '[SV] Your work in Tailoring and Inscription',
  ...
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.sender': '[SV] The Crafting Guild',
  'entities.letters.guild_trend_weaponcrafting_armorcrafting.subject':
    '[SV] Your work in Weaponcrafting and Armorcrafting',
  'entities.npcs.alchemist_verane.greeting':
    '[SV] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents.',
  'entities.npcs.alchemist_verane.name': '[SV] Alchemist Verane',
  'entities.npcs.alchemist_verane.title': '[SV] Master of the Apothecary',
  'entities.npcs.cook_marlow.greeting':
    '[SV] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there.',
  'entities.npcs.cook_marlow.name': '[SV] Cook Marlow',
  'entities.npcs.cook_marlow.title': '[SV] Master of the Kitchens',
  'entities.npcs.forgemistress_darva.greeting':
    '[SV] The forge answers to me, {className}. Bring good ore and it will answer to you too.',
  'entities.npcs.forgemistress_darva.name': '[SV] Forgemistress Darva',
  'entities.npcs.forgemistress_darva.title': '[SV] Master of the Forge',
  'entities.npcs.tanner_hesk.greeting':
    '[SV] A hide is only as good as its tanning, {className}. The vats are ready when you are.',
  'entities.npcs.tanner_hesk.name': '[SV] Tanner Hesk',
  'entities.npcs.tanner_hesk.title': '[SV] Master of the Tannery',
  'entities.npcs.tinker_gizzel.greeting':
    '[SV] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack.',
  'entities.npcs.tinker_gizzel.name': '[SV] Tinker Gizzel',
  'entities.npcs.tinker_gizzel.title': '[SV] Master of the Toolworks',
  'entities.npcs.weaver_ottilie.greeting':
    '[SV] Mind the threads, {className}. A steady hand at the loom beats a strong one.',
  'entities.npcs.weaver_ottilie.name': '[SV] Weaver Ottilie',
  'entities.npcs.weaver_ottilie.title': '[SV] Master of the Loom',
  'gatherEvent.ancientHeartwood': '[SV] {finder} felled an ancient heartwood!',
  'gatherEvent.moonlitBloom': '[SV] {finder} discovered a moonlit bloom!',
  'gatherEvent.pristineVein': '[SV] {finder} struck a pristine vein!',
  'heroicShop.buyConfirmAccept': '[SV] Buy',
  'heroicShop.buyConfirmBody':
    '[SV] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.',
  'heroicShop.buyConfirmCancel': '[SV] Cancel',
  'heroicShop.buyConfirmTitle': '[SV] Confirm Purchase',
  'hudChrome.crafting.comboTierUnmetNamed': '[SV] Raise {crafts} to tier {tier}.',
  'hudChrome.crafting.difficultyFull': '[SV] Full skill gain',
  'hudChrome.crafting.difficultyNone': '[SV] No skill gain',
  'hudChrome.crafting.difficultyReduced': '[SV] Reduced skill gain',
  'hudChrome.crafting.enchantedLine': '[SV] Enchanted',
  'hudChrome.crafting.makersMark': '[SV] Crafted by {name}',
  'hudChrome.crafting.masterworkSeal': '[SV] Masterwork',
  'hudChrome.crafting.masterworkToast': '[SV] Masterwork! {name}',
  'hudChrome.crafting.masterworkZoneLine': '[SV] {crafter} crafted a masterwork {name}!',
  'hudChrome.crafting.skillReqLine': '[SV] Requires {craft} {skill}',
  'hudChrome.crafting.stationBadge': '[SV] Station',
  'hudChrome.crafting.stationName.apothecary': '[SV] Apothecary',
  'hudChrome.crafting.stationName.forge': '[SV] Forge',
  'hudChrome.crafting.stationName.kitchens': '[SV] Kitchens',
  'hudChrome.crafting.stationName.loom': '[SV] Loom',
  'hudChrome.crafting.stationName.tannery': '[SV] Tannery',
  'hudChrome.crafting.stationName.toolworks': '[SV] Toolworks',
  'hudChrome.crafting.stationOutOfRangeNamed': '[SV] Move to the {station} to craft this.',
  'hudChrome.crafting.stationRequired': '[SV] You must be at the {station} to craft that.',
  'hudChrome.crafting.tierUpToast': '[SV] {craft} advanced to tier {tier}!',
  'hudChrome.death.healerConfirmAccept': '[SV] Revive Me',
  'hudChrome.death.healerConfirmBody':
    "[SV] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
  'hudChrome.death.healerConfirmCancel': '[SV] Cancel',
  'hudChrome.death.healerConfirmTitle': "[SV] Accept the Keeper's Toll?",
  'hudChrome.gathering.gatherLine': '[SV] You gather: {name}.',
  'hudChrome.gathering.gatherLineQty': '[SV] You gather: {name} x{qty}.',
  'hudChrome.mobile.professions': '[SV] Professions',
  'hudChrome.options.showThirdActionBar': '[SV] Show Third Action Bar',
  'hudChrome.playerMenu.streamerBadgeTitle': '[SV] Verified streamer',
  'hudChrome.professions.ceilingCommon': '[SV] Common cap',
  'hudChrome.professions.ceilingRare': '[SV] Rare cap',
  'hudChrome.professions.ceilingUnlimited': '[SV] No empowerment cap',
  'hudChrome.professions.close': '[SV] Close professions',
  'hudChrome.professions.ctaHeader': '[SV] Next step',
  'hudChrome.professions.ctaRaise':
    '[SV] Keep raising {craft}: {points} more points to the next tier.',
  'hudChrome.professions.ctaStart': '[SV] Craft or gather with any profession to begin.',
  'hudChrome.professions.gatheringHeader': '[SV] Gathering',
  'hudChrome.professions.hobbyLabel': '[SV] Hobby: {craft}',
  'hudChrome.professions.identityHeader': '[SV] Identity',
  'hudChrome.professions.majorsLabel': '[SV] Majors: {a} and {b}',
  'hudChrome.professions.nextUnlockMax': '[SV] At maximum skill',
  'hudChrome.professions.nextUnlockSpecialized':
    '[SV] {points} points to Specialized: material costs drop',
  'hudChrome.professions.nextUnlockTier':
    '[SV] {points} points to the next tier: masterwork odds improve',
  'hudChrome.professions.nudgeDormant': '[SV] Your {craft} knowledge lies dormant',
  'hudChrome.professions.nudgeNearTier': '[SV] {craft}: {points} points from the next tier',
  'hudChrome.professions.pairsHeld': '[SV] Pairs held: {count}',
  'hudChrome.professions.perkSpecializedAt': '[SV] Specializes at {threshold} skill',
  'hudChrome.professions.perkSpecializedLine': '[SV] {craft}: Specialized, material costs -{pct}%',
  'hudChrome.professions.perksHeader': '[SV] Perks',
  'hudChrome.professions.returnsLabel': '[SV] Returns: {count}',
  'hudChrome.professions.ringAria': '[SV] Craft wheel',
  'hudChrome.professions.roleDormant': '[SV] Dormant',
  'hudChrome.professions.roleHobby': '[SV] Hobby',
  'hudChrome.professions.roleMajor': '[SV] Major',
  'hudChrome.professions.roleUnattuned': '[SV] Unattuned',
  'hudChrome.professions.skillValue': '[SV] {skill} / {max}',
  'hudChrome.professions.skillsHeader': '[SV] Craft skills',
  'hudChrome.professions.switchCost': '[SV] Next archetype switch costs {cost} amends',
  'hudChrome.professions.syncing': '[SV] Waiting for your profession data from the realm.',
  'hudChrome.professions.tierPipAria': '[SV] Tier {tier}',
  'hudChrome.professions.title': '[SV] Professions',
  'hudChrome.professions.tutorialLine':
    '[SV] Reach {target} skill in any craft to unlock your first tier.',
  'hudChrome.professions.unattunedIdentity':
    '[SV] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.',
  'hudChrome.training.alreadyKnown': '[SV] You already know that recipe.',
  'hudChrome.training.cannotAfford': '[SV] You cannot afford that training.',
  'hudChrome.training.close': '[SV] Close training',
  'hudChrome.training.dialogOption': '[SV] Training',
  'hudChrome.training.dialogOptionAria': '[SV] Browse training from {name}',
  'hudChrome.training.empty': '[SV] This master has nothing to teach.',
  'hudChrome.training.free': '[SV] Free',
  'hudChrome.training.learned': '[SV] Recipe learned: {recipe}',
  'hudChrome.training.notTaughtHere': '[SV] That recipe is not taught here.',
  'hudChrome.training.outOfRange': '[SV] You must be at the station to train.',
  'hudChrome.training.requirement': '[SV] Taught at {craft} {skill}',
  'hudChrome.training.stateKnown': '[SV] Known',
  'hudChrome.training.stateLocked': '[SV] Locked',
  'hudChrome.training.stateTeachable': '[SV] Available',
  'hudChrome.training.tierUnmet': '[SV] You need {craft} {skill} to learn that recipe.',
  'hudChrome.training.title': '[SV] Training: {name}',
  'hudChrome.training.trainAria': '[SV] Learn {name} for {fee}',
  'itemUi.market.rarityLegendary': '[SV] Legendary',
  'loading.reconnectingAttempt':
    '[SV] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)',
  'loading.reconnectingNow':
    '[SV] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})',
  'loading.slowConnection':
    '[SV] This is taking longer than usual. Check your internet connection.',
};
