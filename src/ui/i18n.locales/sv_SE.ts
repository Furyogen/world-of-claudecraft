...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Tidvattensporten',
  'entities.zones.atlantis.name': 'Atlantis',
  'entities.zones.atlantis.welcome': 'Kupolen sjunger än, och Atlantis består under Undertiden.',
  'entities.zones.atlantis.pois.0.label': 'Atlantis',
  'entities.zones.atlantis.pois.1.label': 'Tidvattensportens torg',
  'entities.zones.atlantis.pois.2.label': 'Lumenkronan',
  'entities.zones.atlantis.pois.3.label': 'Pärlmarknaden',
  'entities.zones.atlantis.pois.4.label': 'Det Dränkta Arkivet',
  'entities.zones.atlantis.pois.5.label': 'Kelpväktarnas annex',
  'entities.mobs.glimmerfin_eel.name': 'Glimmerfenad ål',
  'entities.mobs.pearlshell_skitterer.name': 'Pärlskalskrypare',
  'entities.mobs.kelpshade_lurker.name': 'Kelpskuggelurare',
  'entities.mobs.undertow_maw.name': 'Underströmmens Gap',
  'entities.npcs.keeper_nerissa.name': 'Väktare Nerissa',
  'entities.npcs.keeper_nerissa.title': 'Lumenkronans väktare',
  'entities.npcs.keeper_nerissa.greeting': 'Akta glaset, ytbo. Det har hållit i en tidsålder — hjälp oss hålla det så.',
  'entities.npcs.tidewright_ollo.name': 'Tidvattensmed Ollo',
  'entities.npcs.tidewright_ollo.title': 'Pärlmarknadens tidvattensmed',
  'entities.npcs.tidewright_ollo.greeting': 'Färskt från djupets sista torra destillerier. Mynt först, historier sen.',
