...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.mirror_world.welcome': 'Glaset minns dig. Se upp med vilken sida av det du går på.',
  ...
  'entities.npcs.dread_sentinel_c.greeting': 'Vänd om. Det svarta glaset är inte för de levande - inte heller var det någonsin för oss.',
  'entities.quests.q_gargoyle_south.title': 'Väktarens Tull',
  'entities.quests.q_gargoyle_south.text': 'Skenet blir till ord bakom dina ögon: skördemännen trängs vid mitt glas, {playerName}. Gallra dem, och vägen till Highwatch är din.',
  'entities.quests.q_gargoyle_south.completion': 'Stenen brummar en gång, nöjd. Bakom den klarnar spegeln som ett äntligen släppt, hållet andetag.',
  ...
  'entities.quests.q_gargoyle_west.text': 'Skenet blir till ord bakom dina ögon: hämta mig fyra vita lakan från de fattiga döda, {playerName}. Vägen till Eastbrook öppnas för den som betalar i tyg.',
  'entities.quests.q_gargoyle_west.completion': 'Lakanen sjunker in i stenen och är borta. Spegeln bakom den vaknar med ljus.',
  'entities.quests.q_gargoyle_west.objectives.0.label': 'Vitt Lakan',
  'entities.quests.q_gargoyle_north.title': 'Skördad Strålglans',
  'entities.quests.q_gargoyle_north.text': 'Skenet blir till ord bakom dina ögon: andehjordarna brinner för klart för glaset, {playerName}. Fäll fem, och Fenbridge är ett steg bort.',
  'entities.quests.q_gargoyle_north.completion': 'Stenen dricker ljuset du spillde. Spegeln bakom den öppnar sig som ett öga.',
  ...
  'entities.npcs.veilwright_ollo.greeting': 'Döda mäns rockar, buteljerade suckar, ärliga priser - slöjan förser. Allt på mitt bord lades ner av någon som nu inget äger; konsten är att skilja vad de döda är klara med från vad de ännu kramar. Missta dig, och de kommer till ståndet vid midnatt. Fråga Väktaren om ljuset i brunnen, vill du ha den sorgliga versionen. Jag säljer bara rockarna.',
  ...
  'entities.npcs.mistwitch_morwen.greeting': 'Dimman håller de flesta av er vakna. Jag kan brygga dig den andra sortens sömn — den som svarar.',
  'entities.quests.q_deepdream_recipe.title': 'Ett recept på djup sömn',
  'entities.quests.q_deepdream_recipe.text': 'Brygden kräver tre röster, {playerName}: två vita lakan från fattigdomsspökena som inget annat äger, två horn från andeenhörningarna som betar i dunklet, och två huvor skurna från skördemännen som vaktar bältet. Ta hit dem så brygger jag dig en sömn med tänder.',
  'entities.quests.q_deepdream_recipe.completion': 'Lakan, horn, huva — de fattiga, de strålande, de tålmodiga. Kitteln gillar dig. Drick den någonstans mjukt, vandrare: du kommer att möta den du burit på.',
  ...
  'entities.quests.q_face_your_echo.text': 'Drick brygden så ställer drömmen en spegel framför dig — ditt Eko, varje ärr och varje knep du har på andra sidan. Besegra det du är, {playerName}, och kom tillbaka med minen du gör.',
  'entities.quests.q_face_your_echo.completion': 'Du kom tillbaka, och det gjorde inte spegeln. Vad den lämnade i din hand är ditt — drömmen betalar det priset bara en gång.',
