...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.playerMenu.mute': 'Tysta',
  'hudChrome.playerMenu.unmute': 'Sluta tysta',
  ...
  'hudChrome.social.mutedSection': 'Tystade',
  'hudChrome.social.blockedSection': 'Blockerade',
  'hudChrome.social.stopMutingTitle': 'Sluta tysta {name}',
