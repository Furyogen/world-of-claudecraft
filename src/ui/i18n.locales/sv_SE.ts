...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_old_cragmaw.objectives.0.label': "Gamle Cragmaw fälld",
  ...
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Ryggstalkerskinn",
  ...
  'entities.quests.q_stalkers_return.objectives.0.label': "Ryggstalker fälld",
  ...
  'entities.quests.q_stalkers_return.title': "Stalkrarna återvänder",
  'hudChrome.dailyRewards.pointsGained': "{points} dagliga belöningspoäng intjänade.",
  ...
  'hudChrome.options.walkByAutoloot': "Automatisk plundring vid passage",
