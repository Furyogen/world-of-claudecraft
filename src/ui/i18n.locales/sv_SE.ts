...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'auth.recovery.body': "Ange en e-postadress så att du kan återställa ditt konto. Vi använder den bara för att bekräfta att kontot är ditt om du behöver återställa lösenordet.",
  'auth.recovery.failed': "Kunde inte spara din e-post. Försök igen.",
  'auth.recovery.invalid': "Ange en giltig e-postadress.",
  'auth.recovery.logOut': "Logga ut",
  'auth.recovery.save': "Spara e-post",
  'auth.recovery.title': "Lägg till återställnings-e-post",
  'questUi.tracker.hideFromMap': "Dölj {name} från kartan",
  'questUi.tracker.showOnMap': "Visa {name} på kartan",
  'entities.mobs.thunzharr_stormling.name': "Väckt stormling",
  'entities.mobs.thunzharr_waking_peak.name': "Thunzharr, den vaknande toppen",
  'entities.quests.q_old_cragmaw.completion': "Nere till sist. Bergsfolket svor att katten skulle överleva själva muren. Stalkers håller sig till sina höga snöfält nu, {playerName}, och mina patruller kan gå vägen utan att blöda för det. Hela ryggen är tystare tack vare ditt arbete.",
  'entities.quests.q_old_cragmaw.objectives.0.label': "Gamle Cragmaw dräpt",
  'entities.quests.q_old_cragmaw.text': "Bergsfolket gav ett namn åt spåren min spejare hittade: Gamle Cragmaw, en ärrpälsad katt-tyrann som överlevt tre generationer av sin egen flock. Han är orsaken till att stalkers svämmar över min väg, {playerName}. Hans lya ligger på den västra ryggen ovanför vägen söderut. Ta med en vän och fäll den gamle djävulen.",
  'entities.quests.q_old_cragmaw.title': "Gamle Cragmaw",
  'entities.quests.q_stalker_cloaks.completion': "Tio goda pälsar, tjocka som alla jag har... nej, se på dem, {playerName}. Sönderrivna, hälften av dem, och inte av klinga eller spjut. Klomärken breda som min hand, rakt genom vinterpälsen. Något på den ryggen sliter sönder sina egna.",
  'entities.quests.q_stalker_cloaks.objectives.0.label': "Ryggstalker-päls",
  'entities.quests.q_stalker_cloaks.text': "Åtta pälsar fodrade officerarnas mantlar, och nu vill varje soldat på muren ha samma sak, {playerName}. De har rätt: vintern tar fingrar först, och ursäkter värmer inte. Tio pälsar till från ryggarna söder om porten, så sover hela vakten varmt.",
  'entities.quests.q_stalker_cloaks.title': "Mantlar åt vakten",
  'entities.quests.q_stalkers_return.completion': "Fjorton till, och ändå räknar mina patruller färska spår varje morgon. Min spejare kom tillbaka från den höga ryggen vit som snögränsen: avtryck stora som en sköld, säger hon, och gamla byten ingen stalker skulle lämna. Vad som än går där uppe är ingen vanlig katt.",
  'entities.quests.q_stalkers_return.objectives.0.label': "Ryggstalker dräpt",
  'entities.quests.q_stalkers_return.text': "Tolv döda, och ryggen kryllar tätare än dagen du började, {playerName}. Bestar kastar sig inte mot en mur av hunger. Något på den höga ryggen driver dem nedåt, och tills jag vet vad, upphör inte gallringen. Fjorton till.",
  'entities.quests.q_stalkers_return.title': "Stalkers återvänder",
  'hudChrome.dailyRewards.pointsGained': "{points} dagliga belöningspoäng tjänade.",
  ...
  'hudChrome.discord.roleTag.admin': "Administratör",
  ...
  'hudChrome.options.showOwnNameplate': "Visa min namnplåt",
  'hudChrome.options.walkByAutoloot': "Automatisk plundring när du går förbi",
  'hudChrome.targetFrame.lock': "Lås målram",
  'hudChrome.targetFrame.unlock': "Flytta målram",
  'hudChrome.worldBoss.spawn': "{name} reser sig över Thornpeak Heights!",
  'wallet.extensionHelp': "För att se en plånbok här, håll ett webbläsartillägg för plånbok som Solflare Wallet aktivt.",
};
