...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.quests.q_prof_workorder_forge.completion':
    '[SV] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.',
  ...
  'entities.quests.q_prof_workorder_kitchens.completion':
    '[SV] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.',
  ...
  'entities.quests.q_prof_workorder_loom.completion':
    '[SV] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.',
  ...
  'entities.quests.q_prof_workorder_tannery.completion':
    '[SV] Good hides. Fair pay. Again when you have more.',
  ...
  'entities.quests.q_prof_workorder_tannery.text':
    '[SV] Vats are empty. Bring eight rough hides. Coin when you do.',
  ...
  'hudChrome.crafting.attunementReturnCost':
    '[SV] If you leave this pair, returning to it later costs {cost} make-amends tasks.',
  ...
  'hudChrome.crafting.learnMoreAtStation':
    '[SV] {master} at the {station} can teach you more {craft} recipes.',
  ...
  'hudChrome.crafting.trendNudge':
    '[SV] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.',
  'hudChrome.crafting.trendNudgeNoMaster':
    '[SV] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.',
  ...
  'hudChrome.enchantName.enchant_helmet_greater_fortitude':
    '[SV] Enchant Helmet - Greater Fortitude',
  ...
  'hudChrome.enchantName.enchant_weapon_greater_spellpower':
    '[SV] Enchant Weapon - Greater Spellpower',
  ...
  'hudChrome.enchanting.disenchantConfirmBody':
    '[SV] This destroys {item} and yields arcane materials. This cannot be undone.',
  ...
  'hudChrome.enchanting.disenchantThrottled':
    '[SV] You are disenchanting too quickly. Wait a moment and try again.',
  ...
  'hudChrome.enchanting.enchantInsufficient':
    '[SV] You do not have the materials for that enchant.',
  'hudChrome.enchanting.enchantThrottled':
    '[SV] You are enchanting too quickly. Wait a moment and try again.',
  ...
  'hudChrome.enchanting.salvageConfirmBody':
    '[SV] This destroys {item} and yields crafting materials. This cannot be undone.',
  ...
  'hudChrome.enchanting.salvageThrottled':
    '[SV] You are salvaging too quickly. Wait a moment and try again.',
  ...
  'hudChrome.gathering.downgradeMark':
    "[SV] Bags full: the find was stored without its gatherer's mark.",
  ...
  'hudChrome.gathering.toolTierUnmet.herbalism':
    '[SV] You need a tier {tier} herbalism sickle to gather this patch.',
  'hudChrome.gathering.toolTierUnmet.logging':
    '[SV] You need a tier {tier} logging axe to fell this stand.',
  'hudChrome.gathering.toolTierUnmet.mining':
    '[SV] You need a tier {tier} mining pick to harvest this vein.',
  'hudChrome.gathering.toolTierUnmetCorpse':
    '[SV] You need a tier {tier} gathering tool to recover the finest materials.',
  ...
  'hudChrome.loot.takeLootTooltip':
    '[SV] Takes the coins and dropped items. Does not use up the harvest.',
  'hudChrome.loot.unifiedPressHint':
    '[SV] The interact key loots and harvests in one press, using your town focus.',
