...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ashen_psalter.name': 'Askpsalter',
  'entities.items.brimming_waterskin.name': 'Bräddfull vattensäck',
  'entities.items.cactus_pressed_water.name': 'Pressat kaktusvatten',
  'entities.items.caravan_guard_mail.name': 'Karavanvaktens brynja',
  'entities.items.caravan_manifest.name': 'Vattenfläckat fraktbrev',
  'entities.items.cinder_soaked_veil.name': 'Glöddränkt slöja',
  'entities.items.crown_brazier.name': 'Kronfyrfat',
  'entities.items.crown_guard_seal.name': 'Kronvaktens sigill',
  'entities.items.duneblade_token.name': 'Dynklinge-pollett',
  'entities.items.duneforged_warblade.name': 'Dynsmidd krigsklinga',
  'entities.items.dunewatch_sash.name': 'Dynvaktens skärp',
  'entities.items.duskmane_pelt.name': 'Skymningsmanpäls',
  'entities.items.emberbound_leggings.name': 'Glödbundna benskenor',
  'entities.items.emberglass_scepter.name': 'Glödglasspira',
  'entities.items.emberveil_writ.name': 'Glödslöjans påbud',
  'entities.items.glasscarab_shell.name': 'Glasskarabéskal',
  'entities.items.glasscut_dirk.name': 'Glasskåredolk',
  'entities.items.heart_of_the_first_ember.name': 'Den Första Glödens hjärta',
  'entities.items.heartspring_offering.name': 'Hjärtkällans offerskål',
  'entities.items.kareshs_last_skin.name': 'Kareshs sista vattensäck',
  'entities.items.lastwell_datewine.name': 'Dadelvin från Sista Brunnen',
  'entities.items.living_cinder.name': 'Levande glöd',
  'entities.items.moltenheart_girdle.name': 'Smälthjärtebälte',
  'entities.items.moltenheart_slagcore.name': 'Smälthjärtats slaggkärna',
  'entities.items.mural_rubbing.name': 'Muralavgnidning',
  'entities.items.parched_kings_goblet.name': 'Den Förtorkade Kungens bägare',
  'entities.items.prowler_fang.name': 'Smygarhuggtand',
  'entities.items.sentinel_core_stone.name': 'Väktarens kärnsten',
  'entities.items.springheart_blessing.name': 'Hjärtkällans välsignelse',
  'entities.items.stolen_waterskin.name': 'Stulen vattensäck',
  'entities.items.sunbaked_flatbread.name': 'Solbakat tunnbröd',
  'entities.items.sunbleached_bone.name': 'Solblekt ben',
  'entities.items.sunbleached_staff.name': 'Solblekt stav',
  'entities.items.sunglass_shard.name': 'Solglasskärva',
  'entities.items.sunspeakers_ash_crown.name': 'Soltalarens askkrona',
  'entities.items.vestment_of_the_sunken_crown.name': 'Den Sjunkna Kronans skrud',
  'entities.items.vigil_obelisk_dawn.name': 'Gryningseldens sigill',
  'entities.items.vigil_obelisk_dusk.name': 'Skymningseldens sigill',
  'entities.items.vigil_obelisk_noon.name': 'Middagseldens sigill',
  'entities.items.wastes_relic_cache.name': 'Solhovets relikgömma',
  'entities.items.wastewalker_jerkin.name': 'Ödevandrarens jacka',
  'entities.items.wastewalker_treads.name': 'Ödevandrarens kängor',
