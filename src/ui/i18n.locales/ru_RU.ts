...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Врата Прилива',
  'entities.zones.atlantis.name': 'Атлантида',
  'entities.zones.atlantis.welcome': 'Купол всё ещё поёт, и Атлантида держится под Глубинным Течением.',
  'entities.zones.atlantis.pois.0.label': 'Атлантида',
  'entities.zones.atlantis.pois.1.label': 'Площадь Врат Прилива',
  'entities.zones.atlantis.pois.2.label': 'Корона Люмена',
  'entities.zones.atlantis.pois.3.label': 'Жемчужный рынок',
  'entities.zones.atlantis.pois.4.label': 'Затонувший архив',
  'entities.zones.atlantis.pois.5.label': 'Пристройка стражей водорослей',
  'entities.mobs.glimmerfin_eel.name': 'Угорь-искропёр',
  'entities.mobs.pearlshell_skitterer.name': 'Жемчужнопанцирный скороход',
  'entities.mobs.kelpshade_lurker.name': 'Ловчий келповой тени',
  'entities.mobs.undertow_maw.name': 'Пасть Отбойного Течения',
  'entities.npcs.keeper_nerissa.name': 'Хранительница Нерисса',
  'entities.npcs.keeper_nerissa.title': 'Страж Короны Люмена',
  'entities.npcs.keeper_nerissa.greeting': 'Береги стекло, гость с поверхности. Оно держится целую эпоху — помоги нам сохранить его.',
  'entities.npcs.tidewright_ollo.name': 'Оло Приливодел',
  'entities.npcs.tidewright_ollo.title': 'Приливодел Жемчужного рынка',
  'entities.npcs.tidewright_ollo.greeting': 'Свежее из последних сухих перегонных кубов глубин. Сначала монета, потом истории.',
