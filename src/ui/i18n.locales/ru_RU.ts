...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.mounts.name_weirdo_cream_truck': 'Фургон «Чудо-крем»',
  ...
  'hudChrome.mounts.desc_weirdo_cream_truck':
    'Побитый фургон с мороженым: открытая кабина, рожок на крыше и колокольчик, который играет всякий раз, когда фургон отрывается от земли.',
  ...
  'entities.items.reins_weirdo_cream_truck.name': 'Ключ зажигания фургона «Чудо-крем»',
