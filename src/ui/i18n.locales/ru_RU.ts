...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.weapons': 'Коллекция оружия',
  'hudChrome.wocStore.empty': 'Сейчас облики оружия недоступны.',
  'hudChrome.wocStore.weaponCosmetic': 'Облик оружия',
  'hudChrome.wocStore.purchaseAria': 'Купить {item} за {cost} Claudium',
  'hudChrome.wocStore.owned': 'Получено',
  'hudChrome.wocStore.ownedAria': 'Предмет {item} уже получен',
  ...
  'hudChrome.wocStore.usdApprox': 'около {usd} долл. США',
