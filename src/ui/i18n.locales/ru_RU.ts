...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'questUi.dialog.brewDraught': 'Свари мне Отвар глубокого сна.',
  'questUi.dialog.brewDraughtAria': 'Попросить {name} сварить Отвар глубокого сна',
  'questUi.dialog.gargoyleBow': 'Поклониться.',
  'questUi.dialog.gargoyleBowAria': 'Поклониться {name}',
  'questUi.dialog.gargoyleAttack': 'Напасть.',
  'questUi.dialog.gargoyleAttackAria': 'Напасть на {name}',
  'questUi.dialog.gargoyleShimmer': 'Статуя мерцает от переполняющей её силы...',
  'hud.core.deepdreamZone': 'Глубокий Сон',
  ...
  'entities.zones.thornpeak_heights.pois.10.label': 'Зеркальные Врата',
  'entities.zones.mirror_world.name': 'Зеркальный мир',
  'entities.zones.mirror_world.welcome': 'Стекло тебя помнит. Следи, по какую его сторону идёшь.',
  'entities.zones.mirror_world.pois.0.label': 'Зеркальный мир',
  'entities.zones.mirror_world.pois.1.label': 'Площадь Зеркальных Врат',
  'entities.zones.mirror_world.pois.2.label': 'Корона Люмена',
  'entities.zones.mirror_world.pois.3.label': 'Завуалированный рынок',
  'entities.zones.mirror_world.pois.4.label': 'Безмолвный архив',
  'entities.zones.mirror_world.pois.5.label': 'Зеркальное озеро',
  'entities.zones.mirror_world.pois.6.label': 'Туманная топь',
  'entities.zones.mirror_world.pois.7.label': 'Ведьмина лощина',
  'entities.zones.mirror_world.pois.8.label': 'Зеркало Истбрука',
  'entities.zones.mirror_world.pois.9.label': 'Зеркало Фенбриджа',
  'entities.mobs.poverty_ghost.name': 'Призрак нищеты',
  'entities.mobs.spirit_unicorn.name': 'Духовный единорог',
  'entities.mobs.hooded_reaper.name': 'Жнец',
  'entities.mobs.gloomhulk.name': 'Мракан',
  'entities.mobs.mirrorbound_sentry.name': 'Зеркальный страж',
  'entities.mobs.voidfang_stalker.name': 'Бледноклыкий ловчий',
  'entities.npcs.dread_sentinel_a.name': 'Жуткий страж',
  'entities.npcs.dread_sentinel_a.title': 'Смотритель Тёмного Зеркала',
  'entities.npcs.dread_sentinel_a.greeting': 'Твоя смерть ждёт тебя.',
  'entities.npcs.dread_sentinel_b.name': 'Жуткий страж',
  'entities.npcs.dread_sentinel_b.title': 'Смотритель Тёмного Зеркала',
  'entities.npcs.dread_sentinel_b.greeting': 'При жизни мы держали дамбу. Держим и ныне.',
  'entities.npcs.dread_sentinel_c.name': 'Жуткий страж',
  'entities.npcs.dread_sentinel_c.title': 'Смотритель Тёмного Зеркала',
  'entities.npcs.dread_sentinel_c.greeting': 'Поверни назад. Чёрное стекло не для живых... и никогда не было для нас.',
  'entities.quests.q_gargoyle_south.title': 'Пошлина Смотрителя',
  'entities.quests.q_gargoyle_south.text': 'Мерцание складывается в слова за твоими глазами: жнецы теснятся у моего стекла, {playerName}. Проредь их, и путь к Highwatch станет твоим.',
  'entities.quests.q_gargoyle_south.completion': 'Камень довольно гудит один раз. За ним зеркало проясняется, как наконец отпущенный сдержанный вздох.',
  'entities.quests.q_gargoyle_south.objectives.0.label': 'Жнец сражён',
  'entities.quests.q_gargoyle_west.title': 'Пошлина простынями',
  'entities.quests.q_gargoyle_west.text': 'Мерцание складывается в слова за твоими глазами: принеси мне четыре белые простыни с бедных мертвецов, {playerName}. Дорога к Eastbrook открыта тем, кто платит холстом.',
  'entities.quests.q_gargoyle_west.completion': 'Простыни тонут в камне и исчезают. Зеркало за ним пробуждается светом.',
  'entities.quests.q_gargoyle_west.objectives.0.label': 'Белая простыня',
  'entities.quests.q_gargoyle_north.title': 'Пожатое сияние',
  'entities.quests.q_gargoyle_north.text': 'Мерцание складывается в слова за твоими глазами: духовные стада горят для стекла слишком ярко, {playerName}. Сократи пятерых, и Fenbridge в шаге.',
  'entities.quests.q_gargoyle_north.completion': 'Камень пьёт пролитый тобою свет. Зеркало за ним раскрывается, как глаз.',
  'entities.quests.q_gargoyle_north.objectives.0.label': 'Духовный единорог сражён',
  'entities.zones.mirror_world.pois.10.label': 'Чёрный каньон',
  'entities.mobs.gargoyle_awakened.name': 'Страж-горгулья',
  'entities.mobs.mistshade_lurker.name': 'Туманный ловчий',
  'entities.mobs.gloaming_maw.name': 'Пасть Сумерек',
  'entities.mobs.player_echo.name': 'Эхо',
  'entities.npcs.keeper_nerissa.name': 'Нерисса Неупокоенная',
  'entities.npcs.keeper_nerissa.title': 'Призрачная хранительница Короны Люмен',
  'entities.npcs.keeper_nerissa.greeting': 'Я хранила Люмен-Корону при жизни, и Корона держит стекло честным - каждое зеркало в этой долине показывает истинное, кроме одного. Смерть не освободила меня от поста, {playerName}, ибо то одно всё ещё давит. Свет Короны угасает, и где он гаснет, там долина просачивается наружу. Следи, по какой стороне стекла идёшь. В последнее время ему трудно различить.',
  'entities.items.warden_sigil.name': 'Печать стража',
  'entities.items.drowned_lumen.name': 'Утонувший люмен',
  'entities.quests.q_the_failing_radiance.title': 'Угасающее сияние',
  'entities.quests.q_the_failing_radiance.text': 'Ты чувствуешь мой холод и мнишь меня преданием. Я - пост, {playerName}. Люмен-Корона, что я хранила, не золотой венец: это свет каждого здешнего зеркала, шов, что держит живых и мёртвых в раздельных отражениях, чтобы одно не утопило другое. Этот свет угасает, и видно это по Зеркальным стражам: прежде сама лучезарность Короны в дозоре, ныне они - стекло, полное краденого света, что теснится в северных руинах, ибо шов больше не указывает им, где стоять. Разбей восьмерых. Каждый осколок, что ты рассеешь, - толика возвращённого света и толика доказательства, что тебе можно доверить остальное.',
  'entities.quests.q_the_failing_radiance.completion': 'Осколки уплывают к колодцу, точно снег, что падает вверх, и на один вздох вся долина становится оттенком светлее. Это не продлится. Но ты чинишь швы, а не рассекаешь их, {playerName}: здесь это реже, чем ты думаешь. Ты ведь разбил и ДРУГУЮ корону? Железную, под Торнпиком. Тогда впервые за триста лет этот свет, быть может, вернётся. Останься. Долина давно ждёт рук, что затворяют раны.',
  'entities.quests.q_the_failing_radiance.objectives.0.label': 'Зеркальный страж разбит',
  'entities.quests.q_what_the_poor_keep.title': 'Что ещё хранят бедняки',
  'entities.quests.q_what_the_poor_keep.text': 'Нищие призраки южного берега при жизни не имели ничего, {playerName}: ничего, кроме савана, в котором их погребли, ибо приход не мог оплатить гроба. Ныне свет Короны слишком слаб, чтобы разжать их хватку, и они бродят, сжимая единственное, что когда-либо было их. Не сочти это жестокостью; это любовь, которой некуда деться. Принеси мне пять их саванов. Я опущу каждый в колодец и произнесу имя, что было слишком бедным, чтобы быть высеченным. В этом весь обряд: быть бедным, и мёртвым, и всё же названным по имени.',
  'entities.quests.q_what_the_poor_keep.completion': 'Пять саванов, пять имён. Я произношу их в колодец, и вода принимает их, как мать снимает пальто со спящего ребёнка. Призраков на берегу нынче ночью меньше, {playerName}: не убитых, освобождённых. Это делала целая Корона: держала мёртвых достаточно близко, чтобы суметь отпустить их. Теперь мы делаем это руками, ты и я, по пять имён кряду. Это медленнее. Это не пустяк.',
  'entities.quests.q_what_the_poor_keep.objectives.0.label': 'Белый саван',
  'entities.quests.q_the_wardens_names.title': 'Имена стражей',
  'entities.quests.q_the_wardens_names.text': 'Троих, что мерят Чёрный каньон, бегущие зовут Грозными стражами. Некогда я звала их по имени: они были моим орденом, {playerName}, последними, кто при жизни держал дамбу Соболиного зеркала, и они не отступили, даже когда отступили их сердца. Ни один клинок их больше не освободит; чёрное стекло оседлало их слишком глубоко, чтобы им пасть. Но это стекло перекинулось со стражей на жнецов, что теснятся на дамбе, и за долгие годы жнецы вырвали печати стражей. Принеси мне три, срезанные с жнецов каньона, чтобы я произнесла три имени вслух в последний раз.',
  'entities.quests.q_the_wardens_names.completion': 'Корвин. Олдус. Бренна. Вот: сказаны, и говорить их легче, чем когда-либо было держать. Скоро они смогут остановиться; я об этом позабочусь. Но берегись того, что близится, {playerName}: сорванные печати значат, что стекло той дамбы истончается, а рана на её конце ждала именно этого. Я должна вновь зажечь Корону и подпереть Соболиное, прежде чем что-то по ту сторону заметит, что дверь оголилась. Мне нужно ещё одно, последнее, - и оно под чёрной водой.',
  'entities.quests.q_the_wardens_names.objectives.0.label': 'Печать стража',
  'entities.quests.q_what_the_glass_wants.title': 'Чего хочет стекло',
  'entities.quests.q_what_the_glass_wants.text': 'Ты одолел своего Эхо и счёл это испытанием себя, {playerName}. Это не так. Я варю Глубокий сон из савана, рога и капюшона, но то, против чего твой сон поставил зеркало, то, что вошло в твоём лице, - этого я не варю. Оно просачивается из чёрного стекла каньона. Жнецы, что теснятся у входа в каньон, густы от той же течи; повергни восьмерых и смотри, куда ползут их тени. Тогда я покажу самим глазам Нериссы, где её рана кровоточит воистину.',
  'entities.quests.q_what_the_glass_wants.completion': 'На северо-восток. Всегда на северо-восток, всегда к Соболиному — ты видел? Твой Эхо не был ТОБОЙ, странник. Он был осколком того, что живёт за той дверью, облачённым в ближайшее отражение, какое смог украсть: твоё. Сон - лишь самое тонкое место, что нашла течь; каньон - самое широкое. Скажи Нериссе. Она заслужила правду об этом, и ты тоже.',
  'entities.quests.q_what_the_glass_wants.objectives.0.label': 'Жнец повержен у входа в каньон',
  'entities.quests.q_relight_the_lumen_crown.title': 'Зажечь Люмен-Корону вновь',
  'entities.quests.q_relight_the_lumen_crown.text': 'Стражи названы, и дамба истончается, а потому я должна свершить теперь то, что откладывала с самой смерти: зажечь Люмен-Корону в последний раз и придавить Соболиное с этой стороны. Последнюю истинную искру Короны проглотила Сумеречная Пасть, когда пала в пруд, — оттого-то тварь и светится изнутри. Вырежи из неё свет обратно, {playerName}. Чёрное стекло вышлет своих мрачных големов, чтобы прервать обряд; повергни четверых. Принеси мне утонувшую искру, пока я ещё помню, как держать такую. Последний долг хранителя - стать тем, кому больше не нужно хранить.',
  'entities.quests.q_relight_the_lumen_crown.completion': 'Она горит. После всей этой тьмы она ещё помнит мою руку. Смотри: стекло вновь ИСТИННО; ни биения за водой, ни души, потерянной меж миром и его отражением. И бремя наконец сошло с меня. Я не исчезаю, {playerName}; меня СМЕНЯЮТ. Это не сокрушение Соболиного, лишь удержание; нет во мне силы сокрушить то, что ждёт там, и я не дерзнула бы. Но удержанное ещё на век - удержано. Когда дружина отважнее нас наконец войдёт ВНУТРЬ тех врат, они найдут ту сторону готовой. Скажи в Хайуотче, что их хранительница стояла на страже до конца, а затем была сменена. Стекло запомнит тебя. Позаботься дать ему нечто, достойное отражения.',
  'entities.quests.q_relight_the_lumen_crown.objectives.0.label': 'Сумеречная Пасть повержена',
  'entities.quests.q_relight_the_lumen_crown.objectives.1.label': 'Утонувший люмен',
  'entities.quests.q_relight_the_lumen_crown.objectives.2.label': 'Мрачный голем сломлен',
  'entities.npcs.veilwright_ollo.name': 'Оло Ткач Вуали',
  'entities.npcs.veilwright_ollo.title': 'Торговец Сокрытого рынка',
  'entities.npcs.veilwright_ollo.greeting': 'Плащи мертвецов, вздохи в бутылках, честные цены - завеса подаёт. Всё на моём столе оставил тот, у кого больше ничего нет; хитрость в том, чтобы отличить, с чем мёртвые покончили, от того, что ещё сжимают. Ошибёшься - придут к лавке в полночь. Спроси Хранительницу о свете в колодце, если хочешь печальную повесть. Я лишь торгую плащами.',
  'entities.npcs.gargoyle_sentinel_south.name': 'Страж-горгулья',
  'entities.npcs.gargoyle_sentinel_south.title': 'Хранитель Зеркала',
  'entities.npcs.gargoyle_sentinel_south.greeting': 'Каменные глаза со скрежетом поворачиваются к тебе. Он слушает.',
  'entities.npcs.gargoyle_sentinel_west.name': 'Страж-горгулья',
  'entities.npcs.gargoyle_sentinel_west.title': 'Хранитель Зеркала',
  'entities.npcs.gargoyle_sentinel_west.greeting': 'Каменные глаза со скрежетом поворачиваются к тебе. Он слушает.',
  'entities.npcs.gargoyle_sentinel_north.name': 'Страж-горгулья',
  'entities.npcs.gargoyle_sentinel_north.title': 'Хранитель Зеркала',
  'entities.npcs.gargoyle_sentinel_north.greeting': 'Каменные глаза со скрежетом поворачиваются к тебе. Он слушает.',
  'entities.npcs.mistwitch_morwen.name': 'Морвен, Ведьма туманов',
  'entities.npcs.mistwitch_morwen.title': 'Варщица снов из Лощины',
  'entities.npcs.mistwitch_morwen.greeting': 'Туман не даёт вашим уснуть. Я сварю тебе другой сон — тот, что отвечает.',
  'entities.quests.q_deepdream_recipe.title': 'Рецепт глубокого сна',
  'entities.quests.q_deepdream_recipe.text': 'Отвару нужны три голоса, {playerName}: две белые простыни призраков нищеты, у которых больше ничего нет, два рога духовных единорогов, что пасутся во мгле, и два капюшона, срезанных со жнецов, стерегущих пояс. Принеси их — и я сварю тебе сон с зубами.',
  'entities.quests.q_deepdream_recipe.completion': 'Простыня, рог, капюшон — бедные, сияющие, терпеливые. Ты по нраву котлу. Выпей его там, где мягко, странник: встретишь того, кого носишь в себе.',
  'entities.quests.q_deepdream_recipe.objectives.0.label': 'Белая простыня',
  'entities.quests.q_deepdream_recipe.objectives.1.label': 'Духовный рог',
  'entities.quests.q_deepdream_recipe.objectives.2.label': 'Чёрный капюшон',
  'entities.quests.q_face_your_echo.title': 'Взгляни в лицо своему Эху',
  'entities.quests.q_face_your_echo.text': 'Выпей отвар — и сон поставит перед тобой зеркало: твоё Эхо, каждый твой шрам и каждый твой приём по ту сторону. Одолей то, что ты есть, {playerName}, и принеси мне своё лицо после этого.',
  'entities.quests.q_face_your_echo.completion': 'Ты вернулся, а зеркало — нет. Что оно оставило у тебя в руке — твоё; сон платит эту цену лишь однажды.',
  'entities.quests.q_face_your_echo.objectives.0.label': 'Твоё Эхо повержено',
  'entities.items.white_sheet.name': 'Белая простыня',
  'entities.items.spirit_horn.name': 'Духовный рог',
  'entities.items.black_hood.name': 'Чёрный капюшон',
  'entities.items.deepdream_draught.name': 'Отвар глубокого сна',
  'entities.items.mirror_shard.name': 'Зеркальный осколок',
  'entities.items.ghostly_mirrorblade.name': 'Призрачный зеркальный клинок',
  'entities.items.ghostly_shroudmantle.name': 'Призрачная саванная мантия',
  'entities.items.ghostly_wraithjerkin.name': 'Призрачный колет',
  'entities.items.ghostly_palegrips.name': 'Призрачные бледные хваты',
  'entities.items.ghostly_hushboots.name': 'Призрачные тихие сапоги',
  'entities.items.ghostly_glasscord.name': 'Призрачный стеклянный пояс',
