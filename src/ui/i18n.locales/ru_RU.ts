...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.items.ring_of_the_nine.name': 'Кольцо девяти',
  'entities.items.nielas_band.name': 'Обруч Ниэлы',
  ...
  'entities.items.band_of_the_architect.name': 'Кольцо архитектора',
  'entities.items.swiftstride_pendant.name': 'Кулон быстрой поступи',
