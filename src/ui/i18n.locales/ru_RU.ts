...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.claudium.reviewLine':
    'Вы платите {pay} {rail} и получаете {claudium} Клаудиума ({usd}).',
  ...
  'hudChrome.claudium.confirmPending':
    'Ожидание подтверждения в сети. Это может занять некоторое время.',
  ...
  'hudChrome.claudium.confirmRequote':
    'Цена изменилась. Получите новую котировку и повторите попытку.',
  ...
  'hudChrome.claudium.confirmFailed':
    'Этот платёж пока не удалось подтвердить. Пожалуйста, повторите чуть позже.',
  ...
  'hudChrome.claudium.redeemFailed':
    'Этот код не удалось активировать. Проверьте код и повторите попытку.',
  'hudChrome.claudium.back': 'Назад',
  'hudChrome.claudium.tabHistory': 'История',
  'hudChrome.claudium.giftTitle': 'Подарить карту',
  'hudChrome.claudium.giftDenominationLabel': 'Номинал',
  'hudChrome.claudium.giftRecipientLabel': 'Получатель',
  'hudChrome.claudium.giftToSelf': 'Себе',
  'hudChrome.claudium.giftToOther': 'Другому',
  'hudChrome.claudium.giftEmailLabel': 'Эл. почта получателя',
  'hudChrome.claudium.giftEmailInvalid': 'Введите корректный адрес эл. почты.',
  'hudChrome.claudium.giftOccasionLabel': 'Повод',
  'hudChrome.claudium.giftMessageLabel': 'Личное сообщение',
  'hudChrome.claudium.giftMessagePlaceholder': 'Добавьте короткое сообщение (необязательно)',
  'hudChrome.claudium.giftDeliveryLabel': 'Доставка',
  'hudChrome.claudium.giftScheduleLabel': 'Запланировать доставку (необязательно)',
  'hudChrome.claudium.giftReviewButton': 'Проверить подарок',
  'hudChrome.claudium.giftReviewSelf': 'Эту подарочную карту сможете активировать вы.',
  'hudChrome.claudium.giftReviewEmail': 'Мы отправим эту подарочную карту на {email}.',
  'hudChrome.claudium.giftReviewShared':
    'Вы получите ссылку, чтобы поделиться этой подарочной картой.',
  'hudChrome.claudium.giftReviewScheduled': 'Доставка запланирована на выбранную вами дату.',
  'hudChrome.claudium.giftConfirmButton': 'Подтвердить и оплатить',
  'hudChrome.claudium.giftAnotherButton': 'Подарить ещё одну',
  'hudChrome.claudium.giftPending':
    'Выпускаем вашу подарочную карту. Это может занять некоторое время.',
  'hudChrome.claudium.giftIssued': 'Ваша подарочная карта готова к отправке.',
  'hudChrome.claudium.giftFailed':
    'Не удалось выпустить эту подарочную карту. Пожалуйста, повторите чуть позже.',
  'hudChrome.claudium.giftDeclined': 'Платёж отклонён. Подарочная карта не выпущена.',
  'hudChrome.claudium.giftLinkLabel': 'Ссылка на подарочную карту',
  'hudChrome.claudium.giftQrAlt': 'QR-код ссылки для активации подарочной карты',
  'hudChrome.claudium.giftTerms':
    'Подарочные карты можно обменять только на Клаудиум. Их нельзя обменять на деньги или вернуть.',
  'hudChrome.claudium.deliveryEmail': 'Эл. почта',
  'hudChrome.claudium.deliveryLink': 'Поделиться ссылкой',
  'hudChrome.claudium.deliveryReveal': 'Показать сейчас',
  'hudChrome.claudium.occasionBirthday': 'День рождения',
  'hudChrome.claudium.occasionHoliday': 'Праздник',
  'hudChrome.claudium.occasionCongrats': 'Поздравление',
  'hudChrome.claudium.occasionThankyou': 'Благодарность',
  'hudChrome.claudium.occasionGeneric': 'Просто так',
  'hudChrome.claudium.reasonPurchaseStripe': 'Покупка (карта)',
  'hudChrome.claudium.reasonPurchaseSol': 'Покупка (SOL)',
  'hudChrome.claudium.reasonPurchaseUsdc': 'Покупка (USDC)',
  'hudChrome.claudium.reasonPurchaseWoc': 'Покупка (WOC)',
  'hudChrome.claudium.reasonGiftcardRedeem': 'Подарочная карта активирована',
  'hudChrome.claudium.reasonSpend': 'Покупка косметики',
  'hudChrome.claudium.reasonRefund': 'Возврат средств',
  'hudChrome.claudium.reasonChargeback': 'Возвратный платёж',
  'hudChrome.claudium.reasonGiftcardVoid': 'Подарочная карта аннулирована',
  'hudChrome.claudium.historyTitle': 'История транзакций',
  'hudChrome.claudium.historyLoading': 'Загрузка вашей истории...',
  'hudChrome.claudium.historyError':
    'Не удалось загрузить вашу историю. Пожалуйста, повторите попытку.',
  'hudChrome.claudium.historyEmpty': 'У вас пока нет транзакций с Клаудиумом.',
  'hudChrome.claudium.historyLoadMore': 'Загрузить ещё',
  'hudChrome.claudium.historyFilterLabel': 'Фильтр по типу',
  'hudChrome.claudium.historyFilterAll': 'Все типы',
  'hudChrome.claudium.historyExplorer': 'Посмотреть в Solana Explorer',
  'hudChrome.claudium.historyReceipt': 'Покупка картой',
  'hudChrome.claudium.historyGiftNote': 'Подарочная карта',
  'hudChrome.claudium.timeJustNow': 'только что',
  'hudChrome.claudium.discountLabel': 'Скидка',
  'hudChrome.claudium.discountSummary': 'Скидка {percent}% от эффективной цены привязки',
