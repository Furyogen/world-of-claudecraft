...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.auraOverlay.sound': 'Звук оповещения',
  'hudChrome.auraOverlay.soundNone': 'Без звука',
  ...
  'hudChrome.auraOverlay.cues.waterDrop': 'Капля воды',
  'hudChrome.auraOverlay.cues.bubblePop': 'Лопнувший пузырь',
  'hudChrome.auraOverlay.cues.hardBell': 'Резкий колокол',
  'hudChrome.auraOverlay.cues.templeGong': 'Храмовый гонг',
  'hudChrome.auraOverlay.cues.anvilStrike': 'Удар по наковальне',
  'hudChrome.auraOverlay.cues.coinDrop': 'Падение монет',
  'hudChrome.auraOverlay.cues.swordDraw': 'Обнажение клинка',
  'hudChrome.auraOverlay.cues.blaringHorn': 'Ревущий рог',
  'hudChrome.auraOverlay.cues.carKlaxon': 'Автомобильный клаксон',
  'hudChrome.auraOverlay.cues.sonarPing': 'Сигнал сонара',
  'hudChrome.auraOverlay.cues.electricZap': 'Электрический разряд',
  'hudChrome.auraOverlay.cues.catMeow': 'Мяуканье кошки',
  'hudChrome.auraOverlay.cues.owlHoot': 'Уханье совы',
  'hudChrome.auraOverlay.cues.wolfHowl': 'Волчий вой',
  'hudChrome.auraOverlay.cues.frogCroak': 'Кваканье лягушки',
  'hudChrome.auraOverlay.cues.windWhoosh': 'Порыв ветра',
  'hudChrome.auraOverlay.cues.steamHiss': 'Шипение пара',
