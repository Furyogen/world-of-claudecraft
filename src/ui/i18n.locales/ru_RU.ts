...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.howto':
    'Пройдите испытание замка: уклоняйтесь от цепов, лавируйте среди брёвен, ловите момент топоров, пересеките разводной мост, избегайте валунов. Кто первым пересечёт финиш, получит корону. Падения лишь отнимают время.',
  ...
  'hudChrome.hc.section.flail_bridge': 'Мост цепов',
  'hudChrome.hc.section.log_court': 'Двор брёвен',
  'hudChrome.hc.section.axe_walk': 'Проход топоров',
  'hudChrome.hc.section.drawspan': 'Разводной мост',
  'hudChrome.hc.section.boulder_alley': 'Аллея валунов',
  ...
  'guide.hodricsCastlePage.fallsBody':
    'Удар от препятствия или падение в пропасть лишь отправляют вас к последней контрольной точке. На этой дороге никто не погибает: единственная цена падения — те секунды, что нужны, чтобы снова наверстать упущенное.',
  'guide.hodricsCastlePage.standingsHeading': 'Корона',
  'guide.hodricsCastlePage.standingsBody':
    'Кто первым пересекает финишную черту, забирает Корону Ходрика за этот заезд. Число ваших заездов, побед и лучшее время растут с каждым новым участием.',
