...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.chat.categories.hide': 'Скрыть строки категории {category} во вкладке Все',
  'hudChrome.chat.categories.show': 'Показать строки категории {category} во вкладке Все',
  'hudChrome.chat.categories.game': 'Игра',
  'hudChrome.chat.categories.loot': 'Добыча',
  'hudChrome.chat.categories.xp': 'Опыт',
  'hudChrome.chat.categories.quest': 'Задания',
  'hudChrome.chat.categories.event': 'События',
  'hudChrome.chat.categories.public': 'Общий',
  'hudChrome.chat.categories.party': 'Группа',
  'hudChrome.chat.categories.guild': 'Гильдия',
  'hudChrome.chat.categories.channels': 'Каналы',
  'hudChrome.chat.categories.whispers': 'Шёпот',
