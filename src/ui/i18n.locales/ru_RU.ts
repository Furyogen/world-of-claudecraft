...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.hc.title': 'Замок Ходрика',
  'hudChrome.hc.close': 'Закрыть окно Гонтлета',
  'hudChrome.hc.zoneName': 'Замок Ходрика',
  'hudChrome.hc.offlineNote': 'Стол Гонтлета ещё не синхронизирован. Один момент.',
  'hudChrome.hc.joinQueue': 'Присоединиться к Гонтлету',
  'hudChrome.hc.leaveQueue': 'Покинуть очередь',
  'hudChrome.hc.queuedAt':
    'В очереди, позиция {position}. Заезд начнётся, когда наберётся десять участников.',
  'hudChrome.hc.inMatchNote': 'Вы участвуете в гонке. Смотрите только вперёд!',
  'hudChrome.hc.practice': 'Потренироваться с придворными',
  'hudChrome.hc.practiceNote':
    'Сразитесь с придворными лорда Ходрика: девять соперников, никакого ожидания.',
  'hudChrome.hc.record': 'Корон {wins} / Гонок {races}',
  'hudChrome.hc.bestTime': 'Лучшее время {seconds}с',
  'hudChrome.hc.bestNone': 'Пока нет завершённых заездов',
  'hudChrome.hc.rank': 'Позиция {rank} / {total}',
  'hudChrome.hc.finishPlace': 'Финиш: {place} место',
  'hudChrome.hc.overWon': 'Корона теперь ваша!',
  'hudChrome.hc.overPlaced': 'Гонка окончена: {place} место',
  'hudChrome.hc.howto':
    'Три раунда, десять гонщиков, одна корона. Лорд Ходрик перестраивает свою полосу каждый раунд: переживите отсев (проходят шестеро, затем трое) и выиграйте финал. Падения стоят лишь времени.',
  'hudChrome.hc.round': 'Раунд {round}/{rounds}',
  'hudChrome.hc.advance': 'Проходят: {count}',
  'hudChrome.hc.spectating': 'Наблюдаете с галереи',
  'hudChrome.hc.intermissionRebuild': 'Лорд Ходрик перестраивает полосу!',
  'hudChrome.hc.intermissionQualified': 'Вы прошли. Скоро следующий раунд.',
  'hudChrome.hc.intermissionEliminated': 'Выбыли! Наслаждайтесь видом с галереи.',
  'hudChrome.hc.section.hammer_bridge': 'Молотовый мост',
  'hudChrome.hc.section.rotor_court': 'Двор с брёвнами',
  'hudChrome.hc.section.boulder_climb': 'Валунный подъём',
  'hudChrome.hc.section.piston_ledge': 'Карниз с поршнями',
  'hudChrome.hc.section.spinner_court': 'Двор с каруселями',
  'hudChrome.hc.section.landing': 'Площадка',
  'hudChrome.hc.banner.round': 'Раунд {round}!',
  'hudChrome.hc.banner.qualified': 'ПРОШЁЛ!',
  'hudChrome.hc.banner.eliminated': 'ВЫБЫЛ',
  'hudChrome.hc.log.qualified': 'Вы проходите в следующий раунд.',
  'hudChrome.hc.log.eliminated': 'Выбыли в раунде {round}. На галерее есть закуски.',
  'hudChrome.hc.flavor.rebuild': 'Лорд Ходрик перестроил полосу. Новая трасса, та же корона!',
  'hudChrome.hc.section.start_yard': 'Стартовый двор',
  'hudChrome.hc.section.axe_walk': 'Проход топоров',
  'hudChrome.hc.section.drawspan': 'Разводной мост',
  'hudChrome.hc.section.red_ascent': 'Багровый подъём',
  'hudChrome.hc.section.finish_keep': 'Финишная башня',
  'hudChrome.hc.banner.found': 'Гонтлет зовёт!',
  'hudChrome.hc.banner.go': 'Старт!',
  'hudChrome.hc.banner.finish': 'Финиш: {place} место!',
  'hudChrome.hc.banner.crown': 'Вы забираете корону Ходрика!',
  'hudChrome.hc.log.queued': 'Вы встали в очередь Гонтлета (позиция {position}).',
  'hudChrome.hc.log.unqueued': 'Вы покинули очередь Гонтлета.',
  ...
  'hudChrome.hc.flavor.gatesOpen':
    'Ворота замка Ходрика со скрипом открываются. Бегите за короной!',
  'hudChrome.hc.flavor.go': 'Старт! Гонтлет открыт!',
  'hudChrome.hc.err.legsOnly': 'В Гонтлете только ноги: способности запрещены.',
  'hudChrome.hc.err.inMatch': 'Вы уже участвуете в Гонтлете.',
  'hudChrome.hc.err.dead': 'Нельзя встать в очередь Гонтлета будучи мёртвым.',
  'hudChrome.hc.err.arenaConflict': 'Покиньте Колизей, прежде чем участвовать в Гонтлете.',
  ...
  'entities.npcs.hodrics_herald.name': 'Герольд Осрик',
  'entities.npcs.hodrics_herald.title': 'Герольд Гонтлета Ходрика',
  'entities.npcs.hodrics_herald.greeting':
    'Лорд Ходрик открывает свой путь всем желающим! Пройдите Гонтлет, уклонитесь от цепов, возьмите корону!',
  ...
  'guide.nav.hodricsCastle': 'Замок Ходрика',
  'guide.hodricsCastlePage.heading': 'Замок Ходрика',
  'guide.hodricsCastlePage.intro':
    'Лорд Ходрик открывает путь через свой замок любому желающему. Пройдите испытание его старых укреплений и возьмите корону, кем бы вы ни были и какого бы уровня ни достигли.',
  'guide.hodricsCastlePage.heraldHeading': 'Герольд',
  'guide.hodricsCastlePage.heraldBody':
    'Найдите герольда Осрика на окраине Истбрука, чтобы встать в очередь Гонтлета. Заезд начинается, когда наберётся десять участников — настоящих игроков и придворных лорда Ходрика вперемешку, так что гонка почти всегда начинается быстро.',
  'guide.hodricsCastlePage.courseHeading': 'Три раунда, одна корона',
  'guide.hodricsCastlePage.courseBody':
    'Полоса Ходрика - это шоу на выбывание: десять гонщиков начинают первый раунд, шестеро переживают отсев, трое выходят в финал, и один забирает корону. Лорд Ходрик перестраивает трассу между раундами, так что двух одинаковых забегов не бывает: молотовые мосты, дворы с вращающимися брёвнами, коридоры с топорами, скользящие мосты, валунные подъёмы, карнизы с поршнями и вращающиеся платформы - в том порядке, какой сегодня угоден его светлости. Каждое препятствие качается, крутится и катится в своём заводном ритме, без всякой случайности, и внимательный глаз всегда найдёт безопасное окно.',
  'guide.hodricsCastlePage.fairnessHeading': 'Только на своих ногах',
  'guide.hodricsCastlePage.fairnessBody':
    'Здесь никто не колдует: способности запрещены на всю гонку, и все участники бегут с одинаковой скоростью. Исход Гонтлета решают только выдержка и чувство момента, а не снаряжение или уровень.',
  'guide.hodricsCastlePage.fallsHeading': 'Падение стоит времени, не жизни',
  'guide.hodricsCastlePage.fallsBody':
    'Удар препятствия или падение в пропасть лишь возвращают вас к последней контрольной точке. На дамбе никто не погибает: единственная цена падения - секунды, потраченные на то, чтобы догнать остальных. Выбывших в конце раунда эффектно запускают на балкон галереи, откуда они с закусками смотрят остаток шоу.',
  'guide.hodricsCastlePage.standingsHeading': 'Корона',
  'guide.hodricsCastlePage.standingsBody':
    'Первый, кто пересечёт финиш финального раунда, забирает корону Ходрика за это шоу. Число забегов, победы и лучшее время финала копятся с каждой новой очередью.',
  ...
  'hudChrome.gauntlet.eventClosedNote':
    'Сейчас игры не проводятся: очередь и трибуны закрыты. Тренировка открыта всегда.',
  'hudChrome.gauntlet.practicePickTitle': 'Выберите испытание для тренировки',
  'hudChrome.gauntlet.practiceFull': 'Полный Гаунтлет',
  'hudChrome.gauntlet.trialNames.sentinel': 'Переправа Стража',
  'hudChrome.gauntlet.trialNames.sigils': 'Печати из сахарного стекла',
  'hudChrome.gauntlet.trialNames.pull': 'Великое перетягивание',
  'hudChrome.gauntlet.trialNames.echo': 'Эхо Хранителя',
  ...
  'hudChrome.gauntlet.phaseTrial': 'Переправа началась',
  'hudChrome.gauntlet.phaseTrialSigils': 'Начинается гравировка',
  'hudChrome.gauntlet.phaseTrialPull': 'Взяться за канат',
  'hudChrome.gauntlet.phaseTrialEcho': 'Эхо Хранителя начинается',
  'hudChrome.gauntlet.phaseTrialSpan': 'Перейди хрупкий мост',
  'hudChrome.gauntlet.phaseTrialCourt': 'Последняя арена',
  'hudChrome.gauntlet.phaseInterlude': 'Испытание пройдено',
  'hudChrome.gauntlet.phasePodium': 'Гаунтлет завершён',
  'hudChrome.gauntlet.greenLight': 'Зелёный свет!',
  'hudChrome.gauntlet.redLight': 'Красный свет!',
  'hudChrome.gauntlet.vitalityLost': 'Вы потеряли {amount} жизненной силы.',
  'hudChrome.gauntlet.survivorsLeft': 'Осталось {count}',
  'hudChrome.gauntlet.spectating': 'Наблюдение',
  ...
  'entities.npcs.gauntlet_watcher.name': 'Каменный Страж',
  'entities.npcs.gauntlet_watcher.title': 'Хранитель Переправы',
  'entities.npcs.gauntlet_watcher.greeting': 'Страж не моргает.',
  'entities.npcs.gauntlet_contestant.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant.title': 'Участник',
  'entities.npcs.gauntlet_contestant.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_warrior.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_warrior.title': 'Участник',
  'entities.npcs.gauntlet_contestant_warrior.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_paladin.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_paladin.title': 'Участник',
  'entities.npcs.gauntlet_contestant_paladin.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_hunter.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_hunter.title': 'Участник',
  'entities.npcs.gauntlet_contestant_hunter.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_rogue.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_rogue.title': 'Участник',
  'entities.npcs.gauntlet_contestant_rogue.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_priest.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_priest.title': 'Участник',
  'entities.npcs.gauntlet_contestant_priest.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_mage.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_mage.title': 'Участник',
  'entities.npcs.gauntlet_contestant_mage.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_warlock.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_warlock.title': 'Участник',
  'entities.npcs.gauntlet_contestant_warlock.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_shaman.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_shaman.title': 'Участник',
  'entities.npcs.gauntlet_contestant_shaman.greeting': 'Смотри вперёд. Страж наблюдает.',
  'entities.npcs.gauntlet_contestant_druid.name': 'Участник Гаунтлета',
  'entities.npcs.gauntlet_contestant_druid.title': 'Участник',
  'entities.npcs.gauntlet_contestant_druid.greeting': 'Смотри вперёд. Страж наблюдает.',
