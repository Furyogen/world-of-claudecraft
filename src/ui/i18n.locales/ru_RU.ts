...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.npcs.dread_sentinel_c.greeting':
    'Поверни назад. Чёрное стекло не для живых... и никогда не было для нас.',
  'entities.quests.q_gargoyle_south.title': 'Пошлина Смотрителя',
  'entities.quests.q_gargoyle_south.text':
    'Мерцание складывается в слова за твоими глазами: жнецы теснятся у моего стекла, {playerName}. Проредь их, и путь к Highwatch станет твоим.',
  'entities.quests.q_gargoyle_south.completion':
    'Камень довольно гудит один раз. За ним зеркало проясняется, как наконец отпущенный сдержанный вздох.',
  ...
  'entities.quests.q_gargoyle_west.text':
    'Мерцание складывается в слова за твоими глазами: принеси мне четыре белые простыни с бедных мертвецов, {playerName}. Дорога к Eastbrook открыта тем, кто платит холстом.',
  'entities.quests.q_gargoyle_west.completion':
    'Простыни тонут в камне и исчезают. Зеркало за ним пробуждается светом.',
  ...
  'entities.quests.q_gargoyle_north.text':
    'Мерцание складывается в слова за твоими глазами: духовные стада горят для стекла слишком ярко, {playerName}. Сократи пятерых, и Fenbridge в шаге.',
  'entities.quests.q_gargoyle_north.completion':
    'Камень пьёт пролитый тобою свет. Зеркало за ним раскрывается, как глаз.',
  ...
  'entities.quests.q_what_the_poor_keep.text':
    'Нищие призраки южного берега при жизни не имели ничего, {playerName}: ничего, кроме савана, в котором их погребли, ибо приход не мог оплатить гроба. Ныне свет Короны слишком слаб, чтобы разжать их хватку, и они бродят, сжимая единственное, что когда-либо было их. Не сочти это жестокостью; это любовь, которой некуда деться. Принеси мне пять их саванов. Я опущу каждый в колодец и произнесу имя, что было слишком бедным, чтобы быть высеченным. В этом весь обряд: быть бедным, и мёртвым, и всё же названным по имени.',
  'entities.quests.q_what_the_poor_keep.completion':
    'Пять саванов, пять имён. Я произношу их в колодец, и вода принимает их, как мать снимает пальто со спящего ребёнка. Призраков на берегу нынче ночью меньше, {playerName}: не убитых, освобождённых. Это делала целая Корона: держала мёртвых достаточно близко, чтобы суметь отпустить их. Теперь мы делаем это руками, ты и я, по пять имён кряду. Это медленнее. Это не пустяк.',
  ...
  'entities.npcs.gargoyle_sentinel_south.greeting':
    'Каменные глаза со скрежетом поворачиваются к тебе. Он слушает.',
  ...
  'entities.npcs.mistwitch_morwen.greeting':
    'Туман не даёт вашим уснуть. Я сварю тебе другой сон - тот, что отвечает.',
  'entities.quests.q_deepdream_recipe.title': 'Рецепт глубокого сна',
  'entities.quests.q_deepdream_recipe.text':
    'Отвару нужны три голоса, {playerName}: две белые простыни призраков нищеты, у которых больше ничего нет, два рога духовных единорогов, что пасутся во мгле, и два капюшона, срезанных со жнецов, стерегущих пояс. Принеси их - и я сварю тебе сон с зубами.',
  'entities.quests.q_deepdream_recipe.completion':
    'Простыня, рог, капюшон - бедные, сияющие, терпеливые. Ты по нраву котлу. Выпей его там, где мягко, странник: встретишь того, кого носишь в себе.',
  ...
  'entities.quests.q_face_your_echo.text':
    'Выпей отвар - и сон поставит перед тобой зеркало: твоё Эхо, каждый твой шрам и каждый твой приём по ту сторону. Одолей то, что ты есть, {playerName}, и принеси мне своё лицо после этого.',
  'entities.quests.q_face_your_echo.completion':
    'Ты вернулся, а зеркало - нет. Что оно оставило у тебя в руке - твоё; сон платит эту цену лишь однажды.',
  ...
  'guide.worldPage.mirrorBlurb':
    'За зеркалами Хайвотча лежит залитая лунным светом, повитая туманом страна чёрного стекла: Стеклянная долина хранит финальных духов мира, а хранительница Нерисса держит Люменову лощину.',
  'guide.worldPage.mirrorGreeting':
    'Стекло хранит каждое лицо, что оно утопило. Ступай здесь тихо и не вглядывайся слишком долго в собственное.',
  'guide.worldPage.mirrorGreeter': 'Хранительница Нерисса, Люменова лощина',
