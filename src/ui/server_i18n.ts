...
export const DICT: Record<string, Record<string, string>> = {
  en: {
    ...
    'mutes.now': '{name} is now muted.',
    'mutes.noLonger': '{name} is no longer muted.',
    'mutes.already': '{name} is already muted.',
    'mutes.full': 'Your mute list is full.',
    'mutes.self': 'You cannot mute yourself.',
    'mutes.notFound': "No character named '{name}' on your mute list.",
    'mutes.notOnList': '{name} is not on your mute list.',
    'mutes.empty': 'Your mute list is empty.',
    'mutes.list': 'Muted ({count}): {names}',
    'mutes.usage': 'Usage: /mute <name>, /unmute <name>, /mutelist.',
    'blocks.empty': 'Your ignore list is empty.',
    'blocks.list': 'Ignored ({count}): {names}',
  ...
  es: {
    ...
    'mutes.now': '{name} está ahora silenciado.',
    'mutes.noLonger': '{name} ya no está silenciado.',
    'mutes.already': '{name} ya está silenciado.',
    'mutes.full': 'Tu lista de silenciados está llena.',
    'mutes.self': 'No puedes silenciarte a ti mismo.',
    'mutes.notFound': "No hay ningún personaje llamado '{name}' en tu lista de silenciados.",
    'mutes.notOnList': '{name} no está en tu lista de silenciados.',
    'mutes.empty': 'Tu lista de silenciados está vacía.',
    'mutes.list': 'Silenciados ({count}): {names}',
    'mutes.usage': 'Uso: /mute <nombre>, /unmute <nombre>, /mutelist.',
    'blocks.empty': 'Tu lista de ignorados está vacía.',
    'blocks.list': 'Ignorados ({count}): {names}',
  ...
  fr_FR: {
    ...
    'mutes.now': '{name} est maintenant en sourdine.',
    'mutes.noLonger': "{name} n'est plus en sourdine.",
    'mutes.already': '{name} est déjà en sourdine.',
    'mutes.full': 'Votre liste de sourdine est pleine.',
    'mutes.self': 'Vous ne pouvez pas vous mettre en sourdine.',
    'mutes.notFound': "Aucun personnage nommé '{name}' dans votre liste de sourdine.",
    'mutes.notOnList': "{name} n'est pas dans votre liste de sourdine.",
    'mutes.empty': 'Votre liste de sourdine est vide.',
    'mutes.list': 'En sourdine ({count}) : {names}',
    'mutes.usage': 'Utilisation : /mute <nom>, /unmute <nom>, /mutelist.',
    'blocks.empty': 'Votre liste des joueurs ignorés est vide.',
    'blocks.list': 'Ignorés ({count}) : {names}',
  ...
  it_IT: {
    ...
    'mutes.now': '{name} è stato silenziato.',
    'mutes.noLonger': '{name} non è più silenziato.',
    'mutes.already': '{name} è già silenziato.',
    'mutes.full': 'La tua lista dei silenziati è piena.',
    'mutes.self': 'Non puoi silenziare te stesso.',
    'mutes.notFound': "Nessun personaggio di nome '{name}' nella tua lista dei silenziati.",
    'mutes.notOnList': '{name} non è nella tua lista dei silenziati.',
    'mutes.empty': 'La tua lista dei silenziati è vuota.',
    'mutes.list': 'Silenziati ({count}): {names}',
    'mutes.usage': 'Uso: /mute <nome>, /unmute <nome>, /mutelist.',
    'blocks.empty': 'La tua lista degli ignorati è vuota.',
    'blocks.list': 'Ignorati ({count}): {names}',
  ...
  de_DE: {
    ...
    'mutes.now': '{name} ist jetzt stummgeschaltet.',
    'mutes.noLonger': '{name} ist nicht mehr stummgeschaltet.',
    'mutes.already': '{name} ist bereits stummgeschaltet.',
    'mutes.full': 'Deine Stummschaltungsliste ist voll.',
    'mutes.self': 'Du kannst dich nicht selbst stummschalten.',
    'mutes.notFound': "Kein Charakter namens '{name}' auf deiner Stummschaltungsliste.",
    'mutes.notOnList': '{name} steht nicht auf deiner Stummschaltungsliste.',
    'mutes.empty': 'Deine Stummschaltungsliste ist leer.',
    'mutes.list': 'Stummgeschaltet ({count}): {names}',
    'mutes.usage': 'Verwendung: /mute <Name>, /unmute <Name>, /mutelist.',
    'blocks.empty': 'Deine Ignorierliste ist leer.',
    'blocks.list': 'Ignoriert ({count}): {names}',
  ...
  zh_CN: {
    ...
    'mutes.now': '已将 {name} 静音。',
    'mutes.noLonger': '已取消对 {name} 的静音。',
    'mutes.already': '{name} 已经处于静音状态。',
    'mutes.full': '你的静音列表已满。',
    'mutes.self': '你不能将自己静音。',
    'mutes.notFound': '你的静音列表中没有名为“{name}”的角色。',
    'mutes.notOnList': '{name} 不在你的静音列表中。',
    'mutes.empty': '你的静音列表为空。',
    'mutes.list': '已静音（{count}）：{names}',
    'mutes.usage': '用法：/mute <名称>、/unmute <名称>、/mutelist。',
    'blocks.empty': '你的忽略列表为空。',
    'blocks.list': '已忽略（{count}）：{names}',
  ...
  zh_TW: {
    ...
    'mutes.now': '已將 {name} 靜音。',
    'mutes.noLonger': '已取消對 {name} 的靜音。',
    'mutes.already': '{name} 已經處於靜音狀態。',
    'mutes.full': '你的靜音清單已滿。',
    'mutes.self': '你不能將自己靜音。',
    'mutes.notFound': '你的靜音清單中沒有名為「{name}」的角色。',
    'mutes.notOnList': '{name} 不在你的靜音清單中。',
    'mutes.empty': '你的靜音清單是空的。',
    'mutes.list': '已靜音（{count}）：{names}',
    'mutes.usage': '用法：/mute <名稱>、/unmute <名稱>、/mutelist。',
    'blocks.empty': '你的忽略清單是空的。',
    'blocks.list': '已忽略（{count}）：{names}',
  ...
  ko_KR: {
    ...
    'mutes.now': '{name} 님을 음소거했습니다.',
    'mutes.noLonger': '{name} 님의 음소거를 해제했습니다.',
    'mutes.already': '{name} 님은 이미 음소거되어 있습니다.',
    'mutes.full': '음소거 목록이 가득 찼습니다.',
    'mutes.self': '자신을 음소거할 수 없습니다.',
    'mutes.notFound': "음소거 목록에 '{name}'(이)라는 캐릭터가 없습니다.",
    'mutes.notOnList': '{name} 님은 음소거 목록에 없습니다.',
    'mutes.empty': '음소거 목록이 비어 있습니다.',
    'mutes.list': '음소거 ({count}): {names}',
    'mutes.usage': '사용법: /mute <이름>, /unmute <이름>, /mutelist.',
  ...
  ja_JP: {
    ...
    'mutes.now': '{name} をミュートしました。',
    'mutes.noLonger': '{name} のミュートを解除しました。',
    'mutes.already': '{name} はすでにミュートされています。',
    'mutes.full': 'ミュートリストがいっぱいです。',
    'mutes.self': '自分自身をミュートすることはできません。',
    'mutes.notFound': '「{name}」という名前のキャラクターはミュートリストにいません。',
    'mutes.notOnList': '{name} はミュートリストにいません。',
    'mutes.empty': 'ミュートリストは空です。',
    'mutes.list': 'ミュート中（{count}）：{names}',
    'mutes.usage': '使い方: /mute <名前>、/unmute <名前>、/mutelist。',
    'blocks.empty': '無視リストは空です。',
    'blocks.list': '無視中（{count}）：{names}',
  ...
  pt_BR: {
    ...
    'mutes.now': '{name} agora está silenciado.',
    'mutes.noLonger': '{name} não está mais silenciado.',
    'mutes.already': '{name} já está silenciado.',
    'mutes.full': 'Sua lista de silenciados está cheia.',
    'mutes.self': 'Você não pode silenciar a si mesmo.',
    'mutes.notFound': "Nenhum personagem chamado '{name}' na sua lista de silenciados.",
    'mutes.notOnList': '{name} não está na sua lista de silenciados.',
    'mutes.empty': 'Sua lista de silenciados está vazia.',
    'mutes.list': 'Silenciados ({count}): {names}',
    'mutes.usage': 'Uso: /mute <nome>, /unmute <nome>, /mutelist.',
    'blocks.empty': 'Sua lista de ignorados está vazia.',
    'blocks.list': 'Ignorados ({count}): {names}',
    'blocks.usage': 'Uso: /block <nome>, /unblock <nome>, /blocklist.',
  ...
  ru_RU: {
    ...
    'mutes.now': '{name} заглушён.',
    'mutes.noLonger': '{name} больше не заглушён.',
    'mutes.already': '{name} уже заглушён.',
    'mutes.full': 'Ваш список заглушённых переполнен.',
    'mutes.self': 'Вы не можете заглушить себя.',
    'mutes.notFound': 'Персонаж с именем «{name}» отсутствует в вашем списке заглушённых.',
    'mutes.notOnList': '{name} отсутствует в вашем списке заглушённых.',
    'mutes.empty': 'Ваш список заглушённых пуст.',
    'mutes.list': 'Заглушены ({count}): {names}',
    'mutes.usage': 'Использование: /mute <имя>, /unmute <имя>, /mutelist.',
    'blocks.empty': 'Ваш список игнорируемых пуст.',
    'blocks.list': 'Игнорируются ({count}): {names}',
...
const RULES: Rule[] = [
  ...
  // Personal chat mutes (SocialService.muteAdd/muteRemove/muteList, plus the
  // usage notice game.ts sends for a bare /mute).
  { re: /^(.+) is now muted\.$/, build: (m) => tServer('mutes.now', { name: m[1] }) },
  { re: /^(.+) is no longer muted\.$/, build: (m) => tServer('mutes.noLonger', { name: m[1] }) },
  { re: /^(.+) is already muted\.$/, build: (m) => tServer('mutes.already', { name: m[1] }) },
  { re: /^Your mute list is full\.$/, build: () => tServer('mutes.full') },
  { re: /^You cannot mute yourself\.$/, build: () => tServer('mutes.self') },
  {
    re: /^No character named '(.+)' on your mute list\.$/,
    build: (m) => tServer('mutes.notFound', { name: m[1] }),
  },
  {
    re: /^(.+) is not on your mute list\.$/,
    build: (m) => tServer('mutes.notOnList', { name: m[1] }),
  },
  { re: /^Your mute list is empty\.$/, build: () => tServer('mutes.empty') },
  {
    re: /^Muted \((\d+)\): (.+)$/,
    build: (m) => tServer('mutes.list', { count: m[1], names: m[2] }),
  },
  {
    re: /^Usage: \/mute <name>, \/unmute <name>, \/mutelist\.$/,
    build: () => tServer('mutes.usage'),
  },
  // Blocks: the /block (alias /ignore) readouts. The add/remove lines reuse the
  // existing friends.nowIgnored / friends.noLongerIgnored rules above.
  { re: /^Your ignore list is empty\.$/, build: () => tServer('blocks.empty') },
  {
    re: /^Ignored \((\d+)\): (.+)$/,
