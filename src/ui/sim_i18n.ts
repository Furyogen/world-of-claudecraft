...
const baseEnTable = {
  ...
  'log.gatherToolHint': 'Walk up to a resource node and interact with it to harvest.',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'log.gatherToolHint': 'Acércate a un nodo de recursos e interactúa con él para recolectar.',
  ...
  fr_FR: {
    ...
    'log.gatherToolHint':
      "Approchez-vous d'un nœud de ressources et interagissez avec lui pour récolter.",
  ...
  it_IT: {
    ...
    'log.gatherToolHint': 'Avvicinati a un nodo di risorse e interagisci con esso per raccogliere.',
  ...
  de_DE: {
    ...
    'log.gatherToolHint':
      'Geht zu einem Ressourcenvorkommen und interagiert damit, um es zu ernten.',
  ...
  zh_CN: {
    ...
    'log.gatherToolHint': '走到资源点旁并与其互动即可采集。',
  ...
  zh_TW: {
    ...
    'log.gatherToolHint': '走到資源點旁並與其互動即可採集。',
  ...
  ko_KR: {
    ...
    'log.gatherToolHint': '자원 지점에 다가가 상호작용하면 채집할 수 있습니다.',
  ...
  ja_JP: {
    ...
    'log.gatherToolHint': '資源ポイントに近づいて操作すると採集できます。',
  ...
  pt_BR: {
    ...
    'log.gatherToolHint': 'Aproxime-se de um ponto de recursos e interaja com ele para coletar.',
  ...
  ru_RU: {
    ...
    'log.gatherToolHint':
      'Подойдите к источнику ресурсов и взаимодействуйте с ним, чтобы собрать его.',
