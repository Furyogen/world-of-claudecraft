...
export const zh_TW: EnTranslations = {
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "mirrorBlurb": "高守哨站的鏡子之外，是一片月華籠罩、霧氣繚繞的黑色琉璃之境；玻璃之谷收容著王國終局的亡魂，守護者奈瑞莎坐鎮流明谷地。",
      "mirrorGreeting": "玻璃留住它所溺沒的每一張臉。在此輕步而行，也別太久地凝望你自己的倒影。",
      "mirrorGreeter": "守護者奈瑞莎，流明谷地",
      "mirrorPlaceNotes": "流明谷地是這座鏡城的中心，鏡庭及其石像鬼雕像就在上方，觀景階梯則向下延伸；鏡潭是一泓沉靜的黑水，為月草原與哀慟石所環繞；幽暗峭壁與暗林盤踞著谷中最沉重的亡魂；女巫谷地棲居著霧巫莫溫，觀星崖坐擁它那漫長清冷的景致，黑色峽谷則蜿蜒向東，直通黑貂之鏡。",
