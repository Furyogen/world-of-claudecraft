...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "mounts": {
      ...
      "desc_pet_rock": "자신을 계속 밀어 준 이에게 정이 든 균열 밀기 퍼즐의 돌로, 빌린 말과 똑같은 속도로 당신을 태우고 갈려 나아갑니다.",
      "desc_shiny_pet_rock": "같은 돌이지만 마침내 받침대에 끼워져, 자신이 연 균열의 빛으로 금빛이 되었고, 그 뒤로 견딜 수 없이 우쭐합니다.",
