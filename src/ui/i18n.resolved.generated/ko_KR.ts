...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "amountWithUsd": "{amount} 클라우디움 ({usd})",
      "usdAmount": "${usd}",
      ...
      "railSol": "SOL",
      "railUsdc": "USDC",
      "railDisabled": "이 결제 수단은 현재 사용할 수 없습니다.",
      "oracleUnavailable": "실시간 가격을 현재 사용할 수 없습니다. 잠시 후 다시 시도해 주세요.",
      "quoteButton": "견적 받기",
      "amountRow": "{usd}로 {claudium} 클라우디움",
      "sendExactly": "정확히 {amount} {rail} 전송",
      "addressLabel": "받는 주소",
      "memoLabel": "메모 (필수)",
      "splitLabel": "분할",
      "splitBurn": "{amount} {rail} 소각",
      "splitTreasury": "{amount} {rail} 재무고로",
      "splitSummary": "{burn} {rail} 소각, {treasury} {rail} 재무로",
      "reviewLabel": "확인",
      "reviewLine": "{pay} {rail}을(를) 지불하고 {claudium} 클라우디움 ({usd})을(를) 받습니다.",
      "reviewLineCard": "{usd}을(를) 지불하고 {claudium} 클라우디움을 받습니다.",
      "discountLabel": "할인",
      "discountSummary": "실효 페그 가격에서 {percent}% 할인",
      "discountBonus": "{base}에서 {credited} 클라우디움으로 (+{bonus})",
      "wocIncentive": "$WOC로 결제 시 항상 15% 이상 할인",
      "wocPromoNote": "기간 한정 프로모션 포함",
      ...
      "signatureLabel": "거래 서명",
      "signaturePlaceholder": "서명 붙여넣기",
      "confirmButton": "결제 확인",
      "confirmCredited": "{amount} 클라우디움이 적립되었습니다.",
      "confirmFailed": "아직 이 결제를 확인할 수 없습니다. 잠시 후 다시 시도해 주세요.",
      "confirmPending": "온체인 확인을 기다리는 중입니다. 잠시 시간이 걸릴 수 있습니다.",
      "confirmNotFinalized": "결제가 아직 온체인에서 확인되지 않았습니다. 정상적인 상황이니 잠시 후 다시 확인하세요.",
      "confirmRequote": "가격이 변동되었습니다. 새 견적을 받아 다시 시도하세요.",
      "retryButton": "다시 시도",
      "requoteButton": "새 견적 받기",
      "insufficientBalance": "클라우디움이 부족합니다",
      "topUpButton": "Top up",
      "redeemTitle": "기프트 카드 교환",
      "enterCode": "기프트 카드 코드를 입력하세요",
      "codePlaceholder": "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX",
      "redeemButton": "교환",
      "redeemed": "{amount} 클라우디움을 교환했습니다. 새 잔액: {balance}.",
      "redeemFailed": "이 코드를 교환할 수 없습니다. 코드를 확인하고 다시 시도하세요.",
      "back": "뒤로",
      "historyExplorer": "Solana Explorer에서 보기",
      "historyReceipt": "카드 구매",
      "historyGiftNote": "기프트 카드",
      "timeJustNow": "방금",
      "timeMinutes": "{n}m ago",
      "timeHours": "{n}h ago",
      "timeDays": "{n}d ago",
      "tabGift": "Gift",
      "tabHistory": "내역",
      "giftTitle": "기프트 카드 선물하기",
      "giftDenominationLabel": "금액",
      "giftRecipientLabel": "받는 사람",
      "giftToSelf": "나에게",
      "giftToOther": "다른 사람에게",
      "giftEmailLabel": "받는 사람 이메일",
      "giftEmailPlaceholder": "name@example.com",
      "giftEmailInvalid": "유효한 이메일 주소를 입력하세요.",
      "giftOccasionLabel": "상황",
      "giftMessageLabel": "개인 메시지",
      "giftMessagePlaceholder": "짧은 메시지 추가 (선택)",
      "giftDeliveryLabel": "전달 방법",
      "giftScheduleLabel": "전달 예약 (선택)",
      "giftReviewButton": "선물 확인",
      "giftReviewSelf": "이 기프트 카드는 본인이 교환할 수 있습니다.",
      "giftReviewEmail": "이 기프트 카드를 {email}(으)로 보내드립니다.",
      "giftReviewShared": "이 기프트 카드를 공유할 링크를 받게 됩니다.",
      "giftReviewScheduled": "선택한 날짜에 전달됩니다.",
      "giftConfirmButton": "확인 후 결제",
      "giftAnotherButton": "하나 더 선물하기",
      "giftPending": "기프트 카드를 발급하고 있습니다. 잠시 걸릴 수 있습니다.",
      "giftIssued": "기프트 카드를 공유할 수 있습니다.",
      "giftFailed": "기프트 카드를 발급할 수 없습니다. 잠시 후 다시 시도하세요.",
      "giftDeclined": "결제가 거절되었습니다. 기프트 카드가 발급되지 않았습니다.",
      "giftLinkLabel": "기프트 카드 링크",
      "giftQrAlt": "기프트 카드 교환 링크 QR 코드",
      "giftTerms": "기프트 카드는 클라우디움으로만 교환할 수 있습니다. 현금으로 교환하거나 환불할 수 없습니다.",
      "deliveryEmail": "이메일",
      "deliveryLink": "링크 공유",
      "deliveryReveal": "지금 표시",
      "occasionBirthday": "생일",
      "occasionHoliday": "기념일",
      "occasionCongrats": "축하",
      "occasionThankyou": "감사",
      "occasionGeneric": "그냥",
      "reasonPurchaseStripe": "구매 (카드)",
      "reasonPurchaseSol": "구매 (SOL)",
      "reasonPurchaseUsdc": "구매 (USDC)",
      "reasonPurchaseWoc": "구매 (WOC)",
      "reasonGiftcardRedeem": "기프트 카드 교환",
      "reasonSpend": "장식 구매",
      "reasonRefund": "환불",
      "reasonChargeback": "지불 거절",
      "reasonGiftcardVoid": "기프트 카드 무효화",
      "historyTitle": "거래 내역",
      "historyLoading": "내역을 불러오는 중...",
      "historyError": "내역을 불러올 수 없습니다. 다시 시도하세요.",
      "historyEmpty": "아직 클라우디움 거래가 없습니다.",
