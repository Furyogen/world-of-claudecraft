...
export const it_IT: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "voiceChatEnabled": "Chat vocale (prossimità)",
      "voiceChatMicDenied": "L’accesso al microfono è stato negato. La chat vocale ne ha bisogno per funzionare.",
