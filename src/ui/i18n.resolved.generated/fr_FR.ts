...
export const fr_FR: EnTranslations = {
  ...
  "entities": {
    "abilities": {
      ...
      "lingering_dread": {
        "name": "Terreur persistante",
        "description": "Pousse un cri de guerre qui effraie les ennemis à moins de 10 m pendant 4 s. La peur persiste jusqu'à ce que chaque cible subisse des dégâts équivalant à 20 % de ses points de vie maximum. (Talent de guerrier)"
      },
      "stormthrow": {
        "name": "Lancer-tempête",
      ...
      "cleansing_verdict": {
        ...
        "description": "Purifie un effet magique néfaste sur une cible alliée et lui rend {damage} points de vie grâce au Sacré."
      },
      "voidfeast": {
        "name": "Festin du Vide",
        "description": "Dévore un effet magique (un effet bénéfique sur un ennemi ou néfaste sur un allié) et vous rend 6 % de vos points de vie maximum."
      },
      "spellsteal": {
        "name": "Vol de sort",
      ...
      "startle_shot": {
        "name": "Tir saisissant",
        "description": "Un tir imprévisible qui désoriente la cible pendant {duration} s. Tout dégât met fin à l'effet."
      },
      "spell_reflect": {
        "name": "Renvoi de sort",
        "description": "Levez votre bouclier et renvoyez le prochain sort hostile à son lanceur."
      },
      "smoke_screen": {
        "name": "Écran de fumée",
        "description": "Disparaissez dans un nuage de fumée, ce qui augmente vos chances d'esquiver pendant un moment."
      },
      "typhoon": {
        "name": "Typhon",
        "description": "Une rafale de vent repousse tous les ennemis proches et les hébète, ce qui ralentit leurs déplacements."
      },
      "bear_charge": {
        "name": "Ruée de Bruin",
