  ...
  "entities": {
    ...
    "npcs": {
      ...
      "caravan_master_saffa": {
        "name": "商队总管萨法",
        "title": "最后之井的守护者",
        "greeting": "在这里，水是唯一的钱币，朋友。高望派我们来精打细算地花——而这片荒原一心想让我们破产。"
      },
      "scout_maren_wastes": {
        "name": "玛伦斥候",
        "title": "元帅的斥候",
        "greeting": "我在泥沼湿地追过泥泞，也在荆峰高地踏过雪。沙子更糟。沙子记得你走过的每一步。"
      },
      "loremaster_caddis_wastes": {
        "name": "凯迪斯博学者",
        "title": "沉没王冠学者",
        "greeting": "扎凯斯一夜之间倾覆，{playerName}——整整一个王国，话说到一半就熔成了玻璃。我等了一辈子，就想听完那半句话。"
      },
      "brother_aldric_wastes": {
        "name": "奥德里克修士",
        "title": "山谷牧师",
        "greeting": "墓龙的热度连这里都在渗透，{playerName}——隔着靴底我都能感觉到。不管邪教在那片玻璃里挖什么，绝不能让他们带回去。"
      },
      "old_haruk": {
        "name": "老哈鲁克",
        "title": "心泉守望者",
        "greeting": "早在这眼泉水需要人看守之前，我家就世代守着它了。九位国王饮过泉水。第十位却想把它一口喝干。"
      },
      "provisioner_ashka": {
        "name": "补给官阿什卡",
        "title": "商队补给官",
        "greeting": "薄饼、椰枣酒，还有没泡过尸体的清水。全荒原最好的货色。"
      },
      "forgemaster_derin": {
        "name": "锻造大师德林",
        "title": "商队铁匠",
        "greeting": "炉膛里是沙，淬火桶里是沙，牙缝里还是沙。这份怨气全打进了刀刃——反倒更锋利了。"
      },
      "auctioneer_zeph": {
        "name": "拍卖师泽夫",
        "title": "世界市场管理人",
        "greeting": "世界市场连最后之井都能触及，朋友。金子在哪片沙漠里都一样沉。"
      },
      "wellwatch_hana": {
        "name": "井卫哈娜",
        "title": "商队卫士",
        "greeting": "带着水进来，带着水出去。中间发生的一切，都归我管。"
      },
      "wellwatch_toma": {
        "name": "井卫托马",
        "title": "商队卫士",
        "greeting": "安静的一班岗。在这儿，“安静”只是说沙子嚼得慢了些。"
      },
      "drover_pell": {
        "name": "驮夫佩尔",
        "title": "骡队驮夫",
        "greeting": "骡子先喝水。商队的规矩。你要想跟骡子讲道理，请自便。"
      },
      "dowser_emrys": {
        "name": "寻水者埃姆里斯",
        "title": "寻水人",
        "greeting": "我的探水杖在瀑布那儿弯成了两折，可方圆四十里再没别处有反应。这片土地离坟场，只差一眼泉水。"
      }
    },
    "quests": {
      "q_prof_intro": {
      ...
      "q_sw_arrival": {
        "title": "最后之井",
        "text": "欢迎来到地图的尽头，{playerName}。高望管这趟行动叫“南方远征”；我管它叫四十条人命和一眼泉水。别的都往后放——先取水。去营地以北的心泉水池灌满四只水囊，好让我知道通往瀑布的这条线走得安全。",
        "completion": "清冽、干净，你身上也没插着箭——这是最后之井整季听到的最好的消息。",
        "objectives": {
          "0": {
            "label": "满溢水囊"
          }
      ...
      "q_sw_prowlers": {
        "title": "暮色之牙",
        "text": "暮鬃兽已经听熟了我们水车的声音，{playerName}。每到黄昏它们就逼近一分，昨夜一头竟连着挽具把一头骡子拖走了。去营地以南的骨风平原削减兽群，带八张兽皮回来，证明这一课它们记住了。",
        "completion": "八张皮，桩线边就少了八道影子。骡子们总算能睡了——比我睡得还多。",
        "objectives": {
          "0": {
            "label": "击败暮鬃潜行兽"
          },
      ...
      "q_sw_carrion_glass": {
        "title": "食腐之玻",
        "text": "驮夫们管它们叫玻璃甲虫——猎犬那么大的甲虫，壳是熔成的玻璃，正从东边的焦地里成群涌出。德林发誓那壳能把刀刃磨得比任何磨石都利。敲碎八只甲虫，带回六只完整的壳；小心壳上的亮光，那说明它们正在硬化。",
        "completion": "瞧瞧这刃口的光！德林欠我一辈子的磨刀钱，而东边的路欠你一段更安静的旅程。",
        "objectives": {
          "0": {
            "label": "击败玻璃甲虫"
          },
      ...
      "q_sw_lost_caravan": {
        "title": "沙丘所藏",
        "text": "有三辆货车没能抵达水井，{playerName}——粮食、工具，还有赶头车的人，我妹妹的丈夫。风暴把它们吹散在西南的沙丘里。找到残骸，仔细搜一遍。我需要货单来清点损失……我还得知道，有没有人活着走了出去。",
        "completion": "靴印朝着远离残骸的方向延伸——然后就只剩劫掠者的足迹了。他们把车夫活着带走了。那要么是慈悲，要么是算计，而在这片荒原上，我知道该赌哪一个。",
        "objectives": {
          "0": {
            "label": "已搜查货车残骸"
          }
      ...
      "q_sw_marauders": {
        "title": "水税",
        "text": "沙丘之刃管这叫收税：要么交水，要么流血，见面即付。他们在沙丘西南的洼地里扎着营，围着我们被抢的篝火，喝着我们被抢的水囊。打垮他们，{playerName}。放倒十个劫掠者，再带回五只水囊——那一张张皮革里装的，是我们的人命。",
        "completion": "你带回的每一只水囊，都是这口井边有人多活的一天。沙丘之刃会记住向我们收税的代价。",
        "objectives": {
          "0": {
            "label": "击败沙丘之刃劫掠者"
          },
      ...
      "q_sw_karesh": {
        "title": "焦渴之王",
        "text": "他们的头目自封“焦渴者卡雷什”——他喝干了自己的蓄水池，还往残渣里撒盐，免得对手跟上来。一个能对自家水井下此狠手的人，对我们的井只会更狠。他在西面山脊下的卡雷什洼地里称王。终结他的统治，{playerName}，再把他私藏的最后一只水囊带回来。",
        "completion": "这就是焦渴之王的最后一囊水了。萨法会把它倒回井里——一滴不少，这是原则。",
        "objectives": {
          "0": {
            "label": "击败焦渴者卡雷什"
          },
      ...
      "q_sw_survey": {
        "title": "未竟之句",
        "text": "既然水井暂时用不上你——就陪我走一趟历史吧，{playerName}。太阳王庭留下了壁画：一幅在渡槽之脊下，一幅在平顶山脚，还有一幅在绿洲废墟的双塔旁。把三幅都拓下来。扎凯斯死在半句话上，而我打算读完剩下的半句。",
        "completion": "看——句子接上了：“当王冠烫得再也戴不住时，诸王登上平顶山，把火焰还了回去。”一场弃绝之仪，借方尖碑而行——先晨，再午，后暮。这顺序很要紧，{playerName}。仪式向来讲究顺序。",
        "objectives": {
          "0": {
            "label": "已拓取壁画"
          }
      ...
      "q_sw_vigil_dawn": {
        "title": "守夜之仪：晨",
        "text": "营地以西的平顶山正是“守夜台”本身——诸王的弃绝之路。晨曦方尖碑立在第一层台地上，那是太阳最先照到的地方。攀上盘山道，把手按上去。晨曦最先苏醒；壁画对这一点相当固执。",
        "completion": "你感到它在嗡鸣了？妙极。两个纪元过去，仪式的力量竟还在。晨已点亮——午在上方等着。",
        "objectives": {
          "0": {
            "label": "从方尖碑取得晨火印记"
          }
      ...
      "q_sw_vigil_noon": {
        "title": "守夜之仪：午",
        "text": "正午加冕于峰顶——第二座方尖碑立在平顶山的最高处，在那里，太阳独占整片天空。攀登本身就是仪式的一部分，{playerName}：诸王当年是顶着王冠一步一步爬上去的。去唤醒正午方尖碑。",
        "completion": "先晨，后午。仪式只剩最后一个时辰了——而守夜台已经开始注意到我们。",
        "objectives": {
          "0": {
            "label": "从方尖碑取得午火印记"
          }
      ...
      "q_sw_vigil_dusk": {
        "title": "守夜之仪：暮",
        "text": "黄昏总是最后一个到场——它的方尖碑立在西面的山嘴上，俯瞰峡谷。但你要明白这仪式的本质，{playerName}：弃绝，必须有见证。王庭以活的山岩铸了一尊哨卫来作见证，当暮火点亮，它便会醒来，审判你是真心弃绝，还是只想索取。说服它。彻底地说服。",
        "completion": "哨卫判定你配得上——或者判定你杀不死，对一块石头来说，这是同一个结论。守夜之仪已成，扎凯斯的每一扇门，如今都成了值得一问的问题。",
        "objectives": {
          "0": {
            "label": "黄昏方尖碑已唤醒"
          },
      ...
      "q_sw_revenants": {
        "title": "死者的岗哨",
        "text": "扎凯斯的士兵从没听说战争打输了——更没听说战争只打了一夜。他们在瀑布以北的外城废墟里游荡，甲胄熔进了骨头，向过路人索要早已无人记得的口令。送十二个亡魂安息，{playerName}，再收集他们的卫队印信；有了印，我们才能进到城市更深处。",
        "completion": "每一枚印信都还是温的——至死效忠，死后犹然。维系他们岗哨的东西还在更深处，而现在，我们的官阶比它高了。",
        "objectives": {
          "0": {
            "label": "击败日炙亡魂"
          },
      ...
      "q_sw_courtiers": {
        "title": "灰烬王庭",
        "text": "再往深处，王庭本身仍在开庭——内侍与诵经士守着一位死去国王的礼制，对着一座熔渣王座诵读诗篇。他们的诗篇集里记着圣殿的礼文，而礼文里藏着点燃王冠火盆的仪式。去搅散这场朝会，{playerName}，给我带回一本书页完好的诗篇集。",
        "completion": "哦，这可是绝妙的手笔——整套火盆仪轨，出自一位死去领唱人的笔下。他们对着一座空王座，把它唱了两百年。我几乎要可怜他们了。几乎。",
        "objectives": {
          "0": {
            "label": "击败灰烬廷臣"
          },
      ...
      "q_sw_braziers": {
        "title": "燃起的王冠",
        "text": "诗篇在诸塔之间点出了三座王冠火盆——三座齐燃，内圣殿便会自行开启，一如当年的加冕礼。我已把仪文用粉笔抄在了你的护手上，{playerName}；尽量别出汗。先把丑话说在前头：点亮的王冠，是看得见的王冠。第三簇火苗燃起的那一刻，全城的东西都会知道。",
        "completion": "我们在井边看着塔楼一座接一座亮起——萨法哭了，而我承认，这回我没教训任何人。圣殿的门开了。里面有什么东西，正在唱和。",
        "objectives": {
          "0": {
            "label": "已点燃王冠火盆"
          }
      ...
      "q_sw_sunspeaker": {
        "title": "第十次加冕",
        "text": "圣殿里的声音属于太阳代言人阿塔里斯——扎凯斯九王皆由他加冕。诗篇称他为王庭活着的记忆，而他用两个纪元筹备着第十次加冕：为火焰本身加冕。他就站在双塔之间的太阳王座前。废黜他，{playerName}，赶在他完成一场全沙漠都会后悔的仪式之前。",
        "completion": "九顶王冠，他戴上了九个额头；而第十顶，本要烧尽整个世界才戴得下。史书将记载：是你宣布扎凯斯王庭休庭。我会亲自盯着史书，一字不差地这么写。",
        "objectives": {
          "0": {
            "label": "太阳代言人阿塔里斯已被废黜"
          }
      ...
      "q_sw_emberveil": {
        "title": "烬纱",
        "text": "你已经见过东边崖沿那些蒙纱的营地了，{playerName}。他们是龙教——一支分裂出来的教派，自称烬纱，趁高望死盯着圣所大门时翻过了山口。母教高歌着要唤醒墓龙，这一支却在挖东西，想武装它。他们的狂热者和炎术师正把那片玻璃翻了个遍。趁他们还没找到，削减他们的人手。",
        "completion": "那片玻璃里少了十六把铲子。可挖掘昼夜不停——他们已经不是在找了，{playerName}。他们是在开掘。",
        "objectives": {
          "0": {
            "label": "击败烬纱狂热者"
          },
      ...
      "q_sw_writs": {
        "title": "烬纱教令",
        "text": "他们的头目身上带着教令——用母教密文写就的指令。那套密文我在高望破解过一次，在这里就能再破解一次。给我带来五份烬纱教令，{playerName}，我们就能读到他们被派来取的究竟是什么。",
        "completion": "正如我所惧。“寻回初烬——诸太阳王窃取并锁住的、主上之火的碎片。将它送至圣所之门；封印绝不会容忍出自它自身的火焰。”他们要用墓龙自己被窃的火，烧开墓龙的门，{playerName}。",
        "objectives": {
          "0": {
            "label": "烬纱教令"
          }
      ...
      "q_sw_glasscut": {
        "title": "天空燃烧之地",
        "text": "玻璃裂谷正是初烬坠落之处——就在它毁灭扎凯斯的那一夜。地面至今滚烫，烬火元素在那里游走，像一簇簇从未落地的火星。初烬正在苏醒，{playerName}；邪教挖得越近，它的火星就越胆大。驱散八个元素，再给我带来五枚活烬。我必须掂一掂我们将要面对的这团火。",
        "completion": "泡在祝福过的盐里，它们还在扭动……这是龙火，如今再无可疑。初烬不是遗物，{playerName}，它是残躯——科祖尔怒火上活生生的一块，而且它还记得自己曾被当作王冠佩戴。",
        "objectives": {
          "0": {
            "label": "击败烬火元素"
          },
      ...
      "q_sw_offering": {
        "title": "心泉不忘",
        "text": "牧师打算直面那团火，还要带上你。那就先听一句守井人的智慧吧，{playerName}：心泉自墓龙牢狱的正下方涌起，而从一物之下流过的水，最了解那一物。带上我的供碗，去瀑布顶端的水池，倾倒，然后聆听。这眼泉水曾经溺熄过这团火。去讨火烧之前，先让泉水祝福你。",
        "completion": "你也听见了——深处的水，在世界之下流动。把那声音当铠甲穿上吧，{playerName}。火焰喧嚣，可泉水先于它存在，也会在它熄灭之后长存。",
        "objectives": {
          "0": {
            "label": "已在心泉倾倒供品"
          }
      ...
      "q_sw_first_ember": {
        "title": "初烬",
        "text": "它出土了，{playerName}。邪教的矿坑在黎明破开，玻璃裂谷从内部亮起——初烬立在它两个纪元前砸出的坑里，把火焰穿成一身王袍，烬纱信徒成排朝它跪拜。一旦它抵达圣所之门，高望流过的每一滴血都将化为灰烬。你身上有泉水的祝福，也有守夜台的见证。下到玻璃里去，替扎凯斯写完那半句话：火焰，还回去。",
        "completion": "它死去的那一刻，瀑布骤然湍急明亮——那是泉水，把宿敌收入水底。你做到了九位国王没能做到的事，{playerName}：你把火还了回去。坐下吧，喝口水。今晚的水最甜。",
        "objectives": {
          "0": {
            "label": "初烬已被熄灭"
          }
      ...
      "q_sw_afterglow": {
        "title": "水归生者",
        "text": "哈鲁克说，泉水如今唱低了一个音，像一笔还清的债。烬纱或成灰或远遁，王庭已休庭，我的账本上终于是水多过愁。最后一件事，{playerName}——在营地里走一圈，让玛伦、凯迪斯和奥德里克修士好好向你道一声谢。他们挣得了这个机会，你也一样。",
        "completion": "那么一切都结束了，最后之井也终于只是……一口井。若是这个老商队头儿说了还算数，它将是一条活路上众多水井中的第一口。灼热荒原会记住你的名字，{playerName}——水记得一切。",
        "objectives": {
          "0": {
            "label": "已与玛伦斥候交谈"
          },
