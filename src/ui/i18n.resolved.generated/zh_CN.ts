...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      ...
      "vitality": "生命力",
      "survivorsAria": "{total} 人中还有 {count} 人存活",
      "prizeAria": "奖金池:{amount}",
      ...
      "hint": {
        ...
        "pull": "随每声鼓点点击、轻触或按空格键。",
        "wagerHold": "点击一枚石子,藏起相应数量的弹珠。",
        "wagerGuess": "点击石头:一点为单,两点为双。",
        "span": "横渡玻璃桥。每对板中藏着一块脆板。",
        "court": "光环闪起时点击对手,将其推出场外。"
      }
    },
    "hc": {
      "title": "霍德里克城堡",
