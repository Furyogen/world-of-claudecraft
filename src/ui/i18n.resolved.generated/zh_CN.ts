...
export const zh_CN: EnTranslations = {
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "mirrorBlurb": "高守哨站的镜子之外，是一片月华笼罩、雾气缭绕的黑色琉璃之境；玻璃之谷收容着位面终局的亡魂，守护者奈瑞莎坐镇流明谷地。",
      "mirrorGreeting": "玻璃留住它所溺没的每一张脸。在此轻步而行，也别太久地凝望你自己的倒影。",
      "mirrorGreeter": "守护者奈瑞莎，流明谷地",
      "mirrorPlaceNotes": "流明谷地是这座镜城的中心，镜庭及其石像鬼雕像就在上方，观景阶梯则向下延伸；镜潭是一泓沉静的黑水，为月草甸与哀恸石所环绕；幽暗峭壁与暗林盘踞着谷中最沉重的亡魂；女巫谷地栖居着雾巫莫温，观星崖坐拥它那漫长清冷的景致，黑色峡谷则蜿蜒向东，直通黑貂之镜。",
