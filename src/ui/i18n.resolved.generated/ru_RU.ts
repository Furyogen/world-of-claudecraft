  ...
  "entities": {
    ...
    "mobs": {
      ...
      "pearlshell_skitterer": {
        "name": "Жемчужнопанцирный скороход"
      },
      "kelpshade_lurker": {
        "name": "Ловчий келповой тени"
      },
      "undertow_maw": {
        "name": "Пасть Отбойного Течения"
      },
      "ironvein_foreman": {
    ...
    "npcs": {
      ...
      "keeper_nerissa": {
        "name": "Хранительница Нерисса",
        "title": "Страж Короны Люмена",
        "greeting": "Береги стекло, гость с поверхности. Оно держится целую эпоху — помоги нам сохранить его."
      },
      "tidewright_ollo": {
        "name": "Оло Приливодел",
        "title": "Приливодел Жемчужного рынка",
        "greeting": "Свежее из последних сухих перегонных кубов глубин. Сначала монета, потом истории."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "zones": {
      ...
      "atlantis": {
        "name": "Атлантида",
        "welcome": "Купол всё ещё поёт, и Атлантида держится под Глубинным Течением.",
        "pois": {
          "0": {
            "label": "Атлантида"
          },
          "1": {
            "label": "Площадь Врат Прилива"
          },
          "2": {
            "label": "Корона Люмена"
          },
          "3": {
            "label": "Жемчужный рынок"
          },
          "4": {
            "label": "Затонувший архив"
          },
          "5": {
            "label": "Пристройка стражей водорослей"
          }
        }
      }
    },
