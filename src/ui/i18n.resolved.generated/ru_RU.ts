...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hc": {
      ...
      "howto": "Пройдите испытание замка: уклоняйтесь от цепов, лавируйте среди брёвен, ловите момент топоров, пересеките разводной мост, избегайте валунов. Кто первым пересечёт финиш, получит корону. Падения лишь отнимают время.",
      ...
      "section": {
        ...
        "flail_bridge": "Мост цепов",
        "log_court": "Двор брёвен",
        "axe_walk": "Проход топоров",
        "drawspan": "Разводной мост",
        "boulder_alley": "Аллея валунов",
  ...
  "guide": {
    ...
    "hodricsCastlePage": {
      ...
      "courseHeading": "Трасса испытания",
      "courseBody": "Трасса идёт от Стартового двора через Мост цепов, Двор брёвен, Проход топоров, Разводной мост, Аллею валунов и вверх по Багровому подъёму к Финишной башне. Каждое препятствие качается, вращается или катится по своему собственному, всегда неизменному ритму — никогда случайно, так что внимательный взгляд всегда найдёт безопасное окно.",
      ...
      "fallsBody": "Удар от препятствия или падение в пропасть лишь отправляют вас к последней контрольной точке. На этой дороге никто не погибает: единственная цена падения — те секунды, что нужны, чтобы снова наверстать упущенное.",
      "standingsHeading": "Корона",
      "standingsBody": "Кто первым пересекает финишную черту, забирает Корону Ходрика за этот заезд. Число ваших заездов, побед и лучшее время растут с каждым новым участием."
    },
    "wishPage": {
