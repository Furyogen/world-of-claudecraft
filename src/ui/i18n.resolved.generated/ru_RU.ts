...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "auraEffect": {
      ...
      "arcaneCharges": "Заряды тайной магии (до 4). Каждый заряд усиливает урон вашего следующего Эфирного всплеска и ускоряет его чтение на 5%, но резко повышает его расход маны. Стрелы эфира расходуют все заряды.",
      "aetherRush": "Ваш следующий Эфирный всплеск бесплатен и читается вдвое быстрее",
      "perfectMoment": "Удерживает 4 заряда тайной магии. Стрелы эфира больше не расходуют их, позволяя раз за разом выпускать полный залп из пяти снарядов",
      "temporalEcho": "Отмечены эхом более здорового мгновения: часть тайного урона заклинателя возвращается, исцеляя вас",
      "increase": {
