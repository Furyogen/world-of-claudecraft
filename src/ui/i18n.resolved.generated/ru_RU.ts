...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      ...
      "phaseTrialWager": "Пари Хранителя начинается",
      ...
      "placeSecond": "2nd",
      "placeThird": "3rd",
      "roleAttacker": "Атакующий",
      "roleDefender": "Защитник",
      ...
      "hint": {
        ...
        "pull": "Кликайте, касайтесь или жмите пробел в такт барабану.",
        "wagerHold": "Кликните по камешку, чтобы спрятать столько шариков.",
        "wagerGuess": "Кликните по камню: одна точка значит нечет, две точки значат чет.",
        "span": "Перейдите по стеклу. В каждой паре одна панель хрупкая.",
        "court": "Когда кольцо вспыхнет, кликните по сопернику, чтобы вытолкнуть его."
      }
    },
    "hc": {
      "title": "Замок Ходрика",
