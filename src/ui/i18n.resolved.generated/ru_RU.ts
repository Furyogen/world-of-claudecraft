  ...
  "entities": {
    "abilities": {
      ...
      "aura_surge": {
        ...
        "description": "Бросает выкованный на рассвете щит, наносящий {damage} ед. урона от Света и лишающий основную цель возможности произносить заклинания на 2 сек. Затем щит отскакивает не более чем к {jumps} другим противникам в радиусе {radius} м, нанося {falloff} ед. урона за отскок. (талант паладина)"
      },
      "holy_shield": {
      ...
      "lingering_dread": {
        "name": "Тянущийся ужас",
        "description": "Издаёт боевой клич, обращая врагов в радиусе 10 м в бегство на 4 сек. Страх не рассеивается, пока каждая цель не получит урон в размере 20% от максимального запаса здоровья. (талант воина)"
      },
      "stormthrow": {
      ...
      "spell_reflect": {
        ...
        "description": "Поднимает щит, отражая следующее вражеское заклинание обратно в чародея."
      },
      "smoke_screen": {
        "name": "Дымовая завеса",
        "description": "Скрывает вас в облаке дыма, повышая шанс уклонения на время."
      },
      "typhoon": {
        "name": "Тайфун",
        "description": "Порыв ветра отбрасывает всех врагов поблизости и оглушает их, замедляя передвижение."
      },
      "bear_charge": {
        "name": "Натиск бурого",
