...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "dungeonsPage": {
      ...
      "abyssBody": "Пылающий разлом под Грозовым кряжем, где закованный в цепи легион раздувает горны своего инфернального владыки. Путь один: вниз, мимо лавы и пасти бездны, к самому сердцу бездны.",
  ...
  "entities": {
    ...
    "items": {
      ...
      "charred_legion_tablet": {
        "name": "Обугленная табличка легиона"
      },
      "brands_of_the_first_flame": {
        "name": "Клейма первого пламени"
      },
      "forgekeepers_ledger": {
        "name": "Книга Хранителя горна"
      },
      "azazels_broken_covenant": {
        "name": "Разорванный договор Азазеля"
      },
      "emberforged_vambraces": {
        "name": "Наручи, выкованные в углях"
      },
      "cinderthread_mantle": {
        "name": "Оплечье из пепельной нити"
      },
      "hellstalker_boots": {
        "name": "Сапоги адского охотника"
      },
      "forgekeepers_warhammer": {
        "name": "Боевой молот Хранителя горна"
      },
      "forgekeepers_runestaff": {
        "name": "Рунный посох Хранителя горна"
      },
      "forgekeepers_fang": {
        "name": "Клык Хранителя горна"
      },
      "azazels_ruinblade": {
        "name": "Клинок погибели Азазеля"
      },
      "azazels_soulstaff": {
        "name": "Посох душ Азазеля"
      },
      "azazels_emberfang": {
        "name": "Угольный клык Азазеля"
      },
      "hellforged_bulwark": {
        "name": "Оплот адской ковки"
      },
      "cinderseer_raiment": {
        "name": "Одеяние провидца углей"
      },
      "abysswalker_harness": {
        "name": "Портупея странника Бездны"
      },
      "bristleback_maul": {
    ...
    "mobs": {
      ...
      "abyssal_legionnaire": {
        "name": "Легионер Бездны"
      },
      "cinder_magus": {
        "name": "Маг углей"
      },
      "molten_hellhound": {
        "name": "Расплавленная адская гончая"
      },
      "flamebound_smith": {
        "name": "Скованный пламенем кузнец"
      },
      "abyssal_gladiator": {
        "name": "Гладиатор Бездны"
      },
      "infernal_cinderling": {
        "name": "Адский уголёк"
      },
      "forgekeeper": {
        "name": "Хранитель горна"
      },
      "pyre_golem": {
        "name": "Голем погребального костра"
      },
    ...
    "quests": {
      ...
      "q_infernal_abyss_echoes": {
        "title": "Эхо под Грозовым кряжем",
        "text": "Грозовой кряж породила не буря, {playerName}. Древнейшие таблички называют его крышкой, выкованной над пламенем, которое упало из-за пределов мира. Под восточной скалой открылась новая трещина. Войдите туда с четырьмя союзниками и найдите табличку легиона и клейма, высеченные у первого пламени.",
        "completion": "На табличке названо войско, которое добровольно шагнуло в огонь. Клейма называют силу, которой оно служило: Азазель. Эту темницу построили не для того, чтобы не впустить демонов, {playerName}. Это врата, через которые должен был войти их владыка.",
        "objectives": {
          "0": {
            "label": "Обугленная табличка легиона расшифрована"
          },
          "1": {
            "label": "Клейма первого пламени изучены"
          }
        }
      },
      "q_infernal_abyss_covenant": {
        "title": "Разорванный договор",
        "text": "Клятва легиона обещала Азазелю путь в наш мир, но у каждого договора есть цена и изъян. Вернитесь в Адскую бездну. Найдите книгу Хранителя горна и разорванный договор возле Пасти. Если мы узнаем, что связывало Азазеля, то, возможно, поймём, как его убить.",
        "completion": "Вот изъян: Азазель питал врата именами собственного легиона. Каждый поглощённый слуга делал его сильнее, но привязывал его жизнь к горну в глубине. Сокрушите владыку в сердце этого горна, и врата погибнут вместе с ним.",
        "objectives": {
          "0": {
            "label": "Книга Хранителя горна найдена"
          },
          "1": {
            "label": "Разорванный договор Азазеля прочитан"
          }
        }
      },
      "q_infernal_abyss_azazel": {
        "title": "Владыка Адской бездны",
        "text": "Договор даёт нам лишь один шанс, {playerName}. Спуститесь с верными спутниками за горн и Пасть. Сразитесь с Азазелем там, где первое пламя касается нашего мира, выстойте против его легионов и погасите владыку Преисподней, прежде чем Грозовой кряж станет его открытыми вратами.",
        "completion": "Гора затихла. Она не спит, не ждёт, а просто молчит. Азазель возвёл вечность из украденных имён, а вы положили ей конец одним собственным смертным именем. Высокий Дозор запомнит его, {playerName}.",
        "objectives": {
          "0": {
            "label": "Азазель, владыка Преисподней, повержен"
          }
        }
      },
      "q_drowned_choir": {
    ...
    "dungeons": {
      ...
      "infernal_abyss": {
        "name": "Адская бездна",
        "enterText": "Вы спускаетесь под Грозовой кряж в Адскую бездну.",
        "leaveText": "Вы поднимаетесь из горнильной тьмы навстречу горному ветру."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
