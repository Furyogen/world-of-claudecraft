...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      ...
      "sigilsTitle": "Обведите знак",
      "sigilsHint": "Обведите вырезанную линию и не дайте ей треснуть.",
      "cracks": "Трещины",
      "traced": "Обведено",
      "sigilsShattered": "Стекло разбилось!",
      "wagerTitle": "Пари Хранителя",
      "wagerYours": "Ваши: {count}",
      ...
      "odd": "Нечет",
      "even": "Чёт",
      "wagerWon": "Вы выиграли поединок.",
      "wagerLost": "Вы проиграли поединок."
    },
    "hc": {
      "title": "Замок Ходрика",
