...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "cameraPrompt": {
      ...
      "mouseDesc": "Двигайте мышью, чтобы поворачивать камеру. Современное управление, которое предпочитает большинство новичков.",
      "recommended": "Рекомендуется",
      "classicTitle": "Классическая камера",
      "classicDesc": "Удерживайте правую кнопку мыши, чтобы поворачивать камеру. Классическая схема управления.",
