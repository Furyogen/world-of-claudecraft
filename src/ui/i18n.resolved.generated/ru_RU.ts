...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "claudium": {
      ...
      "amountWithUsd": "{amount} Клаудиума ({usd})",
      "usdAmount": "${usd}",
      ...
      "kindSkin": "Облик",
      "kindItem": "Предмет",
      "tabsLabel": "Вкладки Клаудиума",
      "tabBuy": "Купить",
      "tabRedeem": "Активировать",
      "railSol": "SOL",
      "railUsdc": "USDC",
      "railDisabled": "Этот способ оплаты сейчас недоступен.",
      "oracleUnavailable": "Актуальные цены сейчас недоступны. Пожалуйста, повторите попытку чуть позже.",
      "quoteButton": "Получить котировку",
      "amountRow": "{usd} за {claudium} Клаудиума",
      "sendExactly": "Отправьте ровно {amount} {rail}",
      "addressLabel": "Отправить на",
      "memoLabel": "Заметка (обязательно)",
      "splitLabel": "Распределение",
      "splitBurn": "{amount} {rail} сожжено",
      "splitTreasury": "{amount} {rail} в казну",
      "splitSummary": "сжигается {burn} {rail}, {treasury} {rail} в казну",
      "reviewLabel": "Проверка",
      "reviewLine": "Вы платите {pay} {rail} и получаете {claudium} Клаудиума ({usd}).",
      "reviewLineCard": "Вы платите {usd} и получаете {claudium} Клаудиума.",
      "discountLabel": "Скидка",
      "discountSummary": "Скидка {percent}% от эффективной цены привязки",
      "discountBonus": "{base} до {credited} Клаудиума (+{bonus})",
      "wocIncentive": "Платите $WOC - всегда скидка от 15%",
      "wocPromoNote": "Включает ограниченную по времени акцию",
      "expiresIn": "Котировка истекает через {time}",
      "quoteExpired": "Эта котировка истекла. Получите новую.",
      "copyAddress": "Скопировать адрес",
      "copied": "Скопировано",
      "payNote": "Отправьте точную сумму с заметкой из своего кошелька, затем вставьте подпись транзакции для подтверждения. Сервис проверяет её в блокчейне перед начислением.",
      "signatureLabel": "Подпись транзакции",
      "signaturePlaceholder": "Вставьте подпись",
      "confirmButton": "Подтвердить оплату",
      "confirmCredited": "Начислено {amount} Клаудиума.",
      "confirmFailed": "Этот платёж пока не удалось подтвердить. Пожалуйста, повторите чуть позже.",
      "confirmPending": "Ожидание подтверждения в сети. Это может занять некоторое время.",
      "confirmNotFinalized": "Ваш платеж еще не подтвержден в сети. Это нормально: подождите немного и подтвердите снова.",
      "confirmRequote": "Цена изменилась. Получите новую котировку и повторите попытку.",
      "retryButton": "Повторить",
      "requoteButton": "Получить новую котировку",
      "insufficientBalance": "Недостаточно Клаудиума",
      "topUpButton": "Top up",
      "redeemTitle": "Активировать подарочную карту",
      "enterCode": "Введите код подарочной карты",
      "codePlaceholder": "XXXXX-XXXXX-XXXXX-XXXXX-XXXXX",
      "redeemButton": "Активировать",
      "redeemed": "Активировано {amount} Клаудиума. Новый баланс: {balance}.",
      "redeemFailed": "Этот код не удалось активировать. Проверьте код и повторите попытку.",
      "back": "Назад",
      "historyExplorer": "Посмотреть в Solana Explorer",
      "historyReceipt": "Покупка картой",
      "historyGiftNote": "Подарочная карта",
      ...
      "tabGift": "Gift",
      "tabHistory": "История",
      "giftTitle": "Подарить карту",
      "giftDenominationLabel": "Номинал",
      "giftRecipientLabel": "Получатель",
      "giftToSelf": "Себе",
      "giftToOther": "Другому",
      "giftEmailLabel": "Эл. почта получателя",
      "giftEmailPlaceholder": "name@example.com",
      "giftEmailInvalid": "Введите корректный адрес эл. почты.",
      "giftOccasionLabel": "Повод",
      "giftMessageLabel": "Личное сообщение",
      "giftMessagePlaceholder": "Добавьте короткое сообщение (необязательно)",
      "giftDeliveryLabel": "Доставка",
      "giftScheduleLabel": "Запланировать доставку (необязательно)",
      "giftReviewButton": "Проверить подарок",
      "giftReviewSelf": "Эту подарочную карту сможете активировать вы.",
      "giftReviewEmail": "Мы отправим эту подарочную карту на {email}.",
      "giftReviewShared": "Вы получите ссылку, чтобы поделиться этой подарочной картой.",
      "giftReviewScheduled": "Доставка запланирована на выбранную вами дату.",
      "giftConfirmButton": "Подтвердить и оплатить",
      "giftAnotherButton": "Подарить ещё одну",
      "giftPending": "Выпускаем вашу подарочную карту. Это может занять некоторое время.",
      "giftIssued": "Ваша подарочная карта готова к отправке.",
      "giftFailed": "Не удалось выпустить эту подарочную карту. Пожалуйста, повторите чуть позже.",
      "giftDeclined": "Платёж отклонён. Подарочная карта не выпущена.",
      "giftLinkLabel": "Ссылка на подарочную карту",
      "giftQrAlt": "QR-код ссылки для активации подарочной карты",
      "giftTerms": "Подарочные карты можно обменять только на Клаудиум. Их нельзя обменять на деньги или вернуть.",
      "deliveryEmail": "Эл. почта",
      "deliveryLink": "Поделиться ссылкой",
      "deliveryReveal": "Показать сейчас",
      "occasionBirthday": "День рождения",
      "occasionHoliday": "Праздник",
      "occasionCongrats": "Поздравление",
      "occasionThankyou": "Благодарность",
      "occasionGeneric": "Просто так",
      "reasonPurchaseStripe": "Покупка (карта)",
      "reasonPurchaseSol": "Покупка (SOL)",
      "reasonPurchaseUsdc": "Покупка (USDC)",
      "reasonPurchaseWoc": "Покупка (WOC)",
      "reasonGiftcardRedeem": "Подарочная карта активирована",
      "reasonSpend": "Покупка косметики",
      "reasonRefund": "Возврат средств",
      "reasonChargeback": "Возвратный платёж",
      "reasonGiftcardVoid": "Подарочная карта аннулирована",
      "historyTitle": "История транзакций",
      "historyLoading": "Загрузка вашей истории...",
      "historyError": "Не удалось загрузить вашу историю. Пожалуйста, повторите попытку.",
      "historyEmpty": "У вас пока нет транзакций с Клаудиумом.",
