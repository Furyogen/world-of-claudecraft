...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "gauntlet": {
      ...
      "queuePosition": "Место в очереди: {n}",
      "spectate": "Наблюдать",
      ...
      "phaseTrialSigils": "Начинается гравировка",
      "phaseTrialPull": "Взяться за канат",
      "phaseTrialEcho": "Эхо Хранителя начинается",
      "phaseTrialSpan": "Перейди хрупкий мост",
      "phaseTrialCourt": "Последняя арена",
      ...
      "placeSecond": "2nd",
      "placeThird": "3rd",
      "sigilsShattered": "Стекло разбилось!",
      "echoRound": "Раунд {n} из {total}",
      "echoSeconds": "{seconds}s",
      "hint": {
        "sentinel": "Беги на зелёный. Замри на красный.",
        "sigils": "Обведите высеченную фигуру: зажмите и ведите по линии, пока не пройдёте её целиком. Сойдёте с линии, и плита треснет.",
        "sigilsLive": "Зажмите и ведите по высеченной линии. Начните где угодно и пройдите её целиком.",
        "pull": "Кликайте по кругу, когда он сожмётся до внутреннего кольца.",
        "echoWatch": "Смотрите, в каком порядке вспыхивают камни.",
        "echoAnswer": "Кликайте по камням в том же порядке.",
        "span": "Перейдите по стеклу. В каждой паре одна панель хрупкая.",
        "court": "Сразитесь с соперником: дойдите до короны в дальнем конце или вытолкните его с ринга. Роли меняются по таймеру."
      }
    },
    "hub": {
      "enter": "Вы проходите сквозь мерцающий портал в Испытательную арену.",
      "leave": "Вы возвращаетесь в Истврукскую долину.",
      "zoneName": "Атеней испытаний"
    },
    "hc": {
      "title": "Замок Ходрика",
      "close": "Закрыть окно Гонтлета",
      "zoneName": "Замок Ходрика",
      "offlineNote": "Стол Гонтлета ещё не синхронизирован. Один момент.",
      "howto": "Три раунда, десять гонщиков, одна корона. Лорд Ходрик перестраивает свою полосу каждый раунд: переживите отсев (проходят шестеро, затем трое) и выиграйте финал. Падения стоят лишь времени.",
      "joinQueue": "Присоединиться к Гонтлету",
      "leaveQueue": "Покинуть очередь",
      "queuedAt": "В очереди, позиция {position}. Заезд начнётся, когда наберётся десять участников.",
      "inMatchNote": "Вы участвуете в гонке. Смотрите только вперёд!",
      "practice": "Потренироваться с придворными",
      "practiceNote": "Сразитесь с придворными лорда Ходрика: девять соперников, никакого ожидания.",
      "record": "Корон {wins} / Гонок {races}",
      "bestTime": "Лучшее время {seconds}с",
      "bestNone": "Пока нет завершённых заездов",
      "rank": "Позиция {rank} / {total}",
      "finishPlace": "Финиш: {place} место",
      "timeLeft": "{seconds}s",
      "overWon": "Корона теперь ваша!",
      "overPlaced": "Гонка окончена: {place} место",
      "round": "Раунд {round}/{rounds}",
      "advance": "Проходят: {count}",
      "spectating": "Наблюдаете с галереи",
      "intermissionRebuild": "Лорд Ходрик перестраивает полосу!",
      "intermissionQualified": "Вы прошли. Скоро следующий раунд.",
      "intermissionEliminated": "Выбыли! Наслаждайтесь видом с галереи.",
      "section": {
        "start_yard": "Стартовый двор",
        "hammer_bridge": "Молотовый мост",
        "rotor_court": "Двор с брёвнами",
        "axe_walk": "Проход топоров",
        "drawspan": "Разводной мост",
        "boulder_climb": "Валунный подъём",
        "piston_ledge": "Карниз с поршнями",
        "spinner_court": "Двор с каруселями",
        "landing": "Площадка",
        "red_ascent": "Багровый подъём",
        "finish_keep": "Финишная башня"
      },
      "banner": {
        "found": "Гонтлет зовёт!",
        "go": "Старт!",
        ...
        "qualified": "ПРОШЁЛ!",
        "eliminated": "ВЫБЫЛ",
        "finish": "Финиш: {place} место!",
        "crown": "Вы забираете корону Ходрика!"
      },
      "log": {
        "queued": "Вы встали в очередь Гонтлета (позиция {position}).",
        "unqueued": "Вы покинули очередь Гонтлета.",
        "fall": "Пропасть поглотила вас. Возврат к контрольной точке.",
        "checkpoint": "Контрольная точка {index} пройдена.",
        "qualified": "Вы проходите в следующий раунд.",
        "eliminated": "Выбыли в раунде {round}. На галерее есть закуски.",
        "placed": "Вы завершили Гонтлет на {place} месте."
      },
      "flavor": {
        "queueJoin": "Вы встали в очередь Гонтлета. Лорд Ходрик смазывает цепы в вашу честь.",
        "gatesOpen": "Ворота замка Ходрика со скрипом открываются. Бегите за короной!",
        "go": "Старт! Гонтлет открыт!",
        "rebuild": "Лорд Ходрик перестроил полосу. Новая трасса, та же корона!"
      },
      "err": {
        "legsOnly": "В Гонтлете только ноги: способности запрещены.",
        "inMatch": "Вы уже участвуете в Гонтлете.",
        "dead": "Нельзя встать в очередь Гонтлета будучи мёртвым.",
        "arenaConflict": "Покиньте Колизей, прежде чем участвовать в Гонтлете."
      }
    },
    "death": {
  ...
  "guide": {
    ...
    "hodricsCastlePage": {
      "heading": "Замок Ходрика",
      "intro": "Лорд Ходрик открывает путь через свой замок любому желающему. Пройдите испытание его старых укреплений и возьмите корону, кем бы вы ни были и какого бы уровня ни достигли.",
      "heraldHeading": "Герольд",
      "heraldBody": "Найдите герольда Осрика на окраине Истбрука, чтобы встать в очередь Гонтлета. Заезд начинается, когда наберётся десять участников — настоящих игроков и придворных лорда Ходрика вперемешку, так что гонка почти всегда начинается быстро.",
      "courseHeading": "Три раунда, одна корона",
      "courseBody": "Полоса Ходрика - это шоу на выбывание: десять гонщиков начинают первый раунд, шестеро переживают отсев, трое выходят в финал, и один забирает корону. Лорд Ходрик перестраивает трассу между раундами, так что двух одинаковых забегов не бывает: молотовые мосты, дворы с вращающимися брёвнами, коридоры с топорами, скользящие мосты, валунные подъёмы, карнизы с поршнями и вращающиеся платформы - в том порядке, какой сегодня угоден его светлости. Каждое препятствие качается, крутится и катится в своём заводном ритме, без всякой случайности, и внимательный глаз всегда найдёт безопасное окно.",
      "fairnessHeading": "Только на своих ногах",
      "fairnessBody": "Здесь никто не колдует: способности запрещены на всю гонку, и все участники бегут с одинаковой скоростью. Исход Гонтлета решают только выдержка и чувство момента, а не снаряжение или уровень.",
      "fallsHeading": "Падение стоит времени, не жизни",
      "fallsBody": "Удар препятствия или падение в пропасть лишь возвращают вас к последней контрольной точке. На дамбе никто не погибает: единственная цена падения - секунды, потраченные на то, чтобы догнать остальных. Выбывших в конце раунда эффектно запускают на балкон галереи, откуда они с закусками смотрят остаток шоу.",
      "standingsHeading": "Корона",
      "standingsBody": "Первый, кто пересечёт финиш финального раунда, забирает корону Ходрика за это шоу. Число забегов, победы и лучшее время финала копятся с каждой новой очередью."
    },
    "valeCupPage": {
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "hodrics_herald": {
        ...
        "greeting": "Лорд Ходрик открывает свой путь всем желающим! Пройдите Гонтлет, уклонитесь от цепов, возьмите корону!"
      },
      "groundskeeper_bram": {
