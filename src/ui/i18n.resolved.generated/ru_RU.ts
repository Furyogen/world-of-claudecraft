...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "abilityVfx": "Визуальные эффекты способностей (бета)",
      "abilityVfxNote": "Новые кинематографичные эффекты заклинаний. Пока доступно только шаману; остальные классы сохраняют классические эффекты до выхода переработки.",
