...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "keybinds": {
      ...
      "discord": "Discord",
      "battleground": "Поля боя (Могильный марш)"
    },
    "options": {
    ...
    "bg": {
      "zoneName": "Могильный марш",
      "teamA": "Рота Углей",
      "teamB": "Бледная рота",
      "time": "{m}:{s}",
      "mobileLabel": "Бой",
      "indicator": {
        "queued": "В очереди на Могильный марш",
        "queuedDetail": "{position} в очереди, ожидание {time}",
        "queuedAria": "В очереди на Могильный марш: {position} в очереди, ожидание {time}. Открыть окно полей боя.",
        "live": "На Могильном марше идёт битва",
        "liveDetail": "{time}, {killsA} против {killsB}",
        "liveAria": "На Могильном марше идёт битва: {time}, {killsA} против {killsB}. Откройте окно полей боя, чтобы посмотреть.",
        "watch": "Смотреть"
      },
      "window": {
        "title": "Поля боя",
        "subtitle": "Могильный марш: две дороги, четыре бастиона, один Камень войны.",
        "close": "Закрыть окно полей боя",
        "offlineNote": "Военный лагерь ещё собирается. Поля боя откроются, когда мир ответит.",
        "enterQueue": "Вступить на Могильный марш",
        "leaveQueue": "Покинуть очередь",
        "queued": "{position} в очереди, ожидание {time} (собрано {count})",
        "queueNote": "Каждый боец сражается на полевом стандарте с базовой раскладкой талантов своего класса. Вставайте в очередь в одиночку или ведите группу до пяти человек.",
        "partyNote": "Ваша группа из {count} человек встанет в очередь вместе.",
        "leaderNote": "Только лидер группы может поставить её в очередь.",
        "deserter": "Колокол дезертира звонит по вам. Снова встать в очередь можно через {time}.",
        "inMatch": "Битва началась.",
        "liveHeading": "Идущие битвы",
        "matchLine": "{teamA} {killsA} против {teamB} {killsB}, {time}, сражаются {players}",
        "watch": "Смотреть",
        "watchAria": "Смотреть идущую битву ({time})",
        "noLive": "Сейчас битв нет.",
        "practice": "Тренировка на Могильном марше",
        "practiceNote": "Соберите полный отряд вымуштрованных ботов и изучите дороги. Тренировочные бои не влияют на рейтинг."
      },
      "spectate": {
        "stop": "Прекратить просмотр"
      },
      "hud": {
        "knellUp": "Страж колокола на посту",
        "knellSpawns": "Страж колокола через {time}",
        "knellSilenced": "{team}: колокол умолк, {seconds} с",
        "stripAria": "{teamA} {killsA}, {teamB} {killsB}, осталось {time}",
        "countdownTitle": "Мёртвые строятся в ряды",
        "respawnTitle": "Вы пали.",
        "respawnSub": "Поле с вами ещё не закончило.",
        "returning": "Возвращение в мир через {seconds} с"
      },
      "banner": {
        "found": "На Могильном марше собирается битва!",
        "countdown": "Битва начнётся через {seconds}...",
        "start": "Знамёна подняты. В бой!",
        "bulwarkWestOuter": "Западный внешний бастион роты «{team}» пал.",
        "bulwarkWestInner": "Западный внутренний бастион роты «{team}» пал.",
        "bulwarkEastOuter": "Восточный внешний бастион роты «{team}» пал.",
        "bulwarkEastInner": "Восточный внутренний бастион роты «{team}» пал.",
        "warstoneDown": "Камень войны роты «{team}» расколот!",
        "knell": "{team} заставила колокол умолкнуть!",
        "warstoneThreat": "Ваш Камень войны атакуют!"
      },
      "log": {
        "queued": "Вы встали в очередь на Могильный марш ({position} в очереди).",
        "unqueued": "Вы покинули очередь на Могильный марш.",
        "roster": "{team} собирается: {allies} против {enemies}.",
        "kill": "{killer} сразил {victim}!",
        "down": "Вы пали. Поле вернёт вас к Камню войны через {seconds} с."
      },
      "end": {
        "win": "Победа! Вражеский Камень войны расколот.",
        "loss": "Поражение. Ваш Камень войны расколот.",
        "draw": "Поле умолкло. Ничья.",
        "rating": "Рейтинг {rating} ({delta})."
      },
      "err": {
        "level10": "Чтобы вступить на Могильный марш, нужен как минимум 10-й уровень.",
        "deserter": "Нельзя вставать в очередь, пока звонит Колокол дезертира.",
        "cannotSpectate": "Сейчас вы не можете наблюдать.",
        "matchEnded": "Та битва уже закончилась.",
        "noDuel": "Нельзя вызывать на дуэль на Могильном марше."
      }
    }
  },
  "guide": {
    ...
    "bgPage": {
      "heading": "Могильный марш",
      "intro": "Могильный марш - поле боя пять на пять: две роты бойцов ведут колонны поднятых солдат по двум старым дорогам, ломают вражеские башни и раскалывают Камень войны, что держит чужое войско на марше. Вставайте в очередь откуда угодно, остальное сделает поле.",
      "storyHeading": "Поле, что не знает покоя",
      ...
      "companiesHeading": "Две роты, у каждой своё знамя",
      "companiesBody": "Бойцы берут знамя Роты Углей или Бледной роты. Вставайте в очередь в одиночку или группой, и поле сведёт вас в роту из пяти. Стороны временные, как на арене: никаких постоянных фракций, а бой с игроками всегда остаётся вашим выбором.",
      "fairNote": "Могильный марш честен по замыслу. Каждый боец сражается на полевом стандарте с базовой раскладкой талантов своего класса, так что исход решает игра, а не снаряжение и уровни.",
      "fieldHeading": "Как читать поле",
      "fieldBody": "Между двумя базами лежат Щитовая дорога на западе, Копейная дорога на востоке и разбитые Курганы между ними, а в сердце поля - разрушенная колокольная часовня. Схематическая карта показывает дороги, башни, союзников и колокол.",
      "roadsTitle": "Две дороги",
      "roadsBody": "Колонны костепанцирных ревенантов маршируют по каждой дороге к вражеской базе. Они бьются с теми, кто встанет на пути, и осаждают укрепления; идти вместе с колонной - значит брать землю.",
      "bulwarksTitle": "Бастионы",
      "bulwarksBody": "Каждую дорогу стерегут тяжёлые башни-стражи, внешняя и внутренняя у каждой роты. Они карают бойцов, обижающих их подопечных, и пока не падёт внешняя, внутреннюю не тронуть. Вскройте одну дорогу, и вражеский Камень войны останется беззащитен.",
      "knellTitle": "Колокол",
      "knellBody": "В часовне висит колокол, поднявший это войско, и его хранитель - Страж колокола. Рота, сразившая Стража, на время заставляет колокол умолкнуть, и её колонны маршируют злее.",
      "deathHeading": "Пасть на Могильном марше",
      "deathBody": "Поле отвергает смерть. Павший боец ненадолго выбывает, затем просыпается у своего Камня войны, каждый раз чуть медленнее. Никакого бега за телом и никаких потерь; цена - лишь время вне поля.",
      "watchHeading": "Наблюдение за битвой",
      "watchBody": "Любую идущую в мире битву можно посмотреть. Значок у миникарты объявляет о живой битве, а окно полей боя перечисляет каждый матч с кнопкой просмотра. Зрители следуют за одной из рот, видят табло матча и могут прекратить просмотр в любой момент.",
      "ladderHeading": "Рейтинговая таблица",
      "ladderBody": "Рейтинговый Могильный марш ведёт собственный зачёт, как арена. Окно полей боя показывает ваш рейтинг, счёт побед и таблицу рейтинговых бойцов в сети. Матчи, дополненные ботами, не влияют на рейтинг, как и автономная тренировка."
    },
    "wishPage": {
