...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "motionPrediction": "Прогноз движения",
      "motionPredictionNote": "Предсказывает движение вашего персонажа между обновлениями сервера, делая перемещение в сети отзывчивее. Возле стен и препятствий может выглядеть неточно; при отключении используется классическое сглаживание.",
