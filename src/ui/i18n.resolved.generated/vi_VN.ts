...
export const vi_VN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "[VI] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.",
    ...
    "townFocus": {
      ...
      "tierHint": "[VI] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.",
      "townOnlyHint": "[VI] Focus can only be changed while you are in town.",
    ...
    "bags": {
      ...
      "itemAriaInstanced": "[VI] {item}, quantity {count}, maker-marked copy",
    ...
    "loot": {
      "chestTitle": "Rương",
      "takeLootButton": "[VI] Take Loot",
      "takeLootTooltip": "[VI] Takes the coins and dropped items. Does not use up the harvest.",
      "unifiedPressHint": "[VI] The interact key loots and harvests in one press, using your town focus."
    },
    "spellbook": {
    ...
    "social": {
      ...
      "onlineHeader": "[VI] Online ({n})",
      "offlineHeader": "[VI] Offline ({n})",
      "hideOffline": "[VI] Hide offline",
      "hideOfflineTitle": "[VI] Hide offline guild members"
    },
    "gathering": {
      "title": "Thu thập",
      "mining": "Khai mỏ",
      ...
      "catchLine": "[VI] You reel in: {name}",
      "biteLine": "[VI] Something takes the bait!",
      "gotAwayLine": "[VI] It got away.",
      "nodeName": {
        "ore": "[VI] Ore Vein",
        "wood": "[VI] Timber Stand",
        "herb": "[VI] Herb Patch"
      },
      "tierRequired": {
        "mining": "[VI] Requires a tier {tier} mining pick",
        "logging": "[VI] Requires a tier {tier} logging axe",
        "herbalism": "[VI] Requires a tier {tier} herbalism sickle"
      },
      "toolTierUnmet": {
        "mining": "[VI] You need a tier {tier} mining pick to harvest this vein.",
        "logging": "[VI] You need a tier {tier} logging axe to fell this stand.",
        "herbalism": "[VI] You need a tier {tier} herbalism sickle to gather this patch."
      },
      "toolTierUnmetCorpse": "[VI] You need a tier {tier} gathering tool to recover the finest materials.",
      "downgradeMark": "[VI] Bags full: the find was stored without its gatherer's mark.",
      "downgradeFind": "[VI] Bags full: a pristine find slipped away.",
      "stateReady": "[VI] Ready",
      "stateCooldown": "[VI] Respawning"
    },
    "archetypeTitle": {
      "label": "Danh hiệu",
      "none": "Không có",
    ...
    "enchantName": {
      "enchant_weapon_might": "[VI] Enchant Weapon - Might",
      "enchant_weapon_intellect": "[VI] Enchant Weapon - Spellpower",
      "enchant_helmet_fortitude": "[VI] Enchant Helmet - Fortitude",
      "enchant_neck_spirit": "[VI] Enchant Necklace - Spirit",
      "enchant_shoulder_agility": "[VI] Enchant Shoulders - Agility",
      "enchant_chest_stamina": "[VI] Enchant Chest - Stamina",
      "enchant_waist_stamina": "[VI] Enchant Belt - Stamina",
      "enchant_legs_stamina": "[VI] Enchant Legs - Stamina",
      "enchant_gloves_agility": "[VI] Enchant Gloves - Agility",
      "enchant_gloves_intellect": "[VI] Enchant Gloves - Spellpower",
      "enchant_feet_agility": "[VI] Enchant Boots - Agility",
      "enchant_ring_spirit": "[VI] Enchant Ring - Spirit",
      "enchant_weapon_agility": "[VI] Enchant Weapon - Agility",
      "enchant_helmet_intellect": "[VI] Enchant Helmet - Intellect",
      "enchant_helmet_armor": "[VI] Enchant Helmet - Reinforcement",
      "enchant_neck_intellect": "[VI] Enchant Necklace - Intellect",
      "enchant_neck_agility": "[VI] Enchant Necklace - Agility",
      "enchant_shoulder_strength": "[VI] Enchant Shoulders - Strength",
      "enchant_shoulder_intellect": "[VI] Enchant Shoulders - Intellect",
      "enchant_chest_spirit": "[VI] Enchant Chest - Spirit",
      "enchant_chest_armor": "[VI] Enchant Chest - Reinforcement",
      "enchant_waist_strength": "[VI] Enchant Belt - Strength",
      "enchant_waist_agility": "[VI] Enchant Belt - Agility",
      "enchant_legs_intellect": "[VI] Enchant Legs - Intellect",
      "enchant_gloves_strength": "[VI] Enchant Gloves - Strength",
      "enchant_feet_strength": "[VI] Enchant Boots - Strength",
      "enchant_feet_stamina": "[VI] Enchant Boots - Stamina",
      "enchant_ring_strength": "[VI] Enchant Ring - Strength",
      "enchant_ring_agility": "[VI] Enchant Ring - Agility",
      "enchant_ring_intellect": "[VI] Enchant Ring - Intellect",
      "enchant_weapon_greater_might": "[VI] Enchant Weapon - Greater Might",
      "enchant_weapon_greater_spellpower": "[VI] Enchant Weapon - Greater Spellpower",
      "enchant_helmet_greater_fortitude": "[VI] Enchant Helmet - Greater Fortitude",
      "enchant_chest_greater_stamina": "[VI] Enchant Chest - Greater Stamina",
      "enchant_legs_greater_stamina": "[VI] Enchant Legs - Greater Stamina",
      "enchant_gloves_greater_agility": "[VI] Enchant Gloves - Greater Agility",
      "enchant_weapon_runed_edge": "[VI] Enchant Weapon - Runed Edge",
      "enchant_weapon_runed_focus": "[VI] Enchant Weapon - Runed Focus",
      "enchant_chest_runeweave": "[VI] Enchant Chest - Runeweave",
      "enchant_legs_runed_hide": "[VI] Enchant Legs - Runed Hide",
      "enchant_helmet_runed_links": "[VI] Enchant Helmet - Runed Links"
    },
    "professions": {
      "title": "Nghề nghiệp",
      ...
      "nextUnlockMastered": "[VI] Mastered, for now",
    ...
    "crafting": {
      ...
      "attunementReturnCost": "[VI] If you leave this pair, returning to it later costs {cost} make-amends tasks.",
      "identity": {
      ...
      "difficultyMinimal": "[VI] Minimal skill gain",
      ...
      "learnMoreAtStation": "[VI] {master} at the {station} can teach you more {craft} recipes.",
      ...
      "trendNudge": "[VI] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.",
      "trendNudgeNoMaster": "[VI] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.",
      "attunedZoneLine": "[VI] {name} has attuned as {archetype}!",
      "attunedBanner": "[VI] Attuned: {title}",
      "tierTutorial": {
        "title": "[VI] Your First Tier",
        "tierCap": "[VI] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.",
        "radar": "[VI] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.",
        "masters": "[VI] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.",
        "dismiss": "[VI] Got it"
      },
      "makersMark": "Được chế tạo bởi {name}",
      "gatheredBy": "[VI] Gathered by {name}",
    ...
    "itemMenu": {
      "use": "Sử dụng",
      "equip": "[VI] Equip",
      "disenchant": "[VI] Disenchant",
      "salvage": "[VI] Salvage",
      "applyEnchant": "[VI] Apply Enchant"
    },
    "enchanting": {
      "disenchantedLine": "[VI] You disenchant {item}.",
      "salvagedLine": "[VI] You salvage {item}.",
      "enchantAppliedLine": "[VI] You enchant {item} with {enchant}.",
      "notHeld": "[VI] You do not have that item.",
      "notDisenchantable": "[VI] You cannot disenchant that.",
      "notSalvageable": "[VI] You cannot salvage that.",
      "disenchantThrottled": "[VI] You are disenchanting too quickly. Wait a moment and try again.",
      "salvageThrottled": "[VI] You are salvaging too quickly. Wait a moment and try again.",
      "enchantThrottled": "[VI] You are enchanting too quickly. Wait a moment and try again.",
      "enchantWrongSlot": "[VI] That enchant cannot be applied to that item.",
      "enchantUnknown": "[VI] That enchant does not exist.",
      "enchantInsufficient": "[VI] You do not have the materials for that enchant.",
      "disenchantConfirmTitle": "[VI] Disenchant {item}?",
      "disenchantConfirmBody": "[VI] This destroys {item} and yields arcane materials. This cannot be undone.",
      "disenchantConfirmBodySpecial": "[VI] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.",
      "salvageConfirmTitle": "[VI] Salvage {item}?",
      "salvageConfirmBody": "[VI] This destroys {item} and yields crafting materials. This cannot be undone.",
      "salvageConfirmBodySpecial": "[VI] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.",
      "pickerTitle": "[VI] Apply Enchant",
      "targetTitle": "[VI] Choose an item to enchant",
      "noEnchants": "[VI] No enchant uses this reagent.",
      "noTargets": "[VI] No eligible item to enchant."
    },
    "training": {
      "title": "Đào tạo: {name}",
      "close": "Đóng đào tạo",
  ...
  "stats": {
    ...
    "charactersCreated": "[VI] Characters Created",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "tradeBound": "[VI] That item is bound and cannot be traded."
    },
    "logs": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "mosshide_vest": {
        "name": "[VI] Mosshide Vest"
      },
      "thornling_grips": {
        "name": "[VI] Thornling Grips"
      },
      "acolyte_chain_grips": {
        "name": "[VI] Acolyte Chain Grips"
      },
      "votive_chain_belt": {
        "name": "[VI] Votive Chain Belt"
      },
      "briarroot_staff": {
        "name": "[VI] Briarroot Staff"
      },
      "valefire_lantern": {
        "name": "[VI] Valefire Lantern"
      },
      "fenbark_leggings": {
        "name": "[VI] Fenbark Leggings"
      },
      "mirebloom_treads": {
        "name": "[VI] Mirebloom Treads"
      },
      "fenwarden_sabatons": {
        "name": "[VI] Fenwarden Sabatons"
      },
      "marshlight_hauberk": {
        "name": "[VI] Marshlight Hauberk"
      },
      "duskthorn_mantle": {
        "name": "[VI] Duskthorn Mantle"
      },
      "fenshadow_maul": {
        "name": "[VI] Fenshadow Maul"
      },
      "wildgrove_cinch": {
        "name": "[VI] Wildgrove Cinch"
      },
      "cragward_pauldrons": {
        "name": "[VI] Cragward Pauldrons"
      },
      "cragthorn_greatstaff": {
        "name": "[VI] Cragthorn Greatstaff"
      },
      "moonbark_vestments": {
        "name": "[VI] Moonbark Vestments"
      },
      "peaksong_helm": {
        "name": "[VI] Peaksong Helm"
      },
      "stormchant_gauntlets": {
        "name": "[VI] Stormchant Gauntlets"
      },
      "cragprowl_belt": {
        "name": "[VI] Cragprowl Belt"
      },
      "stormroot_cowl": {
        "name": "[VI] Stormroot Cowl"
      },
      "thunderward_legguards": {
        "name": "[VI] Thunderward Legguards"
      },
      "revenantstep_treads": {
        "name": "[VI] Revenantstep Treads"
      },
      "shardfang_grips": {
        "name": "[VI] Shardfang Grips"
      },
      "shardsong_mantle": {
        "name": "[VI] Shardsong Mantle"
      },
      "wyrmcult_spellgrips": {
        "name": "[VI] Wyrmcult Spellgrips"
      },
      "thornpeak_wildwraps": {
        "name": "[VI] Thornpeak Wildwraps"
      },
      "stormvotive_hauberk": {
        "name": "[VI] Stormvotive Hauberk"
      },
      "cryptbloom_shoulderguards": {
        "name": "[VI] Cryptbloom Shoulderguards"
      },
      "gravewyrm_thornmaul": {
        "name": "[VI] Gravewyrm Thornmaul"
      },
      "vestments_of_the_waking_grove": {
        "name": "[VI] Vestments of the Waking Grove"
      },
      "nightfangs_greatstaff": {
        "name": "[VI] Nightfang's Greatstaff"
      },
      "maul_of_the_scourged_wilds": {
        "name": "[VI] Maul of the Scourged Wilds"
      },
      "tidehymn_slippers": {
        "name": "[VI] Tidehymn Slippers"
      },
      "pearlward_aegis": {
        "name": "[VI] Pearlward Aegis"
      },
      "wildgrowth_leggings": {
        "name": "[VI] Wildgrowth Leggings"
      },
      "grovewardens_grips": {
        "name": "[VI] Grovewarden's Grips"
      },
      "verdant_walkers": {
        "name": "[VI] Verdant Walkers"
      },
      "lunarward_cinch": {
        "name": "[VI] Lunarward Cinch"
      },
      "dreamroot_boots": {
        "name": "[VI] Dreamroot Boots"
      },
      "stormbark_mantle": {
        "name": "[VI] Stormbark Mantle"
      },
      "wildsoul_maul": {
        "name": "[VI] Wildsoul Maul"
      },
      "resonant_thread": {
        "name": "[VI] Resonant Thread"
      },
      "resonant_hide": {
        "name": "[VI] Resonant Hide"
      },
      "resonant_links": {
        "name": "[VI] Resonant Links"
      },
      "resonant_steel": {
        "name": "[VI] Resonant Steel"
      },
      "resonant_timber": {
        "name": "[VI] Resonant Timber"
      },
      "conjured_water4": {
    ...
    "quests": {
      ...
      "q_prof_amends_apothecary": {
        "title": "[VI] Back on the Stove",
        "text": "[VI] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.",
        "completion": "[VI] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.",
        "objectives": {
          "0": {
            "label": "[VI] Wild Boar hunted"
          }
      ...
      "q_prof_amends_bombardier": {
        "title": "[VI] The Ledger Grows",
        "text": "[VI] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.",
        "completion": "[VI] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?",
        "objectives": {
          "0": {
            "label": "[VI] Tunnel Rat exterminated"
          }
        }
      },
      "q_prof_workorder_forge": {
        "title": "[VI] Forge Work Order",
        "text": "[VI] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.",
        "completion": "[VI] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.",
        "objectives": {
          "0": {
            "label": "[VI] Copper Ore delivered"
          }
        }
      },
      "q_prof_workorder_kitchens": {
        "title": "[VI] Kitchens Work Order",
        "text": "[VI] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.",
        "completion": "[VI] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.",
        "objectives": {
          "0": {
            "label": "[VI] Game Meat delivered"
          }
        }
      },
      "q_prof_workorder_loom": {
        "title": "[VI] Loom Work Order",
        "text": "[VI] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.",
        "completion": "[VI] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.",
        "objectives": {
          "0": {
            "label": "[VI] Spider Silk delivered"
          }
        }
      },
      "q_prof_workorder_toolworks": {
        "title": "[VI] Toolworks Work Order",
        "text": "[VI] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.",
        "completion": "[VI] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.",
        "objectives": {
          "0": {
            "label": "[VI] Ironbark Log delivered"
          }
        }
      },
      "q_prof_workorder_tannery": {
        "title": "[VI] Tannery Work Order",
        "text": "[VI] Vats are empty. Bring eight rough hides. Coin when you do.",
        "completion": "[VI] Good hides. Fair pay. Again when you have more.",
        "objectives": {
          "0": {
            "label": "[VI] Rough Hide delivered"
          }
        }
      },
      "q_prof_workorder_apothecary": {
        "title": "[VI] Apothecary Work Order",
        "text": "[VI] My shelves require goldleaf, and the market's stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.",
        "completion": "[VI] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.",
        "objectives": {
          "0": {
            "label": "[VI] Goldleaf Herb delivered"
          }
        }
      },
      "q_prof_hobby_switch": {
    ...
    "letters": {
      ...
      "mastery_reset_notice": {
        "sender": "[VI] The Guildhall",
        "subject": "[VI] Your craft, made honest",
      ...
      "prof_tier_weaponcrafting_armorcrafting_1": {
        "sender": "[VI] Forgemistress Darva",
        "subject": "[VI] A spark worth noting",
        "body": "[VI] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot."
      },
      "prof_tier_weaponcrafting_armorcrafting_2": {
        "sender": "[VI] Forgemistress Darva",
        "subject": "[VI] Rare work, and earned",
        "body": "[VI] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good."
      },
      "prof_tier_weaponcrafting_armorcrafting_3": {
        "sender": "[VI] Forgemistress Darva",
        "subject": "[VI] The metal answers you now",
        "body": "[VI] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm."
      },
      "prof_tier_weaponcrafting_armorcrafting_4": {
        "sender": "[VI] Forgemistress Darva",
        "subject": "[VI] Near the top of the ladder",
        "body": "[VI] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb."
      },
      "prof_tier_weaponcrafting_armorcrafting_5": {
        "sender": "[VI] Forgemistress Darva",
        "subject": "[VI] Mastery, at last",
        "body": "[VI] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new."
      },
      "prof_tier_leatherworking_tailoring_1": {
        "sender": "[VI] Weaver Ottilie",
        "subject": "[VI] An even first row",
        "body": "[VI] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully."
      },
      "prof_tier_leatherworking_tailoring_2": {
        "sender": "[VI] Weaver Ottilie",
        "subject": "[VI] Rare work, well measured",
        "body": "[VI] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased."
      },
      "prof_tier_leatherworking_tailoring_3": {
        "sender": "[VI] Weaver Ottilie",
        "subject": "[VI] The pattern comes clear",
        "body": "[VI] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice."
      },
      "prof_tier_leatherworking_tailoring_4": {
        "sender": "[VI] Weaver Ottilie",
        "subject": "[VI] One row from the top",
        "body": "[VI] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now."
      },
      "prof_tier_leatherworking_tailoring_5": {
        "sender": "[VI] Weaver Ottilie",
        "subject": "[VI] The last stitch",
        "body": "[VI] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly."
      },
      "prof_tier_alchemy_cooking_1": {
        "sender": "[VI] Cook Marlow",
        "subject": "[VI] A taste of things to come",
        "body": "[VI] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving."
      },
      "prof_tier_alchemy_cooking_2": {
        "sender": "[VI] Cook Marlow",
        "subject": "[VI] Rare work, and no burnt edges",
        "body": "[VI] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long."
      },
      "prof_tier_alchemy_cooking_3": {
        "sender": "[VI] Cook Marlow",
        "subject": "[VI] Now you are cooking",
        "body": "[VI] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting."
      },
      "prof_tier_alchemy_cooking_4": {
        "sender": "[VI] Cook Marlow",
        "subject": "[VI] One course from the feast",
        "body": "[VI] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle."
      },
      "prof_tier_alchemy_cooking_5": {
        "sender": "[VI] Cook Marlow",
        "subject": "[VI] Mastery, served hot",
        "body": "[VI] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table."
      },
      "prof_tier_engineering_alchemy_1": {
        "sender": "[VI] Tinker Gizzel",
        "subject": "[VI] FIRST spark, ha",
        "body": "[VI] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go."
      },
      "prof_tier_engineering_alchemy_2": {
        "sender": "[VI] Tinker Gizzel",
        "subject": "[VI] Rare, oh, RARE",
        "body": "[VI] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA."
      },
      "prof_tier_engineering_alchemy_3": {
        "sender": "[VI] Tinker Gizzel",
        "subject": "[VI] Now it gets loud",
        "body": "[VI] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses."
      },
      "prof_tier_engineering_alchemy_4": {
        "sender": "[VI] Tinker Gizzel",
        "subject": "[VI] One rung, ONE, from the top",
        "body": "[VI] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink."
      },
      "prof_tier_engineering_alchemy_5": {
        "sender": "[VI] Tinker Gizzel",
        "subject": "[VI] MASTERY, kaboom",
        "body": "[VI] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous."
      }
    },
    "itemSets": {
      "boundstone_vanguard": {
