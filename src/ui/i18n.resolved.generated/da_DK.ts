...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "corpseHarvest": {
      "title": "Høst",
      "harvestButton": "Høst",
      "harvestTooltip": "[DA] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.",
    ...
    "townFocus": {
      ...
      "tierHint": "[DA] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.",
      "townOnlyHint": "[DA] Focus can only be changed while you are in town.",
    ...
    "bags": {
      ...
      "itemAriaInstanced": "[DA] {item}, quantity {count}, maker-marked copy",
    ...
    "loot": {
      "chestTitle": "Kiste",
      "takeLootButton": "[DA] Take Loot",
      "takeLootTooltip": "[DA] Takes the coins and dropped items. Does not use up the harvest.",
      "unifiedPressHint": "[DA] The interact key loots and harvests in one press, using your town focus."
    },
    "spellbook": {
    ...
    "social": {
      ...
      "onlineHeader": "[DA] Online ({n})",
      "offlineHeader": "[DA] Offline ({n})",
      "hideOffline": "[DA] Hide offline",
      "hideOfflineTitle": "[DA] Hide offline guild members"
    },
    "gathering": {
      "title": "Indsamling",
      "mining": "Minedrift",
      ...
      "catchLine": "[DA] You reel in: {name}",
      "biteLine": "[DA] Something takes the bait!",
      "gotAwayLine": "[DA] It got away.",
      "nodeName": {
        "ore": "[DA] Ore Vein",
        "wood": "[DA] Timber Stand",
        "herb": "[DA] Herb Patch"
      },
      "tierRequired": {
        "mining": "[DA] Requires a tier {tier} mining pick",
        "logging": "[DA] Requires a tier {tier} logging axe",
        "herbalism": "[DA] Requires a tier {tier} herbalism sickle"
      },
      "toolTierUnmet": {
        "mining": "[DA] You need a tier {tier} mining pick to harvest this vein.",
        "logging": "[DA] You need a tier {tier} logging axe to fell this stand.",
        "herbalism": "[DA] You need a tier {tier} herbalism sickle to gather this patch."
      },
      "toolTierUnmetCorpse": "[DA] You need a tier {tier} gathering tool to recover the finest materials.",
      "downgradeMark": "[DA] Bags full: the find was stored without its gatherer's mark.",
      "downgradeFind": "[DA] Bags full: a pristine find slipped away.",
      "stateReady": "[DA] Ready",
      "stateCooldown": "[DA] Respawning"
    },
    "archetypeTitle": {
      "label": "Titel",
      "none": "Ingen",
    ...
    "enchantName": {
      "enchant_weapon_might": "[DA] Enchant Weapon - Might",
      "enchant_weapon_intellect": "[DA] Enchant Weapon - Spellpower",
      "enchant_helmet_fortitude": "[DA] Enchant Helmet - Fortitude",
      "enchant_neck_spirit": "[DA] Enchant Necklace - Spirit",
      "enchant_shoulder_agility": "[DA] Enchant Shoulders - Agility",
      "enchant_chest_stamina": "[DA] Enchant Chest - Stamina",
      "enchant_waist_stamina": "[DA] Enchant Belt - Stamina",
      "enchant_legs_stamina": "[DA] Enchant Legs - Stamina",
      "enchant_gloves_agility": "[DA] Enchant Gloves - Agility",
      "enchant_gloves_intellect": "[DA] Enchant Gloves - Spellpower",
      "enchant_feet_agility": "[DA] Enchant Boots - Agility",
      "enchant_ring_spirit": "[DA] Enchant Ring - Spirit",
      "enchant_weapon_agility": "[DA] Enchant Weapon - Agility",
      "enchant_helmet_intellect": "[DA] Enchant Helmet - Intellect",
      "enchant_helmet_armor": "[DA] Enchant Helmet - Reinforcement",
      "enchant_neck_intellect": "[DA] Enchant Necklace - Intellect",
      "enchant_neck_agility": "[DA] Enchant Necklace - Agility",
      "enchant_shoulder_strength": "[DA] Enchant Shoulders - Strength",
      "enchant_shoulder_intellect": "[DA] Enchant Shoulders - Intellect",
      "enchant_chest_spirit": "[DA] Enchant Chest - Spirit",
      "enchant_chest_armor": "[DA] Enchant Chest - Reinforcement",
      "enchant_waist_strength": "[DA] Enchant Belt - Strength",
      "enchant_waist_agility": "[DA] Enchant Belt - Agility",
      "enchant_legs_intellect": "[DA] Enchant Legs - Intellect",
      "enchant_gloves_strength": "[DA] Enchant Gloves - Strength",
      "enchant_feet_strength": "[DA] Enchant Boots - Strength",
      "enchant_feet_stamina": "[DA] Enchant Boots - Stamina",
      "enchant_ring_strength": "[DA] Enchant Ring - Strength",
      "enchant_ring_agility": "[DA] Enchant Ring - Agility",
      "enchant_ring_intellect": "[DA] Enchant Ring - Intellect",
      "enchant_weapon_greater_might": "[DA] Enchant Weapon - Greater Might",
      "enchant_weapon_greater_spellpower": "[DA] Enchant Weapon - Greater Spellpower",
      "enchant_helmet_greater_fortitude": "[DA] Enchant Helmet - Greater Fortitude",
      "enchant_chest_greater_stamina": "[DA] Enchant Chest - Greater Stamina",
      "enchant_legs_greater_stamina": "[DA] Enchant Legs - Greater Stamina",
      "enchant_gloves_greater_agility": "[DA] Enchant Gloves - Greater Agility",
      "enchant_weapon_runed_edge": "[DA] Enchant Weapon - Runed Edge",
      "enchant_weapon_runed_focus": "[DA] Enchant Weapon - Runed Focus",
      "enchant_chest_runeweave": "[DA] Enchant Chest - Runeweave",
      "enchant_legs_runed_hide": "[DA] Enchant Legs - Runed Hide",
      "enchant_helmet_runed_links": "[DA] Enchant Helmet - Runed Links"
    },
    "professions": {
      "title": "Erhverv",
      "close": "Luk erhverv",
      ...
      "nextUnlockMastered": "[DA] Mastered, for now",
    ...
    "crafting": {
      ...
      "attunementReturnCost": "[DA] If you leave this pair, returning to it later costs {cost} make-amends tasks.",
      "identity": {
      ...
      "trendNudge": "[DA] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.",
      "trendNudgeNoMaster": "[DA] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.",
      "attunedZoneLine": "[DA] {name} has attuned as {archetype}!",
      "attunedBanner": "[DA] Attuned: {title}",
      "tierTutorial": {
        "title": "[DA] Your First Tier",
        "tierCap": "[DA] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.",
        "radar": "[DA] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.",
        "masters": "[DA] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.",
        "dismiss": "[DA] Got it"
      },
      "makersMark": "Udformet af {name}",
      "gatheredBy": "[DA] Gathered by {name}",
    ...
    "itemMenu": {
      "use": "[DA] Use",
      "equip": "[DA] Equip",
      "disenchant": "[DA] Disenchant",
      "salvage": "[DA] Salvage",
      "applyEnchant": "[DA] Apply Enchant"
    },
    "enchanting": {
      "disenchantedLine": "[DA] You disenchant {item}.",
      "salvagedLine": "[DA] You salvage {item}.",
      "enchantAppliedLine": "[DA] You enchant {item} with {enchant}.",
      "notHeld": "[DA] You do not have that item.",
      "notDisenchantable": "[DA] You cannot disenchant that.",
      "notSalvageable": "[DA] You cannot salvage that.",
      "disenchantThrottled": "[DA] You are disenchanting too quickly. Wait a moment and try again.",
      "salvageThrottled": "[DA] You are salvaging too quickly. Wait a moment and try again.",
      "enchantThrottled": "[DA] You are enchanting too quickly. Wait a moment and try again.",
      "enchantWrongSlot": "[DA] That enchant cannot be applied to that item.",
      "enchantUnknown": "[DA] That enchant does not exist.",
      "enchantInsufficient": "[DA] You do not have the materials for that enchant.",
      "disenchantConfirmTitle": "[DA] Disenchant {item}?",
      "disenchantConfirmBody": "[DA] This destroys {item} and yields arcane materials. This cannot be undone.",
      "disenchantConfirmBodySpecial": "[DA] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.",
      "salvageConfirmTitle": "[DA] Salvage {item}?",
      "salvageConfirmBody": "[DA] This destroys {item} and yields crafting materials. This cannot be undone.",
      "salvageConfirmBodySpecial": "[DA] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.",
      "pickerTitle": "[DA] Apply Enchant",
      "targetTitle": "[DA] Choose an item to enchant",
      "noEnchants": "[DA] No enchant uses this reagent.",
      "noTargets": "[DA] No eligible item to enchant."
    },
    "training": {
      "title": "Træning: {name}",
      "close": "Luk træning",
  ...
  "stats": {
    ...
    "charactersCreated": "[DA] Characters Created",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "tradeBound": "[DA] That item is bound and cannot be traded."
    },
    "logs": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "mosshide_vest": {
        "name": "[DA] Mosshide Vest"
      },
      "thornling_grips": {
        "name": "[DA] Thornling Grips"
      },
      "acolyte_chain_grips": {
        "name": "[DA] Acolyte Chain Grips"
      },
      "votive_chain_belt": {
        "name": "[DA] Votive Chain Belt"
      },
      "briarroot_staff": {
        "name": "[DA] Briarroot Staff"
      },
      "valefire_lantern": {
        "name": "[DA] Valefire Lantern"
      },
      "fenbark_leggings": {
        "name": "[DA] Fenbark Leggings"
      },
      "mirebloom_treads": {
        "name": "[DA] Mirebloom Treads"
      },
      "fenwarden_sabatons": {
        "name": "[DA] Fenwarden Sabatons"
      },
      "marshlight_hauberk": {
        "name": "[DA] Marshlight Hauberk"
      },
      "duskthorn_mantle": {
        "name": "[DA] Duskthorn Mantle"
      },
      "fenshadow_maul": {
        "name": "[DA] Fenshadow Maul"
      },
      "wildgrove_cinch": {
        "name": "[DA] Wildgrove Cinch"
      },
      "cragward_pauldrons": {
        "name": "[DA] Cragward Pauldrons"
      },
      "cragthorn_greatstaff": {
        "name": "[DA] Cragthorn Greatstaff"
      },
      "moonbark_vestments": {
        "name": "[DA] Moonbark Vestments"
      },
      "peaksong_helm": {
        "name": "[DA] Peaksong Helm"
      },
      "stormchant_gauntlets": {
        "name": "[DA] Stormchant Gauntlets"
      },
      "cragprowl_belt": {
        "name": "[DA] Cragprowl Belt"
      },
      "stormroot_cowl": {
        "name": "[DA] Stormroot Cowl"
      },
      "thunderward_legguards": {
        "name": "[DA] Thunderward Legguards"
      },
      "revenantstep_treads": {
        "name": "[DA] Revenantstep Treads"
      },
      "shardfang_grips": {
        "name": "[DA] Shardfang Grips"
      },
      "shardsong_mantle": {
        "name": "[DA] Shardsong Mantle"
      },
      "wyrmcult_spellgrips": {
        "name": "[DA] Wyrmcult Spellgrips"
      },
      "thornpeak_wildwraps": {
        "name": "[DA] Thornpeak Wildwraps"
      },
      "stormvotive_hauberk": {
        "name": "[DA] Stormvotive Hauberk"
      },
      "cryptbloom_shoulderguards": {
        "name": "[DA] Cryptbloom Shoulderguards"
      },
      "gravewyrm_thornmaul": {
        "name": "[DA] Gravewyrm Thornmaul"
      },
      "vestments_of_the_waking_grove": {
        "name": "[DA] Vestments of the Waking Grove"
      },
      "nightfangs_greatstaff": {
        "name": "[DA] Nightfang's Greatstaff"
      },
      "maul_of_the_scourged_wilds": {
        "name": "[DA] Maul of the Scourged Wilds"
      },
      "tidehymn_slippers": {
        "name": "[DA] Tidehymn Slippers"
      },
      "pearlward_aegis": {
        "name": "[DA] Pearlward Aegis"
      },
      "wildgrowth_leggings": {
        "name": "[DA] Wildgrowth Leggings"
      },
      "grovewardens_grips": {
        "name": "[DA] Grovewarden's Grips"
      },
      "verdant_walkers": {
        "name": "[DA] Verdant Walkers"
      },
      "lunarward_cinch": {
        "name": "[DA] Lunarward Cinch"
      },
      "dreamroot_boots": {
        "name": "[DA] Dreamroot Boots"
      },
      "stormbark_mantle": {
        "name": "[DA] Stormbark Mantle"
      },
      "wildsoul_maul": {
        "name": "[DA] Wildsoul Maul"
      },
      "resonant_thread": {
        "name": "[DA] Resonant Thread"
      },
      "resonant_hide": {
        "name": "[DA] Resonant Hide"
      },
      "resonant_links": {
        "name": "[DA] Resonant Links"
      },
      "resonant_steel": {
        "name": "[DA] Resonant Steel"
      },
      "resonant_timber": {
        "name": "[DA] Resonant Timber"
      },
      "conjured_water4": {
    ...
    "quests": {
      ...
      "q_prof_amends_apothecary": {
        "title": "[DA] Back on the Stove",
        "text": "[DA] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.",
        "completion": "[DA] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.",
        "objectives": {
          "0": {
            "label": "[DA] Wild Boar hunted"
          }
      ...
      "q_prof_amends_bombardier": {
        "title": "[DA] The Ledger Grows",
        "text": "[DA] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.",
        "completion": "[DA] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?",
        "objectives": {
          "0": {
            "label": "[DA] Tunnel Rat exterminated"
          }
        }
      },
      "q_prof_workorder_forge": {
        "title": "[DA] Forge Work Order",
        "text": "[DA] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.",
        "completion": "[DA] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.",
        "objectives": {
          "0": {
            "label": "[DA] Copper Ore delivered"
          }
        }
      },
      "q_prof_workorder_kitchens": {
        "title": "[DA] Kitchens Work Order",
        "text": "[DA] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.",
        "completion": "[DA] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.",
        "objectives": {
          "0": {
            "label": "[DA] Game Meat delivered"
          }
        }
      },
      "q_prof_workorder_loom": {
        "title": "[DA] Loom Work Order",
        "text": "[DA] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.",
        "completion": "[DA] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.",
        "objectives": {
          "0": {
            "label": "[DA] Spider Silk delivered"
          }
        }
      },
      "q_prof_workorder_toolworks": {
        "title": "[DA] Toolworks Work Order",
        "text": "[DA] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.",
        "completion": "[DA] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.",
        "objectives": {
          "0": {
            "label": "[DA] Ironbark Log delivered"
          }
        }
      },
      "q_prof_workorder_tannery": {
        "title": "[DA] Tannery Work Order",
        "text": "[DA] Vats are empty. Bring eight rough hides. Coin when you do.",
        "completion": "[DA] Good hides. Fair pay. Again when you have more.",
        "objectives": {
          "0": {
            "label": "[DA] Rough Hide delivered"
          }
        }
      },
      "q_prof_workorder_apothecary": {
        "title": "[DA] Apothecary Work Order",
        "text": "[DA] My shelves require goldleaf, and the market's stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.",
        "completion": "[DA] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.",
        "objectives": {
          "0": {
            "label": "[DA] Goldleaf Herb delivered"
          }
        }
      },
      "q_prof_hobby_switch": {
    ...
    "letters": {
      ...
      "mastery_reset_notice": {
        "sender": "[DA] The Guildhall",
        "subject": "[DA] Your craft, made honest",
      ...
      "prof_tier_weaponcrafting_armorcrafting_1": {
        "sender": "[DA] Forgemistress Darva",
        "subject": "[DA] A spark worth noting",
        "body": "[DA] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot."
      },
      "prof_tier_weaponcrafting_armorcrafting_2": {
        "sender": "[DA] Forgemistress Darva",
        "subject": "[DA] Rare work, and earned",
        "body": "[DA] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good."
      },
      "prof_tier_weaponcrafting_armorcrafting_3": {
        "sender": "[DA] Forgemistress Darva",
        "subject": "[DA] The metal answers you now",
        "body": "[DA] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm."
      },
      "prof_tier_weaponcrafting_armorcrafting_4": {
        "sender": "[DA] Forgemistress Darva",
        "subject": "[DA] Near the top of the ladder",
        "body": "[DA] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb."
      },
      "prof_tier_weaponcrafting_armorcrafting_5": {
        "sender": "[DA] Forgemistress Darva",
        "subject": "[DA] Mastery, at last",
        "body": "[DA] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new."
      },
      "prof_tier_leatherworking_tailoring_1": {
        "sender": "[DA] Weaver Ottilie",
        "subject": "[DA] An even first row",
        "body": "[DA] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully."
      },
      "prof_tier_leatherworking_tailoring_2": {
        "sender": "[DA] Weaver Ottilie",
        "subject": "[DA] Rare work, well measured",
        "body": "[DA] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased."
      },
      "prof_tier_leatherworking_tailoring_3": {
        "sender": "[DA] Weaver Ottilie",
        "subject": "[DA] The pattern comes clear",
        "body": "[DA] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice."
      },
      "prof_tier_leatherworking_tailoring_4": {
        "sender": "[DA] Weaver Ottilie",
        "subject": "[DA] One row from the top",
        "body": "[DA] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now."
      },
      "prof_tier_leatherworking_tailoring_5": {
        "sender": "[DA] Weaver Ottilie",
        "subject": "[DA] The last stitch",
        "body": "[DA] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly."
      },
      "prof_tier_alchemy_cooking_1": {
        "sender": "[DA] Cook Marlow",
        "subject": "[DA] A taste of things to come",
        "body": "[DA] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving."
      },
      "prof_tier_alchemy_cooking_2": {
        "sender": "[DA] Cook Marlow",
        "subject": "[DA] Rare work, and no burnt edges",
        "body": "[DA] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long."
      },
      "prof_tier_alchemy_cooking_3": {
        "sender": "[DA] Cook Marlow",
        "subject": "[DA] Now you are cooking",
        "body": "[DA] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting."
      },
      "prof_tier_alchemy_cooking_4": {
        "sender": "[DA] Cook Marlow",
        "subject": "[DA] One course from the feast",
        "body": "[DA] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle."
      },
      "prof_tier_alchemy_cooking_5": {
        "sender": "[DA] Cook Marlow",
        "subject": "[DA] Mastery, served hot",
        "body": "[DA] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table."
      },
      "prof_tier_engineering_alchemy_1": {
        "sender": "[DA] Tinker Gizzel",
        "subject": "[DA] FIRST spark, ha",
        "body": "[DA] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go."
      },
      "prof_tier_engineering_alchemy_2": {
        "sender": "[DA] Tinker Gizzel",
        "subject": "[DA] Rare, oh, RARE",
        "body": "[DA] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA."
      },
      "prof_tier_engineering_alchemy_3": {
        "sender": "[DA] Tinker Gizzel",
        "subject": "[DA] Now it gets loud",
        "body": "[DA] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses."
      },
      "prof_tier_engineering_alchemy_4": {
        "sender": "[DA] Tinker Gizzel",
        "subject": "[DA] One rung, ONE, from the top",
        "body": "[DA] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink."
      },
      "prof_tier_engineering_alchemy_5": {
        "sender": "[DA] Tinker Gizzel",
        "subject": "[DA] MASTERY, kaboom",
        "body": "[DA] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous."
      }
    },
    "itemSets": {
      "boundstone_vanguard": {
