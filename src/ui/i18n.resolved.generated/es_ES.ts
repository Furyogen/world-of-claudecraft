...
export const es_ES: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "dailyRewards": {
      ...
      "pointsGained": "Has ganado {points} puntos de recompensas diarias.",
    ...
    "worldBoss": {
      "spawn": "{name} se alza sobre Thornpeak Heights!"
    },
    "loot": {
      "chestTitle": "Cofre"
    },
    ...
    "targetFrame": {
      "unlock": "Mover marco del objetivo",
      "lock": "Bloquear marco del objetivo"
    },
    "itemTooltip": {
  ...
  "auth": {
    ...
    "recovery": {
      ...
      "failed": "Introduce una dirección de correo electrónico válida."
    }
  },
  "wallet": {
    "label": "Cartera $WOC",
  ...
  "entities": {
    ...
    "mobs": {
      ...
      "thunzharr_waking_peak": {
        "name": "Thunzharr, la Cima Despierta"
      },
      "thunzharr_stormling": {
        "name": "Pequeño tormentoso despertado"
      },
      "ironvein_foreman": {
    ...
    "quests": {
      ...
      "q_stalkers_return": {
        ...
        "text": "Doce muertos y la cresta sigue llena, {playerName}. Algo empuja a las bestias hacia el muro. Abate catorce más.",
        "completion": "Catorce más, y aún hay huellas frescas cada mañana. Lo que camina arriba no es un felino común.",
        "objectives": {
          "0": {
            "label": "Acechador de la cresta abatido"
          }
      ...
      "q_stalker_cloaks": {
        ...
        "text": "Los soldados del muro necesitan capas cálidas, {playerName}. Reúne diez pieles de los acechadores de las crestas al sur de la puerta.",
        "completion": "Diez pieles buenas, pero muchas están rasgadas, {playerName}. Algo en esa cresta está atacando a los suyos.",
        "objectives": {
          "0": {
            "label": "Piel de acechador de la cresta"
          }
      ...
      "q_old_cragmaw": {
        "title": "Viejo Cragmaw",
        "text": "La gente de la montaña nombró las huellas: Viejo Cragmaw. Su guarida está en la cresta occidental sobre el camino del sur, {playerName}. Lleva un aliado y acaba con la vieja bestia.",
        "completion": "Por fin cayó. Los acechadores volverán a las nieves altas, {playerName}, y mis patrullas podrán recorrer el camino sin sangrar. La cresta está más tranquila por tu trabajo.",
        "objectives": {
          "0": {
