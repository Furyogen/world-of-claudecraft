...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "mirrorBlurb": "ハイウォッチの鏡の向こうに広がるのは、月光に照らされ霧に包まれた黒硝子の国。ガラスの谷がレルム終盤の亡霊たちを抱え、守り手ネリッサがルーメンの窪地を治めています。",
      "mirrorGreeting": "硝子は、そこに溺れさせたすべての顔を留めている。ここでは静かに歩き、自らの映し身をあまり長く覗き込むな。",
      "mirrorGreeter": "守り手ネリッサ、ルーメンの窪地",
      "mirrorPlaceNotes": "ルーメンの窪地は鏡の町の中心。すぐ上に鏡の宮廷とガーゴイル像が並び、下へはオーバールックの階段が落ちていきます。鏡の淵は静かな黒い水をたたえ、月草原と嘆きの石に囲まれ、グルームクラグと暗き森が谷でもっとも重い亡霊たちを抱えます。魔女の窪地には霧の魔女モルウェンが住み、スターゲイザーの棚は長く冷たい眺めを持ち、黒い峡谷は東へ蛇行して黒貂の鏡へと通じています。",
