...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "hc": {
      ...
      "howto": "城の試練を駆け抜けろ:フレイルを避け、丸太をかわし、斧のタイミングを計り、跳ね橋を渡り、岩を避けろ。最初にゴールした者が王冠を手にする。落下しても時間が失われるだけだ。",
      "joinQueue": "ガントレットに参加",
      "leaveQueue": "列を離れる",
  ...
  "guide": {
    ...
    "hodricsCastlePage": {
      ...
      "courseHeading": "ガントレットのコース",
      "courseBody": "コースはスタート広場から始まり、フレイルの橋、丸太の中庭、斧の回廊、跳ね橋、岩石の小道を抜けて、紅の坂道をゴールの主塔まで駆け上がる。すべての仕掛けは決して不規則ではなく、それぞれ一定のリズムで揺れ、回転し、転がる。よく見れば必ず安全な瞬間を見つけられる。",
      ...
      "fallsBody": "仕掛けに弾き飛ばされても、深淵に落ちても、直前のチェックポイントへ戻されるだけだ。この通路で命を落とす者はいない。転落の本当の代償は、遅れた分の数秒を取り戻す時間だけだ。",
      "standingsHeading": "王冠",
      "standingsBody": "最初にゴールラインを越えた者が、そのレースのホドリックの王冠を手にする。出走回数、勝利数、自己ベストは参加するたびに積み重なっていく。"
    },
    "wishPage": {
      "heading": "知っておきたかったこと",
