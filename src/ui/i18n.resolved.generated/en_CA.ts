...
export const en_CA: EnTranslations = {
  ...
  "editor": {
    ...
    "help": {
      ...
      "key": {
        "tools": "Select, Move, Rotate and Scale use the number keys 1-4, shown on their buttons in the tool rail. X deletes the selected assets; every other tool is click-only.",
