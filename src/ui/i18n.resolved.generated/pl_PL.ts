...
export const pl_PL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "dailyRewards": {
      ...
      "pointsGained": "Zdobyto {points} punktów codziennych nagród.",
    ...
    "options": {
      ...
      "showOwnNameplate": "Pokaż mój znacznik imienia",
      ...
      "walkByAutoloot": "Automatyczny łup przy przejściu",
  ...
  "auth": {
    ...
    "recovery": {
      ...
      "failed": "Wpisz prawidłowy adres e-mail."
    }
  },
  "wallet": {
    "label": "Portfel $WOC",
    ...
    "extensionHelp": "Aby zobaczyć tutaj portfel, pozostaw aktywne rozszerzenie portfela w przeglądarce, takie jak Solflare Wallet.",
  ...
  "entities": {
    ...
    "mobs": {
      ...
      "thunzharr_waking_peak": {
        "name": "Thunzharr, Przebudzony Szczyt"
      },
      "thunzharr_stormling": {
    ...
    "quests": {
      ...
      "q_stalkers_return": {
        ...
        "objectives": {
          "0": {
            "label": "Prześladowca z grani zabity"
          }
        }
      },
      "q_stalker_cloaks": {
        ...
        "objectives": {
          "0": {
            "label": "Skóra prześladowcy z grani"
          }
        }
      },
      "q_old_cragmaw": {
        "title": "Stary Cragmaw",
        "text": "Stary Cragmaw: de sporen leiden naar de westelijke kam boven de zuidweg, {playerName}. Neem hulp mee en versla het oude beest.",
        "completion": "Stary Cragmaw is gevallen, {playerName}. De patrouilles kunnen de weg weer gebruiken en de kam is rustiger door je werk.",
        "objectives": {
          "0": {
