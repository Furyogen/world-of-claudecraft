...
export const pl_PL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "[PL] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.",
    ...
    "townFocus": {
      ...
      "tierHint": "[PL] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.",
      "townOnlyHint": "[PL] Focus can only be changed while you are in town.",
    ...
    "bags": {
      ...
      "itemAriaInstanced": "[PL] {item}, quantity {count}, maker-marked copy",
    ...
    "loot": {
      "chestTitle": "Skrzynia",
      "takeLootButton": "[PL] Take Loot",
      "takeLootTooltip": "[PL] Takes the coins and dropped items. Does not use up the harvest.",
      "unifiedPressHint": "[PL] The interact key loots and harvests in one press, using your town focus."
    },
    "spellbook": {
    ...
    "social": {
      ...
      "onlineHeader": "[PL] Online ({n})",
      "offlineHeader": "[PL] Offline ({n})",
      "hideOffline": "[PL] Hide offline",
      "hideOfflineTitle": "[PL] Hide offline guild members"
    },
    "gathering": {
      "title": "Zbieractwo",
      "mining": "Górnictwo",
      ...
      "catchLine": "[PL] You reel in: {name}",
      "biteLine": "[PL] Something takes the bait!",
      "gotAwayLine": "[PL] It got away.",
      "nodeName": {
        "ore": "[PL] Ore Vein",
        "wood": "[PL] Timber Stand",
        "herb": "[PL] Herb Patch"
      },
      "tierRequired": {
        "mining": "[PL] Requires a tier {tier} mining pick",
        "logging": "[PL] Requires a tier {tier} logging axe",
        "herbalism": "[PL] Requires a tier {tier} herbalism sickle"
      },
      "toolTierUnmet": {
        "mining": "[PL] You need a tier {tier} mining pick to harvest this vein.",
        "logging": "[PL] You need a tier {tier} logging axe to fell this stand.",
        "herbalism": "[PL] You need a tier {tier} herbalism sickle to gather this patch."
      },
      "toolTierUnmetCorpse": "[PL] You need a tier {tier} gathering tool to recover the finest materials.",
      "downgradeMark": "[PL] Bags full: the find was stored without its gatherer's mark.",
      "downgradeFind": "[PL] Bags full: a pristine find slipped away.",
      "stateReady": "[PL] Ready",
      "stateCooldown": "[PL] Respawning"
    },
    "archetypeTitle": {
      "label": "Tytuł",
      "none": "Brak",
    ...
    "enchantName": {
      "enchant_weapon_might": "[PL] Enchant Weapon - Might",
      "enchant_weapon_intellect": "[PL] Enchant Weapon - Spellpower",
      "enchant_helmet_fortitude": "[PL] Enchant Helmet - Fortitude",
      "enchant_neck_spirit": "[PL] Enchant Necklace - Spirit",
      "enchant_shoulder_agility": "[PL] Enchant Shoulders - Agility",
      "enchant_chest_stamina": "[PL] Enchant Chest - Stamina",
      "enchant_waist_stamina": "[PL] Enchant Belt - Stamina",
      "enchant_legs_stamina": "[PL] Enchant Legs - Stamina",
      "enchant_gloves_agility": "[PL] Enchant Gloves - Agility",
      "enchant_gloves_intellect": "[PL] Enchant Gloves - Spellpower",
      "enchant_feet_agility": "[PL] Enchant Boots - Agility",
      "enchant_ring_spirit": "[PL] Enchant Ring - Spirit",
      "enchant_weapon_agility": "[PL] Enchant Weapon - Agility",
      "enchant_helmet_intellect": "[PL] Enchant Helmet - Intellect",
      "enchant_helmet_armor": "[PL] Enchant Helmet - Reinforcement",
      "enchant_neck_intellect": "[PL] Enchant Necklace - Intellect",
      "enchant_neck_agility": "[PL] Enchant Necklace - Agility",
      "enchant_shoulder_strength": "[PL] Enchant Shoulders - Strength",
      "enchant_shoulder_intellect": "[PL] Enchant Shoulders - Intellect",
      "enchant_chest_spirit": "[PL] Enchant Chest - Spirit",
      "enchant_chest_armor": "[PL] Enchant Chest - Reinforcement",
      "enchant_waist_strength": "[PL] Enchant Belt - Strength",
      "enchant_waist_agility": "[PL] Enchant Belt - Agility",
      "enchant_legs_intellect": "[PL] Enchant Legs - Intellect",
      "enchant_gloves_strength": "[PL] Enchant Gloves - Strength",
      "enchant_feet_strength": "[PL] Enchant Boots - Strength",
      "enchant_feet_stamina": "[PL] Enchant Boots - Stamina",
      "enchant_ring_strength": "[PL] Enchant Ring - Strength",
      "enchant_ring_agility": "[PL] Enchant Ring - Agility",
      "enchant_ring_intellect": "[PL] Enchant Ring - Intellect",
      "enchant_weapon_greater_might": "[PL] Enchant Weapon - Greater Might",
      "enchant_weapon_greater_spellpower": "[PL] Enchant Weapon - Greater Spellpower",
      "enchant_helmet_greater_fortitude": "[PL] Enchant Helmet - Greater Fortitude",
      "enchant_chest_greater_stamina": "[PL] Enchant Chest - Greater Stamina",
      "enchant_legs_greater_stamina": "[PL] Enchant Legs - Greater Stamina",
      "enchant_gloves_greater_agility": "[PL] Enchant Gloves - Greater Agility",
      "enchant_weapon_runed_edge": "[PL] Enchant Weapon - Runed Edge",
      "enchant_weapon_runed_focus": "[PL] Enchant Weapon - Runed Focus",
      "enchant_chest_runeweave": "[PL] Enchant Chest - Runeweave",
      "enchant_legs_runed_hide": "[PL] Enchant Legs - Runed Hide",
      "enchant_helmet_runed_links": "[PL] Enchant Helmet - Runed Links"
    },
    "professions": {
      "title": "Zawody",
      ...
      "nextUnlockMastered": "[PL] Mastered, for now",
    ...
    "crafting": {
      ...
      "attunementReturnCost": "[PL] If you leave this pair, returning to it later costs {cost} make-amends tasks.",
      "identity": {
      ...
      "difficultyMinimal": "[PL] Minimal skill gain",
      ...
      "learnMoreAtStation": "[PL] {master} at the {station} can teach you more {craft} recipes.",
      ...
      "trendNudge": "[PL] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.",
      "trendNudgeNoMaster": "[PL] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.",
      "attunedZoneLine": "[PL] {name} has attuned as {archetype}!",
      "attunedBanner": "[PL] Attuned: {title}",
      "tierTutorial": {
        "title": "[PL] Your First Tier",
        "tierCap": "[PL] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.",
        "radar": "[PL] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.",
        "masters": "[PL] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.",
        "dismiss": "[PL] Got it"
      },
      "makersMark": "Stworzone przez {name}",
      "gatheredBy": "[PL] Gathered by {name}",
    ...
    "itemMenu": {
      "use": "[PL] Use",
      "equip": "[PL] Equip",
      "disenchant": "[PL] Disenchant",
      "salvage": "[PL] Salvage",
      "applyEnchant": "[PL] Apply Enchant"
    },
    "enchanting": {
      "disenchantedLine": "[PL] You disenchant {item}.",
      "salvagedLine": "[PL] You salvage {item}.",
      "enchantAppliedLine": "[PL] You enchant {item} with {enchant}.",
      "notHeld": "[PL] You do not have that item.",
      "notDisenchantable": "[PL] You cannot disenchant that.",
      "notSalvageable": "[PL] You cannot salvage that.",
      "disenchantThrottled": "[PL] You are disenchanting too quickly. Wait a moment and try again.",
      "salvageThrottled": "[PL] You are salvaging too quickly. Wait a moment and try again.",
      "enchantThrottled": "[PL] You are enchanting too quickly. Wait a moment and try again.",
      "enchantWrongSlot": "[PL] That enchant cannot be applied to that item.",
      "enchantUnknown": "[PL] That enchant does not exist.",
      "enchantInsufficient": "[PL] You do not have the materials for that enchant.",
      "disenchantConfirmTitle": "[PL] Disenchant {item}?",
      "disenchantConfirmBody": "[PL] This destroys {item} and yields arcane materials. This cannot be undone.",
      "disenchantConfirmBodySpecial": "[PL] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.",
      "salvageConfirmTitle": "[PL] Salvage {item}?",
      "salvageConfirmBody": "[PL] This destroys {item} and yields crafting materials. This cannot be undone.",
      "salvageConfirmBodySpecial": "[PL] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.",
      "pickerTitle": "[PL] Apply Enchant",
      "targetTitle": "[PL] Choose an item to enchant",
      "noEnchants": "[PL] No enchant uses this reagent.",
      "noTargets": "[PL] No eligible item to enchant."
    },
    "training": {
  ...
  "stats": {
    ...
    "charactersCreated": "[PL] Characters Created",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "tradeBound": "[PL] That item is bound and cannot be traded."
    },
    "logs": {
      "standUp": "Wstajesz.",
  ...
  "entities": {
    ...
    "items": {
      ...
      "mosshide_vest": {
        "name": "[PL] Mosshide Vest"
      },
      "thornling_grips": {
        "name": "[PL] Thornling Grips"
      },
      "acolyte_chain_grips": {
        "name": "[PL] Acolyte Chain Grips"
      },
      "votive_chain_belt": {
        "name": "[PL] Votive Chain Belt"
      },
      "briarroot_staff": {
        "name": "[PL] Briarroot Staff"
      },
      "valefire_lantern": {
        "name": "[PL] Valefire Lantern"
      },
      "fenbark_leggings": {
        "name": "[PL] Fenbark Leggings"
      },
      "mirebloom_treads": {
        "name": "[PL] Mirebloom Treads"
      },
      "fenwarden_sabatons": {
        "name": "[PL] Fenwarden Sabatons"
      },
      "marshlight_hauberk": {
        "name": "[PL] Marshlight Hauberk"
      },
      "duskthorn_mantle": {
        "name": "[PL] Duskthorn Mantle"
      },
      "fenshadow_maul": {
        "name": "[PL] Fenshadow Maul"
      },
      "wildgrove_cinch": {
        "name": "[PL] Wildgrove Cinch"
      },
      "cragward_pauldrons": {
        "name": "[PL] Cragward Pauldrons"
      },
      "cragthorn_greatstaff": {
        "name": "[PL] Cragthorn Greatstaff"
      },
      "moonbark_vestments": {
        "name": "[PL] Moonbark Vestments"
      },
      "peaksong_helm": {
        "name": "[PL] Peaksong Helm"
      },
      "stormchant_gauntlets": {
        "name": "[PL] Stormchant Gauntlets"
      },
      "cragprowl_belt": {
        "name": "[PL] Cragprowl Belt"
      },
      "stormroot_cowl": {
        "name": "[PL] Stormroot Cowl"
      },
      "thunderward_legguards": {
        "name": "[PL] Thunderward Legguards"
      },
      "revenantstep_treads": {
        "name": "[PL] Revenantstep Treads"
      },
      "shardfang_grips": {
        "name": "[PL] Shardfang Grips"
      },
      "shardsong_mantle": {
        "name": "[PL] Shardsong Mantle"
      },
      "wyrmcult_spellgrips": {
        "name": "[PL] Wyrmcult Spellgrips"
      },
      "thornpeak_wildwraps": {
        "name": "[PL] Thornpeak Wildwraps"
      },
      "stormvotive_hauberk": {
        "name": "[PL] Stormvotive Hauberk"
      },
      "cryptbloom_shoulderguards": {
        "name": "[PL] Cryptbloom Shoulderguards"
      },
      "gravewyrm_thornmaul": {
        "name": "[PL] Gravewyrm Thornmaul"
      },
      "vestments_of_the_waking_grove": {
        "name": "[PL] Vestments of the Waking Grove"
      },
      "nightfangs_greatstaff": {
        "name": "[PL] Nightfang's Greatstaff"
      },
      "maul_of_the_scourged_wilds": {
        "name": "[PL] Maul of the Scourged Wilds"
      },
      "tidehymn_slippers": {
        "name": "[PL] Tidehymn Slippers"
      },
      "pearlward_aegis": {
        "name": "[PL] Pearlward Aegis"
      },
      "wildgrowth_leggings": {
        "name": "[PL] Wildgrowth Leggings"
      },
      "grovewardens_grips": {
        "name": "[PL] Grovewarden's Grips"
      },
      "verdant_walkers": {
        "name": "[PL] Verdant Walkers"
      },
      "lunarward_cinch": {
        "name": "[PL] Lunarward Cinch"
      },
      "dreamroot_boots": {
        "name": "[PL] Dreamroot Boots"
      },
      "stormbark_mantle": {
        "name": "[PL] Stormbark Mantle"
      },
      "wildsoul_maul": {
        "name": "[PL] Wildsoul Maul"
      },
      "resonant_thread": {
        "name": "[PL] Resonant Thread"
      },
      "resonant_hide": {
        "name": "[PL] Resonant Hide"
      },
      "resonant_links": {
        "name": "[PL] Resonant Links"
      },
      "resonant_steel": {
        "name": "[PL] Resonant Steel"
      },
      "resonant_timber": {
        "name": "[PL] Resonant Timber"
      },
      "conjured_water4": {
    ...
    "quests": {
      ...
      "q_prof_amends_apothecary": {
        "title": "[PL] Back on the Stove",
        "text": "[PL] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.",
        "completion": "[PL] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.",
        "objectives": {
          "0": {
            "label": "[PL] Wild Boar hunted"
          }
      ...
      "q_prof_amends_bombardier": {
        "title": "[PL] The Ledger Grows",
        "text": "[PL] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.",
        "completion": "[PL] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?",
        "objectives": {
          "0": {
            "label": "[PL] Tunnel Rat exterminated"
          }
        }
      },
      "q_prof_workorder_forge": {
        "title": "[PL] Forge Work Order",
        "text": "[PL] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.",
        "completion": "[PL] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.",
        "objectives": {
          "0": {
            "label": "[PL] Copper Ore delivered"
          }
        }
      },
      "q_prof_workorder_kitchens": {
        "title": "[PL] Kitchens Work Order",
        "text": "[PL] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.",
        "completion": "[PL] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.",
        "objectives": {
          "0": {
            "label": "[PL] Game Meat delivered"
          }
        }
      },
      "q_prof_workorder_loom": {
        "title": "[PL] Loom Work Order",
        "text": "[PL] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.",
        "completion": "[PL] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.",
        "objectives": {
          "0": {
            "label": "[PL] Spider Silk delivered"
          }
        }
      },
      "q_prof_workorder_toolworks": {
        "title": "[PL] Toolworks Work Order",
        "text": "[PL] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.",
        "completion": "[PL] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.",
        "objectives": {
          "0": {
            "label": "[PL] Ironbark Log delivered"
          }
        }
      },
      "q_prof_workorder_tannery": {
        "title": "[PL] Tannery Work Order",
        "text": "[PL] Vats are empty. Bring eight rough hides. Coin when you do.",
        "completion": "[PL] Good hides. Fair pay. Again when you have more.",
        "objectives": {
          "0": {
            "label": "[PL] Rough Hide delivered"
          }
        }
      },
      "q_prof_workorder_apothecary": {
        "title": "[PL] Apothecary Work Order",
        "text": "[PL] My shelves require goldleaf, and the market's stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.",
        "completion": "[PL] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.",
        "objectives": {
          "0": {
            "label": "[PL] Goldleaf Herb delivered"
          }
        }
      },
      "q_prof_hobby_switch": {
    ...
    "letters": {
      ...
      "mastery_reset_notice": {
        "sender": "[PL] The Guildhall",
        "subject": "[PL] Your craft, made honest",
      ...
      "prof_tier_weaponcrafting_armorcrafting_1": {
        "sender": "[PL] Forgemistress Darva",
        "subject": "[PL] A spark worth noting",
        "body": "[PL] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot."
      },
      "prof_tier_weaponcrafting_armorcrafting_2": {
        "sender": "[PL] Forgemistress Darva",
        "subject": "[PL] Rare work, and earned",
        "body": "[PL] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good."
      },
      "prof_tier_weaponcrafting_armorcrafting_3": {
        "sender": "[PL] Forgemistress Darva",
        "subject": "[PL] The metal answers you now",
        "body": "[PL] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm."
      },
      "prof_tier_weaponcrafting_armorcrafting_4": {
        "sender": "[PL] Forgemistress Darva",
        "subject": "[PL] Near the top of the ladder",
        "body": "[PL] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb."
      },
      "prof_tier_weaponcrafting_armorcrafting_5": {
        "sender": "[PL] Forgemistress Darva",
        "subject": "[PL] Mastery, at last",
        "body": "[PL] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new."
      },
      "prof_tier_leatherworking_tailoring_1": {
        "sender": "[PL] Weaver Ottilie",
        "subject": "[PL] An even first row",
        "body": "[PL] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully."
      },
      "prof_tier_leatherworking_tailoring_2": {
        "sender": "[PL] Weaver Ottilie",
        "subject": "[PL] Rare work, well measured",
        "body": "[PL] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased."
      },
      "prof_tier_leatherworking_tailoring_3": {
        "sender": "[PL] Weaver Ottilie",
        "subject": "[PL] The pattern comes clear",
        "body": "[PL] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice."
      },
      "prof_tier_leatherworking_tailoring_4": {
        "sender": "[PL] Weaver Ottilie",
        "subject": "[PL] One row from the top",
        "body": "[PL] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now."
      },
      "prof_tier_leatherworking_tailoring_5": {
        "sender": "[PL] Weaver Ottilie",
        "subject": "[PL] The last stitch",
        "body": "[PL] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly."
      },
      "prof_tier_alchemy_cooking_1": {
        "sender": "[PL] Cook Marlow",
        "subject": "[PL] A taste of things to come",
        "body": "[PL] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving."
      },
      "prof_tier_alchemy_cooking_2": {
        "sender": "[PL] Cook Marlow",
        "subject": "[PL] Rare work, and no burnt edges",
        "body": "[PL] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long."
      },
      "prof_tier_alchemy_cooking_3": {
        "sender": "[PL] Cook Marlow",
        "subject": "[PL] Now you are cooking",
        "body": "[PL] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting."
      },
      "prof_tier_alchemy_cooking_4": {
        "sender": "[PL] Cook Marlow",
        "subject": "[PL] One course from the feast",
        "body": "[PL] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle."
      },
      "prof_tier_alchemy_cooking_5": {
        "sender": "[PL] Cook Marlow",
        "subject": "[PL] Mastery, served hot",
        "body": "[PL] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table."
      },
      "prof_tier_engineering_alchemy_1": {
        "sender": "[PL] Tinker Gizzel",
        "subject": "[PL] FIRST spark, ha",
        "body": "[PL] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go."
      },
      "prof_tier_engineering_alchemy_2": {
        "sender": "[PL] Tinker Gizzel",
        "subject": "[PL] Rare, oh, RARE",
        "body": "[PL] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA."
      },
      "prof_tier_engineering_alchemy_3": {
        "sender": "[PL] Tinker Gizzel",
        "subject": "[PL] Now it gets loud",
        "body": "[PL] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses."
      },
      "prof_tier_engineering_alchemy_4": {
        "sender": "[PL] Tinker Gizzel",
        "subject": "[PL] One rung, ONE, from the top",
        "body": "[PL] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink."
      },
      "prof_tier_engineering_alchemy_5": {
        "sender": "[PL] Tinker Gizzel",
        "subject": "[PL] MASTERY, kaboom",
        "body": "[PL] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous."
      }
    },
    "itemSets": {
      "boundstone_vanguard": {
