...
export const es: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "death": {
      ...
      "healerConfirmTitle": "[ES] Accept the Keeper's Toll?",
      "healerConfirmBody": "[ES] The Pale Keeper will revive you here, but the Keeper's Toll reduces all of your attributes by 75%, for up to 10 minutes at higher levels. Walking your spirit back to your corpse revives you with no penalty.",
      "healerConfirmAccept": "[ES] Revive Me",
      "healerConfirmCancel": "[ES] Cancel"
    },
    "fct": {
    ...
    "options": {
      ...
      "showThirdActionBar": "[ES] Show Third Action Bar",
    ...
    "playerMenu": {
      ...
      "streamerBadgeTitle": "[ES] Verified streamer"
    },
    "lootSettings": {
    ...
    "gathering": {
      ...
      "gatherLine": "[ES] You gather: {name}.",
      "gatherLineQty": "[ES] You gather: {name} x{qty}."
    },
    "archetypeTitle": {
      "label": "Título",
      "none": "Ninguno",
    ...
    "professions": {
      "title": "[ES] Professions",
      "close": "[ES] Close professions",
      "ringAria": "[ES] Craft wheel",
      "skillsHeader": "[ES] Craft skills",
      "gatheringHeader": "[ES] Gathering",
      "perksHeader": "[ES] Perks",
      "identityHeader": "[ES] Identity",
      "roleMajor": "[ES] Major",
      "roleHobby": "[ES] Hobby",
      "roleDormant": "[ES] Dormant",
      "roleUnattuned": "[ES] Unattuned",
      "ceilingUnlimited": "[ES] No empowerment cap",
      "ceilingRare": "[ES] Rare cap",
      "ceilingCommon": "[ES] Common cap",
      "skillValue": "[ES] {skill} / {max}",
      "tierPipAria": "[ES] Tier {tier}",
      "nextUnlockTier": "[ES] {points} points to the next tier: masterwork odds improve",
      "nextUnlockSpecialized": "[ES] {points} points to Specialized: material costs drop",
      "nextUnlockMax": "[ES] At maximum skill",
      "perkSpecializedLine": "[ES] {craft}: Specialized, material costs -{pct}%",
      "perkSpecializedAt": "[ES] Specializes at {threshold} skill",
      "switchCost": "[ES] Next archetype switch costs {cost} amends",
      "syncing": "[ES] Waiting for your profession data from the realm.",
      "tutorialLine": "[ES] Reach {target} skill in any craft to unlock your first tier.",
      "ctaHeader": "[ES] Next step",
      "ctaRaise": "[ES] Keep raising {craft}: {points} more points to the next tier.",
      "ctaStart": "[ES] Craft or gather with any profession to begin.",
      "unattunedIdentity": "[ES] You are not yet attuned to an archetype. Raise your crafts and complete an attunement to choose your pair.",
      "nudgeNearTier": "[ES] {craft}: {points} points from the next tier",
      "nudgeDormant": "[ES] Your {craft} knowledge lies dormant",
      "hobbyLabel": "[ES] Hobby: {craft}",
      "majorsLabel": "[ES] Majors: {a} and {b}",
      "pairsHeld": "[ES] Pairs held: {count}",
      "returnsLabel": "[ES] Returns: {count}"
    },
    "crafting": {
      "title": "Elaboración",
      ...
      "comboTierUnmetNamed": "[ES] Raise {crafts} to tier {tier}.",
      ...
      "stationRequired": "[ES] You must be at the {station} to craft that.",
      "stationName": {
        "forge": "[ES] Forge",
        "kitchens": "[ES] Kitchens",
        "apothecary": "[ES] Apothecary",
        "tannery": "[ES] Tannery",
        "loom": "[ES] Loom",
        "toolworks": "[ES] Toolworks"
      },
      ...
      "skillReqLine": "[ES] Requires {craft} {skill}",
      "difficultyFull": "[ES] Full skill gain",
      "difficultyReduced": "[ES] Reduced skill gain",
      "difficultyNone": "[ES] No skill gain",
      "stationBadge": "[ES] Station",
      "stationOutOfRangeNamed": "[ES] Move to the {station} to craft this.",
      "masterworkToast": "[ES] Masterwork! {name}",
      "masterworkZoneLine": "[ES] {crafter} crafted a masterwork {name}!",
      "tierUpToast": "[ES] {craft} advanced to tier {tier}!",
      "makersMark": "[ES] Crafted by {name}",
      "masterworkSeal": "[ES] Masterwork",
      "enchantedLine": "[ES] Enchanted"
    },
    "training": {
      "title": "[ES] Training: {name}",
      "close": "[ES] Close training",
      "empty": "[ES] This master has nothing to teach.",
      "free": "[ES] Free",
      "stateKnown": "[ES] Known",
      "stateTeachable": "[ES] Available",
      "stateLocked": "[ES] Locked",
      "requirement": "[ES] Taught at {craft} {skill}",
      "trainAria": "[ES] Learn {name} for {fee}",
      "dialogOption": "[ES] Training",
      "dialogOptionAria": "[ES] Browse training from {name}",
      "learned": "[ES] Recipe learned: {recipe}",
      "tierUnmet": "[ES] You need {craft} {skill} to learn that recipe.",
      "cannotAfford": "[ES] You cannot afford that training.",
      "notTaughtHere": "[ES] That recipe is not taught here.",
      "alreadyKnown": "[ES] You already know that recipe.",
      "outOfRange": "[ES] You must be at the station to train."
    },
    "finder": {
  ...
  "gatherEvent": {
    "pristineVein": "[ES] {finder} struck a pristine vein!",
    "ancientHeartwood": "[ES] {finder} felled an ancient heartwood!",
    "moonlitBloom": "[ES] {finder} discovered a moonlit bloom!"
  },
  "apiError": {
    "validation": {
  ...
  "heroicShop": {
    ...
    "buyConfirmTitle": "[ES] Confirm Purchase",
    "buyConfirmBody": "[ES] Buy {item} for {marks} Heroic Marks? Marks purchases cannot be refunded.",
    "buyConfirmAccept": "[ES] Buy",
    "buyConfirmCancel": "[ES] Cancel"
  },
  "cardDuel": {
  ...
  "delveUi": {
    ...
    "shop": {
      ...
      "buyConfirmTitle": "[ES] Confirm Purchase",
      "buyConfirmBody": "[ES] Buy {item} for {marks} Delve Marks? Marks purchases cannot be refunded.",
      "buyConfirmAccept": "[ES] Buy",
      "buyConfirmCancel": "[ES] Cancel"
    },
    "tracker": {
  ...
  "loading": {
    ...
    "reconnectingAttempt": "[ES] Connection lost. Reconnecting... (attempt {attempt}/{maxAttempts}, retrying in {seconds}s)",
    "reconnectingNow": "[ES] Connection lost. Reconnecting now... (attempt {attempt}/{maxAttempts})",
    "slowConnection": "[ES] This is taking longer than usual. Check your internet connection.",
  ...
  "entities": {
    ...
    "items": {
      ...
      "ironbark_log": {
        "name": "[ES] Ironbark Log"
      },
      "silverleaf_herb": {
        "name": "[ES] Silverleaf Herb"
      },
      "rough_hide": {
        "name": "[ES] Rough Hide"
      },
      ...
      "homespun_cloth": {
        "name": "[ES] Homespun Cloth"
      },
      "pristine_hide": {
        "name": "[ES] Pristine Hide"
      },
      "pristine_silk": {
        "name": "[ES] Pristine Silk"
      },
      "pristine_venom_gland": {
        "name": "[ES] Pristine Venom Gland"
      },
      "prime_cut": {
        "name": "[ES] Prime Cut"
      },
      "smithing_flux": {
        "name": "[ES] Smithing Flux"
      },
      "spool_of_thread": {
        "name": "[ES] Spool of Thread"
      },
      "tanning_agent": {
        "name": "[ES] Tanning Agent"
      },
      "cooking_salt": {
        "name": "[ES] Cooking Salt"
      },
      "glass_vial": {
        "name": "[ES] Glass Vial"
      },
      "copper_bearded_axe": {
        "name": "[ES] Copper Bearded Axe"
      },
      "copper_flanged_mace": {
        "name": "[ES] Copper Flanged Mace"
      },
      "ironbark_boar_spear": {
        "name": "[ES] Ironbark Boar Spear"
      },
      "ironedge_longsword": {
        "name": "[ES] Ironedge Longsword"
      },
      "ironshod_maul": {
        "name": "[ES] Ironshod Maul"
      },
      "whetted_iron_dirk": {
        "name": "[ES] Whetted Iron Dirk"
      },
      "thorium_warblade": {
        "name": "[ES] Thorium Warblade"
      },
      "arcanite_war_axe": {
        "name": "[ES] Arcanite War Axe"
      },
      "elderwood_battle_staff": {
        "name": "[ES] Elderwood Battle Staff"
      },
      "riveted_copper_girdle": {
        "name": "[ES] Riveted Copper Girdle"
      },
      "coppermail_sabatons": {
        "name": "[ES] Coppermail Sabatons"
      },
      "coppermail_gauntlets": {
        "name": "[ES] Coppermail Gauntlets"
      },
      "ironlink_hauberk": {
        "name": "[ES] Ironlink Hauberk"
      },
      "ironlink_legguards": {
        "name": "[ES] Ironlink Legguards"
      },
      "ironlink_spaulders": {
        "name": "[ES] Ironlink Spaulders"
      },
      "thoriumscale_greathelm": {
        "name": "[ES] Thoriumscale Greathelm"
      },
      "thoriumscale_cuirass": {
        "name": "[ES] Thoriumscale Cuirass"
      },
      "thoriumscale_leggings": {
        "name": "[ES] Thoriumscale Leggings"
      },
      "homespun_hood": {
        "name": "[ES] Homespun Hood"
      },
      "homespun_mitts": {
        "name": "[ES] Homespun Mitts"
      },
      "silverthread_slippers": {
        "name": "[ES] Silverthread Slippers"
      },
      "goldweave_robe": {
        "name": "[ES] Goldweave Robe"
      },
      "goldweave_leggings": {
        "name": "[ES] Goldweave Leggings"
      },
      "silkspun_satchel": {
        "name": "[ES] Silkspun Satchel"
      },
      "silkbinders_raiment": {
        "name": "[ES] Silkbinder's Raiment"
      },
      "sunweave_mantle": {
        "name": "[ES] Sunweave Mantle"
      },
      "sunweave_treads": {
        "name": "[ES] Sunweave Treads"
      },
      "fenbridge_hide_leggings": {
        "name": "[ES] Fenbridge Hide Leggings"
      },
      "fenbridge_hide_boots": {
        "name": "[ES] Fenbridge Hide Boots"
      },
      "fenbridge_hide_belt": {
        "name": "[ES] Fenbridge Hide Belt"
      },
      "marshstalker_jerkin": {
        "name": "[ES] Marshstalker Jerkin"
      },
      "marshstalker_hood": {
        "name": "[ES] Marshstalker Hood"
      },
      "marshstalker_spaulders": {
        "name": "[ES] Marshstalker Spaulders"
      },
      "mirewarden_jerkin": {
        "name": "[ES] Mirewarden Jerkin"
      },
      "mirewarden_leggings": {
        "name": "[ES] Mirewarden Leggings"
      },
      "mirewarden_treads": {
        "name": "[ES] Mirewarden Treads"
      },
      "pan_seared_perch": {
        "name": "[ES] Pan-Seared River Perch"
      },
      "hunters_game_skewer": {
        "name": "[ES] Hunter's Game Skewer"
      },
      "herbed_marsh_pike": {
        "name": "[ES] Herbed Marsh Pike"
      },
      "ashwood_smoked_eel": {
        "name": "[ES] Ashwood Smoked Eel"
      },
      "goldleaf_game_stew": {
        "name": "[ES] Goldleaf Game Stew"
      },
      "frostgill_chowder": {
        "name": "[ES] Frostgill Chowder"
      },
      "silvered_carp_supper": {
        "name": "[ES] Silvered Carp Supper"
      },
      "anglers_feast_platter": {
        "name": "[ES] Angler's Feast Platter"
      },
      "marlows_grand_roast": {
        "name": "[ES] Marlow's Grand Roast"
      },
      "silverleaf_healing_draught": {
        "name": "[ES] Silverleaf Healing Draught"
      },
      "silverleaf_mana_draught": {
        "name": "[ES] Silverleaf Mana Draught"
      },
      "elixir_of_the_boar": {
        "name": "[ES] Elixir of the Boar"
      },
      "goldleaf_healing_draught": {
        "name": "[ES] Goldleaf Healing Draught"
      },
      "goldleaf_mana_draught": {
        "name": "[ES] Goldleaf Mana Draught"
      },
      "venomfire_elixir": {
        "name": "[ES] Venomfire Elixir"
      },
      "sunpetal_healing_draught": {
        "name": "[ES] Sunpetal Healing Draught"
      },
      "sunpetal_mana_draught": {
        "name": "[ES] Sunpetal Mana Draught"
      },
      "elixir_of_the_serpent": {
        "name": "[ES] Elixir of the Serpent"
      },
      "conjured_water4": {
    ...
    "npcs": {
      ...
      "forgemistress_darva": {
        "name": "[ES] Forgemistress Darva",
        "title": "[ES] Master of the Forge",
        "greeting": "[ES] The forge answers to me, {className}. Bring good ore and it will answer to you too."
      },
      "cook_marlow": {
        "name": "[ES] Cook Marlow",
        "title": "[ES] Master of the Kitchens",
        "greeting": "[ES] Nothing leaves my kitchens half-cooked, {className}. Sit, eat, then get back out there."
      },
      "weaver_ottilie": {
        "name": "[ES] Weaver Ottilie",
        "title": "[ES] Master of the Loom",
        "greeting": "[ES] Mind the threads, {className}. A steady hand at the loom beats a strong one."
      },
      "tinker_gizzel": {
        "name": "[ES] Tinker Gizzel",
        "title": "[ES] Master of the Toolworks",
        "greeting": "[ES] Springs, sprockets, and sharp edges, {className}: the toolworks has whatever your hands lack."
      },
      "tanner_hesk": {
        "name": "[ES] Tanner Hesk",
        "title": "[ES] Master of the Tannery",
        "greeting": "[ES] A hide is only as good as its tanning, {className}. The vats are ready when you are."
      },
      "alchemist_verane": {
        "name": "[ES] Alchemist Verane",
        "title": "[ES] Master of the Apothecary",
        "greeting": "[ES] Measure twice and pour once, {className}. The apothecary has no patience for spilled reagents."
      },
      "tidewatcher_ondrel": {
        "name": "Ondrel Vane",
    ...
    "letters": {
      ...
      "guild_trend_engineering_alchemy": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Engineering and Alchemy",
      ...
      "guild_trend_alchemy_cooking": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Alchemy and Cooking",
      ...
      "guild_trend_cooking_leatherworking": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Cooking and Leatherworking",
      ...
      "guild_trend_leatherworking_tailoring": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Leatherworking and Tailoring",
      ...
      "guild_trend_tailoring_inscription": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Tailoring and Inscription",
      ...
      "guild_trend_inscription_enchanting": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Inscription and Enchanting",
      ...
      "guild_trend_enchanting_jewelcrafting": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Enchanting and Jewelcrafting",
      ...
      "guild_trend_jewelcrafting_weaponcrafting": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Jewelcrafting and Weaponcrafting",
      ...
      "guild_trend_weaponcrafting_armorcrafting": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Weaponcrafting and Armorcrafting",
      ...
      "guild_trend_armorcrafting_engineering": {
        "sender": "[ES] The Crafting Guild",
        "subject": "[ES] Your work in Armorcrafting and Engineering",
