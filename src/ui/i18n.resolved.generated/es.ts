  ...
  "entities": {
    "abilities": {
      ...
      "lingering_dread": {
        ...
        "description": "Lanza un grito de batalla que infunde miedo a los enemigos en un radio de 10 m durante 4 s. El miedo persiste hasta que cada objetivo recibe un 20% de su salud máxima como daño. (Talento de guerrero)"
      },
      "stormthrow": {
      ...
      "cleansing_verdict": {
        ...
        "description": "Purga un efecto mágico dañino de un objetivo amistoso y le restaura {damage} p. de salud con poder Sagrado."
      },
      "voidfeast": {
        "name": "Festín del Vacío",
        "description": "Devora un efecto mágico (uno beneficioso de un enemigo o uno dañino de un aliado) y te sana un 6% de tu salud máxima."
      },
      "spellsteal": {
        "name": "Robar hechizo",
      ...
      "startle_shot": {
        "name": "Disparo de sobresalto",
        "description": "Un disparo impredecible que desorienta al objetivo durante {duration} s. Cualquier daño interrumpe el efecto."
      },
      "spell_reflect": {
        "name": "Reflejo de hechizos",
        "description": "Alza tu escudo y refleja el siguiente hechizo hostil hacia quien lo lanzó."
      },
      "smoke_screen": {
        "name": "Cortina de humo",
        "description": "Desaparece en una nube de humo, lo que aumenta durante un tiempo tu probabilidad de esquivar."
      },
      "typhoon": {
        "name": "Tifón",
        "description": "Una ráfaga de viento repele a todos los enemigos cercanos y los atonta, lo que reduce su velocidad de movimiento."
      },
      "bear_charge": {
