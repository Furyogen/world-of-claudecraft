...
export const id_ID: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "corpseHarvest": {
      "title": "Panen",
      "harvestButton": "Panen",
      "harvestTooltip": "[ID] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.",
    ...
    "townFocus": {
      ...
      "tierHint": "[ID] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.",
      "townOnlyHint": "[ID] Focus can only be changed while you are in town.",
    ...
    "bags": {
      ...
      "itemAriaInstanced": "[ID] {item}, quantity {count}, maker-marked copy",
    ...
    "loot": {
      "chestTitle": "Peti",
      "takeLootButton": "[ID] Take Loot",
      "takeLootTooltip": "[ID] Takes the coins and dropped items. Does not use up the harvest.",
      "unifiedPressHint": "[ID] The interact key loots and harvests in one press, using your town focus."
    },
    "spellbook": {
    ...
    "social": {
      ...
      "onlineHeader": "[ID] Online ({n})",
      "offlineHeader": "[ID] Offline ({n})",
      "hideOffline": "[ID] Hide offline",
      "hideOfflineTitle": "[ID] Hide offline guild members"
    },
    "gathering": {
      "title": "Pengumpulan",
      "mining": "Penambangan",
      ...
      "catchLine": "[ID] You reel in: {name}",
      "biteLine": "[ID] Something takes the bait!",
      "gotAwayLine": "[ID] It got away.",
      "nodeName": {
        "ore": "[ID] Ore Vein",
        "wood": "[ID] Timber Stand",
        "herb": "[ID] Herb Patch"
      },
      "tierRequired": {
        "mining": "[ID] Requires a tier {tier} mining pick",
        "logging": "[ID] Requires a tier {tier} logging axe",
        "herbalism": "[ID] Requires a tier {tier} herbalism sickle"
      },
      "toolTierUnmet": {
        "mining": "[ID] You need a tier {tier} mining pick to harvest this vein.",
        "logging": "[ID] You need a tier {tier} logging axe to fell this stand.",
        "herbalism": "[ID] You need a tier {tier} herbalism sickle to gather this patch."
      },
      "toolTierUnmetCorpse": "[ID] You need a tier {tier} gathering tool to recover the finest materials.",
      "downgradeMark": "[ID] Bags full: the find was stored without its gatherer's mark.",
      "downgradeFind": "[ID] Bags full: a pristine find slipped away.",
      "stateReady": "[ID] Ready",
      "stateCooldown": "[ID] Respawning"
    },
    "archetypeTitle": {
      "label": "Gelar",
      "none": "Tidak Ada",
    ...
    "enchantName": {
      "enchant_weapon_might": "[ID] Enchant Weapon - Might",
      "enchant_weapon_intellect": "[ID] Enchant Weapon - Spellpower",
      "enchant_helmet_fortitude": "[ID] Enchant Helmet - Fortitude",
      "enchant_neck_spirit": "[ID] Enchant Necklace - Spirit",
      "enchant_shoulder_agility": "[ID] Enchant Shoulders - Agility",
      "enchant_chest_stamina": "[ID] Enchant Chest - Stamina",
      "enchant_waist_stamina": "[ID] Enchant Belt - Stamina",
      "enchant_legs_stamina": "[ID] Enchant Legs - Stamina",
      "enchant_gloves_agility": "[ID] Enchant Gloves - Agility",
      "enchant_gloves_intellect": "[ID] Enchant Gloves - Spellpower",
      "enchant_feet_agility": "[ID] Enchant Boots - Agility",
      "enchant_ring_spirit": "[ID] Enchant Ring - Spirit",
      "enchant_weapon_agility": "[ID] Enchant Weapon - Agility",
      "enchant_helmet_intellect": "[ID] Enchant Helmet - Intellect",
      "enchant_helmet_armor": "[ID] Enchant Helmet - Reinforcement",
      "enchant_neck_intellect": "[ID] Enchant Necklace - Intellect",
      "enchant_neck_agility": "[ID] Enchant Necklace - Agility",
      "enchant_shoulder_strength": "[ID] Enchant Shoulders - Strength",
      "enchant_shoulder_intellect": "[ID] Enchant Shoulders - Intellect",
      "enchant_chest_spirit": "[ID] Enchant Chest - Spirit",
      "enchant_chest_armor": "[ID] Enchant Chest - Reinforcement",
      "enchant_waist_strength": "[ID] Enchant Belt - Strength",
      "enchant_waist_agility": "[ID] Enchant Belt - Agility",
      "enchant_legs_intellect": "[ID] Enchant Legs - Intellect",
      "enchant_gloves_strength": "[ID] Enchant Gloves - Strength",
      "enchant_feet_strength": "[ID] Enchant Boots - Strength",
      "enchant_feet_stamina": "[ID] Enchant Boots - Stamina",
      "enchant_ring_strength": "[ID] Enchant Ring - Strength",
      "enchant_ring_agility": "[ID] Enchant Ring - Agility",
      "enchant_ring_intellect": "[ID] Enchant Ring - Intellect",
      "enchant_weapon_greater_might": "[ID] Enchant Weapon - Greater Might",
      "enchant_weapon_greater_spellpower": "[ID] Enchant Weapon - Greater Spellpower",
      "enchant_helmet_greater_fortitude": "[ID] Enchant Helmet - Greater Fortitude",
      "enchant_chest_greater_stamina": "[ID] Enchant Chest - Greater Stamina",
      "enchant_legs_greater_stamina": "[ID] Enchant Legs - Greater Stamina",
      "enchant_gloves_greater_agility": "[ID] Enchant Gloves - Greater Agility",
      "enchant_weapon_runed_edge": "[ID] Enchant Weapon - Runed Edge",
      "enchant_weapon_runed_focus": "[ID] Enchant Weapon - Runed Focus",
      "enchant_chest_runeweave": "[ID] Enchant Chest - Runeweave",
      "enchant_legs_runed_hide": "[ID] Enchant Legs - Runed Hide",
      "enchant_helmet_runed_links": "[ID] Enchant Helmet - Runed Links"
    },
    "professions": {
      "title": "Profesi",
      "close": "Tutup profesi",
      ...
      "nextUnlockMastered": "[ID] Mastered, for now",
    ...
    "crafting": {
      ...
      "attunementReturnCost": "[ID] If you leave this pair, returning to it later costs {cost} make-amends tasks.",
      "identity": {
      ...
      "difficultyMinimal": "[ID] Minimal skill gain",
      ...
      "learnMoreAtStation": "[ID] {master} at the {station} can teach you more {craft} recipes.",
      ...
      "trendNudge": "[ID] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.",
      "trendNudgeNoMaster": "[ID] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.",
      "attunedZoneLine": "[ID] {name} has attuned as {archetype}!",
      "attunedBanner": "[ID] Attuned: {title}",
      "tierTutorial": {
        "title": "[ID] Your First Tier",
        "tierCap": "[ID] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.",
        "radar": "[ID] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.",
        "masters": "[ID] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.",
        "dismiss": "[ID] Got it"
      },
    ...
    "itemMenu": {
      ...
      "salvage": "[ID] Salvage",
      "applyEnchant": "[ID] Apply Enchant"
    },
    "enchanting": {
      "disenchantedLine": "[ID] You disenchant {item}.",
      "salvagedLine": "[ID] You salvage {item}.",
      "enchantAppliedLine": "[ID] You enchant {item} with {enchant}.",
      "notHeld": "[ID] You do not have that item.",
      "notDisenchantable": "[ID] You cannot disenchant that.",
      "notSalvageable": "[ID] You cannot salvage that.",
      "disenchantThrottled": "[ID] You are disenchanting too quickly. Wait a moment and try again.",
      "salvageThrottled": "[ID] You are salvaging too quickly. Wait a moment and try again.",
      "enchantThrottled": "[ID] You are enchanting too quickly. Wait a moment and try again.",
      "enchantWrongSlot": "[ID] That enchant cannot be applied to that item.",
      "enchantUnknown": "[ID] That enchant does not exist.",
      "enchantInsufficient": "[ID] You do not have the materials for that enchant.",
      "disenchantConfirmTitle": "[ID] Disenchant {item}?",
      "disenchantConfirmBody": "[ID] This destroys {item} and yields arcane materials. This cannot be undone.",
      "disenchantConfirmBodySpecial": "[ID] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.",
      "salvageConfirmTitle": "[ID] Salvage {item}?",
      "salvageConfirmBody": "[ID] This destroys {item} and yields crafting materials. This cannot be undone.",
      "salvageConfirmBodySpecial": "[ID] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.",
      "pickerTitle": "[ID] Apply Enchant",
      "targetTitle": "[ID] Choose an item to enchant",
      "noEnchants": "[ID] No enchant uses this reagent.",
      "noTargets": "[ID] No eligible item to enchant."
    },
    "training": {
  ...
  "stats": {
    ...
    "charactersCreated": "[ID] Characters Created",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "tradeBound": "[ID] That item is bound and cannot be traded."
    },
    "logs": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "mosshide_vest": {
        "name": "[ID] Mosshide Vest"
      },
      "thornling_grips": {
        "name": "[ID] Thornling Grips"
      },
      "acolyte_chain_grips": {
        "name": "[ID] Acolyte Chain Grips"
      },
      "votive_chain_belt": {
        "name": "[ID] Votive Chain Belt"
      },
      "briarroot_staff": {
        "name": "[ID] Briarroot Staff"
      },
      "valefire_lantern": {
        "name": "[ID] Valefire Lantern"
      },
      "fenbark_leggings": {
        "name": "[ID] Fenbark Leggings"
      },
      "mirebloom_treads": {
        "name": "[ID] Mirebloom Treads"
      },
      "fenwarden_sabatons": {
        "name": "[ID] Fenwarden Sabatons"
      },
      "marshlight_hauberk": {
        "name": "[ID] Marshlight Hauberk"
      },
      "duskthorn_mantle": {
        "name": "[ID] Duskthorn Mantle"
      },
      "fenshadow_maul": {
        "name": "[ID] Fenshadow Maul"
      },
      "wildgrove_cinch": {
        "name": "[ID] Wildgrove Cinch"
      },
      "cragward_pauldrons": {
        "name": "[ID] Cragward Pauldrons"
      },
      "cragthorn_greatstaff": {
        "name": "[ID] Cragthorn Greatstaff"
      },
      "moonbark_vestments": {
        "name": "[ID] Moonbark Vestments"
      },
      "peaksong_helm": {
        "name": "[ID] Peaksong Helm"
      },
      "stormchant_gauntlets": {
        "name": "[ID] Stormchant Gauntlets"
      },
      "cragprowl_belt": {
        "name": "[ID] Cragprowl Belt"
      },
      "stormroot_cowl": {
        "name": "[ID] Stormroot Cowl"
      },
      "thunderward_legguards": {
        "name": "[ID] Thunderward Legguards"
      },
      "revenantstep_treads": {
        "name": "[ID] Revenantstep Treads"
      },
      "shardfang_grips": {
        "name": "[ID] Shardfang Grips"
      },
      "shardsong_mantle": {
        "name": "[ID] Shardsong Mantle"
      },
      "wyrmcult_spellgrips": {
        "name": "[ID] Wyrmcult Spellgrips"
      },
      "thornpeak_wildwraps": {
        "name": "[ID] Thornpeak Wildwraps"
      },
      "stormvotive_hauberk": {
        "name": "[ID] Stormvotive Hauberk"
      },
      "cryptbloom_shoulderguards": {
        "name": "[ID] Cryptbloom Shoulderguards"
      },
      "gravewyrm_thornmaul": {
        "name": "[ID] Gravewyrm Thornmaul"
      },
      "vestments_of_the_waking_grove": {
        "name": "[ID] Vestments of the Waking Grove"
      },
      "nightfangs_greatstaff": {
        "name": "[ID] Nightfang's Greatstaff"
      },
      "maul_of_the_scourged_wilds": {
        "name": "[ID] Maul of the Scourged Wilds"
      },
      "tidehymn_slippers": {
        "name": "[ID] Tidehymn Slippers"
      },
      "pearlward_aegis": {
        "name": "[ID] Pearlward Aegis"
      },
      "wildgrowth_leggings": {
        "name": "[ID] Wildgrowth Leggings"
      },
      "grovewardens_grips": {
        "name": "[ID] Grovewarden's Grips"
      },
      "verdant_walkers": {
        "name": "[ID] Verdant Walkers"
      },
      "lunarward_cinch": {
        "name": "[ID] Lunarward Cinch"
      },
      "dreamroot_boots": {
        "name": "[ID] Dreamroot Boots"
      },
      "stormbark_mantle": {
        "name": "[ID] Stormbark Mantle"
      },
      "wildsoul_maul": {
        "name": "[ID] Wildsoul Maul"
      },
      "resonant_thread": {
        "name": "[ID] Resonant Thread"
      },
      "resonant_hide": {
        "name": "[ID] Resonant Hide"
      },
      "resonant_links": {
        "name": "[ID] Resonant Links"
      },
      "resonant_steel": {
        "name": "[ID] Resonant Steel"
      },
      "resonant_timber": {
        "name": "[ID] Resonant Timber"
      },
      "conjured_water4": {
    ...
    "quests": {
      ...
      "q_prof_amends_apothecary": {
        "title": "[ID] Back on the Stove",
        "text": "[ID] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.",
        "completion": "[ID] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.",
        "objectives": {
          "0": {
            "label": "[ID] Wild Boar hunted"
          }
      ...
      "q_prof_amends_bombardier": {
        "title": "[ID] The Ledger Grows",
        "text": "[ID] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.",
        "completion": "[ID] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?",
        "objectives": {
          "0": {
            "label": "[ID] Tunnel Rat exterminated"
          }
        }
      },
      "q_prof_workorder_forge": {
        "title": "[ID] Forge Work Order",
        "text": "[ID] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.",
        "completion": "[ID] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.",
        "objectives": {
          "0": {
            "label": "[ID] Copper Ore delivered"
          }
        }
      },
      "q_prof_workorder_kitchens": {
        "title": "[ID] Kitchens Work Order",
        "text": "[ID] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.",
        "completion": "[ID] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.",
        "objectives": {
          "0": {
            "label": "[ID] Game Meat delivered"
          }
        }
      },
      "q_prof_workorder_loom": {
        "title": "[ID] Loom Work Order",
        "text": "[ID] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.",
        "completion": "[ID] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.",
        "objectives": {
          "0": {
            "label": "[ID] Spider Silk delivered"
          }
        }
      },
      "q_prof_workorder_toolworks": {
        "title": "[ID] Toolworks Work Order",
        "text": "[ID] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.",
        "completion": "[ID] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.",
        "objectives": {
          "0": {
            "label": "[ID] Ironbark Log delivered"
          }
        }
      },
      "q_prof_workorder_tannery": {
        "title": "[ID] Tannery Work Order",
        "text": "[ID] Vats are empty. Bring eight rough hides. Coin when you do.",
        "completion": "[ID] Good hides. Fair pay. Again when you have more.",
        "objectives": {
          "0": {
            "label": "[ID] Rough Hide delivered"
          }
        }
      },
      "q_prof_workorder_apothecary": {
        "title": "[ID] Apothecary Work Order",
        "text": "[ID] My shelves require goldleaf, and the market's stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.",
        "completion": "[ID] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.",
        "objectives": {
          "0": {
            "label": "[ID] Goldleaf Herb delivered"
          }
        }
      },
      "q_prof_hobby_switch": {
    ...
    "letters": {
      ...
      "mastery_reset_notice": {
        "sender": "[ID] The Guildhall",
        "subject": "[ID] Your craft, made honest",
      ...
      "prof_tier_weaponcrafting_armorcrafting_1": {
        "sender": "[ID] Forgemistress Darva",
        "subject": "[ID] A spark worth noting",
        "body": "[ID] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot."
      },
      "prof_tier_weaponcrafting_armorcrafting_2": {
        "sender": "[ID] Forgemistress Darva",
        "subject": "[ID] Rare work, and earned",
        "body": "[ID] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good."
      },
      "prof_tier_weaponcrafting_armorcrafting_3": {
        "sender": "[ID] Forgemistress Darva",
        "subject": "[ID] The metal answers you now",
        "body": "[ID] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm."
      },
      "prof_tier_weaponcrafting_armorcrafting_4": {
        "sender": "[ID] Forgemistress Darva",
        "subject": "[ID] Near the top of the ladder",
        "body": "[ID] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb."
      },
      "prof_tier_weaponcrafting_armorcrafting_5": {
        "sender": "[ID] Forgemistress Darva",
        "subject": "[ID] Mastery, at last",
        "body": "[ID] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new."
      },
      "prof_tier_leatherworking_tailoring_1": {
        "sender": "[ID] Weaver Ottilie",
        "subject": "[ID] An even first row",
        "body": "[ID] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully."
      },
      "prof_tier_leatherworking_tailoring_2": {
        "sender": "[ID] Weaver Ottilie",
        "subject": "[ID] Rare work, well measured",
        "body": "[ID] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased."
      },
      "prof_tier_leatherworking_tailoring_3": {
        "sender": "[ID] Weaver Ottilie",
        "subject": "[ID] The pattern comes clear",
        "body": "[ID] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice."
      },
      "prof_tier_leatherworking_tailoring_4": {
        "sender": "[ID] Weaver Ottilie",
        "subject": "[ID] One row from the top",
        "body": "[ID] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now."
      },
      "prof_tier_leatherworking_tailoring_5": {
        "sender": "[ID] Weaver Ottilie",
        "subject": "[ID] The last stitch",
        "body": "[ID] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly."
      },
      "prof_tier_alchemy_cooking_1": {
        "sender": "[ID] Cook Marlow",
        "subject": "[ID] A taste of things to come",
        "body": "[ID] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving."
      },
      "prof_tier_alchemy_cooking_2": {
        "sender": "[ID] Cook Marlow",
        "subject": "[ID] Rare work, and no burnt edges",
        "body": "[ID] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long."
      },
      "prof_tier_alchemy_cooking_3": {
        "sender": "[ID] Cook Marlow",
        "subject": "[ID] Now you are cooking",
        "body": "[ID] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting."
      },
      "prof_tier_alchemy_cooking_4": {
        "sender": "[ID] Cook Marlow",
        "subject": "[ID] One course from the feast",
        "body": "[ID] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle."
      },
      "prof_tier_alchemy_cooking_5": {
        "sender": "[ID] Cook Marlow",
        "subject": "[ID] Mastery, served hot",
        "body": "[ID] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table."
      },
      "prof_tier_engineering_alchemy_1": {
        "sender": "[ID] Tinker Gizzel",
        "subject": "[ID] FIRST spark, ha",
        "body": "[ID] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go."
      },
      "prof_tier_engineering_alchemy_2": {
        "sender": "[ID] Tinker Gizzel",
        "subject": "[ID] Rare, oh, RARE",
        "body": "[ID] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA."
      },
      "prof_tier_engineering_alchemy_3": {
        "sender": "[ID] Tinker Gizzel",
        "subject": "[ID] Now it gets loud",
        "body": "[ID] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses."
      },
      "prof_tier_engineering_alchemy_4": {
        "sender": "[ID] Tinker Gizzel",
        "subject": "[ID] One rung, ONE, from the top",
        "body": "[ID] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink."
      },
      "prof_tier_engineering_alchemy_5": {
        "sender": "[ID] Tinker Gizzel",
        "subject": "[ID] MASTERY, kaboom",
        "body": "[ID] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous."
      }
    },
    "itemSets": {
      "boundstone_vanguard": {
