...
export const sv_SE: EnTranslations = {
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "mirrorBlurb": "Ett månbelyst, dimhöljt land av svart glas bortom Highwatchs speglar, där Glasdalen vaktar rikets slutspelsandar och Väktarinnan Nerissa håller Lumen-sänkan.",
      "mirrorGreeting": "Glaset behåller varje ansikte det har dränkt. Gå varsamt här, och blicka inte för länge in i ditt eget.",
      "mirrorGreeter": "Väktarinnan Nerissa, Lumen-sänkan",
      "mirrorPlaceNotes": "Lumen-sänkan är spegelstadens hjärta, med Spegelhovet och dess gargoljstatyer strax ovanför och Utsiktstrappan som stupar nedanför; Spegelsjön är stilla svart vatten, omgärdad av Månängen och Sorgestenarna; Dysterklipporna och Mörkskogen rymmer dalens tyngsta andar; Häxans Sänka hyser Morwen Dimhäxan, Stjärnskådarens Avsats sin långa kalla utsikt, och Den Svarta Ravinen slingrar sig österut till Sable-spegeln.",
