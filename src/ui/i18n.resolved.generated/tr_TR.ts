...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "walkByAutoloot": "Yanından geçerken otomatik yağmala",
  ...
  "auth": {
    ...
    "recovery": {
      ...
      "failed": "Geçerli bir e-posta adresi gir."
    }
  },
  "wallet": {
    "label": "$WOC Cüzdanı",
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_stalker_cloaks": {
        ...
        "objectives": {
          "0": {
            "label": "Sırt İzci postu"
          }
        }
      },
      "q_old_cragmaw": {
        "title": "Yaşlı Cragmaw",
        "text": "Yaşlı Cragmaw: de sporen leiden naar de westelijke kam boven de zuidweg, {playerName}. Neem hulp mee en versla het oude beest.",
        "completion": "Yaşlı Cragmaw is gevallen, {playerName}. De patrouilles kunnen de weg weer gebruiken en de kam is rustiger door je werk.",
        "objectives": {
          "0": {
