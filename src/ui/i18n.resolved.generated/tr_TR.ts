...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "corpseHarvest": {
      "title": "Toplama",
      "harvestButton": "Topla",
      "harvestTooltip": "[TR] Gathers the checked components. Each corpse can be harvested once, first come. Does not take the loot.",
    ...
    "townFocus": {
      ...
      "tierHint": "[TR] Every {points} points on a component raise its harvest tier one step, up to {steps} steps; fewer than {points} points still boost the yield.",
      "townOnlyHint": "[TR] Focus can only be changed while you are in town.",
    ...
    "bags": {
      ...
      "itemAriaInstanced": "[TR] {item}, quantity {count}, maker-marked copy",
    ...
    "loot": {
      "chestTitle": "Sandık",
      "takeLootButton": "[TR] Take Loot",
      "takeLootTooltip": "[TR] Takes the coins and dropped items. Does not use up the harvest.",
      "unifiedPressHint": "[TR] The interact key loots and harvests in one press, using your town focus."
    },
    "spellbook": {
    ...
    "social": {
      ...
      "onlineHeader": "[TR] Online ({n})",
      "offlineHeader": "[TR] Offline ({n})",
      "hideOffline": "[TR] Hide offline",
      "hideOfflineTitle": "[TR] Hide offline guild members"
    },
    "gathering": {
      "title": "Toplama",
      "mining": "Madencilik",
      ...
      "catchLine": "[TR] You reel in: {name}",
      "biteLine": "[TR] Something takes the bait!",
      "gotAwayLine": "[TR] It got away.",
      "nodeName": {
        "ore": "[TR] Ore Vein",
        "wood": "[TR] Timber Stand",
        "herb": "[TR] Herb Patch"
      },
      "tierRequired": {
        "mining": "[TR] Requires a tier {tier} mining pick",
        "logging": "[TR] Requires a tier {tier} logging axe",
        "herbalism": "[TR] Requires a tier {tier} herbalism sickle"
      },
      "toolTierUnmet": {
        "mining": "[TR] You need a tier {tier} mining pick to harvest this vein.",
        "logging": "[TR] You need a tier {tier} logging axe to fell this stand.",
        "herbalism": "[TR] You need a tier {tier} herbalism sickle to gather this patch."
      },
      "toolTierUnmetCorpse": "[TR] You need a tier {tier} gathering tool to recover the finest materials.",
      "downgradeMark": "[TR] Bags full: the find was stored without its gatherer's mark.",
      "downgradeFind": "[TR] Bags full: a pristine find slipped away.",
      "stateReady": "[TR] Ready",
      "stateCooldown": "[TR] Respawning"
    },
    "archetypeTitle": {
      "label": "Unvan",
      "none": "Yok",
    ...
    "enchantName": {
      "enchant_weapon_might": "[TR] Enchant Weapon - Might",
      "enchant_weapon_intellect": "[TR] Enchant Weapon - Spellpower",
      "enchant_helmet_fortitude": "[TR] Enchant Helmet - Fortitude",
      "enchant_neck_spirit": "[TR] Enchant Necklace - Spirit",
      "enchant_shoulder_agility": "[TR] Enchant Shoulders - Agility",
      "enchant_chest_stamina": "[TR] Enchant Chest - Stamina",
      "enchant_waist_stamina": "[TR] Enchant Belt - Stamina",
      "enchant_legs_stamina": "[TR] Enchant Legs - Stamina",
      "enchant_gloves_agility": "[TR] Enchant Gloves - Agility",
      "enchant_gloves_intellect": "[TR] Enchant Gloves - Spellpower",
      "enchant_feet_agility": "[TR] Enchant Boots - Agility",
      "enchant_ring_spirit": "[TR] Enchant Ring - Spirit",
      "enchant_weapon_agility": "[TR] Enchant Weapon - Agility",
      "enchant_helmet_intellect": "[TR] Enchant Helmet - Intellect",
      "enchant_helmet_armor": "[TR] Enchant Helmet - Reinforcement",
      "enchant_neck_intellect": "[TR] Enchant Necklace - Intellect",
      "enchant_neck_agility": "[TR] Enchant Necklace - Agility",
      "enchant_shoulder_strength": "[TR] Enchant Shoulders - Strength",
      "enchant_shoulder_intellect": "[TR] Enchant Shoulders - Intellect",
      "enchant_chest_spirit": "[TR] Enchant Chest - Spirit",
      "enchant_chest_armor": "[TR] Enchant Chest - Reinforcement",
      "enchant_waist_strength": "[TR] Enchant Belt - Strength",
      "enchant_waist_agility": "[TR] Enchant Belt - Agility",
      "enchant_legs_intellect": "[TR] Enchant Legs - Intellect",
      "enchant_gloves_strength": "[TR] Enchant Gloves - Strength",
      "enchant_feet_strength": "[TR] Enchant Boots - Strength",
      "enchant_feet_stamina": "[TR] Enchant Boots - Stamina",
      "enchant_ring_strength": "[TR] Enchant Ring - Strength",
      "enchant_ring_agility": "[TR] Enchant Ring - Agility",
      "enchant_ring_intellect": "[TR] Enchant Ring - Intellect",
      "enchant_weapon_greater_might": "[TR] Enchant Weapon - Greater Might",
      "enchant_weapon_greater_spellpower": "[TR] Enchant Weapon - Greater Spellpower",
      "enchant_helmet_greater_fortitude": "[TR] Enchant Helmet - Greater Fortitude",
      "enchant_chest_greater_stamina": "[TR] Enchant Chest - Greater Stamina",
      "enchant_legs_greater_stamina": "[TR] Enchant Legs - Greater Stamina",
      "enchant_gloves_greater_agility": "[TR] Enchant Gloves - Greater Agility",
      "enchant_weapon_runed_edge": "[TR] Enchant Weapon - Runed Edge",
      "enchant_weapon_runed_focus": "[TR] Enchant Weapon - Runed Focus",
      "enchant_chest_runeweave": "[TR] Enchant Chest - Runeweave",
      "enchant_legs_runed_hide": "[TR] Enchant Legs - Runed Hide",
      "enchant_helmet_runed_links": "[TR] Enchant Helmet - Runed Links"
    },
    "professions": {
      "title": "Meslekler",
      ...
      "nextUnlockMastered": "[TR] Mastered, for now",
    ...
    "crafting": {
      ...
      "attunementReturnCost": "[TR] If you leave this pair, returning to it later costs {cost} make-amends tasks.",
      "identity": {
      ...
      "trendNudge": "[TR] Your hands are leaning toward the {archetype}. Its attunement waits with {master}.",
      "trendNudgeNoMaster": "[TR] Your hands are leaning toward the {archetype}. Seek a craft master to take it up.",
      "attunedZoneLine": "[TR] {name} has attuned as {archetype}!",
      "attunedBanner": "[TR] Attuned: {title}",
      "tierTutorial": {
        "title": "[TR] Your First Tier",
        "tierCap": "[TR] A craft reaches its first tier at {skill} skill, and each tier improves what it can make. But a craft only climbs past rare work once it is one of your two majors.",
        "radar": "[TR] Your professions form a wheel. Attune to an adjacent pair and those two crafts become uncapped majors, one craft across the wheel becomes a rare-capped hobby, and the rest lie dormant: their knowledge kept, but capped at common until you take them up again.",
        "masters": "[TR] Craft masters in the towns offer attunement quests. Visit one to choose your pair whenever you are ready. Nothing you have learned is ever lost.",
        "dismiss": "[TR] Got it"
      },
      "makersMark": "{name} tarafından hazırlanmıştır",
      "gatheredBy": "[TR] Gathered by {name}",
    ...
    "itemMenu": {
      "use": "Kullan",
      "equip": "[TR] Equip",
      "disenchant": "[TR] Disenchant",
      "salvage": "[TR] Salvage",
      "applyEnchant": "[TR] Apply Enchant"
    },
    "enchanting": {
      "disenchantedLine": "[TR] You disenchant {item}.",
      "salvagedLine": "[TR] You salvage {item}.",
      "enchantAppliedLine": "[TR] You enchant {item} with {enchant}.",
      "notHeld": "[TR] You do not have that item.",
      "notDisenchantable": "[TR] You cannot disenchant that.",
      "notSalvageable": "[TR] You cannot salvage that.",
      "disenchantThrottled": "[TR] You are disenchanting too quickly. Wait a moment and try again.",
      "salvageThrottled": "[TR] You are salvaging too quickly. Wait a moment and try again.",
      "enchantThrottled": "[TR] You are enchanting too quickly. Wait a moment and try again.",
      "enchantWrongSlot": "[TR] That enchant cannot be applied to that item.",
      "enchantUnknown": "[TR] That enchant does not exist.",
      "enchantInsufficient": "[TR] You do not have the materials for that enchant.",
      "disenchantConfirmTitle": "[TR] Disenchant {item}?",
      "disenchantConfirmBody": "[TR] This destroys {item} and yields arcane materials. This cannot be undone.",
      "disenchantConfirmBodySpecial": "[TR] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields arcane materials. This cannot be undone.",
      "salvageConfirmTitle": "[TR] Salvage {item}?",
      "salvageConfirmBody": "[TR] This destroys {item} and yields crafting materials. This cannot be undone.",
      "salvageConfirmBodySpecial": "[TR] This destroys a special copy of {item} (signed, masterwork, or enchanted) and yields crafting materials. This cannot be undone.",
      "pickerTitle": "[TR] Apply Enchant",
      "targetTitle": "[TR] Choose an item to enchant",
      "noEnchants": "[TR] No enchant uses this reagent.",
      "noTargets": "[TR] No eligible item to enchant."
    },
    "training": {
      "title": "Eğitim: {name}",
      "close": "Eğitimi kapat",
  ...
  "stats": {
    ...
    "charactersCreated": "[TR] Characters Created",
  ...
  "hud": {
    ...
    "errors": {
      ...
      "tradeBound": "[TR] That item is bound and cannot be traded."
    },
    "logs": {
  ...
  "entities": {
    ...
    "items": {
      ...
      "mosshide_vest": {
        "name": "[TR] Mosshide Vest"
      },
      "thornling_grips": {
        "name": "[TR] Thornling Grips"
      },
      "acolyte_chain_grips": {
        "name": "[TR] Acolyte Chain Grips"
      },
      "votive_chain_belt": {
        "name": "[TR] Votive Chain Belt"
      },
      "briarroot_staff": {
        "name": "[TR] Briarroot Staff"
      },
      "valefire_lantern": {
        "name": "[TR] Valefire Lantern"
      },
      "fenbark_leggings": {
        "name": "[TR] Fenbark Leggings"
      },
      "mirebloom_treads": {
        "name": "[TR] Mirebloom Treads"
      },
      "fenwarden_sabatons": {
        "name": "[TR] Fenwarden Sabatons"
      },
      "marshlight_hauberk": {
        "name": "[TR] Marshlight Hauberk"
      },
      "duskthorn_mantle": {
        "name": "[TR] Duskthorn Mantle"
      },
      "fenshadow_maul": {
        "name": "[TR] Fenshadow Maul"
      },
      "wildgrove_cinch": {
        "name": "[TR] Wildgrove Cinch"
      },
      "cragward_pauldrons": {
        "name": "[TR] Cragward Pauldrons"
      },
      "cragthorn_greatstaff": {
        "name": "[TR] Cragthorn Greatstaff"
      },
      "moonbark_vestments": {
        "name": "[TR] Moonbark Vestments"
      },
      "peaksong_helm": {
        "name": "[TR] Peaksong Helm"
      },
      "stormchant_gauntlets": {
        "name": "[TR] Stormchant Gauntlets"
      },
      "cragprowl_belt": {
        "name": "[TR] Cragprowl Belt"
      },
      "stormroot_cowl": {
        "name": "[TR] Stormroot Cowl"
      },
      "thunderward_legguards": {
        "name": "[TR] Thunderward Legguards"
      },
      "revenantstep_treads": {
        "name": "[TR] Revenantstep Treads"
      },
      "shardfang_grips": {
        "name": "[TR] Shardfang Grips"
      },
      "shardsong_mantle": {
        "name": "[TR] Shardsong Mantle"
      },
      "wyrmcult_spellgrips": {
        "name": "[TR] Wyrmcult Spellgrips"
      },
      "thornpeak_wildwraps": {
        "name": "[TR] Thornpeak Wildwraps"
      },
      "stormvotive_hauberk": {
        "name": "[TR] Stormvotive Hauberk"
      },
      "cryptbloom_shoulderguards": {
        "name": "[TR] Cryptbloom Shoulderguards"
      },
      "gravewyrm_thornmaul": {
        "name": "[TR] Gravewyrm Thornmaul"
      },
      "vestments_of_the_waking_grove": {
        "name": "[TR] Vestments of the Waking Grove"
      },
      "nightfangs_greatstaff": {
        "name": "[TR] Nightfang's Greatstaff"
      },
      "maul_of_the_scourged_wilds": {
        "name": "[TR] Maul of the Scourged Wilds"
      },
      "tidehymn_slippers": {
        "name": "[TR] Tidehymn Slippers"
      },
      "pearlward_aegis": {
        "name": "[TR] Pearlward Aegis"
      },
      "wildgrowth_leggings": {
        "name": "[TR] Wildgrowth Leggings"
      },
      "grovewardens_grips": {
        "name": "[TR] Grovewarden's Grips"
      },
      "verdant_walkers": {
        "name": "[TR] Verdant Walkers"
      },
      "lunarward_cinch": {
        "name": "[TR] Lunarward Cinch"
      },
      "dreamroot_boots": {
        "name": "[TR] Dreamroot Boots"
      },
      "stormbark_mantle": {
        "name": "[TR] Stormbark Mantle"
      },
      "wildsoul_maul": {
        "name": "[TR] Wildsoul Maul"
      },
      "resonant_thread": {
        "name": "[TR] Resonant Thread"
      },
      "resonant_hide": {
        "name": "[TR] Resonant Hide"
      },
      "resonant_links": {
        "name": "[TR] Resonant Links"
      },
      "resonant_steel": {
        "name": "[TR] Resonant Steel"
      },
      "resonant_timber": {
        "name": "[TR] Resonant Timber"
      },
      "conjured_water4": {
    ...
    "quests": {
      ...
      "q_prof_amends_apothecary": {
        "title": "[TR] Back on the Stove",
        "text": "[TR] Well, look who is back at my pot. No hard feelings, {playerName}, a kitchen always has room, but you know the tab runs longer every time you walk out on it. Go thin the wild boars in the east meadow, because honest sweat is the first ingredient, and it will remind your hands of the work.",
        "completion": "[TR] There is the old flavor. Alchemy and Cooking are back on your stove as majors. Stay a while this time.",
        "objectives": {
          "0": {
            "label": "[TR] Wild Boar hunted"
          }
      ...
      "q_prof_amends_bombardier": {
        "title": "[TR] The Ledger Grows",
        "text": "[TR] You came BACK, ha, they always come back, the loud stuff has a pull, yes? No sulking from me, {playerName}, but the ledger, oh the ledger, it grows every time you skip out, more each return, that is only fair. Go clear the tunnel rats out of the dig for me, sweat first, sparks later, that is the rule I just made up.",
        "completion": "[TR] THERE it is, the itch is back in your hands. Engineering and Alchemy, majors again, go on, go make a bang. Try to stay put this time, eh?",
        "objectives": {
          "0": {
            "label": "[TR] Tunnel Rat exterminated"
          }
        }
      },
      "q_prof_workorder_forge": {
        "title": "[TR] Forge Work Order",
        "text": "[TR] The forge always wants feeding, {playerName}. Bring me eight lumps of copper ore and I will see you paid for the haul. No ceremony, just ore and coin.",
        "completion": "[TR] Good weight, no slag. Here is your due. The forge will be hungry again soon enough.",
        "objectives": {
          "0": {
            "label": "[TR] Copper Ore delivered"
          }
        }
      },
      "q_prof_workorder_kitchens": {
        "title": "[TR] Kitchens Work Order",
        "text": "[TR] My larder is looking thin, {playerName}, and thin larders make grumpy cooks. Fetch me eight cuts of game meat and there is coin in it for you, plus my undying gratitude, which is worth less but tastes better.",
        "completion": "[TR] Now that is a full pantry. Here is your pay. Come back when your bags are heavy again.",
        "objectives": {
          "0": {
            "label": "[TR] Game Meat delivered"
          }
        }
      },
      "q_prof_workorder_loom": {
        "title": "[TR] Loom Work Order",
        "text": "[TR] The loom runs dry and idle hands waste daylight, {playerName}. Bring me six skeins of spider silk and I will pay you a fair rate, counted out to the copper.",
        "completion": "[TR] Fine silk, evenly spun. Your coin, exactly measured. The loom thanks you, and so do I.",
        "objectives": {
          "0": {
            "label": "[TR] Spider Silk delivered"
          }
        }
      },
      "q_prof_workorder_toolworks": {
        "title": "[TR] Toolworks Work Order",
        "text": "[TR] Hafts, handles, stocks, I go through wood like it is going out of style, which it is NOT, wood is eternal, {playerName}. Haul me eight ironbark logs and I will pay you, coin, real coin, not a favor, I promise, mostly.",
        "completion": "[TR] Perfect, perfect, straight grain, no rot. Here, your coin, see, I keep my word (mostly). Bring more when you trip over a tree.",
        "objectives": {
          "0": {
            "label": "[TR] Ironbark Log delivered"
          }
        }
      },
      "q_prof_workorder_tannery": {
        "title": "[TR] Tannery Work Order",
        "text": "[TR] Vats are empty. Bring eight rough hides. Coin when you do.",
        "completion": "[TR] Good hides. Fair pay. Again when you have more.",
        "objectives": {
          "0": {
            "label": "[TR] Rough Hide delivered"
          }
        }
      },
      "q_prof_workorder_apothecary": {
        "title": "[TR] Apothecary Work Order",
        "text": "[TR] My shelves require goldleaf, and the market's stock is, predictably, adulterated. Bring me six goldleaf herbs, unbruised, and you will be compensated precisely. Bruised leaves will be declined, so mind your satchel.",
        "completion": "[TR] Acceptable. Potent, and properly handled. Your payment, counted to the coin. Do not let it go to your head, that is a different reagent.",
        "objectives": {
          "0": {
            "label": "[TR] Goldleaf Herb delivered"
          }
        }
      },
      "q_prof_hobby_switch": {
    ...
    "letters": {
      ...
      "mastery_reset_notice": {
        "sender": "[TR] The Guildhall",
        "subject": "[TR] Your craft, made honest",
      ...
      "prof_tier_weaponcrafting_armorcrafting_1": {
        "sender": "[TR] Forgemistress Darva",
        "subject": "[TR] A spark worth noting",
        "body": "[TR] Word reaches my forge that one of your majors now holds at uncommon work. It is the smallest rung on a long climb, but you earned it at the anvil, not by asking. Keep the fire hot."
      },
      "prof_tier_weaponcrafting_armorcrafting_2": {
        "sender": "[TR] Forgemistress Darva",
        "subject": "[TR] Rare work, and earned",
        "body": "[TR] They tell me a major of yours has reached rare work. That is the rung where sloppy hands fall away and the real smiths are left standing. You are still standing. Good."
      },
      "prof_tier_weaponcrafting_armorcrafting_3": {
        "sender": "[TR] Forgemistress Darva",
        "subject": "[TR] The metal answers you now",
        "body": "[TR] A major of yours has climbed past rare into serious work. The metal answers a hand like that, no longer fighting it. Do not let the praise soften your arm."
      },
      "prof_tier_weaponcrafting_armorcrafting_4": {
        "sender": "[TR] Forgemistress Darva",
        "subject": "[TR] Near the top of the ladder",
        "body": "[TR] One of your majors stands a single rung below mastery. Few hands I have known reach this height, and fewer keep their edge here. Finish the climb."
      },
      "prof_tier_weaponcrafting_armorcrafting_5": {
        "sender": "[TR] Forgemistress Darva",
        "subject": "[TR] Mastery, at last",
        "body": "[TR] A major of yours has reached mastery, the highest a hand can climb. I do not give praise freely, so hear this once: the forge is proud of you. Now go teach the fire something new."
      },
      "prof_tier_leatherworking_tailoring_1": {
        "sender": "[TR] Weaver Ottilie",
        "subject": "[TR] An even first row",
        "body": "[TR] The guild notes that one of your majors has reached uncommon work. It is only the first row of many, but it is even and true. Measure the next as carefully."
      },
      "prof_tier_leatherworking_tailoring_2": {
        "sender": "[TR] Weaver Ottilie",
        "subject": "[TR] Rare work, well measured",
        "body": "[TR] A major of yours has climbed to rare work. That is where a careless hand shows every dropped stitch, and yours has not. I am quietly pleased."
      },
      "prof_tier_leatherworking_tailoring_3": {
        "sender": "[TR] Weaver Ottilie",
        "subject": "[TR] The pattern comes clear",
        "body": "[TR] One of your majors has passed rare into finer work. The pattern comes clear to a hand at this level, no more guessing. Keep measuring twice."
      },
      "prof_tier_leatherworking_tailoring_4": {
        "sender": "[TR] Weaver Ottilie",
        "subject": "[TR] One row from the top",
        "body": "[TR] A major of yours sits one row short of mastery. The last row is always the hardest to keep even. Do not rush it now."
      },
      "prof_tier_leatherworking_tailoring_5": {
        "sender": "[TR] Weaver Ottilie",
        "subject": "[TR] The last stitch",
        "body": "[TR] A major of yours has reached mastery. I measured your work twice, as I measure everything, and it holds. Few hands ever tie the last stitch this cleanly. I am proud, and I do not say so lightly."
      },
      "prof_tier_alchemy_cooking_1": {
        "sender": "[TR] Cook Marlow",
        "subject": "[TR] A taste of things to come",
        "body": "[TR] Word drifts back to my kitchen that one of your majors has reached uncommon work. It is a first taste, nothing more, but a promising one. Keep the pot moving."
      },
      "prof_tier_alchemy_cooking_2": {
        "sender": "[TR] Cook Marlow",
        "subject": "[TR] Rare work, and no burnt edges",
        "body": "[TR] They tell me a major of yours has simmered up to rare work. That is the heat where most cooks scorch the dish, and you did not. Sit, but not for long."
      },
      "prof_tier_alchemy_cooking_3": {
        "sender": "[TR] Cook Marlow",
        "subject": "[TR] Now you are cooking",
        "body": "[TR] One of your majors has bubbled past rare into real depth. Now you are cooking, as they say. Season boldly and keep tasting."
      },
      "prof_tier_alchemy_cooking_4": {
        "sender": "[TR] Cook Marlow",
        "subject": "[TR] One course from the feast",
        "body": "[TR] A major of yours is a single course short of mastery. The last one is always the richest and the easiest to overdo. Steady hands on the ladle."
      },
      "prof_tier_alchemy_cooking_5": {
        "sender": "[TR] Cook Marlow",
        "subject": "[TR] Mastery, served hot",
        "body": "[TR] A major of yours has reached mastery, the top shelf of the whole pantry. I feed everyone, but few ever cook their way up here. Proud of you, truly. Now go make something that makes them weep at the table."
      },
      "prof_tier_engineering_alchemy_1": {
        "sender": "[TR] Tinker Gizzel",
        "subject": "[TR] FIRST spark, ha",
        "body": "[TR] Oi, the numbers say one of your majors just hit uncommon work, small potatoes, tiny, but it POPPED, yes? First spark is always the cutest. More sparks. Go."
      },
      "prof_tier_engineering_alchemy_2": {
        "sender": "[TR] Tinker Gizzel",
        "subject": "[TR] Rare, oh, RARE",
        "body": "[TR] They tell me a major of yours climbed to rare work, and rare is where it starts getting properly dangerous (the good kind). Most hands quit before the fun. Not you. HA."
      },
      "prof_tier_engineering_alchemy_3": {
        "sender": "[TR] Tinker Gizzel",
        "subject": "[TR] Now it gets loud",
        "body": "[TR] One of your majors blew past rare into the serious stuff, oh this is where it gets LOUD. Do not stop now, whatever you do, momentum is everything, also fuses."
      },
      "prof_tier_engineering_alchemy_4": {
        "sender": "[TR] Tinker Gizzel",
        "subject": "[TR] One rung, ONE, from the top",
        "body": "[TR] A major of yours is ONE rung under mastery, one, singular, do you feel it humming? The last step is the biggest bang. Do not blink."
      },
      "prof_tier_engineering_alchemy_5": {
        "sender": "[TR] Tinker Gizzel",
        "subject": "[TR] MASTERY, kaboom",
        "body": "[TR] A major of yours hit mastery, the very TOP, kaboom, the whole ladder, done. I do not hand out praise, I hand out fuses, but here, take both: you are brilliant and slightly terrifying. Go make the mountains nervous."
      }
    },
    "itemSets": {
      "boundstone_vanguard": {
