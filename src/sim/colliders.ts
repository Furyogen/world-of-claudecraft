...
function staticWorldColliders(seed: number): Collider[] {
  ...
  // Atlantis dome glass: each dome ring becomes a run of OBB wall segments,
  // skipping the open gap arcs (the city ↔ annex breach). The glass is
  // see-through, so the chase cam ghosts through instead of pulling in.
