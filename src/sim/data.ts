...
export const ARENA_X_MIN = INSTANCE_X_BASE + 4160; // includes the complete 44yd arena footprint plus camera margin
export const ARENA_X_MAX = INSTANCE_X_BASE + 4240;
