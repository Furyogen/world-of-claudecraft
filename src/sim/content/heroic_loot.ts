...
export const HEROIC_ITEMS: Record<string, ItemDef> = {
  ...
  deathless_greatblade: {
    ...
    // A 2H carries BOTH hands' stat budgets (TWOHAND_STAT_MULT in
    // item_budget.ts): the one-hand 22 points double to 44, split on the same
    // 13:9 identity (normalizePrimaryStats), which lands exactly on 26/18.
    stats: { str: 26, sta: 18 },
    sellValue: 16000,
    requiredClass: HEAVY,
  },
