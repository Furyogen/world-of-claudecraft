...
export function helpLines(): string[] {
  return [
    ...
    'Hide a player: /mute <name>, /unmute <name>, /mutelist (aliases /ignore, /unignore, /ignorelist). A mute hides their public chat only; blocking, from the player menu, also stops their invites, whispers and mail.',
