...
export function helpLines(): string[] {
  return [
    ...
    'Hide a player: /mute <name> hides their public chat only. /block <name> (alias /ignore) also stops their whispers, invites and mail. Also /unmute, /unblock, /mutelist, /blocklist.',
