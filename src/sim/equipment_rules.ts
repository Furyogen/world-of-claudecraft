...
// can wield a dagger": rogues and hunters, plus druids since they fight with
// one-handed blades out of form and their feral forms scale from the Agility a
// dagger carries (src/sim/melee_ap.ts).
//
