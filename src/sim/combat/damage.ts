...
export function dealDamage(
  ...
  // [dev] A god-mode player (/dev god) hits for 100x so a solo tester can down
  // raid bosses to inspect drops. Gated on devCommands so it can NEVER apply in
  // production (where gm marks real, non-fighting game masters). Draws no rng.
