...
import { authoredColliders } from './rift/authored';
...
export interface DungeonLayout {
  ...
  /** Authored axis-aligned room graph used by bespoke dungeon interiors. When
   * present it REPLACES the rectangular/polygon shell entirely: walls, collision,
   * and the rendered modules all derive from these fields (see rift/authored.ts
   * and dungeon_rooms.ts). */
  rooms?: AuthoredRoom[];
