...
export const INFERNAL_ABYSS_LAYOUT: DungeonLayout = {
  ...
  decor: [
    ...
    { key: 'lava_brazier', x: -6, z: 14, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 6, z: 22, yaw: Math.PI, r: 0.9 },
    ...
    { key: 'lava_brazier', x: -58, z: 47, yaw: Math.PI / 2, r: 0.9 },
    { key: 'lava_brazier', x: -38, z: 55, yaw: -Math.PI / 2, r: 0.9 },
    ...
    { key: 'lava_brazier', x: 30, z: 92, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 60, z: 72, yaw: Math.PI, r: 0.9 },
    { key: 'chained_demon_obelisk', x: 37, z: 73, yaw: 0, r: 1.4 },
    { key: 'chained_demon_obelisk', x: 58, z: 91, yaw: Math.PI, r: 1.4 },
    { key: 'lava_brazier', x: -7, z: 102, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 7, z: 108, yaw: Math.PI, r: 0.9 },
    { key: 'lava_fissure', x: 0, z: 134, yaw: 0, scale: 2.2 },
    { key: 'lava_brazier', x: -5, z: 161, yaw: Math.PI / 2, r: 0.9 },
    { key: 'lava_brazier', x: 5, z: 161, yaw: -Math.PI / 2, r: 0.9 },
    { key: 'lava_brazier', x: -29, z: 184, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 29, z: 184, yaw: Math.PI, r: 0.9 },
    { key: 'lava_brazier', x: -29, z: 210, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 29, z: 210, yaw: Math.PI, r: 0.9 },
    { key: 'lava_brazier', x: -8, z: 177, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 8, z: 177, yaw: Math.PI, r: 0.9 },
    { key: 'lava_brazier', x: -8, z: 213, yaw: 0, r: 0.9 },
    { key: 'lava_brazier', x: 8, z: 213, yaw: Math.PI, r: 0.9 },
