...
| Ruin statue prop (`public/models/props/ruin_statue.glb`) | World of ClaudeCraft | Project-generated via Tripo AI text-to-3D and optimized for shipping | Project asset |
