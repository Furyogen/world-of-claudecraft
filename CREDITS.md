...
| Generated creature model + animations (kauriki_form, the druid Kauriki tank form) | World of ClaudeCraft | Project-generated Tripo AI 3D sculpt, owned under the Tripo paid-plan license; auto-rigged with preset clip retargets, then a locally authored haka attack and death clip plus per-clip sole and arm corrections baked via scripts/build_kauriki_form_anims.mjs | Project asset | With the project only |
