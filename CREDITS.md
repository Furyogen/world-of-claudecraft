...
license**. Media assets that are not listed here are MIT like everything else.
...
- **Community-contributed artwork and recordings used with permission** — the
  ...
  effect. These were contributed to World of ClaudeCraft by community members
  and are used with permission granted to Levy Street. **Redistribution requires
  permission, which must be arranged through Levy Street** (tony@levystreet.com).
