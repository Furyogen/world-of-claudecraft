...
| Infernal Abyss models (Azazel, Pyre Golem, heart altar, forge anvil, chained obelisk, weapon rack, lava brazier) | World of ClaudeCraft | Project-generated via Tripo AI v3 (text/image-to-3D, creatures rigged and animated), owned under the Tripo paid-plan terms | Project asset |
| Infernal Abyss environment set (furnace, throne, maze wall, chain gantry, bridge, magma spires, portcullis, forge crane) | World of ClaudeCraft | Project-generated via Tripo AI v3 (text/image-to-3D), owned under the Tripo paid-plan terms | Project asset |
| Infernal Abyss detail set (skull gate, lavafall shrine, cracked floor plate, battlefield debris, crucible, forge tools, bellows, armory crates, weapon display, spectator stand, hanging cage, guardian statue) | World of ClaudeCraft | Project-generated via Tripo AI v3 (text/image-to-3D), owned under the Tripo paid-plan terms | Project asset |
| Infernal Abyss ambience set (basalt buttress, furnace wall relief, chained war banners, ossuary pile, molten ingot molds, arena carnage, horned wall sconce, magma crystals) | World of ClaudeCraft | Project-generated via Tripo AI v3 (text/image-to-3D), owned under the Tripo paid-plan terms | Project asset |
...
| Goldcrest Bank reference building (`public/models/props/goldcrest_bank_reference.glb`) | World of ClaudeCraft | Project-generated via Tripo AI and restored through `scripts/asset_pipeline`; owned under the Tripo paid-plan license | Project asset |
