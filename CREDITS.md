...
| Hover cosmetic back attachments (hover_butterfly_wings, hover_angel_wings, hover_jetpack in `public/models/cosmetics/`) | World of ClaudeCraft | Project-generated via scripts/asset_pipeline (Tripo AI 3D), packaged by scripts/build_hover_attachments.mjs | Project asset |
