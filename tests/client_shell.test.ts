...
describe('client HTML shell', () => {
  ...
  it('ships crawlable SEO metadata and sitemap hints', () => {
    ...
    expect(dataDeletionHtml).toContain('href="https://discord.gg/wYCQAfppF7"');
    ...
    expect(supportHtml).toContain('href="https://discord.gg/wYCQAfppF7"');
  ...
  it('offers Discord and Donate entries in the mobile drawer of BOTH entries', () => {
    ...
    expect(mainTs).toContain("const DISCORD_INVITE_URL = 'https://discord.gg/wYCQAfppF7';");
