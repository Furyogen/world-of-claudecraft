...
describe('item-art consistency accepted-art provenance', () => {
  it('pins the exact scope, style contract, and byte-identical generation reports', () => {
    ...
    expect(value.sourceEvidence).toEqual([
      ...
      },
      {
        ...
        acceptedSha256: '53f0ef99cc3b1bc29b85f7757648e8c0f0ce4807eb865aa1901f58c5413b1ef2',
        acceptedBytes: 109_679,
      },
    ]);
  ...
  it('pins the final 817-item visual audit, Heroic accounting, and evidence digests', () => {
    ...
    expect(verdictBytes.length).toBe(109_679);
    expect(sha256(verdictBytes)).toBe(
      '53f0ef99cc3b1bc29b85f7757648e8c0f0ce4807eb865aa1901f58c5413b1ef2',
    );
    ...
    expect(verdict.evidence.catalog).toEqual({
      ...
      sha256: '3d5b08f0e7d1bae1ecc3e74785344ac20bc71aee4fa0087431c264513134339d',
      bytes: 455_328,
    });
    ...
    expect(verdict.evidence.sheetSetSha256).toBe(
      '94cea359bc5a1e91b2d5aba6f94529939bd1f8e64410ff6219ea1497f6acb0dd',
    );
    ...
    expect(verdict.evidence.shippingCatalogSha256).toBe(
      '537b63d3f0d8b80c825d1d951e6c3e976c9604748efd1b6e19038fe64a1b5094',
    );
