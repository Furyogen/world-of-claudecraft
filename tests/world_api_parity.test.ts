...
// it lands the matching edit here in the SAME commit. The count pins (222 / 60 / 162)
...
// Partition: 60 `data` + 162 `method` (read-returning + command-void + async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 27 facets', () => {
  ...
  it('the union of the 27 facets equals the pinned 222-member IWORLD_MEMBERS set', () => {
