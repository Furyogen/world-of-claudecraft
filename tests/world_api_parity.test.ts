...
//
// `IWorld` (src/world_api.ts, 208 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (208 / 54 / 154)
...
// The 208 members of `interface IWorld`, in interface order (world_api.ts).
...
export const IWORLD_MEMBERS = [
  ...
  { name: 'muteAdd', kind: 'method' },
  { name: 'muteRemove', kind: 'method' },
...
//   (4) their union, sorted, equals the pinned 208-name IWORLD_MEMBERS set (a member
