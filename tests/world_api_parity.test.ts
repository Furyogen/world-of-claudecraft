...
// it lands the matching edit here in the SAME commit. The count pins (183 / 49 / 134)
...
// Partition: 49 `data` + 134 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 134', () => {
