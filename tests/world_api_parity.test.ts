...
// it lands the matching edit here in the SAME commit. The count pins (161 / 39 / 122)
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 22 facets', () => {
  ...
  it('the union of the 23 facets equals the pinned 161-member IWORLD_MEMBERS set', () => {
