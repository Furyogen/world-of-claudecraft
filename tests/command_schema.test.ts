...
const EXPECTED_SEND_COUNT = 141; // +readyrespond, deed title, the four authoritative Rift item-progression commands, Season 1 Armory skin, ignore_add/ignore_remove, and unstuck
const EXPECTED_DISPATCH_COUNT = 150; // client commands plus the 9 dispatch-only commands
