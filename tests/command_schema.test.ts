...
const EXPECTED_SEND_COUNT = 134; // +bank, Vale Cup, town focus, deed title, stow_weapon, readyrespond
const EXPECTED_DISPATCH_COUNT = 143; // +bank, Vale Cup, town focus, deed title, stow_weapon, readyrespond
