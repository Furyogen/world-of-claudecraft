...
const EXPECTED_SEND_COUNT = 133; // +readyrespond, bank commands, Vale Cup, town focus, stow_weapon
const EXPECTED_DISPATCH_COUNT = 142; // +readyrespond, bank commands, Vale Cup, town focus, stow_weapon
