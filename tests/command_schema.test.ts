...
const EXPECTED_SEND_COUNT = 132; // +bank deposit/withdraw/buy-slots, Vale Cup, town focus, stow_weapon
const EXPECTED_DISPATCH_COUNT = 141; // +bank deposit/withdraw/buy-slots, Vale Cup, town focus, stow_weapon
